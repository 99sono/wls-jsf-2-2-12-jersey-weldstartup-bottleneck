...
public class AppScopedBean3575 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3575.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3575");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3575");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3575");
    }
