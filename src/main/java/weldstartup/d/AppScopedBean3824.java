...
public class AppScopedBean3824 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3824.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3824");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3824");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3824");
    }
