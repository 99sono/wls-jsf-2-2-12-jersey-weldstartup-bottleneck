...
public class AppScopedBean3637 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3637.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3637");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3637");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3637");
    }
