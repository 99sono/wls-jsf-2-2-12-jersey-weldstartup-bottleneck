...
public class AppScopedBean3237 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3237.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3237");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3237");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3237");
    }
