...
public class AppScopedBean3361 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3361.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3361");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3361");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3361");
    }
