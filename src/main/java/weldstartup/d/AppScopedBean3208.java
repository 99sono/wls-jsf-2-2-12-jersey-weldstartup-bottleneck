...
public class AppScopedBean3208 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3208.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3208");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3208");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3208");
    }
