...
public class AppScopedBean3010 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3010.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3010");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3010");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3010");
    }
