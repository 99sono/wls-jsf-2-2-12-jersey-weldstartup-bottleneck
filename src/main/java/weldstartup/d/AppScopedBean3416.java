...
public class AppScopedBean3416 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3416.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3416");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3416");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3416");
    }
