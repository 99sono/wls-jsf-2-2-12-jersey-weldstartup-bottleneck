...
public class AppScopedBean3834 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3834.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3834");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3834");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3834");
    }
