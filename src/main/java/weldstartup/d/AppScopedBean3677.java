...
public class AppScopedBean3677 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3677.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3677");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3677");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3677");
    }
