...
public class AppScopedBean3571 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3571.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3571");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3571");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3571");
    }
