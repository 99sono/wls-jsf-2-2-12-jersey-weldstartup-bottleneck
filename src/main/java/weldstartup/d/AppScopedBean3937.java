...
public class AppScopedBean3937 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3937.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3937");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3937");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3937");
    }
