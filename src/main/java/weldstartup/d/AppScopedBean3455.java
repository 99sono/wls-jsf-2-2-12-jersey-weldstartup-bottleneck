...
public class AppScopedBean3455 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3455.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3455");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3455");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3455");
    }
