...
public class AppScopedBean3224 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3224.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3224");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3224");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3224");
    }
