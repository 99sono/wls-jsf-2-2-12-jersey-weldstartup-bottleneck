...
public class AppScopedBean3627 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3627.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3627");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3627");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3627");
    }
