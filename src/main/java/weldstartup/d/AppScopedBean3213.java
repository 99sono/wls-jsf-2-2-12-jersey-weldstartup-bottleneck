...
public class AppScopedBean3213 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3213.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3213");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3213");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3213");
    }
