...
public class AppScopedBean3431 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3431.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3431");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3431");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3431");
    }
