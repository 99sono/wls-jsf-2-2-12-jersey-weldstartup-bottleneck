...
public class AppScopedBean3454 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3454.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3454");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3454");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3454");
    }
