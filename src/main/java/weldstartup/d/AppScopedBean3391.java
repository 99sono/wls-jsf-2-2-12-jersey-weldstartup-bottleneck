...
public class AppScopedBean3391 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3391.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3391");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3391");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3391");
    }
