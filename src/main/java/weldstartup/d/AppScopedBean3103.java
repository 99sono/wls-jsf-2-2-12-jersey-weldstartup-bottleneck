...
public class AppScopedBean3103 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3103.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3103");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3103");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3103");
    }
