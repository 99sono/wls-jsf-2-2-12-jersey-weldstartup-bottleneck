...
public class AppScopedBean3938 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3938.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3938");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3938");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3938");
    }
