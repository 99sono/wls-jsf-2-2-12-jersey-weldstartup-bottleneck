...
public class AppScopedBean3815 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3815.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3815");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3815");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3815");
    }
