...
public class AppScopedBean3693 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3693.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3693");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3693");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3693");
    }
