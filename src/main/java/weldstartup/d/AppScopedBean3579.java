...
public class AppScopedBean3579 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3579.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3579");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3579");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3579");
    }
