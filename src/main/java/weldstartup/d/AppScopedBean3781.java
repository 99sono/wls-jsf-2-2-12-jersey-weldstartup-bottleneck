...
public class AppScopedBean3781 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3781.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3781");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3781");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3781");
    }
