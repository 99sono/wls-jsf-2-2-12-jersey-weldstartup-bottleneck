...
public class AppScopedBean3468 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3468.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3468");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3468");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3468");
    }
