...
public class AppScopedBean3014 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3014.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3014");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3014");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3014");
    }
