...
public class AppScopedBean3315 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3315.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3315");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3315");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3315");
    }
