...
public class AppScopedBean3596 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3596.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3596");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3596");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3596");
    }
