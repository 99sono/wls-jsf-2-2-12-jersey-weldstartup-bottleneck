...
public class AppScopedBean3566 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3566.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3566");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3566");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3566");
    }
