...
public class AppScopedBean3161 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3161.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3161");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3161");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3161");
    }
