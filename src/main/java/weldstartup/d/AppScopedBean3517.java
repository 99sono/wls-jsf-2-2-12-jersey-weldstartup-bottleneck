...
public class AppScopedBean3517 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3517.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3517");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3517");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3517");
    }
