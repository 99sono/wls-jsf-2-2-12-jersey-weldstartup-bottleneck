...
public class AppScopedBean3039 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3039.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3039");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3039");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3039");
    }
