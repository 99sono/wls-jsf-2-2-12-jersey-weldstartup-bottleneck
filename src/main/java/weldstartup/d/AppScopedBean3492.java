...
public class AppScopedBean3492 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3492.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3492");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3492");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3492");
    }
