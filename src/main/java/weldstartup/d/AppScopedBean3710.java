...
public class AppScopedBean3710 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3710.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3710");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3710");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3710");
    }
