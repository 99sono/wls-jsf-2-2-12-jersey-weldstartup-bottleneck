...
public class AppScopedBean3368 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3368.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3368");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3368");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3368");
    }
