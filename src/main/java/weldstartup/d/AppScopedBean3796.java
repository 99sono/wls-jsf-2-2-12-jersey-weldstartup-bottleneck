...
public class AppScopedBean3796 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3796.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3796");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3796");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3796");
    }
