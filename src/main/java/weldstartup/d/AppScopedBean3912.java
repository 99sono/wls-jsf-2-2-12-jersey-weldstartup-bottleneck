...
public class AppScopedBean3912 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3912.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3912");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3912");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3912");
    }
