...
public class AppScopedBean3723 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3723.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3723");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3723");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3723");
    }
