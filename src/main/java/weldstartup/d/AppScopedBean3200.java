...
public class AppScopedBean3200 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3200.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3200");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3200");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3200");
    }
