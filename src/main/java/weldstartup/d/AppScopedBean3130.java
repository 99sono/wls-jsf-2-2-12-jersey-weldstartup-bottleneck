...
public class AppScopedBean3130 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3130.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3130");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3130");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3130");
    }
