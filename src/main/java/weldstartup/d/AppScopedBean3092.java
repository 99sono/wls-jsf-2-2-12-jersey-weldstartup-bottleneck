...
public class AppScopedBean3092 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3092.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3092");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3092");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3092");
    }
