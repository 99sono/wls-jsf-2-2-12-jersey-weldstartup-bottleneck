...
public class AppScopedBean3046 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3046.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3046");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3046");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3046");
    }
