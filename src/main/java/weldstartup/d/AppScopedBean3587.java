...
public class AppScopedBean3587 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3587.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3587");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3587");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3587");
    }
