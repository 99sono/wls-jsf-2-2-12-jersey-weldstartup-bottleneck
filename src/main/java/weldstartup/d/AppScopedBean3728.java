...
public class AppScopedBean3728 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3728.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3728");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3728");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3728");
    }
