...
public class AppScopedBean3850 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3850.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3850");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3850");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3850");
    }
