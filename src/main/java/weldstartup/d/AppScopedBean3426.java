...
public class AppScopedBean3426 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3426.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3426");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3426");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3426");
    }
