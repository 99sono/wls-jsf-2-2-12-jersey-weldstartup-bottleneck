...
public class AppScopedBean3050 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3050.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3050");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3050");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3050");
    }
