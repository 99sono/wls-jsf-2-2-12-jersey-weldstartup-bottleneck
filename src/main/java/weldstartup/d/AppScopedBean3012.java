...
public class AppScopedBean3012 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3012.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3012");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3012");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3012");
    }
