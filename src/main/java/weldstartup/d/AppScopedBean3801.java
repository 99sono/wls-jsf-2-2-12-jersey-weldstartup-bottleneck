...
public class AppScopedBean3801 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3801.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3801");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3801");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3801");
    }
