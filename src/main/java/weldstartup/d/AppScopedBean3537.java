...
public class AppScopedBean3537 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3537.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3537");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3537");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3537");
    }
