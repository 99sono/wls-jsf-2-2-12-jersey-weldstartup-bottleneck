...
public class AppScopedBean3134 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3134.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3134");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3134");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3134");
    }
