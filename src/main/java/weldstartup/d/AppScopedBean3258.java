...
public class AppScopedBean3258 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3258.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3258");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3258");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3258");
    }
