...
public class AppScopedBean3837 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3837.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3837");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3837");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3837");
    }
