...
public class AppScopedBean3541 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3541.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3541");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3541");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3541");
    }
