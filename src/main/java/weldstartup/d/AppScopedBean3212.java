...
public class AppScopedBean3212 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3212.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3212");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3212");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3212");
    }
