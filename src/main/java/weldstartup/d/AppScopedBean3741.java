...
public class AppScopedBean3741 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3741.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3741");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3741");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3741");
    }
