...
public class AppScopedBean3062 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3062.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3062");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3062");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3062");
    }
