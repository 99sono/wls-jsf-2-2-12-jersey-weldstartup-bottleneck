...
public class AppScopedBean3221 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3221.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3221");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3221");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3221");
    }
