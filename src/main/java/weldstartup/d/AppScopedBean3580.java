...
public class AppScopedBean3580 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3580.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3580");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3580");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3580");
    }
