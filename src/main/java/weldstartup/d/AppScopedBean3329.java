...
public class AppScopedBean3329 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3329.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3329");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3329");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3329");
    }
