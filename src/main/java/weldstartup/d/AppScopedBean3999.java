...
public class AppScopedBean3999 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3999.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3999");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3999");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3999");
    }
