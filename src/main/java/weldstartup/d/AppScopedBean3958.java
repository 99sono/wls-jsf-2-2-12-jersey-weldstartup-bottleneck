...
public class AppScopedBean3958 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3958.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3958");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3958");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3958");
    }
