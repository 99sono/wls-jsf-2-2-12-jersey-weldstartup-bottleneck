...
public class AppScopedBean3518 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3518.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3518");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3518");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3518");
    }
