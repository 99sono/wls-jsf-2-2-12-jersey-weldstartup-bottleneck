...
public class AppScopedBean3334 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3334.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3334");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3334");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3334");
    }
