...
public class AppScopedBean3027 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3027.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3027");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3027");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3027");
    }
