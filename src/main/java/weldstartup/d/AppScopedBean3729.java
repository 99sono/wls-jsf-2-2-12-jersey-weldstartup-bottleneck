...
public class AppScopedBean3729 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3729.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3729");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3729");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3729");
    }
