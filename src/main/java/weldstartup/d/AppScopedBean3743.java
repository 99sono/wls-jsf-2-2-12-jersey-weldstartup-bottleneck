...
public class AppScopedBean3743 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3743.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3743");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3743");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3743");
    }
