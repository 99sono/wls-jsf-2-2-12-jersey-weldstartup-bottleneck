...
public class AppScopedBean3248 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3248.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3248");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3248");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3248");
    }
