...
public class AppScopedBean3164 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3164.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3164");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3164");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3164");
    }
