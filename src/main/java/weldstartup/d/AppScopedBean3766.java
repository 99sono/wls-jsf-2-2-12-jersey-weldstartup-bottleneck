...
public class AppScopedBean3766 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3766.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3766");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3766");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3766");
    }
