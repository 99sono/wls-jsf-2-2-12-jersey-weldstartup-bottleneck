...
public class AppScopedBean3506 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3506.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3506");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3506");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3506");
    }
