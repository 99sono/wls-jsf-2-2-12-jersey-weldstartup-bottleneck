...
public class AppScopedBean3389 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3389.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3389");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3389");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3389");
    }
