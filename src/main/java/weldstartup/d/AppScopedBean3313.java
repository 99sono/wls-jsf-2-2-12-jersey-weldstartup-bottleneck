...
public class AppScopedBean3313 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3313.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3313");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3313");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3313");
    }
