...
public class AppScopedBean3557 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3557.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3557");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3557");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3557");
    }
