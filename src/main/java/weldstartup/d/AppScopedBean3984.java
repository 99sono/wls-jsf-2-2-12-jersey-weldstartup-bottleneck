...
public class AppScopedBean3984 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3984.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3984");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3984");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3984");
    }
