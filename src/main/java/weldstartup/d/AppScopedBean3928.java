...
public class AppScopedBean3928 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3928.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3928");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3928");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3928");
    }
