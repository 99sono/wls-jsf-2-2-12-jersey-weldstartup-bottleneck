...
public class AppScopedBean3408 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3408.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3408");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3408");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3408");
    }
