...
public class AppScopedBean3354 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3354.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3354");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3354");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3354");
    }
