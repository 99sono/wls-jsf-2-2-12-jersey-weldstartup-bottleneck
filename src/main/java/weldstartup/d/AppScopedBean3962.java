...
public class AppScopedBean3962 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3962.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3962");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3962");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3962");
    }
