...
public class AppScopedBean3339 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3339.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3339");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3339");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3339");
    }
