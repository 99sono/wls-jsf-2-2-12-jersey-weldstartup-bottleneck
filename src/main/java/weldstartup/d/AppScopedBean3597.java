...
public class AppScopedBean3597 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3597.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3597");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3597");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3597");
    }
