...
public class AppScopedBean3529 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3529.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3529");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3529");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3529");
    }
