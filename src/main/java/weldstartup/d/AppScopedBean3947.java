...
public class AppScopedBean3947 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3947.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3947");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3947");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3947");
    }
