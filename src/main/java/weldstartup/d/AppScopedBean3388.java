...
public class AppScopedBean3388 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3388.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3388");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3388");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3388");
    }
