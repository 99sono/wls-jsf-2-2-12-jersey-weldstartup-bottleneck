...
public class AppScopedBean3605 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3605.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3605");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3605");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3605");
    }
