...
public class AppScopedBean3871 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3871.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3871");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3871");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3871");
    }
