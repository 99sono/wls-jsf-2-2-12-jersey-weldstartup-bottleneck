...
public class AppScopedBean3441 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3441.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3441");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3441");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3441");
    }
