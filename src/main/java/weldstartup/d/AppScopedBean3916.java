...
public class AppScopedBean3916 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3916.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3916");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3916");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3916");
    }
