...
public class AppScopedBean3459 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3459.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3459");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3459");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3459");
    }
