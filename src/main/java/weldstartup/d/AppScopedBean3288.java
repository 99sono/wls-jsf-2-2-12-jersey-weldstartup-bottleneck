...
public class AppScopedBean3288 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3288.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3288");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3288");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3288");
    }
