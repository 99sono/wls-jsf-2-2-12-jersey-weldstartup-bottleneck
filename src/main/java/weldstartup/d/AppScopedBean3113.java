...
public class AppScopedBean3113 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3113.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3113");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3113");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3113");
    }
