...
public class AppScopedBean3432 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3432.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3432");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3432");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3432");
    }
