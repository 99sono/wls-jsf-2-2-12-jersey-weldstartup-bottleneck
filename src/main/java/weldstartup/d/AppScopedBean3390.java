...
public class AppScopedBean3390 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3390.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3390");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3390");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3390");
    }
