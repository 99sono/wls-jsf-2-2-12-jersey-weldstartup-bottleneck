...
public class AppScopedBean3045 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3045.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3045");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3045");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3045");
    }
