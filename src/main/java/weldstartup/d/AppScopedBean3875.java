...
public class AppScopedBean3875 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3875.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3875");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3875");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3875");
    }
