...
public class AppScopedBean3748 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3748.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3748");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3748");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3748");
    }
