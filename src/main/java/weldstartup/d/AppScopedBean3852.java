...
public class AppScopedBean3852 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3852.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3852");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3852");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3852");
    }
