...
public class AppScopedBean3885 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3885.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3885");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3885");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3885");
    }
