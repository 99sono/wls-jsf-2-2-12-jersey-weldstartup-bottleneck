...
public class AppScopedBean3746 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3746.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3746");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3746");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3746");
    }
