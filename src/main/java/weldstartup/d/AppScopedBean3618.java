...
public class AppScopedBean3618 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3618.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3618");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3618");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3618");
    }
