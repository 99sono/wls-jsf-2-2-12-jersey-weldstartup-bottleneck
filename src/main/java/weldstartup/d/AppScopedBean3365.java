...
public class AppScopedBean3365 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3365.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3365");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3365");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3365");
    }
