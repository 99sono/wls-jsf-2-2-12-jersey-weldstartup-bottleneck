...
public class AppScopedBean3527 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3527.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3527");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3527");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3527");
    }
