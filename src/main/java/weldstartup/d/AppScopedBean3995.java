...
public class AppScopedBean3995 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3995.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3995");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3995");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3995");
    }
