...
public class AppScopedBean3095 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3095.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3095");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3095");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3095");
    }
