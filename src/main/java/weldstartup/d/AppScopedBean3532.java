...
public class AppScopedBean3532 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3532.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3532");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3532");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3532");
    }
