...
public class AppScopedBean3018 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3018.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3018");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3018");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3018");
    }
