...
public class AppScopedBean3735 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3735.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3735");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3735");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3735");
    }
