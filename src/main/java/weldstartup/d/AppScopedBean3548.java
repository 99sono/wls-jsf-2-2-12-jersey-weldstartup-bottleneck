...
public class AppScopedBean3548 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3548.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3548");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3548");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3548");
    }
