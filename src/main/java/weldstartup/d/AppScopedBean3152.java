...
public class AppScopedBean3152 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3152.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3152");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3152");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3152");
    }
