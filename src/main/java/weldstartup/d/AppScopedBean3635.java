...
public class AppScopedBean3635 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3635.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3635");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3635");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3635");
    }
