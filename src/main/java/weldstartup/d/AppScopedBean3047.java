...
public class AppScopedBean3047 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3047.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3047");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3047");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3047");
    }
