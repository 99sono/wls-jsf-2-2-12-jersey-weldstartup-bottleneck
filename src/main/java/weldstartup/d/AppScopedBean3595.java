...
public class AppScopedBean3595 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3595.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3595");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3595");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3595");
    }
