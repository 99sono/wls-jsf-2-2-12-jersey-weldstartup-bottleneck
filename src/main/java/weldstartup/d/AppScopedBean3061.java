...
public class AppScopedBean3061 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3061.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3061");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3061");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3061");
    }
