...
public class AppScopedBean3059 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3059.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3059");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3059");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3059");
    }
