...
public class AppScopedBean3006 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3006.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3006");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3006");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3006");
    }
