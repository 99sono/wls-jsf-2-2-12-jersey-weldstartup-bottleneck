...
public class AppScopedBean3291 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3291.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3291");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3291");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3291");
    }
