...
public class AppScopedBean3023 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3023.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3023");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3023");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3023");
    }
