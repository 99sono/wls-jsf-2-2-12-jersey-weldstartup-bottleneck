...
public class AppScopedBean3041 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3041.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3041");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3041");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3041");
    }
