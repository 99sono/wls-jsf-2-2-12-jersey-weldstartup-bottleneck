...
public class AppScopedBean3738 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3738.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3738");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3738");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3738");
    }
