...
public class AppScopedBean3378 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3378.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3378");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3378");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3378");
    }
