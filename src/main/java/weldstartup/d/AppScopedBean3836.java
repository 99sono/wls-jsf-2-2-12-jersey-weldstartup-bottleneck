...
public class AppScopedBean3836 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3836.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3836");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3836");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3836");
    }
