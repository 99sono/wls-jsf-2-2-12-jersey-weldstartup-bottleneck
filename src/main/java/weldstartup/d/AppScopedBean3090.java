...
public class AppScopedBean3090 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3090.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3090");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3090");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3090");
    }
