...
public class AppScopedBean3111 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3111.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3111");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3111");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3111");
    }
