...
public class AppScopedBean3906 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3906.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3906");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3906");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3906");
    }
