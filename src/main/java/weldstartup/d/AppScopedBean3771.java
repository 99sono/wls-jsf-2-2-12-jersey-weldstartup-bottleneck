...
public class AppScopedBean3771 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3771.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3771");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3771");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3771");
    }
