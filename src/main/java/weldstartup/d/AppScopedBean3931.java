...
public class AppScopedBean3931 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3931.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3931");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3931");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3931");
    }
