...
public class AppScopedBean3080 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3080.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3080");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3080");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3080");
    }
