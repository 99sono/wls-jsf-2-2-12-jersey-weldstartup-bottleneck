...
public class AppScopedBean3302 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3302.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3302");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3302");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3302");
    }
