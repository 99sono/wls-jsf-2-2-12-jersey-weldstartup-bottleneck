...
public class AppScopedBean3905 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3905.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3905");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3905");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3905");
    }
