...
public class AppScopedBean3862 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3862.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3862");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3862");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3862");
    }
