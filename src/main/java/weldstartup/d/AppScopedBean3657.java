...
public class AppScopedBean3657 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3657.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3657");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3657");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3657");
    }
