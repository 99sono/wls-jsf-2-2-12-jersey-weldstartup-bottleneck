...
public class AppScopedBean3476 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3476.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3476");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3476");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3476");
    }
