...
public class AppScopedBean3581 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3581.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3581");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3581");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3581");
    }
