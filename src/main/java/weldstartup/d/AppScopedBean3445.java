...
public class AppScopedBean3445 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3445.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3445");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3445");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3445");
    }
