...
public class AppScopedBean3369 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3369.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3369");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3369");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3369");
    }
