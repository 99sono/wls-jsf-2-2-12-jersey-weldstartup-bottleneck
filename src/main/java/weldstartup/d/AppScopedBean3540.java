...
public class AppScopedBean3540 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3540.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3540");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3540");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3540");
    }
