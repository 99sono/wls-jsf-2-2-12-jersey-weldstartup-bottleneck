...
public class AppScopedBean3067 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3067.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3067");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3067");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3067");
    }
