...
public class AppScopedBean3583 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3583.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3583");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3583");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3583");
    }
