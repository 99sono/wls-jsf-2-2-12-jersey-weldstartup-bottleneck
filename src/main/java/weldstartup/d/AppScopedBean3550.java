...
public class AppScopedBean3550 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3550.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3550");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3550");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3550");
    }
