...
public class AppScopedBean3994 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3994.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3994");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3994");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3994");
    }
