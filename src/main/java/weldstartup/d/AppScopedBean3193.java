...
public class AppScopedBean3193 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3193.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3193");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3193");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3193");
    }
