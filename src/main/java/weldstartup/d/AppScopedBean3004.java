...
public class AppScopedBean3004 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3004.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3004");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3004");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3004");
    }
