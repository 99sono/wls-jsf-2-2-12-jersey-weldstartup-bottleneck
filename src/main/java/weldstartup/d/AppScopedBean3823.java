...
public class AppScopedBean3823 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3823.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3823");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3823");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3823");
    }
