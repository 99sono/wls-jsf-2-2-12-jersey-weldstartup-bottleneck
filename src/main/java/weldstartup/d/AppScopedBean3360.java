...
public class AppScopedBean3360 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3360.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3360");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3360");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3360");
    }
