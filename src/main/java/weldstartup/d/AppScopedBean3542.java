...
public class AppScopedBean3542 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3542.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3542");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3542");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3542");
    }
