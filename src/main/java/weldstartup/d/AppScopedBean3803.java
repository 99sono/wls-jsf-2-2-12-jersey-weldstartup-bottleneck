...
public class AppScopedBean3803 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3803.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3803");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3803");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3803");
    }
