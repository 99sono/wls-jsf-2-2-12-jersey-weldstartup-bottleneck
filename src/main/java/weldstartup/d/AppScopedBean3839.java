...
public class AppScopedBean3839 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3839.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3839");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3839");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3839");
    }
