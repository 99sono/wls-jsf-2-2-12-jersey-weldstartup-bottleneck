...
public class AppScopedBean3272 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3272.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3272");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3272");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3272");
    }
