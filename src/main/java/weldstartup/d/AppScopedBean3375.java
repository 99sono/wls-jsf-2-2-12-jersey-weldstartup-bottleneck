...
public class AppScopedBean3375 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3375.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3375");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3375");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3375");
    }
