...
public class AppScopedBean3547 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3547.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3547");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3547");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3547");
    }
