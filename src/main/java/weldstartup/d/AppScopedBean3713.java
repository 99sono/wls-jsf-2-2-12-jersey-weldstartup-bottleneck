...
public class AppScopedBean3713 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3713.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3713");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3713");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3713");
    }
