...
public class AppScopedBean3220 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3220.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3220");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3220");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3220");
    }
