...
public class AppScopedBean3068 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3068.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3068");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3068");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3068");
    }
