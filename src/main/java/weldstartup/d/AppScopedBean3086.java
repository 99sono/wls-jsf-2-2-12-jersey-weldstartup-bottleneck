...
public class AppScopedBean3086 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3086.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3086");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3086");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3086");
    }
