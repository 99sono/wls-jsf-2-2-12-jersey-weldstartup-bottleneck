...
public class AppScopedBean3464 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3464.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3464");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3464");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3464");
    }
