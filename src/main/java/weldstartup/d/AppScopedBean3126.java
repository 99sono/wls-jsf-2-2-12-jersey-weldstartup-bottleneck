...
public class AppScopedBean3126 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3126.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3126");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3126");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3126");
    }
