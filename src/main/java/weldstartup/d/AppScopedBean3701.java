...
public class AppScopedBean3701 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3701.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3701");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3701");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3701");
    }
