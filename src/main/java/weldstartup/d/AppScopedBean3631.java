...
public class AppScopedBean3631 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3631.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3631");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3631");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3631");
    }
