...
public class AppScopedBean3970 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3970.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3970");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3970");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3970");
    }
