...
public class AppScopedBean3311 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3311.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3311");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3311");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3311");
    }
