...
public class AppScopedBean3473 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3473.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3473");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3473");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3473");
    }
