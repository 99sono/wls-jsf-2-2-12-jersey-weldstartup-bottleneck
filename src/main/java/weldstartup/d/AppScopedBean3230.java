...
public class AppScopedBean3230 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3230.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3230");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3230");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3230");
    }
