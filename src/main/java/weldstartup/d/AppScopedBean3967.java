...
public class AppScopedBean3967 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3967.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3967");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3967");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3967");
    }
