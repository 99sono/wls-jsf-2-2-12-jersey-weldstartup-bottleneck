...
public class AppScopedBean3672 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3672.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3672");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3672");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3672");
    }
