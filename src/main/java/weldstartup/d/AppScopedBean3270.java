...
public class AppScopedBean3270 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3270.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3270");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3270");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3270");
    }
