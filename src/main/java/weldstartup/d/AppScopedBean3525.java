...
public class AppScopedBean3525 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3525.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3525");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3525");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3525");
    }
