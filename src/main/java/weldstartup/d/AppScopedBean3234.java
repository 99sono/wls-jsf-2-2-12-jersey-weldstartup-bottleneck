...
public class AppScopedBean3234 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3234.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3234");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3234");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3234");
    }
