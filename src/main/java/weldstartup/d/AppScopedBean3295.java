...
public class AppScopedBean3295 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3295.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3295");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3295");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3295");
    }
