...
public class AppScopedBean3614 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3614.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3614");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3614");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3614");
    }
