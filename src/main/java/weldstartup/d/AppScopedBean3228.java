...
public class AppScopedBean3228 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3228.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3228");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3228");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3228");
    }
