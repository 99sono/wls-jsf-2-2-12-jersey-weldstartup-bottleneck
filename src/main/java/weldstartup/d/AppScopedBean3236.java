...
public class AppScopedBean3236 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3236.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3236");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3236");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3236");
    }
