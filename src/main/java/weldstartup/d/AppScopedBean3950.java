...
public class AppScopedBean3950 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3950.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3950");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3950");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3950");
    }
