...
public class AppScopedBean3484 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3484.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3484");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3484");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3484");
    }
