...
public class AppScopedBean3508 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3508.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3508");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3508");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3508");
    }
