...
public class AppScopedBean3749 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3749.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3749");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3749");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3749");
    }
