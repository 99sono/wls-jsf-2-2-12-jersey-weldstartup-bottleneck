...
public class AppScopedBean3822 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3822.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3822");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3822");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3822");
    }
