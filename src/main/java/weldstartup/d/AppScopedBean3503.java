...
public class AppScopedBean3503 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3503.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3503");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3503");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3503");
    }
