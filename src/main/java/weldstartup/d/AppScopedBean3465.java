...
public class AppScopedBean3465 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3465.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3465");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3465");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3465");
    }
