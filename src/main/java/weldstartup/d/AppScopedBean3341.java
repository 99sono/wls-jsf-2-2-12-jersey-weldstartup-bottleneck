...
public class AppScopedBean3341 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3341.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3341");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3341");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3341");
    }
