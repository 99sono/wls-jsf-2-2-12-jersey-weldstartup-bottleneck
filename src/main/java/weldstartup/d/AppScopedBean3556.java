...
public class AppScopedBean3556 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3556.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3556");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3556");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3556");
    }
