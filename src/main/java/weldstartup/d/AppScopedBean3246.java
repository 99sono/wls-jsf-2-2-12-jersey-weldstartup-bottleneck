...
public class AppScopedBean3246 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3246.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3246");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3246");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3246");
    }
