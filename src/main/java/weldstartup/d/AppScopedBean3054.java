...
public class AppScopedBean3054 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3054.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3054");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3054");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3054");
    }
