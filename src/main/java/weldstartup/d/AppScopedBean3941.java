...
public class AppScopedBean3941 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3941.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3941");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3941");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3941");
    }
