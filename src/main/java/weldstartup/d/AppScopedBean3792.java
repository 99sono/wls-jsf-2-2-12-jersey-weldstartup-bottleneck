...
public class AppScopedBean3792 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3792.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3792");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3792");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3792");
    }
