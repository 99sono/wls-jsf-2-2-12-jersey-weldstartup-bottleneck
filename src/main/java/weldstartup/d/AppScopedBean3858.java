...
public class AppScopedBean3858 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3858.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3858");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3858");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3858");
    }
