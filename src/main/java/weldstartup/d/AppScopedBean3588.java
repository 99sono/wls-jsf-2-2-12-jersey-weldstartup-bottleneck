...
public class AppScopedBean3588 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3588.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3588");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3588");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3588");
    }
