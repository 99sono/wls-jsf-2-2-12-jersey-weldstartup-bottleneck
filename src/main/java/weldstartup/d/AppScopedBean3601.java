...
public class AppScopedBean3601 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3601.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3601");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3601");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3601");
    }
