...
public class AppScopedBean3195 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3195.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3195");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3195");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3195");
    }
