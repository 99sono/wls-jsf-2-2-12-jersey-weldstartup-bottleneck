...
public class AppScopedBean3797 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3797.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3797");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3797");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3797");
    }
