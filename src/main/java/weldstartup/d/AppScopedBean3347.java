...
public class AppScopedBean3347 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3347.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3347");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3347");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3347");
    }
