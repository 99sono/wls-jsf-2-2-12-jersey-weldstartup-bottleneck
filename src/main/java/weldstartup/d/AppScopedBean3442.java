...
public class AppScopedBean3442 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3442.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3442");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3442");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3442");
    }
