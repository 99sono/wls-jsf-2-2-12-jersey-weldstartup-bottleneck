...
public class AppScopedBean3094 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3094.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3094");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3094");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3094");
    }
