...
public class AppScopedBean3474 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3474.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3474");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3474");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3474");
    }
