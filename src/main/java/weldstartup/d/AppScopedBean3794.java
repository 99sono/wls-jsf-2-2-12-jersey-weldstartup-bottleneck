...
public class AppScopedBean3794 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3794.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3794");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3794");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3794");
    }
