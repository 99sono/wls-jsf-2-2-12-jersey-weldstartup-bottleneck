...
public class AppScopedBean3925 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3925.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3925");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3925");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3925");
    }
