...
public class AppScopedBean3720 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3720.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3720");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3720");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3720");
    }
