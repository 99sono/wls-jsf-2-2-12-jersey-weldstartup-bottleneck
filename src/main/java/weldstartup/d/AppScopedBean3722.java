...
public class AppScopedBean3722 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3722.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3722");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3722");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3722");
    }
