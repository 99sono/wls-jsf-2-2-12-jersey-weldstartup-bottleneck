...
public class AppScopedBean3187 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3187.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3187");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3187");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3187");
    }
