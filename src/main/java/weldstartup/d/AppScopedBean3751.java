...
public class AppScopedBean3751 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3751.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3751");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3751");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3751");
    }
