...
public class AppScopedBean3401 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3401.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3401");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3401");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3401");
    }
