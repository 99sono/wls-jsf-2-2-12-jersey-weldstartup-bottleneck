...
public class AppScopedBean3240 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3240.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3240");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3240");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3240");
    }
