...
public class AppScopedBean3146 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3146.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3146");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3146");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3146");
    }
