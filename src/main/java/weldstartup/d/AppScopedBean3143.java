...
public class AppScopedBean3143 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3143.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3143");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3143");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3143");
    }
