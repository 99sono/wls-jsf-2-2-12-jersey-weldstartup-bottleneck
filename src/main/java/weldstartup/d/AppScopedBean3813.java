...
public class AppScopedBean3813 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3813.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3813");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3813");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3813");
    }
