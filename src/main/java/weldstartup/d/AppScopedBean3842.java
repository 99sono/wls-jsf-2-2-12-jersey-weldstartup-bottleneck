...
public class AppScopedBean3842 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3842.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3842");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3842");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3842");
    }
