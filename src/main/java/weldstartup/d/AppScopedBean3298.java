...
public class AppScopedBean3298 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3298.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3298");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3298");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3298");
    }
