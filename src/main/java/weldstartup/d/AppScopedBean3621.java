...
public class AppScopedBean3621 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3621.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3621");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3621");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3621");
    }
