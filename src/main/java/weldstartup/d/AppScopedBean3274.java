...
public class AppScopedBean3274 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3274.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3274");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3274");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3274");
    }
