...
public class AppScopedBean3924 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3924.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3924");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3924");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3924");
    }
