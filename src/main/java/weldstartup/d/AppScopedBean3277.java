...
public class AppScopedBean3277 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3277.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3277");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3277");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3277");
    }
