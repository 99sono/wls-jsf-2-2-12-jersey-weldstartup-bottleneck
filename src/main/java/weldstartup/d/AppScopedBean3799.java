...
public class AppScopedBean3799 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3799.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3799");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3799");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3799");
    }
