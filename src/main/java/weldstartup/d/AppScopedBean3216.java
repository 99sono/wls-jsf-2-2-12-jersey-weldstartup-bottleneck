...
public class AppScopedBean3216 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3216.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3216");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3216");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3216");
    }
