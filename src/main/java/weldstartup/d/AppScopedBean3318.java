...
public class AppScopedBean3318 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3318.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3318");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3318");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3318");
    }
