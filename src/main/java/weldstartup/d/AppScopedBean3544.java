...
public class AppScopedBean3544 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3544.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3544");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3544");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3544");
    }
