...
public class AppScopedBean3742 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3742.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3742");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3742");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3742");
    }
