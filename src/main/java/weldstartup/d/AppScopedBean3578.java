...
public class AppScopedBean3578 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3578.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3578");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3578");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3578");
    }
