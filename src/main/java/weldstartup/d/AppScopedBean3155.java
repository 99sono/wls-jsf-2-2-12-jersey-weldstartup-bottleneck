...
public class AppScopedBean3155 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3155.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3155");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3155");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3155");
    }
