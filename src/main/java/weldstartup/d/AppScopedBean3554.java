...
public class AppScopedBean3554 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3554.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3554");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3554");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3554");
    }
