...
public class AppScopedBean3876 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3876.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3876");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3876");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3876");
    }
