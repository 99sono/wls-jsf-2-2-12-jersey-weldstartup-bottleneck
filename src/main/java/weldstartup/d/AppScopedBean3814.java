...
public class AppScopedBean3814 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3814.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3814");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3814");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3814");
    }
