...
public class AppScopedBean3945 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3945.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3945");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3945");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3945");
    }
