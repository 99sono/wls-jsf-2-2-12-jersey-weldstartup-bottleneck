...
public class AppScopedBean3456 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3456.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3456");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3456");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3456");
    }
