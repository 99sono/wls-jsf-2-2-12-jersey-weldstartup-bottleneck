...
public class AppScopedBean3084 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3084.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3084");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3084");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3084");
    }
