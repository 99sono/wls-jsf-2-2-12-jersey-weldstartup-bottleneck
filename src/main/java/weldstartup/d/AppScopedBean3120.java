...
public class AppScopedBean3120 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3120.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3120");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3120");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3120");
    }
