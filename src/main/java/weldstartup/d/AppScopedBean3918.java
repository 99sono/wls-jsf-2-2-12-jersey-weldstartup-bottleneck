...
public class AppScopedBean3918 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3918.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3918");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3918");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3918");
    }
