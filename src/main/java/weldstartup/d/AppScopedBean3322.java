...
public class AppScopedBean3322 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3322.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3322");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3322");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3322");
    }
