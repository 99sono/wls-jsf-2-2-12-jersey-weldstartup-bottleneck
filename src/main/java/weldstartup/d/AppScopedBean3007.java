...
public class AppScopedBean3007 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3007.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3007");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3007");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3007");
    }
