...
public class AppScopedBean3251 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3251.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3251");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3251");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3251");
    }
