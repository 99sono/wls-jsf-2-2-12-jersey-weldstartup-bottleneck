...
public class AppScopedBean3788 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3788.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3788");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3788");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3788");
    }
