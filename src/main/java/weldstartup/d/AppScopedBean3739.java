...
public class AppScopedBean3739 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3739.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3739");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3739");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3739");
    }
