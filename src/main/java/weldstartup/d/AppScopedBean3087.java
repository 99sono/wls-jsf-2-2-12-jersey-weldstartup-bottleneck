...
public class AppScopedBean3087 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3087.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3087");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3087");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3087");
    }
