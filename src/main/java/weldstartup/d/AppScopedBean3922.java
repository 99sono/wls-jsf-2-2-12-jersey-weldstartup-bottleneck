...
public class AppScopedBean3922 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3922.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3922");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3922");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3922");
    }
