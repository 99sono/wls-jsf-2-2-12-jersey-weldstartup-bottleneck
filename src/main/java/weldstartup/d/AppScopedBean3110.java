...
public class AppScopedBean3110 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3110.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3110");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3110");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3110");
    }
