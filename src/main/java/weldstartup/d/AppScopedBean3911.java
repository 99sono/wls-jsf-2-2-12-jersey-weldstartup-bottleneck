...
public class AppScopedBean3911 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3911.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3911");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3911");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3911");
    }
