...
public class AppScopedBean3689 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3689.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3689");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3689");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3689");
    }
