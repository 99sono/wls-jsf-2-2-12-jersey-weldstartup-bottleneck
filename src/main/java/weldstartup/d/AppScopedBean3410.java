...
public class AppScopedBean3410 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3410.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3410");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3410");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3410");
    }
