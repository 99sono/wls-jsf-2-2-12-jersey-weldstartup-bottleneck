...
public class AppScopedBean3667 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3667.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3667");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3667");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3667");
    }
