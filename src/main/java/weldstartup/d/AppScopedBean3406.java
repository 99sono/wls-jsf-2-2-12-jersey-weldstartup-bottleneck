...
public class AppScopedBean3406 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3406.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3406");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3406");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3406");
    }
