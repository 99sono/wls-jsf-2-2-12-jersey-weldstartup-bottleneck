...
public class AppScopedBean3651 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3651.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3651");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3651");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3651");
    }
