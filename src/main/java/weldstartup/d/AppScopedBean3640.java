...
public class AppScopedBean3640 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3640.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3640");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3640");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3640");
    }
