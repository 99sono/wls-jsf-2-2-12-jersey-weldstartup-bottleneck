...
public class AppScopedBean3917 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3917.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3917");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3917");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3917");
    }
