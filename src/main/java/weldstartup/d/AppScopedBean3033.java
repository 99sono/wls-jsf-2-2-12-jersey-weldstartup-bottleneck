...
public class AppScopedBean3033 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3033.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3033");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3033");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3033");
    }
