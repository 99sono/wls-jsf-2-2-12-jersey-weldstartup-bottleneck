...
public class AppScopedBean3806 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3806.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3806");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3806");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3806");
    }
