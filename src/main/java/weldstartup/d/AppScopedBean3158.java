...
public class AppScopedBean3158 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3158.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3158");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3158");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3158");
    }
