...
public class AppScopedBean3289 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3289.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3289");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3289");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3289");
    }
