...
public class AppScopedBean3169 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3169.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3169");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3169");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3169");
    }
