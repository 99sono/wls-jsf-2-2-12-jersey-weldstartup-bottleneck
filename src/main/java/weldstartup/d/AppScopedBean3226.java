...
public class AppScopedBean3226 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3226.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3226");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3226");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3226");
    }
