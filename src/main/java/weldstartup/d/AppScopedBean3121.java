...
public class AppScopedBean3121 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3121.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3121");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3121");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3121");
    }
