...
public class AppScopedBean3765 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3765.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3765");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3765");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3765");
    }
