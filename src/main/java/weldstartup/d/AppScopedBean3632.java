...
public class AppScopedBean3632 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3632.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3632");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3632");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3632");
    }
