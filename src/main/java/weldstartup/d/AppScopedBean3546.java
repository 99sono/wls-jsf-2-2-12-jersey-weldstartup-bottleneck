...
public class AppScopedBean3546 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3546.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3546");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3546");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3546");
    }
