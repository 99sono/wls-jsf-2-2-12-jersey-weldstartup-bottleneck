...
public class AppScopedBean3808 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3808.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3808");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3808");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3808");
    }
