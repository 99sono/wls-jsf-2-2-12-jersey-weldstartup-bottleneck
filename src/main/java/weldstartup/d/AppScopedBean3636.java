...
public class AppScopedBean3636 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3636.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3636");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3636");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3636");
    }
