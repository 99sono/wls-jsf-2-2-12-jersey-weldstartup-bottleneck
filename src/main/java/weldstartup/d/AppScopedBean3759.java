...
public class AppScopedBean3759 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3759.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3759");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3759");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3759");
    }
