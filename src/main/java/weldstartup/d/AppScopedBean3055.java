...
public class AppScopedBean3055 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3055.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3055");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3055");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3055");
    }
