...
public class AppScopedBean3199 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3199.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3199");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3199");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3199");
    }
