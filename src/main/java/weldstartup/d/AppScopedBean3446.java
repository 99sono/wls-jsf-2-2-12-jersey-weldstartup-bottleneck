...
public class AppScopedBean3446 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3446.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3446");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3446");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3446");
    }
