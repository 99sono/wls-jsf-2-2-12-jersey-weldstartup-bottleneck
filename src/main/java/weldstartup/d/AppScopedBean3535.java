...
public class AppScopedBean3535 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3535.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3535");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3535");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3535");
    }
