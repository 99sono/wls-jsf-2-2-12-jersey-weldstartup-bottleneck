...
public class AppScopedBean3634 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3634.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3634");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3634");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3634");
    }
