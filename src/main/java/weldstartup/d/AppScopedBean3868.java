...
public class AppScopedBean3868 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3868.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3868");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3868");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3868");
    }
