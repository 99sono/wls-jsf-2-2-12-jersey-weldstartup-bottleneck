...
public class AppScopedBean3656 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3656.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3656");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3656");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3656");
    }
