...
public class AppScopedBean3514 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3514.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3514");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3514");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3514");
    }
