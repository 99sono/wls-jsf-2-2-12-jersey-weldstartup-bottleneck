...
public class AppScopedBean3218 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3218.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3218");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3218");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3218");
    }
