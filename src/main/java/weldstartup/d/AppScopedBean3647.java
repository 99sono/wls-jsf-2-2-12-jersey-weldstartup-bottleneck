...
public class AppScopedBean3647 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3647.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3647");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3647");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3647");
    }
