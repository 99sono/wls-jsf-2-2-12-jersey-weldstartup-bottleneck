...
public class AppScopedBean3072 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3072.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3072");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3072");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3072");
    }
