...
public class AppScopedBean3137 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3137.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3137");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3137");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3137");
    }
