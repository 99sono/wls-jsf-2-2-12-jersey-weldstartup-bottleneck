...
public class AppScopedBean3894 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3894.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3894");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3894");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3894");
    }
