...
public class AppScopedBean3940 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3940.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3940");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3940");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3940");
    }
