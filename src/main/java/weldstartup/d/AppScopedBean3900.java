...
public class AppScopedBean3900 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3900.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3900");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3900");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3900");
    }
