...
public class AppScopedBean3189 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3189.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3189");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3189");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3189");
    }
