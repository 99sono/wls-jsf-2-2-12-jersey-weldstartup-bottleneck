...
public class AppScopedBean3966 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3966.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3966");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3966");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3966");
    }
