...
public class AppScopedBean3643 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3643.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3643");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3643");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3643");
    }
