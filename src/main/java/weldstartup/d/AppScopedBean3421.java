...
public class AppScopedBean3421 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3421.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3421");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3421");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3421");
    }
