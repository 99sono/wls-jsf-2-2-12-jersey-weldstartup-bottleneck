...
public class AppScopedBean3160 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3160.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3160");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3160");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3160");
    }
