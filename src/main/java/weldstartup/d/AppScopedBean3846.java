...
public class AppScopedBean3846 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3846.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3846");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3846");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3846");
    }
