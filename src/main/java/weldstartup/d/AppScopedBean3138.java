...
public class AppScopedBean3138 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3138.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3138");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3138");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3138");
    }
