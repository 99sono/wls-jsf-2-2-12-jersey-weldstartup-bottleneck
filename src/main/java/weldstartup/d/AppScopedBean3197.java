...
public class AppScopedBean3197 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3197.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3197");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3197");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3197");
    }
