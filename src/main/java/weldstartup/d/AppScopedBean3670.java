...
public class AppScopedBean3670 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3670.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3670");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3670");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3670");
    }
