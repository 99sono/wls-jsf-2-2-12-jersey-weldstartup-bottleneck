...
public class AppScopedBean3679 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3679.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3679");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3679");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3679");
    }
