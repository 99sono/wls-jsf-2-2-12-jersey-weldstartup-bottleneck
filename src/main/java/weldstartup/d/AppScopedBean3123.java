...
public class AppScopedBean3123 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3123.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3123");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3123");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3123");
    }
