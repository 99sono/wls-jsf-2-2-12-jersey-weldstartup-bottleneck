...
public class AppScopedBean3166 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3166.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3166");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3166");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3166");
    }
