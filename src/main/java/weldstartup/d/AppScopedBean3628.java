...
public class AppScopedBean3628 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3628.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3628");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3628");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3628");
    }
