...
public class AppScopedBean3955 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3955.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3955");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3955");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3955");
    }
