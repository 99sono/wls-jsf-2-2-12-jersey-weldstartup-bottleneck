...
public class AppScopedBean3698 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3698.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3698");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3698");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3698");
    }
