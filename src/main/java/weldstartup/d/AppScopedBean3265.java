...
public class AppScopedBean3265 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3265.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3265");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3265");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3265");
    }
