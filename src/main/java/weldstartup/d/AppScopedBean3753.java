...
public class AppScopedBean3753 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3753.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3753");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3753");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3753");
    }
