...
public class AppScopedBean3889 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3889.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3889");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3889");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3889");
    }
