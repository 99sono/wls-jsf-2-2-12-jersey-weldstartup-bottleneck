...
public class AppScopedBean3300 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3300.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3300");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3300");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3300");
    }
