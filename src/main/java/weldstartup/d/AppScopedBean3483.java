...
public class AppScopedBean3483 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3483.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3483");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3483");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3483");
    }
