...
public class AppScopedBean3611 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3611.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3611");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3611");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3611");
    }
