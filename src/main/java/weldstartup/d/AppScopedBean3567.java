...
public class AppScopedBean3567 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3567.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3567");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3567");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3567");
    }
