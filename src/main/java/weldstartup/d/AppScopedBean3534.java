...
public class AppScopedBean3534 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3534.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3534");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3534");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3534");
    }
