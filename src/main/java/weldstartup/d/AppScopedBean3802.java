...
public class AppScopedBean3802 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3802.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3802");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3802");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3802");
    }
