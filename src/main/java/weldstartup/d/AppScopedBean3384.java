...
public class AppScopedBean3384 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3384.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3384");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3384");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3384");
    }
