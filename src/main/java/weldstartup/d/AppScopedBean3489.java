...
public class AppScopedBean3489 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3489.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3489");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3489");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3489");
    }
