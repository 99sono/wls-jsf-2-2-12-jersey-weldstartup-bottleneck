...
public class AppScopedBean3462 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3462.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3462");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3462");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3462");
    }
