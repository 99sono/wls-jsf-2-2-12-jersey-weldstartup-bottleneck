...
public class AppScopedBean3902 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3902.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3902");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3902");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3902");
    }
