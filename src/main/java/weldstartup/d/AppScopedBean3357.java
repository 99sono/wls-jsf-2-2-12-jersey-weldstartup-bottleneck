...
public class AppScopedBean3357 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3357.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3357");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3357");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3357");
    }
