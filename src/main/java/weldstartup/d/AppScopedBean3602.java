...
public class AppScopedBean3602 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3602.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3602");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3602");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3602");
    }
