...
public class AppScopedBean3340 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3340.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3340");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3340");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3340");
    }
