...
public class AppScopedBean3919 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3919.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3919");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3919");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3919");
    }
