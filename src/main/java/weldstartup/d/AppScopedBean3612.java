...
public class AppScopedBean3612 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3612.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3612");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3612");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3612");
    }
