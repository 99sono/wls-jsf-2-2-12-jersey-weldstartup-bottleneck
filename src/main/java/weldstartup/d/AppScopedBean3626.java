...
public class AppScopedBean3626 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3626.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3626");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3626");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3626");
    }
