...
public class AppScopedBean3486 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3486.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3486");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3486");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3486");
    }
