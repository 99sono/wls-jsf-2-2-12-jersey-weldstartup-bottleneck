...
public class AppScopedBean3205 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3205.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3205");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3205");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3205");
    }
