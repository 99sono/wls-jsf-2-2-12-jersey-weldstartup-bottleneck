...
public class AppScopedBean3359 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3359.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3359");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3359");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3359");
    }
