...
public class AppScopedBean3418 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3418.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3418");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3418");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3418");
    }
