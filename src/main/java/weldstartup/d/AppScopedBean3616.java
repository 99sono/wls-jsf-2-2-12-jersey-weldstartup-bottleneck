...
public class AppScopedBean3616 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3616.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3616");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3616");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3616");
    }
