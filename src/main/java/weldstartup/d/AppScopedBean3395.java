...
public class AppScopedBean3395 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3395.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3395");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3395");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3395");
    }
