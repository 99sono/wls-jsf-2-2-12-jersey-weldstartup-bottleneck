...
public class AppScopedBean3734 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3734.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3734");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3734");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3734");
    }
