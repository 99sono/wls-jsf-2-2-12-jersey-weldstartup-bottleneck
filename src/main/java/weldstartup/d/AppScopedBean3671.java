...
public class AppScopedBean3671 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3671.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3671");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3671");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3671");
    }
