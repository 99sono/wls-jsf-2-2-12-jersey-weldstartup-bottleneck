...
public class AppScopedBean3428 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3428.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3428");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3428");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3428");
    }
