...
public class AppScopedBean3144 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3144.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3144");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3144");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3144");
    }
