...
public class AppScopedBean3921 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3921.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3921");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3921");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3921");
    }
