...
public class AppScopedBean3564 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3564.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3564");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3564");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3564");
    }
