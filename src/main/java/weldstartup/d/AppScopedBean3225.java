...
public class AppScopedBean3225 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3225.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3225");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3225");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3225");
    }
