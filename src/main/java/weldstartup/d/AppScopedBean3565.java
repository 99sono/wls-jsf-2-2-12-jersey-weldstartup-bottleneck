...
public class AppScopedBean3565 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3565.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3565");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3565");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3565");
    }
