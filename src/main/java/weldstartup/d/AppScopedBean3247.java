...
public class AppScopedBean3247 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3247.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3247");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3247");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3247");
    }
