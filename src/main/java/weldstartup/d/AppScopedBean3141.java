...
public class AppScopedBean3141 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3141.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3141");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3141");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3141");
    }
