...
public class AppScopedBean3125 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3125.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3125");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3125");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3125");
    }
