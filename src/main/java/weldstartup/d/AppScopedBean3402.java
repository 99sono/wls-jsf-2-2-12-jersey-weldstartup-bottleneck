...
public class AppScopedBean3402 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3402.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3402");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3402");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3402");
    }
