...
public class AppScopedBean3879 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3879.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3879");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3879");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3879");
    }
