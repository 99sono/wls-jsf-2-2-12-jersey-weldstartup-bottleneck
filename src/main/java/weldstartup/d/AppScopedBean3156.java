...
public class AppScopedBean3156 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3156.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3156");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3156");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3156");
    }
