...
public class AppScopedBean3381 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3381.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3381");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3381");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3381");
    }
