...
public class AppScopedBean3345 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3345.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3345");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3345");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3345");
    }
