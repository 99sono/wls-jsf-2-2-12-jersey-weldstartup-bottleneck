...
public class AppScopedBean3638 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3638.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3638");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3638");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3638");
    }
