...
public class AppScopedBean3472 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3472.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3472");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3472");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3472");
    }
