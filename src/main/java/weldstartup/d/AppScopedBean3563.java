...
public class AppScopedBean3563 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3563.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3563");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3563");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3563");
    }
