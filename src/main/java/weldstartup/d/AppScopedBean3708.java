...
public class AppScopedBean3708 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3708.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3708");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3708");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3708");
    }
