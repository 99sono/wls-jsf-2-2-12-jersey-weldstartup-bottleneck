...
public class AppScopedBean3528 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3528.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3528");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3528");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3528");
    }
