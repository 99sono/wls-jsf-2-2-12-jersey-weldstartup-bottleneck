...
public class AppScopedBean3592 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3592.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3592");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3592");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3592");
    }
