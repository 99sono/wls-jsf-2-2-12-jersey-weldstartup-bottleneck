...
public class AppScopedBean3516 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3516.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3516");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3516");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3516");
    }
