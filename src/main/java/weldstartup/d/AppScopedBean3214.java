...
public class AppScopedBean3214 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3214.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3214");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3214");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3214");
    }
