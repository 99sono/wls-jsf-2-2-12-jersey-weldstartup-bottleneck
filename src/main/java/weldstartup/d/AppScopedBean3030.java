...
public class AppScopedBean3030 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3030.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3030");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3030");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3030");
    }
