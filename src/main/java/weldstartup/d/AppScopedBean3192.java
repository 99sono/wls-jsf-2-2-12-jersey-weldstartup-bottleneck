...
public class AppScopedBean3192 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3192.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3192");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3192");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3192");
    }
