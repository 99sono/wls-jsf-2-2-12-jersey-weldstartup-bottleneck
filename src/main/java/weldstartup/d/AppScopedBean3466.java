...
public class AppScopedBean3466 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3466.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3466");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3466");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3466");
    }
