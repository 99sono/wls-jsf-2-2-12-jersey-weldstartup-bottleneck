...
public class AppScopedBean3936 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3936.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3936");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3936");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3936");
    }
