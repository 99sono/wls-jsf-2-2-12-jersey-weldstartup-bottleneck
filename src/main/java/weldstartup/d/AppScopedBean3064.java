...
public class AppScopedBean3064 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3064.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3064");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3064");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3064");
    }
