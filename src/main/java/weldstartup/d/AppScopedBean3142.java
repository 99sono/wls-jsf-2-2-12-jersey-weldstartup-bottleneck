...
public class AppScopedBean3142 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3142.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3142");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3142");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3142");
    }
