...
public class AppScopedBean3785 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3785.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3785");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3785");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3785");
    }
