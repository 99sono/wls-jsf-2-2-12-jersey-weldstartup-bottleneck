...
public class AppScopedBean3531 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3531.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3531");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3531");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3531");
    }
