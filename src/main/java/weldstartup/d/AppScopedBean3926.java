...
public class AppScopedBean3926 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3926.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3926");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3926");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3926");
    }
