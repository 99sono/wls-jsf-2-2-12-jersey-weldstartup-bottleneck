...
public class AppScopedBean3576 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3576.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3576");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3576");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3576");
    }
