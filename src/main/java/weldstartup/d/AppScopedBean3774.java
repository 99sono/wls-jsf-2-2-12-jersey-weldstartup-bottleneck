...
public class AppScopedBean3774 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3774.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3774");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3774");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3774");
    }
