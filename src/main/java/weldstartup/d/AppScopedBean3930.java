...
public class AppScopedBean3930 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3930.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3930");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3930");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3930");
    }
