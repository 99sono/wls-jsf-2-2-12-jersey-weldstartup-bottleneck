...
public class AppScopedBean3297 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3297.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3297");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3297");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3297");
    }
