...
public class AppScopedBean3150 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3150.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3150");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3150");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3150");
    }
