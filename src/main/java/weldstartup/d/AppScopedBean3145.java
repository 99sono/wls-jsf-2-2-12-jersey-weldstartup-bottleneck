...
public class AppScopedBean3145 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3145.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3145");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3145");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3145");
    }
