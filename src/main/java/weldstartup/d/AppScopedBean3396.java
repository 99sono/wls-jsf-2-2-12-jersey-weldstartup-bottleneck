...
public class AppScopedBean3396 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3396.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3396");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3396");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3396");
    }
