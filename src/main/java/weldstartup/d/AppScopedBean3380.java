...
public class AppScopedBean3380 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3380.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3380");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3380");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3380");
    }
