...
public class AppScopedBean3880 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3880.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3880");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3880");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3880");
    }
