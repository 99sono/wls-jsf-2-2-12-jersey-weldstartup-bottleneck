...
public class AppScopedBean3386 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3386.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3386");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3386");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3386");
    }
