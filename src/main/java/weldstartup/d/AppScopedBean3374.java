...
public class AppScopedBean3374 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3374.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3374");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3374");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3374");
    }
