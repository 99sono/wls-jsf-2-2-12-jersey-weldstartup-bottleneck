...
public class AppScopedBean3572 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3572.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3572");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3572");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3572");
    }
