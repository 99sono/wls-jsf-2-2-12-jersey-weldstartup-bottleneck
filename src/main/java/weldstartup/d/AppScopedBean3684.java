...
public class AppScopedBean3684 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3684.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3684");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3684");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3684");
    }
