...
public class AppScopedBean3644 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3644.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3644");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3644");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3644");
    }
