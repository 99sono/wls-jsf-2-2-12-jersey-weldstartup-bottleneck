...
public class AppScopedBean3685 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3685.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3685");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3685");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3685");
    }
