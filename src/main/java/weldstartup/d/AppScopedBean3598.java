...
public class AppScopedBean3598 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3598.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3598");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3598");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3598");
    }
