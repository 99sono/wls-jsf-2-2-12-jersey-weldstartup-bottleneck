...
public class AppScopedBean3076 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3076.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3076");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3076");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3076");
    }
