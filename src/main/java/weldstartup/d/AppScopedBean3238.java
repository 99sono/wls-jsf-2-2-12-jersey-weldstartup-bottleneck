...
public class AppScopedBean3238 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3238.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3238");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3238");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3238");
    }
