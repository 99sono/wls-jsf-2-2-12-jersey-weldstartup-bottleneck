...
public class AppScopedBean3848 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3848.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3848");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3848");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3848");
    }
