...
public class AppScopedBean3008 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3008.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3008");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3008");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3008");
    }
