...
public class AppScopedBean3294 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3294.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3294");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3294");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3294");
    }
