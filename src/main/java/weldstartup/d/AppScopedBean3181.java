...
public class AppScopedBean3181 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3181.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3181");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3181");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3181");
    }
