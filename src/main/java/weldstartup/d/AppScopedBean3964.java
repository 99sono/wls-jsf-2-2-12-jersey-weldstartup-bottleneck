...
public class AppScopedBean3964 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3964.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3964");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3964");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3964");
    }
