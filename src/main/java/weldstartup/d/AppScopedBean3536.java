...
public class AppScopedBean3536 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3536.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3536");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3536");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3536");
    }
