...
public class AppScopedBean3089 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3089.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3089");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3089");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3089");
    }
