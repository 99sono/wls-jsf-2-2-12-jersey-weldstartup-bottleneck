...
public class AppScopedBean3215 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3215.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3215");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3215");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3215");
    }
