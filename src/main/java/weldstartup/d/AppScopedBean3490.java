...
public class AppScopedBean3490 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3490.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3490");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3490");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3490");
    }
