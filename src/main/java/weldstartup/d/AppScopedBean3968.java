...
public class AppScopedBean3968 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3968.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3968");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3968");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3968");
    }
