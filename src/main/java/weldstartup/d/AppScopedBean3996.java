...
public class AppScopedBean3996 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3996.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3996");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3996");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3996");
    }
