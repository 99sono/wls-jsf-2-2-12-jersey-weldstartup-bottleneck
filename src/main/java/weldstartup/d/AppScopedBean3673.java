...
public class AppScopedBean3673 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3673.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3673");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3673");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3673");
    }
