...
public class AppScopedBean3505 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3505.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3505");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3505");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3505");
    }
