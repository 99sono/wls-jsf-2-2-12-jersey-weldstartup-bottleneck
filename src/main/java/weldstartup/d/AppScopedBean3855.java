...
public class AppScopedBean3855 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3855.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3855");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3855");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3855");
    }
