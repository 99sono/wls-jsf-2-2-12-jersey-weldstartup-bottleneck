...
public class AppScopedBean3412 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3412.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3412");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3412");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3412");
    }
