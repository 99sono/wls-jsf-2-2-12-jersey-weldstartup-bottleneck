...
public class AppScopedBean3942 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3942.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3942");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3942");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3942");
    }
