...
public class AppScopedBean3151 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3151.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3151");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3151");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3151");
    }
