...
public class AppScopedBean3078 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3078.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3078");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3078");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3078");
    }
