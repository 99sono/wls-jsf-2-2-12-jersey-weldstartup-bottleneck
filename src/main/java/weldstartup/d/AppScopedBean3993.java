...
public class AppScopedBean3993 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3993.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3993");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3993");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3993");
    }
