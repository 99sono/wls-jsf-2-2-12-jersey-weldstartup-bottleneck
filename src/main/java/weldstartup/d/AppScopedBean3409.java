...
public class AppScopedBean3409 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3409.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3409");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3409");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3409");
    }
