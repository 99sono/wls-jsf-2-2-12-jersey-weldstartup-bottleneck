...
public class AppScopedBean3312 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3312.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3312");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3312");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3312");
    }
