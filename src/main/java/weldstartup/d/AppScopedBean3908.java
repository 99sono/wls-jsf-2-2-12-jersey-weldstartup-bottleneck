...
public class AppScopedBean3908 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3908.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3908");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3908");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3908");
    }
