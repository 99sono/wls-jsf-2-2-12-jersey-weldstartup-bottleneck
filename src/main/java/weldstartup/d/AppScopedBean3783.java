...
public class AppScopedBean3783 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3783.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3783");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3783");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3783");
    }
