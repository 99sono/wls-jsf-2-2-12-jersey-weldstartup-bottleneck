...
public class AppScopedBean3861 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3861.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3861");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3861");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3861");
    }
