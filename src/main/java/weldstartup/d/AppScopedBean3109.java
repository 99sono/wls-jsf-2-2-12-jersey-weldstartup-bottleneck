...
public class AppScopedBean3109 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3109.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3109");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3109");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3109");
    }
