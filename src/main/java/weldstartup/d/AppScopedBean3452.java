...
public class AppScopedBean3452 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3452.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3452");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3452");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3452");
    }
