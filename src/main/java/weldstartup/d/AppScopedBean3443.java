...
public class AppScopedBean3443 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3443.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3443");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3443");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3443");
    }
