...
public class AppScopedBean3570 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3570.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3570");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3570");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3570");
    }
