...
public class AppScopedBean3974 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3974.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3974");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3974");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3974");
    }
