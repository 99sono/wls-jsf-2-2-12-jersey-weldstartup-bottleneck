...
public class AppScopedBean3304 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3304.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3304");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3304");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3304");
    }
