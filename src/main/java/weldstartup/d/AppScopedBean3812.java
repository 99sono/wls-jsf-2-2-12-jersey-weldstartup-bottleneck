...
public class AppScopedBean3812 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3812.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3812");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3812");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3812");
    }
