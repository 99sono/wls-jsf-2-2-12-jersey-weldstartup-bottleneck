...
public class AppScopedBean3021 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3021.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3021");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3021");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3021");
    }
