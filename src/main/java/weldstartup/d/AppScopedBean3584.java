...
public class AppScopedBean3584 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3584.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3584");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3584");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3584");
    }
