...
public class AppScopedBean3316 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3316.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3316");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3316");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3316");
    }
