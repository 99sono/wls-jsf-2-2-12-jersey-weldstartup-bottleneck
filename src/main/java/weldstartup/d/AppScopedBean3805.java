...
public class AppScopedBean3805 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3805.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3805");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3805");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3805");
    }
