...
public class AppScopedBean3100 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3100.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3100");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3100");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3100");
    }
