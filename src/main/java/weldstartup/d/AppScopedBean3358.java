...
public class AppScopedBean3358 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3358.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3358");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3358");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3358");
    }
