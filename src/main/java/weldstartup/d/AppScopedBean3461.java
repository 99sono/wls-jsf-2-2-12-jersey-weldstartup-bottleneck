...
public class AppScopedBean3461 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3461.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3461");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3461");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3461");
    }
