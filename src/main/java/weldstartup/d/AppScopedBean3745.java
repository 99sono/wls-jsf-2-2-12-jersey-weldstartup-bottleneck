...
public class AppScopedBean3745 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3745.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3745");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3745");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3745");
    }
