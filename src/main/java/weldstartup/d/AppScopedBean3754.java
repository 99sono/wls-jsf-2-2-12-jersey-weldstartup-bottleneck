...
public class AppScopedBean3754 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3754.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3754");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3754");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3754");
    }
