...
public class AppScopedBean3847 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3847.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3847");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3847");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3847");
    }
