...
public class AppScopedBean3733 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3733.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3733");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3733");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3733");
    }
