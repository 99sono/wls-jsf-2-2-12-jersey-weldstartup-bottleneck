...
public class AppScopedBean3568 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3568.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3568");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3568");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3568");
    }
