...
public class AppScopedBean3082 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3082.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3082");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3082");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3082");
    }
