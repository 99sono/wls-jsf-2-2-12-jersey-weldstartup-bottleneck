...
public class AppScopedBean3093 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3093.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3093");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3093");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3093");
    }
