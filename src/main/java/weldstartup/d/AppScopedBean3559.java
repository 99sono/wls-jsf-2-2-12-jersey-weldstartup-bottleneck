...
public class AppScopedBean3559 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3559.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3559");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3559");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3559");
    }
