...
public class AppScopedBean3562 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3562.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3562");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3562");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3562");
    }
