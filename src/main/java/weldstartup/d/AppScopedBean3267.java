...
public class AppScopedBean3267 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3267.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3267");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3267");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3267");
    }
