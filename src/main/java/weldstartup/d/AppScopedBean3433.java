...
public class AppScopedBean3433 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3433.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3433");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3433");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3433");
    }
