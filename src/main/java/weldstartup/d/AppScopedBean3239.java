...
public class AppScopedBean3239 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3239.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3239");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3239");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3239");
    }
