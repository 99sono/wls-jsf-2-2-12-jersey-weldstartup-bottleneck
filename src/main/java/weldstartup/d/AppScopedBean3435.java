...
public class AppScopedBean3435 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3435.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3435");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3435");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3435");
    }
