...
public class AppScopedBean3519 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3519.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3519");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3519");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3519");
    }
