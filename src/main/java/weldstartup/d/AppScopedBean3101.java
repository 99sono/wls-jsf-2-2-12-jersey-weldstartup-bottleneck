...
public class AppScopedBean3101 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3101.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3101");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3101");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3101");
    }
