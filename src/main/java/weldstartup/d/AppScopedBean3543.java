...
public class AppScopedBean3543 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3543.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3543");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3543");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3543");
    }
