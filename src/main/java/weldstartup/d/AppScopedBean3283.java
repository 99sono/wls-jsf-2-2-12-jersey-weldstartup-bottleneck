...
public class AppScopedBean3283 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3283.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3283");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3283");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3283");
    }
