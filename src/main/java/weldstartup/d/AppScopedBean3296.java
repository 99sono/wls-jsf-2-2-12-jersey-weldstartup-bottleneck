...
public class AppScopedBean3296 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3296.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3296");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3296");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3296");
    }
