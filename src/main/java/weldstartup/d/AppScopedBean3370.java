...
public class AppScopedBean3370 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3370.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3370");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3370");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3370");
    }
