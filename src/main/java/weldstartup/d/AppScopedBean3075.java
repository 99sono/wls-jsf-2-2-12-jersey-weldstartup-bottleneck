...
public class AppScopedBean3075 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3075.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3075");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3075");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3075");
    }
