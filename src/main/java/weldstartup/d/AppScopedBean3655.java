...
public class AppScopedBean3655 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3655.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3655");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3655");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3655");
    }
