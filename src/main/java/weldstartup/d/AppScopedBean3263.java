...
public class AppScopedBean3263 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3263.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3263");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3263");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3263");
    }
