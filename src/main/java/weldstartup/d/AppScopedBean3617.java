...
public class AppScopedBean3617 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3617.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3617");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3617");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3617");
    }
