...
public class AppScopedBean3429 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3429.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3429");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3429");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3429");
    }
