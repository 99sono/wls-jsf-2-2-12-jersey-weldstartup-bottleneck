...
public class AppScopedBean3032 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3032.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3032");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3032");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3032");
    }
