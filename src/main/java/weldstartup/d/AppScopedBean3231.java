...
public class AppScopedBean3231 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3231.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3231");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3231");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3231");
    }
