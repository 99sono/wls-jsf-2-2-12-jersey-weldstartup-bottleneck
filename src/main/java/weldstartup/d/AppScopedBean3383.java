...
public class AppScopedBean3383 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3383.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3383");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3383");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3383");
    }
