...
public class AppScopedBean3820 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3820.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3820");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3820");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3820");
    }
