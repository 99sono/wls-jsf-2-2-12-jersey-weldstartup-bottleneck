...
public class AppScopedBean3333 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3333.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3333");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3333");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3333");
    }
