...
public class AppScopedBean3057 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3057.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3057");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3057");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3057");
    }
