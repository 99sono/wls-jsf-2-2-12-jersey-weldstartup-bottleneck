...
public class AppScopedBean3882 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3882.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3882");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3882");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3882");
    }
