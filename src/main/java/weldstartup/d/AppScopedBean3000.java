...
public class AppScopedBean3000 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3000.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3000");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3000");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3000");
    }
