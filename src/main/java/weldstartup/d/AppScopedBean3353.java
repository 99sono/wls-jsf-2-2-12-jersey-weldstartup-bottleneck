...
public class AppScopedBean3353 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3353.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3353");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3353");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3353");
    }
