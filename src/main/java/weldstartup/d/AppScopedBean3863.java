...
public class AppScopedBean3863 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3863.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3863");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3863");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3863");
    }
