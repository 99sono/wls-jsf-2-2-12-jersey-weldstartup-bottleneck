...
public class AppScopedBean3910 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3910.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3910");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3910");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3910");
    }
