...
public class AppScopedBean3664 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3664.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3664");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3664");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3664");
    }
