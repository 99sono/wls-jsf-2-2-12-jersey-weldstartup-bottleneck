...
public class AppScopedBean3494 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3494.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3494");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3494");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3494");
    }
