...
public class AppScopedBean3344 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3344.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3344");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3344");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3344");
    }
