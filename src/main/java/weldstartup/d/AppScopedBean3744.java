...
public class AppScopedBean3744 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3744.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3744");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3744");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3744");
    }
