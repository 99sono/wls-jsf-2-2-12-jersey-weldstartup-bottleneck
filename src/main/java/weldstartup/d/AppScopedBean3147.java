...
public class AppScopedBean3147 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3147.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3147");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3147");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3147");
    }
