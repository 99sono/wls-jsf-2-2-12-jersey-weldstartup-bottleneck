...
public class AppScopedBean3273 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3273.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3273");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3273");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3273");
    }
