...
public class AppScopedBean3978 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3978.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3978");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3978");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3978");
    }
