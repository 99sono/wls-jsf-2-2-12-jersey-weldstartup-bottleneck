...
public class AppScopedBean3856 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3856.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3856");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3856");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3856");
    }
