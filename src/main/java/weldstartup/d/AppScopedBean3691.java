...
public class AppScopedBean3691 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3691.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3691");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3691");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3691");
    }
