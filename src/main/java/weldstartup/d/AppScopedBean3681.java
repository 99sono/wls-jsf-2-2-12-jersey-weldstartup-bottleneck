...
public class AppScopedBean3681 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3681.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3681");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3681");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3681");
    }
