...
public class AppScopedBean3035 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3035.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3035");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3035");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3035");
    }
