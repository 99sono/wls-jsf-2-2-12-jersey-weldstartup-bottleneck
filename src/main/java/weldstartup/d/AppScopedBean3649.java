...
public class AppScopedBean3649 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3649.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3649");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3649");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3649");
    }
