...
public class AppScopedBean3502 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3502.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3502");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3502");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3502");
    }
