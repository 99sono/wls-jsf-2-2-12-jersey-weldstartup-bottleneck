...
public class AppScopedBean3112 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3112.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3112");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3112");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3112");
    }
