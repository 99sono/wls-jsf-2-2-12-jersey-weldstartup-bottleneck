...
public class AppScopedBean3881 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3881.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3881");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3881");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3881");
    }
