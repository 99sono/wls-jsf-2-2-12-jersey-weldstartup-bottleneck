...
public class AppScopedBean3545 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3545.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3545");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3545");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3545");
    }
