...
public class AppScopedBean3857 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3857.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3857");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3857");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3857");
    }
