...
public class AppScopedBean3717 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3717.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3717");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3717");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3717");
    }
