...
public class AppScopedBean3526 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3526.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3526");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3526");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3526");
    }
