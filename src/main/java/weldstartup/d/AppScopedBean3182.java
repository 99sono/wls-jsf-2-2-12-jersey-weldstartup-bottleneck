...
public class AppScopedBean3182 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3182.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3182");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3182");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3182");
    }
