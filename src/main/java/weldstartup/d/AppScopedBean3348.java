...
public class AppScopedBean3348 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3348.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3348");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3348");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3348");
    }
