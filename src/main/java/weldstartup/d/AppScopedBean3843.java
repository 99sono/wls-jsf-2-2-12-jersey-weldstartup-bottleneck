...
public class AppScopedBean3843 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3843.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3843");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3843");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3843");
    }
