...
public class AppScopedBean3427 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3427.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3427");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3427");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3427");
    }
