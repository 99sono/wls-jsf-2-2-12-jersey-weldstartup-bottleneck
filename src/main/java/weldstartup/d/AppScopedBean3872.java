...
public class AppScopedBean3872 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3872.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3872");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3872");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3872");
    }
