...
public class AppScopedBean3826 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3826.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3826");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3826");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3826");
    }
