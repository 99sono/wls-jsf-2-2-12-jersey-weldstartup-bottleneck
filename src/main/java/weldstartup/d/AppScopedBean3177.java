...
public class AppScopedBean3177 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3177.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3177");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3177");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3177");
    }
