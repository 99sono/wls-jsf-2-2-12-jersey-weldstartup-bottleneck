...
public class AppScopedBean3972 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3972.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3972");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3972");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3972");
    }
