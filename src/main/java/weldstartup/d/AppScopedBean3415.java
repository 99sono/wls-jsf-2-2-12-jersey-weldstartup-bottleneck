...
public class AppScopedBean3415 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3415.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3415");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3415");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3415");
    }
