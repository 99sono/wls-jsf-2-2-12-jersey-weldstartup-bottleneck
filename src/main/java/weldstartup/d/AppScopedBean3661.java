...
public class AppScopedBean3661 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3661.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3661");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3661");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3661");
    }
