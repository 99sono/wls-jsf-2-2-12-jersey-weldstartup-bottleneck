...
public class AppScopedBean3957 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3957.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3957");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3957");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3957");
    }
