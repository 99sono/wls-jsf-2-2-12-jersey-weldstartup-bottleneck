...
public class AppScopedBean3696 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3696.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3696");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3696");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3696");
    }
