...
public class AppScopedBean3795 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3795.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3795");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3795");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3795");
    }
