...
public class AppScopedBean3106 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3106.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3106");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3106");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3106");
    }
