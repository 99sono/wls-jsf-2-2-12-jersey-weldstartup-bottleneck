...
public class AppScopedBean3324 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3324.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3324");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3324");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3324");
    }
