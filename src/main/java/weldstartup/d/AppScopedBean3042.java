...
public class AppScopedBean3042 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3042.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3042");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3042");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3042");
    }
