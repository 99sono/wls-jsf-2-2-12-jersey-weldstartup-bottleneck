...
public class AppScopedBean3520 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3520.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3520");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3520");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3520");
    }
