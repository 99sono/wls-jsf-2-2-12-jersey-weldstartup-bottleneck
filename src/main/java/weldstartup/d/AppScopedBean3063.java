...
public class AppScopedBean3063 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3063.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3063");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3063");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3063");
    }
