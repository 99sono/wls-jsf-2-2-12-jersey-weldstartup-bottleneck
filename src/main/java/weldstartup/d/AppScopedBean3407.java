...
public class AppScopedBean3407 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3407.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3407");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3407");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3407");
    }
