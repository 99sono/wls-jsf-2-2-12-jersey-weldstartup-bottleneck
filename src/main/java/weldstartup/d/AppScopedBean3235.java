...
public class AppScopedBean3235 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3235.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3235");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3235");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3235");
    }
