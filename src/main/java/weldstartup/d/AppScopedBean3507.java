...
public class AppScopedBean3507 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3507.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3507");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3507");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3507");
    }
