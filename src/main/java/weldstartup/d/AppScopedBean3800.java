...
public class AppScopedBean3800 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3800.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3800");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3800");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3800");
    }
