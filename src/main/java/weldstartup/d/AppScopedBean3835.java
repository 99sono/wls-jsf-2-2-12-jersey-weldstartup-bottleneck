...
public class AppScopedBean3835 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3835.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3835");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3835");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3835");
    }
