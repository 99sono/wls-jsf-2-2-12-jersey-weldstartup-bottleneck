...
public class AppScopedBean3190 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3190.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3190");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3190");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3190");
    }
