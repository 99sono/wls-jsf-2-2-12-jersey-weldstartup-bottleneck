...
public class AppScopedBean3107 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3107.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3107");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3107");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3107");
    }
