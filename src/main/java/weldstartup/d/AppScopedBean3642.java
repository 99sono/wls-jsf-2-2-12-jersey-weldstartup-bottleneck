...
public class AppScopedBean3642 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3642.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3642");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3642");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3642");
    }
