...
public class AppScopedBean3944 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3944.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3944");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3944");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3944");
    }
