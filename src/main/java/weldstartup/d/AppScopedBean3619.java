...
public class AppScopedBean3619 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3619.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3619");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3619");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3619");
    }
