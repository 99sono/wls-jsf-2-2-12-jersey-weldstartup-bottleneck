...
public class AppScopedBean3172 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3172.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3172");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3172");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3172");
    }
