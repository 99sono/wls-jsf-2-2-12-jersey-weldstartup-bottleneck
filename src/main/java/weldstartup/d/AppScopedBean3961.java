...
public class AppScopedBean3961 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3961.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3961");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3961");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3961");
    }
