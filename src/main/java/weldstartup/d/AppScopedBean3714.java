...
public class AppScopedBean3714 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3714.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3714");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3714");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3714");
    }
