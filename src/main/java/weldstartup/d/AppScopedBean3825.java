...
public class AppScopedBean3825 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3825.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3825");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3825");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3825");
    }
