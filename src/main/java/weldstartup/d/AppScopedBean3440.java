...
public class AppScopedBean3440 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3440.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3440");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3440");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3440");
    }
