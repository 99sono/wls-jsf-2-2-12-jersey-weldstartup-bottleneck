...
public class AppScopedBean3933 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3933.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3933");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3933");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3933");
    }
