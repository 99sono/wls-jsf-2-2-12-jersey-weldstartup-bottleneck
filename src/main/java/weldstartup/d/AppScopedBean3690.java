...
public class AppScopedBean3690 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3690.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3690");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3690");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3690");
    }
