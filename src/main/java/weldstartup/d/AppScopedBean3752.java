...
public class AppScopedBean3752 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3752.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3752");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3752");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3752");
    }
