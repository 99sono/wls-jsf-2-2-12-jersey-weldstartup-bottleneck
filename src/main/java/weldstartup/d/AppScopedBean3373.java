...
public class AppScopedBean3373 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3373.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3373");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3373");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3373");
    }
