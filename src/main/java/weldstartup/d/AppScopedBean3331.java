...
public class AppScopedBean3331 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3331.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3331");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3331");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3331");
    }
