...
public class AppScopedBean3268 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3268.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3268");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3268");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3268");
    }
