...
public class AppScopedBean3914 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3914.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3914");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3914");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3914");
    }
