...
public class AppScopedBean3437 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3437.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3437");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3437");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3437");
    }
