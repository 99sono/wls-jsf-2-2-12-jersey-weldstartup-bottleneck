...
public class AppScopedBean3420 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3420.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3420");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3420");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3420");
    }
