...
public class AppScopedBean3607 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3607.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3607");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3607");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3607");
    }
