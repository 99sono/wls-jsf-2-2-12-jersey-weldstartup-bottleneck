...
public class AppScopedBean3159 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3159.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3159");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3159");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3159");
    }
