...
public class AppScopedBean3615 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3615.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3615");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3615");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3615");
    }
