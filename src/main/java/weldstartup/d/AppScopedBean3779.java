...
public class AppScopedBean3779 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3779.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3779");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3779");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3779");
    }
