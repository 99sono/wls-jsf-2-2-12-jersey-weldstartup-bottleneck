...
public class AppScopedBean3686 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3686.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3686");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3686");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3686");
    }
