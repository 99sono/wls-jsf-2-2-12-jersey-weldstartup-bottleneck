...
public class AppScopedBean3510 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3510.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3510");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3510");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3510");
    }
