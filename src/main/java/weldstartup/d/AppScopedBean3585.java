...
public class AppScopedBean3585 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3585.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3585");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3585");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3585");
    }
