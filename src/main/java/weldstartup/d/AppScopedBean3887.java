...
public class AppScopedBean3887 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3887.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3887");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3887");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3887");
    }
