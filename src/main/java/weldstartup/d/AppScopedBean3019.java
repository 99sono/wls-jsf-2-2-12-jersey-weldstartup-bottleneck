...
public class AppScopedBean3019 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3019.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3019");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3019");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3019");
    }
