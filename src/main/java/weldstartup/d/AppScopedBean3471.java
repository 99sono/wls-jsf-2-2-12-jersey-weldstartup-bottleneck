...
public class AppScopedBean3471 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3471.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3471");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3471");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3471");
    }
