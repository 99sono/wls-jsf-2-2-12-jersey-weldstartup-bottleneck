...
public class AppScopedBean3293 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3293.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3293");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3293");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3293");
    }
