...
public class AppScopedBean3480 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3480.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3480");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3480");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3480");
    }
