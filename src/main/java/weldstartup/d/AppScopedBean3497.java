...
public class AppScopedBean3497 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3497.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3497");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3497");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3497");
    }
