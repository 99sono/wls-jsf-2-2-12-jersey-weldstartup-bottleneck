...
public class AppScopedBean3755 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3755.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3755");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3755");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3755");
    }
