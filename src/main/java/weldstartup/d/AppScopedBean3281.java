...
public class AppScopedBean3281 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3281.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3281");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3281");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3281");
    }
