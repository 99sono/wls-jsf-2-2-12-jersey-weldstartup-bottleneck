...
public class AppScopedBean3036 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3036.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3036");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3036");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3036");
    }
