...
public class AppScopedBean3470 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3470.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3470");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3470");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3470");
    }
