...
public class AppScopedBean3976 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3976.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3976");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3976");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3976");
    }
