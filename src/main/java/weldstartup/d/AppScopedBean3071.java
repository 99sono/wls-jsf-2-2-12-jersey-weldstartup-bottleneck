...
public class AppScopedBean3071 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3071.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3071");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3071");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3071");
    }
