...
public class AppScopedBean3977 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3977.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3977");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3977");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3977");
    }
