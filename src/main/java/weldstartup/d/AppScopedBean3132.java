...
public class AppScopedBean3132 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3132.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3132");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3132");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3132");
    }
