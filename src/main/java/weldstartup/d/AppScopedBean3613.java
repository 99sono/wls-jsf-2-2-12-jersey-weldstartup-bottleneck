...
public class AppScopedBean3613 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3613.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3613");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3613");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3613");
    }
