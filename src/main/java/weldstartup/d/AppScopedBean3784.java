...
public class AppScopedBean3784 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3784.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3784");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3784");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3784");
    }
