...
public class AppScopedBean3153 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3153.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3153");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3153");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3153");
    }
