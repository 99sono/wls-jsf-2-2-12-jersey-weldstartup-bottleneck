...
public class AppScopedBean3232 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3232.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3232");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3232");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3232");
    }
