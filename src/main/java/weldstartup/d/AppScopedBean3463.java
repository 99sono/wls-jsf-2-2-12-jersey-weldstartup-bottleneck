...
public class AppScopedBean3463 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3463.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3463");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3463");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3463");
    }
