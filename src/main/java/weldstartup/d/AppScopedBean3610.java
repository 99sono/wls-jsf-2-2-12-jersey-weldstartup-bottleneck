...
public class AppScopedBean3610 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3610.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3610");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3610");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3610");
    }
