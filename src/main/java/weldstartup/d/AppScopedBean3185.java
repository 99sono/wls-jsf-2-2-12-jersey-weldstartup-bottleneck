...
public class AppScopedBean3185 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3185.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3185");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3185");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3185");
    }
