...
public class AppScopedBean3736 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3736.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3736");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3736");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3736");
    }
