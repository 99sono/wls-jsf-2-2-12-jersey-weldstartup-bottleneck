...
public class AppScopedBean3515 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3515.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3515");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3515");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3515");
    }
