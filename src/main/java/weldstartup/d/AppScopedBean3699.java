...
public class AppScopedBean3699 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3699.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3699");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3699");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3699");
    }
