...
public class AppScopedBean3029 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3029.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3029");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3029");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3029");
    }
