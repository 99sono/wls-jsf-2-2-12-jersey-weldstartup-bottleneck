...
public class AppScopedBean3594 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3594.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3594");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3594");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3594");
    }
