...
public class AppScopedBean3874 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3874.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3874");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3874");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3874");
    }
