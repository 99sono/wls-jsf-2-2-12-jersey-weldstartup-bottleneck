...
public class AppScopedBean3385 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3385.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3385");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3385");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3385");
    }
