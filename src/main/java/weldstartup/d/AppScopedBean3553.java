...
public class AppScopedBean3553 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3553.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3553");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3553");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3553");
    }
