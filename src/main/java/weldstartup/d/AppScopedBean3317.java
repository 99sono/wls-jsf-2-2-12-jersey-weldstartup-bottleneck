...
public class AppScopedBean3317 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3317.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3317");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3317");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3317");
    }
