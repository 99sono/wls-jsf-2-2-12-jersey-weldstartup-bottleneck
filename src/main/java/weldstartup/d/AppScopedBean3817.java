...
public class AppScopedBean3817 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3817.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3817");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3817");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3817");
    }
