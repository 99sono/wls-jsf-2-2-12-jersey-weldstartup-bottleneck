...
public class AppScopedBean3952 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3952.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3952");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3952");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3952");
    }
