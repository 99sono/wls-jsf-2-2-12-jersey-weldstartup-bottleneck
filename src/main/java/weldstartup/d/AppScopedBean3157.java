...
public class AppScopedBean3157 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3157.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3157");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3157");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3157");
    }
