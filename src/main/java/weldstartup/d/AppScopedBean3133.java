...
public class AppScopedBean3133 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3133.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3133");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3133");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3133");
    }
