...
public class AppScopedBean3430 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3430.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3430");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3430");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3430");
    }
