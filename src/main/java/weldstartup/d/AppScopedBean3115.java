...
public class AppScopedBean3115 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3115.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3115");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3115");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3115");
    }
