...
public class AppScopedBean3394 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3394.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3394");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3394");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3394");
    }
