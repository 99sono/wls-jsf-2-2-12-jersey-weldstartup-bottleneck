...
public class AppScopedBean3831 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3831.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3831");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3831");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3831");
    }
