...
public class AppScopedBean3364 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3364.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3364");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3364");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3364");
    }
