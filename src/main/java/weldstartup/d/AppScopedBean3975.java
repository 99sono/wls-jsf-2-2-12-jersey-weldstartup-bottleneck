...
public class AppScopedBean3975 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3975.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3975");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3975");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3975");
    }
