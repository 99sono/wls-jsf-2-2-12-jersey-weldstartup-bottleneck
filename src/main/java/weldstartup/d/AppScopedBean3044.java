...
public class AppScopedBean3044 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3044.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3044");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3044");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3044");
    }
