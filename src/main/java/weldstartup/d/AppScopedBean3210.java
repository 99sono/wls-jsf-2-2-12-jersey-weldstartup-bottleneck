...
public class AppScopedBean3210 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3210.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3210");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3210");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3210");
    }
