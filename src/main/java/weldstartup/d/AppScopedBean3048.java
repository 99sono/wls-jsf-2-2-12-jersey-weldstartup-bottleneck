...
public class AppScopedBean3048 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3048.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3048");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3048");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3048");
    }
