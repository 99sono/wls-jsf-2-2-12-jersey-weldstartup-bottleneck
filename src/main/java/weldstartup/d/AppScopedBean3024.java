...
public class AppScopedBean3024 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3024.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3024");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3024");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3024");
    }
