...
public class AppScopedBean3196 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3196.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3196");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3196");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3196");
    }
