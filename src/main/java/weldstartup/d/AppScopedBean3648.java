...
public class AppScopedBean3648 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3648.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3648");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3648");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3648");
    }
