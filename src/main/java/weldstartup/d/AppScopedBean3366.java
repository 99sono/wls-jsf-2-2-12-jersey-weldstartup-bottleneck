...
public class AppScopedBean3366 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3366.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3366");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3366");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3366");
    }
