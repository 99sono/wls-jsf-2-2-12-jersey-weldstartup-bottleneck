...
public class AppScopedBean3989 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3989.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3989");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3989");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3989");
    }
