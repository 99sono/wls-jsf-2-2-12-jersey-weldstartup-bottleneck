...
public class AppScopedBean3083 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3083.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3083");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3083");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3083");
    }
