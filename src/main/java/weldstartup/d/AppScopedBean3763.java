...
public class AppScopedBean3763 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3763.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3763");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3763");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3763");
    }
