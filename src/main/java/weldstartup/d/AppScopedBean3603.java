...
public class AppScopedBean3603 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3603.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3603");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3603");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3603");
    }
