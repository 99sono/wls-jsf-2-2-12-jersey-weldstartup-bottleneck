...
public class AppScopedBean3422 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3422.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3422");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3422");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3422");
    }
