...
public class AppScopedBean3350 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3350.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3350");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3350");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3350");
    }
