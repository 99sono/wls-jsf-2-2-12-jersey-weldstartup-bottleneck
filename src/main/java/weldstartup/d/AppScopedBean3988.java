...
public class AppScopedBean3988 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3988.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3988");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3988");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3988");
    }
