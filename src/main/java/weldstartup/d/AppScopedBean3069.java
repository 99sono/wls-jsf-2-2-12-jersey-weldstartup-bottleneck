...
public class AppScopedBean3069 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3069.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3069");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3069");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3069");
    }
