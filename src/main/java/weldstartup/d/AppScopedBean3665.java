...
public class AppScopedBean3665 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3665.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3665");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3665");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3665");
    }
