...
public class AppScopedBean3992 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3992.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3992");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3992");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3992");
    }
