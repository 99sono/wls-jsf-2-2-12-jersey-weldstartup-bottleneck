...
public class AppScopedBean3026 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3026.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3026");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3026");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3026");
    }
