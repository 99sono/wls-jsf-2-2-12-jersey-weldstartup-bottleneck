...
public class AppScopedBean3948 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3948.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3948");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3948");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3948");
    }
