...
public class AppScopedBean3624 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3624.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3624");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3624");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3624");
    }
