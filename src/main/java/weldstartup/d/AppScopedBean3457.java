...
public class AppScopedBean3457 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3457.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3457");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3457");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3457");
    }
