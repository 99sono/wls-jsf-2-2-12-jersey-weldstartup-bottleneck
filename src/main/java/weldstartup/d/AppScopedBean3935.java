...
public class AppScopedBean3935 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3935.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3935");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3935");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3935");
    }
