...
public class AppScopedBean3675 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3675.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3675");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3675");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3675");
    }
