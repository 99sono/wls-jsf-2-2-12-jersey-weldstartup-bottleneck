...
public class AppScopedBean3015 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3015.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3015");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3015");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3015");
    }
