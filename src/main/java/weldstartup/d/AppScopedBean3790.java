...
public class AppScopedBean3790 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3790.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3790");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3790");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3790");
    }
