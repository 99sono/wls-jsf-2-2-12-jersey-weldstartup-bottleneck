...
public class AppScopedBean3591 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3591.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3591");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3591");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3591");
    }
