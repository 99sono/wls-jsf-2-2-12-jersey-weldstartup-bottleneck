...
public class AppScopedBean3645 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3645.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3645");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3645");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3645");
    }
