...
public class AppScopedBean3034 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3034.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3034");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3034");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3034");
    }
