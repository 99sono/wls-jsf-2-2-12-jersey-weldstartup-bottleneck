...
public class AppScopedBean3174 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3174.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3174");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3174");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3174");
    }
