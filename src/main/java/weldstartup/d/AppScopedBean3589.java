...
public class AppScopedBean3589 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3589.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3589");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3589");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3589");
    }
