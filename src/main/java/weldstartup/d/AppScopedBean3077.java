...
public class AppScopedBean3077 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3077.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3077");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3077");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3077");
    }
