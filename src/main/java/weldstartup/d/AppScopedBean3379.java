...
public class AppScopedBean3379 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3379.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3379");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3379");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3379");
    }
