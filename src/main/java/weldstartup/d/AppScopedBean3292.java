...
public class AppScopedBean3292 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3292.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3292");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3292");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3292");
    }
