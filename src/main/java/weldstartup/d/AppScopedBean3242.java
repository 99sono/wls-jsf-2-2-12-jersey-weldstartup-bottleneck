...
public class AppScopedBean3242 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3242.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3242");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3242");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3242");
    }
