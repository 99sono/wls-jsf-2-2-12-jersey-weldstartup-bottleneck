...
public class AppScopedBean3577 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3577.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3577");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3577");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3577");
    }
