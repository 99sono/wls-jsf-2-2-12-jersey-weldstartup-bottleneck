...
public class AppScopedBean3706 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3706.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3706");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3706");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3706");
    }
