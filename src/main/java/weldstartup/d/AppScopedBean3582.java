...
public class AppScopedBean3582 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3582.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3582");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3582");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3582");
    }
