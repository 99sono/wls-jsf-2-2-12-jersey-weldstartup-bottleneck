...
public class AppScopedBean3530 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3530.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3530");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3530");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3530");
    }
