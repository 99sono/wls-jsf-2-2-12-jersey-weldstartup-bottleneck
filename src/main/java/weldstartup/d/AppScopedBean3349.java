...
public class AppScopedBean3349 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3349.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3349");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3349");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3349");
    }
