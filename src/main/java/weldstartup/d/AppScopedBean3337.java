...
public class AppScopedBean3337 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3337.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3337");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3337");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3337");
    }
