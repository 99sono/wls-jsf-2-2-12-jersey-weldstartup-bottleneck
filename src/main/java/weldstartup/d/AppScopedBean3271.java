...
public class AppScopedBean3271 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3271.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3271");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3271");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3271");
    }
