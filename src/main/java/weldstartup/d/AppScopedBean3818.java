...
public class AppScopedBean3818 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3818.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3818");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3818");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3818");
    }
