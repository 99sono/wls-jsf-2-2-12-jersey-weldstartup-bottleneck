...
public class AppScopedBean3400 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3400.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3400");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3400");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3400");
    }
