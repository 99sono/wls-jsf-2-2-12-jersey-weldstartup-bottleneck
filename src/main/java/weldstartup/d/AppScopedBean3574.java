...
public class AppScopedBean3574 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3574.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3574");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3574");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3574");
    }
