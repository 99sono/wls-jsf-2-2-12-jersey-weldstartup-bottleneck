...
public class AppScopedBean3705 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3705.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3705");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3705");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3705");
    }
