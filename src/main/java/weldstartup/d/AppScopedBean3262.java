...
public class AppScopedBean3262 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3262.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3262");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3262");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3262");
    }
