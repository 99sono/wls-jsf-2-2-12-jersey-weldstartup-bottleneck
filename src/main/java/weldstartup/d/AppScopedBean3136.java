...
public class AppScopedBean3136 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3136.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3136");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3136");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3136");
    }
