...
public class AppScopedBean3371 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3371.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3371");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3371");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3371");
    }
