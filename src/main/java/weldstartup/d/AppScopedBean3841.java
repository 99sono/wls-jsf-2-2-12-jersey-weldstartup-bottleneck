...
public class AppScopedBean3841 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3841.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3841");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3841");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3841");
    }
