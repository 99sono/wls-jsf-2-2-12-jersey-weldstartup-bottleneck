...
public class AppScopedBean3040 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3040.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3040");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3040");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3040");
    }
