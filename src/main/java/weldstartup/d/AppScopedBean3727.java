...
public class AppScopedBean3727 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3727.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3727");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3727");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3727");
    }
