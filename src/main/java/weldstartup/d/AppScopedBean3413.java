...
public class AppScopedBean3413 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3413.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3413");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3413");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3413");
    }
