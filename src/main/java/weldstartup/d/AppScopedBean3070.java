...
public class AppScopedBean3070 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3070.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3070");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3070");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3070");
    }
