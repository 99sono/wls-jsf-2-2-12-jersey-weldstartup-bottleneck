...
public class AppScopedBean3148 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3148.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3148");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3148");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3148");
    }
