...
public class AppScopedBean3697 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3697.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3697");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3697");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3697");
    }
