...
public class AppScopedBean3810 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3810.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3810");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3810");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3810");
    }
