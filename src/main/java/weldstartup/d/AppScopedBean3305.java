...
public class AppScopedBean3305 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3305.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3305");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3305");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3305");
    }
