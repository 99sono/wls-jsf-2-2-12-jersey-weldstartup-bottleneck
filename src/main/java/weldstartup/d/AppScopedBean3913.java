...
public class AppScopedBean3913 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3913.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3913");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3913");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3913");
    }
