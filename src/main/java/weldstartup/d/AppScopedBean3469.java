...
public class AppScopedBean3469 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3469.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3469");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3469");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3469");
    }
