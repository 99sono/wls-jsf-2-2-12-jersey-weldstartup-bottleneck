...
public class AppScopedBean3904 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3904.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3904");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3904");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3904");
    }
