...
public class AppScopedBean3403 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3403.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3403");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3403");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3403");
    }
