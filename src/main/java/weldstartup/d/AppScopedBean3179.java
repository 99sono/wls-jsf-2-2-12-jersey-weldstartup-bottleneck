...
public class AppScopedBean3179 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3179.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3179");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3179");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3179");
    }
