...
public class AppScopedBean3397 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3397.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3397");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3397");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3397");
    }
