...
public class AppScopedBean3929 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3929.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3929");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3929");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3929");
    }
