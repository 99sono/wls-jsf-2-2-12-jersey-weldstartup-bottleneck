...
public class AppScopedBean3460 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3460.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3460");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3460");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3460");
    }
