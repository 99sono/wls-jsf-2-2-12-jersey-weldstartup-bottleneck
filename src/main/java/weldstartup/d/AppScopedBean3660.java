...
public class AppScopedBean3660 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3660.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3660");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3660");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3660");
    }
