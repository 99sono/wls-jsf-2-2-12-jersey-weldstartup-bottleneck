...
public class AppScopedBean3599 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3599.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3599");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3599");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3599");
    }
