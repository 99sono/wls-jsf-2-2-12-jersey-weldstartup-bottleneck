...
public class AppScopedBean3022 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3022.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3022");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3022");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3022");
    }
