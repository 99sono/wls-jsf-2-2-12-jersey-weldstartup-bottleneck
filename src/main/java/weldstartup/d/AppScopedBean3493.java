...
public class AppScopedBean3493 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3493.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3493");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3493");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3493");
    }
