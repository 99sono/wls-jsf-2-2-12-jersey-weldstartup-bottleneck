...
public class AppScopedBean3175 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3175.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3175");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3175");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3175");
    }
