...
public class AppScopedBean3523 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3523.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3523");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3523");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3523");
    }
