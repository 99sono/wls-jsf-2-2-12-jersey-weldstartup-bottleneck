...
public class AppScopedBean3828 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3828.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3828");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3828");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3828");
    }
