...
public class AppScopedBean3662 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3662.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3662");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3662");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3662");
    }
