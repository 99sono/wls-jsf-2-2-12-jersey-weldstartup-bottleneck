...
public class AppScopedBean3319 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3319.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3319");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3319");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3319");
    }
