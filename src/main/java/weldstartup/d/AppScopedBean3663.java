...
public class AppScopedBean3663 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3663.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3663");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3663");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3663");
    }
