...
public class AppScopedBean3980 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3980.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3980");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3980");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3980");
    }
