...
public class AppScopedBean3946 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3946.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3946");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3946");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3946");
    }
