...
public class AppScopedBean3973 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3973.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3973");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3973");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3973");
    }
