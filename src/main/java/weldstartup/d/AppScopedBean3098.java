...
public class AppScopedBean3098 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3098.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3098");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3098");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3098");
    }
