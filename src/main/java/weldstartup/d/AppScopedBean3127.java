...
public class AppScopedBean3127 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3127.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3127");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3127");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3127");
    }
