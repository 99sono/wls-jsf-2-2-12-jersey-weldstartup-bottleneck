...
public class AppScopedBean3538 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3538.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3538");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3538");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3538");
    }
