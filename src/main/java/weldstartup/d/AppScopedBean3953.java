...
public class AppScopedBean3953 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3953.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3953");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3953");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3953");
    }
