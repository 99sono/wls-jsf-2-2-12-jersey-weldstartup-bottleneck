...
public class AppScopedBean3117 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3117.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3117");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3117");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3117");
    }
