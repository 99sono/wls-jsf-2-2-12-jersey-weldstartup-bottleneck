...
public class AppScopedBean3747 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3747.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3747");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3747");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3747");
    }
