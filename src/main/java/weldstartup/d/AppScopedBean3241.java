...
public class AppScopedBean3241 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3241.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3241");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3241");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3241");
    }
