...
public class AppScopedBean3981 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3981.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3981");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3981");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3981");
    }
