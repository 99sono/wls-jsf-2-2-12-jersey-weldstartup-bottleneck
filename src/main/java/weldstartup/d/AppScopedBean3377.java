...
public class AppScopedBean3377 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3377.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3377");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3377");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3377");
    }
