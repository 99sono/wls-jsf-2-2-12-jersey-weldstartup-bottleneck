...
public class AppScopedBean3170 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3170.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3170");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3170");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3170");
    }
