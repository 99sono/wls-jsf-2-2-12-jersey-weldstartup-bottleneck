...
public class AppScopedBean3666 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3666.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3666");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3666");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3666");
    }
