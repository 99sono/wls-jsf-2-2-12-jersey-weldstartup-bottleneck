...
public class AppScopedBean3971 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3971.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3971");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3971");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3971");
    }
