...
public class AppScopedBean3449 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3449.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3449");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3449");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3449");
    }
