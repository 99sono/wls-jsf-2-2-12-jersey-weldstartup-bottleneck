...
public class AppScopedBean3116 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3116.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3116");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3116");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3116");
    }
