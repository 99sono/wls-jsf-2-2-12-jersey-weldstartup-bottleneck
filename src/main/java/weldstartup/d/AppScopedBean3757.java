...
public class AppScopedBean3757 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3757.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3757");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3757");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3757");
    }
