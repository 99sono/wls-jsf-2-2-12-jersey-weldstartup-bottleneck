...
public class AppScopedBean3243 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3243.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3243");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3243");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3243");
    }
