...
public class AppScopedBean3495 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3495.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3495");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3495");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3495");
    }
