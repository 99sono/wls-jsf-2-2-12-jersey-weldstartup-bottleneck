...
public class AppScopedBean3682 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3682.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3682");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3682");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3682");
    }
