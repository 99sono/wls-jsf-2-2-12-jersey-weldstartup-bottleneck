...
public class AppScopedBean3052 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3052.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3052");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3052");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3052");
    }
