...
public class AppScopedBean3009 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3009.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3009");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3009");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3009");
    }
