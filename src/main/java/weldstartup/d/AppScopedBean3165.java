...
public class AppScopedBean3165 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3165.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3165");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3165");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3165");
    }
