...
public class AppScopedBean3096 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3096.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3096");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3096");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3096");
    }
