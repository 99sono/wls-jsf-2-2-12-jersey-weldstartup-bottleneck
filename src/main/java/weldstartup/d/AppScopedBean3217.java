...
public class AppScopedBean3217 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3217.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3217");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3217");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3217");
    }
