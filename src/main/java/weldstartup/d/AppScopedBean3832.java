...
public class AppScopedBean3832 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3832.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3832");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3832");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3832");
    }
