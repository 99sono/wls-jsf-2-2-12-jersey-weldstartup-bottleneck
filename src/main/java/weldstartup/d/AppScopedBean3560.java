...
public class AppScopedBean3560 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3560.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3560");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3560");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3560");
    }
