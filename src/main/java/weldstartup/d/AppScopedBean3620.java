...
public class AppScopedBean3620 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3620.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3620");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3620");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3620");
    }
