...
public class AppScopedBean3954 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3954.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3954");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3954");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3954");
    }
