...
public class AppScopedBean3878 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3878.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3878");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3878");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3878");
    }
