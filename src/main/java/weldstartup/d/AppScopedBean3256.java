...
public class AppScopedBean3256 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3256.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3256");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3256");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3256");
    }
