...
public class AppScopedBean3168 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3168.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3168");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3168");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3168");
    }
