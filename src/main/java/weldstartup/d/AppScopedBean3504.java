...
public class AppScopedBean3504 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3504.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3504");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3504");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3504");
    }
