...
public class AppScopedBean3694 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3694.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3694");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3694");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3694");
    }
