...
public class AppScopedBean3854 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3854.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3854");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3854");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3854");
    }
