...
public class AppScopedBean3254 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3254.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3254");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3254");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3254");
    }
