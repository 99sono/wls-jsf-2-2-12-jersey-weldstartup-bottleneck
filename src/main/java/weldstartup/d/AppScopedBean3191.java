...
public class AppScopedBean3191 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3191.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3191");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3191");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3191");
    }
