...
public class AppScopedBean3511 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3511.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3511");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3511");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3511");
    }
