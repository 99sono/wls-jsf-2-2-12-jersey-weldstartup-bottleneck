...
public class AppScopedBean3809 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3809.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3809");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3809");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3809");
    }
