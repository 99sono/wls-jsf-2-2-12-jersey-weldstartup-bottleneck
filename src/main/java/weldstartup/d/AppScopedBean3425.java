...
public class AppScopedBean3425 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3425.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3425");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3425");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3425");
    }
