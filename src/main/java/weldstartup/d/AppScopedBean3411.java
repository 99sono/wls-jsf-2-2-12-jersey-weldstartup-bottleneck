...
public class AppScopedBean3411 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3411.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3411");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3411");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3411");
    }
