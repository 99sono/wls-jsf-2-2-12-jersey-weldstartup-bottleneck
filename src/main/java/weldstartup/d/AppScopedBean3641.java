...
public class AppScopedBean3641 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3641.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3641");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3641");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3641");
    }
