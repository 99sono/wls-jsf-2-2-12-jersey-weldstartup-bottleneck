...
public class AppScopedBean3355 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3355.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3355");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3355");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3355");
    }
