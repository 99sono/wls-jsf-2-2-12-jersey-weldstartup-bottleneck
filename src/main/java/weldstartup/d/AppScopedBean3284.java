...
public class AppScopedBean3284 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3284.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3284");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3284");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3284");
    }
