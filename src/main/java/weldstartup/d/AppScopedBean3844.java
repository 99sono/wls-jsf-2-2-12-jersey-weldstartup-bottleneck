...
public class AppScopedBean3844 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3844.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3844");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3844");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3844");
    }
