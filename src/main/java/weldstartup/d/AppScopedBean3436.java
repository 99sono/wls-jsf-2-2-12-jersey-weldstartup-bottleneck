...
public class AppScopedBean3436 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3436.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3436");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3436");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3436");
    }
