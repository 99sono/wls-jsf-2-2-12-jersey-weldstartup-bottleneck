...
public class AppScopedBean3593 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3593.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3593");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3593");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3593");
    }
