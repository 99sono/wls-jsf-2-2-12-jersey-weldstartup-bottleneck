...
public class AppScopedBean3959 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3959.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3959");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3959");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3959");
    }
