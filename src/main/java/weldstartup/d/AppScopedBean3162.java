...
public class AppScopedBean3162 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3162.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3162");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3162");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3162");
    }
