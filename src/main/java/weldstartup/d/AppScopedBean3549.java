...
public class AppScopedBean3549 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3549.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3549");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3549");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3549");
    }
