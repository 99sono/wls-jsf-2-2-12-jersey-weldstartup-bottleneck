...
public class AppScopedBean3332 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3332.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3332");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3332");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3332");
    }
