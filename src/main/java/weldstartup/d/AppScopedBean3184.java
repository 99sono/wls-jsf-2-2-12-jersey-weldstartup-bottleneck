...
public class AppScopedBean3184 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3184.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3184");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3184");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3184");
    }
