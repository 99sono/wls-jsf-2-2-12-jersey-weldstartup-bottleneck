...
public class AppScopedBean3299 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3299.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3299");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3299");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3299");
    }
