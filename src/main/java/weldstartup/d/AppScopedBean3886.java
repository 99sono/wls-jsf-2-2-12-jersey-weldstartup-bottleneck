...
public class AppScopedBean3886 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3886.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3886");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3886");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3886");
    }
