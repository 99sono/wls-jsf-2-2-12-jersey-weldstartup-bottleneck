...
public class AppScopedBean3609 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3609.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3609");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3609");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3609");
    }
