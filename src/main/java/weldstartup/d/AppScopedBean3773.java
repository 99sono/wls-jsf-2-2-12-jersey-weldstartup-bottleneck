...
public class AppScopedBean3773 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3773.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3773");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3773");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3773");
    }
