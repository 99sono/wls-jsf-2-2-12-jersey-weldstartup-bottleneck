...
public class AppScopedBean3623 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3623.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3623");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3623");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3623");
    }
