...
public class AppScopedBean3650 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3650.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3650");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3650");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3650");
    }
