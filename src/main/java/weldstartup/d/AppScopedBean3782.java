...
public class AppScopedBean3782 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3782.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3782");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3782");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3782");
    }
