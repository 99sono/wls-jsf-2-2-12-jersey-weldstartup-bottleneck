...
public class AppScopedBean3259 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3259.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3259");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3259");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3259");
    }
