...
public class AppScopedBean3726 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3726.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3726");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3726");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3726");
    }
