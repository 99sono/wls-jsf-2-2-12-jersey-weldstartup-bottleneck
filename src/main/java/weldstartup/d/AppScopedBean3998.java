...
public class AppScopedBean3998 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3998.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3998");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3998");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3998");
    }
