...
public class AppScopedBean3245 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3245.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3245");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3245");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3245");
    }
