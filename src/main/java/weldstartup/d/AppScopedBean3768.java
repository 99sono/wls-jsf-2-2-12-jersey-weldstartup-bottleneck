...
public class AppScopedBean3768 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3768.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3768");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3768");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3768");
    }
