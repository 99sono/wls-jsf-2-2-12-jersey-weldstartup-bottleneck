...
public class AppScopedBean3778 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3778.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3778");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3778");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3778");
    }
