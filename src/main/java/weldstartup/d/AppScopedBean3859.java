...
public class AppScopedBean3859 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3859.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3859");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3859");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3859");
    }
