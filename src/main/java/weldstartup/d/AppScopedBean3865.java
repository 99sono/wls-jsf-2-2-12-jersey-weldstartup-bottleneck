...
public class AppScopedBean3865 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3865.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3865");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3865");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3865");
    }
