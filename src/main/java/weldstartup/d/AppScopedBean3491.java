...
public class AppScopedBean3491 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3491.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3491");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3491");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3491");
    }
