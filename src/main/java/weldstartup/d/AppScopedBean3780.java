...
public class AppScopedBean3780 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3780.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3780");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3780");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3780");
    }
