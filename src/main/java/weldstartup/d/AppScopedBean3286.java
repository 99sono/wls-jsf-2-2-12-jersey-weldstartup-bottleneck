...
public class AppScopedBean3286 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3286.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3286");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3286");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3286");
    }
