...
public class AppScopedBean3895 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3895.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3895");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3895");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3895");
    }
