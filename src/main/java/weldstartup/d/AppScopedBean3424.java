...
public class AppScopedBean3424 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3424.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3424");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3424");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3424");
    }
