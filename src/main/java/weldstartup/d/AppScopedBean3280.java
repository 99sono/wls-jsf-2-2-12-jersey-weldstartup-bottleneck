...
public class AppScopedBean3280 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3280.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3280");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3280");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3280");
    }
