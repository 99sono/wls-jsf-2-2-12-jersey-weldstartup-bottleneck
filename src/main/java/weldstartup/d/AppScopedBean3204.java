...
public class AppScopedBean3204 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3204.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3204");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3204");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3204");
    }
