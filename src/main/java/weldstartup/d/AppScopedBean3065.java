...
public class AppScopedBean3065 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3065.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3065");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3065");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3065");
    }
