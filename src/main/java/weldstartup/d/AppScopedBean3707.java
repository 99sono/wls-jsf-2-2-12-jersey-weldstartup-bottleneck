...
public class AppScopedBean3707 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3707.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3707");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3707");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3707");
    }
