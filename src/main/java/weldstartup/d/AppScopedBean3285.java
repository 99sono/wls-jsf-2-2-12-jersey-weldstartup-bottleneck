...
public class AppScopedBean3285 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3285.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3285");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3285");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3285");
    }
