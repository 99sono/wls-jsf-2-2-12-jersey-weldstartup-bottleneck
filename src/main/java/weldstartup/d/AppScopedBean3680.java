...
public class AppScopedBean3680 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3680.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3680");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3680");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3680");
    }
