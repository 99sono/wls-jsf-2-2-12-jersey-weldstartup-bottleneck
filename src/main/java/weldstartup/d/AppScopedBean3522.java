...
public class AppScopedBean3522 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3522.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3522");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3522");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3522");
    }
