...
public class AppScopedBean3840 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3840.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3840");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3840");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3840");
    }
