...
public class AppScopedBean3180 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3180.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3180");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3180");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3180");
    }
