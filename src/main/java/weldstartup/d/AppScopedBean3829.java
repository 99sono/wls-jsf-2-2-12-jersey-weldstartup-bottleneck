...
public class AppScopedBean3829 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3829.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3829");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3829");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3829");
    }
