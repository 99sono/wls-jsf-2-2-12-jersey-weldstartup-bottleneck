...
public class AppScopedBean3740 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3740.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3740");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3740");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3740");
    }
