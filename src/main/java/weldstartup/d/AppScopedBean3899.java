...
public class AppScopedBean3899 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3899.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3899");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3899");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3899");
    }
