...
public class AppScopedBean3129 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3129.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3129");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3129");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3129");
    }
