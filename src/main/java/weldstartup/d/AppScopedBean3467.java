...
public class AppScopedBean3467 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3467.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3467");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3467");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3467");
    }
