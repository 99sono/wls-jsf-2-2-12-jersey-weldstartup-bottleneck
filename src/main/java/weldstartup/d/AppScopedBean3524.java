...
public class AppScopedBean3524 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3524.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3524");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3524");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3524");
    }
