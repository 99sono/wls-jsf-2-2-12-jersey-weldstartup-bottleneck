...
public class AppScopedBean3898 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3898.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3898");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3898");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3898");
    }
