...
public class AppScopedBean3760 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3760.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3760");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3760");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3760");
    }
