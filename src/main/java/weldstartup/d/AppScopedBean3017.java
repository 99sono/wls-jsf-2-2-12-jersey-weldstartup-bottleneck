...
public class AppScopedBean3017 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3017.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3017");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3017");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3017");
    }
