...
public class AppScopedBean3590 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3590.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3590");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3590");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3590");
    }
