...
public class AppScopedBean3478 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3478.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3478");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3478");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3478");
    }
