...
public class AppScopedBean3104 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3104.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3104");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3104");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3104");
    }
