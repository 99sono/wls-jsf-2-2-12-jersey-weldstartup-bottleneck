...
public class AppScopedBean3011 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3011.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3011");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3011");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3011");
    }
