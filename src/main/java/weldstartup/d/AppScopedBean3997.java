...
public class AppScopedBean3997 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3997.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3997");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3997");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3997");
    }
