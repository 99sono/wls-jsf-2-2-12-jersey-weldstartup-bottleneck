...
public class AppScopedBean3873 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3873.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3873");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3873");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3873");
    }
