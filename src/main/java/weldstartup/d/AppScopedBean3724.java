...
public class AppScopedBean3724 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3724.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3724");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3724");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3724");
    }
