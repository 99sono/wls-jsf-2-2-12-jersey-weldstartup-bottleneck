...
public class AppScopedBean3202 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3202.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3202");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3202");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3202");
    }
