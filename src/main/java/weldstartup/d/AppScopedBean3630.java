...
public class AppScopedBean3630 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3630.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3630");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3630");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3630");
    }
