...
public class AppScopedBean3870 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3870.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3870");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3870");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3870");
    }
