...
public class AppScopedBean3346 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3346.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3346");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3346");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3346");
    }
