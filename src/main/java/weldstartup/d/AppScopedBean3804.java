...
public class AppScopedBean3804 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3804.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3804");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3804");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3804");
    }
