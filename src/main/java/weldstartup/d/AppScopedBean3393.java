...
public class AppScopedBean3393 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3393.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3393");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3393");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3393");
    }
