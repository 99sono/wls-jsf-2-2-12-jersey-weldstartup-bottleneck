...
public class AppScopedBean3323 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3323.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3323");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3323");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3323");
    }
