...
public class AppScopedBean3343 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3343.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3343");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3343");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3343");
    }
