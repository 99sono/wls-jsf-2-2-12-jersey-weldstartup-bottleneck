...
public class AppScopedBean3255 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3255.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3255");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3255");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3255");
    }
