...
public class AppScopedBean3712 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3712.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3712");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3712");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3712");
    }
