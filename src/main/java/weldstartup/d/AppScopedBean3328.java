...
public class AppScopedBean3328 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3328.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3328");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3328");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3328");
    }
