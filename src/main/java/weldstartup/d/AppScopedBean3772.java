...
public class AppScopedBean3772 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3772.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3772");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3772");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3772");
    }
