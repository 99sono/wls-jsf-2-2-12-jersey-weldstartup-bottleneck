...
public class AppScopedBean3482 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3482.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3482");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3482");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3482");
    }
