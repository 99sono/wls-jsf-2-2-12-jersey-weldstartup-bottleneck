...
public class AppScopedBean3444 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3444.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3444");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3444");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3444");
    }
