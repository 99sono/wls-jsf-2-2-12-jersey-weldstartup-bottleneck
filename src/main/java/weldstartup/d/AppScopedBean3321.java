...
public class AppScopedBean3321 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3321.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3321");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3321");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3321");
    }
