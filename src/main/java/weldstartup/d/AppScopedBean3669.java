...
public class AppScopedBean3669 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3669.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3669");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3669");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3669");
    }
