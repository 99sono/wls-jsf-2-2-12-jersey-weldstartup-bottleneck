...
public class AppScopedBean3692 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3692.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3692");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3692");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3692");
    }
