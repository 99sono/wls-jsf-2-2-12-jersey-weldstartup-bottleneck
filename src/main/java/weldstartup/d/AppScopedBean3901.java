...
public class AppScopedBean3901 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3901.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3901");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3901");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3901");
    }
