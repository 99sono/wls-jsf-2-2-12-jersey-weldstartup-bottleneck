...
public class AppScopedBean3500 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3500.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3500");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3500");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3500");
    }
