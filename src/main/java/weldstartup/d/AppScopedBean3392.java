...
public class AppScopedBean3392 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3392.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3392");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3392");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3392");
    }
