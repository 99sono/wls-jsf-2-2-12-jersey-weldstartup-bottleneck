...
public class AppScopedBean3501 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3501.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3501");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3501");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3501");
    }
