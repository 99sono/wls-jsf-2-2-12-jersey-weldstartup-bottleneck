...
public class AppScopedBean3275 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3275.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3275");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3275");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3275");
    }
