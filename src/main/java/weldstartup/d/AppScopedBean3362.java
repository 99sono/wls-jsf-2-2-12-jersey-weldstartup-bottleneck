...
public class AppScopedBean3362 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3362.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3362");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3362");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3362");
    }
