...
public class AppScopedBean3608 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3608.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3608");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3608");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3608");
    }
