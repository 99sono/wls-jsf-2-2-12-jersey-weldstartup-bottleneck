...
public class AppScopedBean3807 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3807.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3807");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3807");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3807");
    }
