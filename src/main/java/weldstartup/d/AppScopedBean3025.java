...
public class AppScopedBean3025 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3025.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3025");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3025");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3025");
    }
