...
public class AppScopedBean3867 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3867.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3867");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3867");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3867");
    }
