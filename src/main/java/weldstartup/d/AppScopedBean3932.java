...
public class AppScopedBean3932 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3932.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3932");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3932");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3932");
    }
