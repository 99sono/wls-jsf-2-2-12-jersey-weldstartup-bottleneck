...
public class AppScopedBean3278 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3278.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3278");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3278");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3278");
    }
