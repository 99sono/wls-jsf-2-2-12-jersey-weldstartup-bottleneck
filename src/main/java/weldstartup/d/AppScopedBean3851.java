...
public class AppScopedBean3851 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3851.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3851");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3851");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3851");
    }
