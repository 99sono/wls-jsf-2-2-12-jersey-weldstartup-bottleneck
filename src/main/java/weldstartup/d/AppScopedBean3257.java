...
public class AppScopedBean3257 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3257.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3257");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3257");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3257");
    }
