...
public class AppScopedBean3376 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3376.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3376");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3376");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3376");
    }
