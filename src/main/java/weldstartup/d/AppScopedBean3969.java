...
public class AppScopedBean3969 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3969.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3969");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3969");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3969");
    }
