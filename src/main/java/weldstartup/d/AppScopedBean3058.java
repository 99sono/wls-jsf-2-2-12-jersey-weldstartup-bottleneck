...
public class AppScopedBean3058 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3058.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3058");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3058");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3058");
    }
