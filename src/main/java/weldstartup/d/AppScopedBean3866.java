...
public class AppScopedBean3866 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3866.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3866");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3866");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3866");
    }
