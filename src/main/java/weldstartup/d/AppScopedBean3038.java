...
public class AppScopedBean3038 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3038.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3038");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3038");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3038");
    }
