...
public class AppScopedBean3704 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3704.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3704");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3704");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3704");
    }
