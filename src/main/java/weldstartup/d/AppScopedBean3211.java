...
public class AppScopedBean3211 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3211.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3211");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3211");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3211");
    }
