...
public class AppScopedBean3979 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3979.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3979");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3979");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3979");
    }
