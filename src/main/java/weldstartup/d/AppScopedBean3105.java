...
public class AppScopedBean3105 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3105.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3105");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3105");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3105");
    }
