...
public class AppScopedBean3488 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3488.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3488");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3488");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3488");
    }
