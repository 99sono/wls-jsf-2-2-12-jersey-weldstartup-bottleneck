...
public class AppScopedBean3102 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3102.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3102");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3102");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3102");
    }
