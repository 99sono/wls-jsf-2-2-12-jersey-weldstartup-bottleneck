...
public class AppScopedBean3884 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3884.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3884");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3884");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3884");
    }
