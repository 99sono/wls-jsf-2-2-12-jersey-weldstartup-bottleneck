...
public class AppScopedBean3287 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3287.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3287");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3287");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3287");
    }
