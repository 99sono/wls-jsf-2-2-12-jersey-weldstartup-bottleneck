...
public class AppScopedBean3496 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3496.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3496");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3496");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3496");
    }
