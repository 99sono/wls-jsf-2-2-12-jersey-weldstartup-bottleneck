...
public class AppScopedBean3122 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3122.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3122");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3122");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3122");
    }
