...
public class AppScopedBean3625 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3625.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3625");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3625");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3625");
    }
