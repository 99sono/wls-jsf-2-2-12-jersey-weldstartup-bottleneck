...
public class AppScopedBean3398 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3398.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3398");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3398");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3398");
    }
