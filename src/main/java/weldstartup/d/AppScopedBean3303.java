...
public class AppScopedBean3303 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3303.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3303");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3303");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3303");
    }
