...
public class AppScopedBean3982 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3982.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3982");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3982");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3982");
    }
