...
public class AppScopedBean3085 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3085.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3085");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3085");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3085");
    }
