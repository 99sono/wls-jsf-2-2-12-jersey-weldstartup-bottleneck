...
public class AppScopedBean3088 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3088.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3088");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3088");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3088");
    }
