...
public class AppScopedBean3351 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3351.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3351");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3351");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3351");
    }
