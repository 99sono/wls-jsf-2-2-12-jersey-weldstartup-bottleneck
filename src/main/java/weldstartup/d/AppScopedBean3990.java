...
public class AppScopedBean3990 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3990.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3990");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3990");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3990");
    }
