...
public class AppScopedBean3336 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3336.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3336");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3336");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3336");
    }
