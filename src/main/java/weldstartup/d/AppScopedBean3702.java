...
public class AppScopedBean3702 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3702.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3702");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3702");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3702");
    }
