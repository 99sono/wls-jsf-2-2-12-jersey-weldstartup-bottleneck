...
public class AppScopedBean3173 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3173.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3173");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3173");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3173");
    }
