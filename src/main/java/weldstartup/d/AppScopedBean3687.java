...
public class AppScopedBean3687 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3687.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3687");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3687");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3687");
    }
