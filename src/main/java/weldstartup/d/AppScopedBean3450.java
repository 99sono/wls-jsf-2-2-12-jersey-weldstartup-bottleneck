...
public class AppScopedBean3450 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3450.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3450");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3450");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3450");
    }
