...
public class AppScopedBean3767 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3767.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3767");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3767");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3767");
    }
