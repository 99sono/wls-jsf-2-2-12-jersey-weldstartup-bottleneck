...
public class AppScopedBean3307 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3307.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3307");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3307");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3307");
    }
