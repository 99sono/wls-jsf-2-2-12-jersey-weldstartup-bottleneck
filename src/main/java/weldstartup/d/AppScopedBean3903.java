...
public class AppScopedBean3903 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3903.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3903");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3903");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3903");
    }
