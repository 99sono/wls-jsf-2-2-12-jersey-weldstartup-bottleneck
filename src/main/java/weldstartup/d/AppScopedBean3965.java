...
public class AppScopedBean3965 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3965.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3965");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3965");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3965");
    }
