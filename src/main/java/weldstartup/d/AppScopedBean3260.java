...
public class AppScopedBean3260 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3260.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3260");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3260");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3260");
    }
