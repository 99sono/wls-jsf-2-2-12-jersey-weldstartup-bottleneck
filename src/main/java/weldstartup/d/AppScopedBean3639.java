...
public class AppScopedBean3639 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3639.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3639");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3639");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3639");
    }
