...
public class AppScopedBean3892 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3892.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3892");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3892");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3892");
    }
