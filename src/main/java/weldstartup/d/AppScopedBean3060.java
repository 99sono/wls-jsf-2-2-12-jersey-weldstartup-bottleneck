...
public class AppScopedBean3060 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3060.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3060");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3060");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3060");
    }
