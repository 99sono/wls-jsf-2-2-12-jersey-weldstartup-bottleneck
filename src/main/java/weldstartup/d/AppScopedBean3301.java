...
public class AppScopedBean3301 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3301.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3301");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3301");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3301");
    }
