...
public class AppScopedBean3777 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3777.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3777");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3777");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3777");
    }
