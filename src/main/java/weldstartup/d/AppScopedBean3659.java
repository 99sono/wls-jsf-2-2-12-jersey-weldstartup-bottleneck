...
public class AppScopedBean3659 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3659.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3659");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3659");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3659");
    }
