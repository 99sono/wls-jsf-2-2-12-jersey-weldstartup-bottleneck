...
public class AppScopedBean3363 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3363.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3363");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3363");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3363");
    }
