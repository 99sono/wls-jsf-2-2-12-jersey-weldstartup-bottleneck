...
public class AppScopedBean3309 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3309.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3309");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3309");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3309");
    }
