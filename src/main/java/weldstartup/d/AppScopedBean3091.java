...
public class AppScopedBean3091 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3091.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3091");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3091");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3091");
    }
