...
public class AppScopedBean3447 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3447.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3447");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3447");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3447");
    }
