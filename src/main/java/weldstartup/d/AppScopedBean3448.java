...
public class AppScopedBean3448 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3448.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3448");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3448");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3448");
    }
