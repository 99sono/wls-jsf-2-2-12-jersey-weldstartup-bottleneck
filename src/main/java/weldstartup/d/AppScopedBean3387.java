...
public class AppScopedBean3387 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3387.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3387");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3387");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3387");
    }
