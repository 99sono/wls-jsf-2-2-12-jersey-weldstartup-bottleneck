...
public class AppScopedBean3920 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3920.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3920");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3920");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3920");
    }
