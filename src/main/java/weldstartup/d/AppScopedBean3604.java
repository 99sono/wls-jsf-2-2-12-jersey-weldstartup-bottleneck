...
public class AppScopedBean3604 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3604.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3604");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3604");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3604");
    }
