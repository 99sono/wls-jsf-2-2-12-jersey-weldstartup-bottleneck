...
public class AppScopedBean3764 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3764.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3764");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3764");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3764");
    }
