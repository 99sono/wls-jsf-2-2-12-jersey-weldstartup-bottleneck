...
public class AppScopedBean3512 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3512.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3512");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3512");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3512");
    }
