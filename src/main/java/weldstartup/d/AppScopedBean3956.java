...
public class AppScopedBean3956 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3956.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3956");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3956");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3956");
    }
