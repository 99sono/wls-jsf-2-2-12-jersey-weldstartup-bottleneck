...
public class AppScopedBean3845 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3845.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3845");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3845");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3845");
    }
