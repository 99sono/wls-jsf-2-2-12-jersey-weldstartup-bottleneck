...
public class AppScopedBean3709 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3709.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3709");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3709");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3709");
    }
