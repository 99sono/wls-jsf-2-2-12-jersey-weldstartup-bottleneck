...
public class AppScopedBean3986 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3986.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3986");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3986");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3986");
    }
