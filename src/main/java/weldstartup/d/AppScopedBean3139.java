...
public class AppScopedBean3139 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3139.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3139");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3139");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3139");
    }
