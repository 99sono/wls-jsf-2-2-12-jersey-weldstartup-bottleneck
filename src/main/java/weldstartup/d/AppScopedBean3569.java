...
public class AppScopedBean3569 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3569.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3569");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3569");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3569");
    }
