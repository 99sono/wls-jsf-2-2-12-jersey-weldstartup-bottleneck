...
public class AppScopedBean3963 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3963.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3963");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3963");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3963");
    }
