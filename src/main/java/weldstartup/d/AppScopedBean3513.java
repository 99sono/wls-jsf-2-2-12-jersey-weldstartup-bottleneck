...
public class AppScopedBean3513 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3513.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3513");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3513");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3513");
    }
