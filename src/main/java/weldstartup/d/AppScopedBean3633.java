...
public class AppScopedBean3633 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3633.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3633");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3633");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3633");
    }
