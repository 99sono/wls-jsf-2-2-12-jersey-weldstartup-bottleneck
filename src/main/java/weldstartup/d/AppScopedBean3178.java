...
public class AppScopedBean3178 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3178.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3178");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3178");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3178");
    }
