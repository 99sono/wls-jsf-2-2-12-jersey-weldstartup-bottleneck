...
public class AppScopedBean3001 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3001.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3001");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3001");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3001");
    }
