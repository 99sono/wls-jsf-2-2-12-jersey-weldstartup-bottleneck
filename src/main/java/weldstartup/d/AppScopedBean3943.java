...
public class AppScopedBean3943 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3943.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3943");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3943");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3943");
    }
