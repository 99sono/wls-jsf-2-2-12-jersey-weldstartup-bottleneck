...
public class AppScopedBean3131 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3131.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3131");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3131");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3131");
    }
