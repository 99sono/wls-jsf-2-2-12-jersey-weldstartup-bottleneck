...
public class AppScopedBean3171 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3171.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3171");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3171");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3171");
    }
