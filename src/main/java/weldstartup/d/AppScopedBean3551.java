...
public class AppScopedBean3551 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3551.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3551");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3551");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3551");
    }
