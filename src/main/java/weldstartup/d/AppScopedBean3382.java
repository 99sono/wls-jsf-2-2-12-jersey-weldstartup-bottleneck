...
public class AppScopedBean3382 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3382.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3382");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3382");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3382");
    }
