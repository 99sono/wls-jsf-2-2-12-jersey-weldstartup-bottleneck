...
public class AppScopedBean3140 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3140.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3140");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3140");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3140");
    }
