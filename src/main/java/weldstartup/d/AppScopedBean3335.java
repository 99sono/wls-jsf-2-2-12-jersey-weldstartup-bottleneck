...
public class AppScopedBean3335 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3335.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3335");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3335");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3335");
    }
