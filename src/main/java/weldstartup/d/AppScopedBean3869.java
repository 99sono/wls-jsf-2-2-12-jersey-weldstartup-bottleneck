...
public class AppScopedBean3869 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3869.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3869");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3869");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3869");
    }
