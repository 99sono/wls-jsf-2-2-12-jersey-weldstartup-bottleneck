...
public class AppScopedBean3016 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3016.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3016");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3016");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3016");
    }
