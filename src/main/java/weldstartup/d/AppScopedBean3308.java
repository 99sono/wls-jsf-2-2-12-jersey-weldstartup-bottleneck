...
public class AppScopedBean3308 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3308.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3308");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3308");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3308");
    }
