...
public class AppScopedBean3031 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3031.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3031");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3031");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3031");
    }
