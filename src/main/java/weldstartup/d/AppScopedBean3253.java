...
public class AppScopedBean3253 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3253.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3253");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3253");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3253");
    }
