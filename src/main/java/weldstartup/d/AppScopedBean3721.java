...
public class AppScopedBean3721 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3721.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3721");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3721");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3721");
    }
