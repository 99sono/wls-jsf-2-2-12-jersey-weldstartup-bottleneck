...
public class AppScopedBean3987 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3987.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3987");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3987");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3987");
    }
