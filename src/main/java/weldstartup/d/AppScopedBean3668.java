...
public class AppScopedBean3668 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3668.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3668");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3668");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3668");
    }
