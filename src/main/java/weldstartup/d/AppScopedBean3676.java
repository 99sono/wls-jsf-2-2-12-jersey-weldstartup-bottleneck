...
public class AppScopedBean3676 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3676.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3676");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3676");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3676");
    }
