...
public class AppScopedBean3479 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3479.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3479");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3479");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3479");
    }
