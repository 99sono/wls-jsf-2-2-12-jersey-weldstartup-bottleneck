...
public class AppScopedBean3960 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3960.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3960");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3960");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3960");
    }
