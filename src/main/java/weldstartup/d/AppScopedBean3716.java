...
public class AppScopedBean3716 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3716.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3716");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3716");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3716");
    }
