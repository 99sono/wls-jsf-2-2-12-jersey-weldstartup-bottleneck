...
public class AppScopedBean3606 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3606.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3606");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3606");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3606");
    }
