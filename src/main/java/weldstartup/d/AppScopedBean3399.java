...
public class AppScopedBean3399 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3399.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3399");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3399");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3399");
    }
