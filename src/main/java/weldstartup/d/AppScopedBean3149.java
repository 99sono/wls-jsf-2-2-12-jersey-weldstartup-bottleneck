...
public class AppScopedBean3149 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3149.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3149");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3149");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3149");
    }
