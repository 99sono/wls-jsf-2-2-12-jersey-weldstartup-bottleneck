...
public class AppScopedBean3066 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3066.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3066");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3066");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3066");
    }
