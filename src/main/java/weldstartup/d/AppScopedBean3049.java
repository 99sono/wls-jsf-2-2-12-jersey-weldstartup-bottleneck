...
public class AppScopedBean3049 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3049.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3049");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3049");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3049");
    }
