...
public class AppScopedBean3762 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3762.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3762");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3762");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3762");
    }
