...
public class AppScopedBean3750 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3750.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3750");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3750");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3750");
    }
