...
public class AppScopedBean3700 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3700.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3700");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3700");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3700");
    }
