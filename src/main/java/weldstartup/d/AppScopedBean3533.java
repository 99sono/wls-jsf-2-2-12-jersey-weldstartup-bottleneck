...
public class AppScopedBean3533 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3533.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3533");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3533");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3533");
    }
