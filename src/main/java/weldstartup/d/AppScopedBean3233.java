...
public class AppScopedBean3233 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3233.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3233");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3233");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3233");
    }
