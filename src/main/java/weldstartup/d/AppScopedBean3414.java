...
public class AppScopedBean3414 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3414.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3414");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3414");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3414");
    }
