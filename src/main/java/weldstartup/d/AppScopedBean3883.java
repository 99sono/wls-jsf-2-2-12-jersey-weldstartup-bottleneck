...
public class AppScopedBean3883 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3883.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3883");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3883");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3883");
    }
