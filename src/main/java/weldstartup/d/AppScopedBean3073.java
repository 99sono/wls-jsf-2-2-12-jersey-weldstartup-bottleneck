...
public class AppScopedBean3073 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3073.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3073");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3073");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3073");
    }
