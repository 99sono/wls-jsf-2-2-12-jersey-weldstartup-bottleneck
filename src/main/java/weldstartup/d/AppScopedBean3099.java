...
public class AppScopedBean3099 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3099.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3099");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3099");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3099");
    }
