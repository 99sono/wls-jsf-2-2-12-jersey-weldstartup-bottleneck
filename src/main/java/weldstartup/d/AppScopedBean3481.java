...
public class AppScopedBean3481 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3481.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3481");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3481");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3481");
    }
