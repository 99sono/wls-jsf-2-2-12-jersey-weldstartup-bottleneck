...
public class AppScopedBean3314 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3314.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3314");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3314");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3314");
    }
