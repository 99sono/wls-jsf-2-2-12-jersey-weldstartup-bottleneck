...
public class AppScopedBean3310 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3310.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3310");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3310");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3310");
    }
