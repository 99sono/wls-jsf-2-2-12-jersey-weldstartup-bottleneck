...
public class AppScopedBean3890 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3890.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3890");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3890");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3890");
    }
