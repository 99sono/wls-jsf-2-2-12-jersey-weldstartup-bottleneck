...
public class AppScopedBean3005 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3005.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3005");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3005");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3005");
    }
