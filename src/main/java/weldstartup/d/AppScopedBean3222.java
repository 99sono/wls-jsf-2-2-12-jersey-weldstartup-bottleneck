...
public class AppScopedBean3222 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3222.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3222");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3222");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3222");
    }
