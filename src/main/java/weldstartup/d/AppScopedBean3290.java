...
public class AppScopedBean3290 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3290.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3290");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3290");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3290");
    }
