...
public class AppScopedBean3695 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3695.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3695");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3695");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3695");
    }
