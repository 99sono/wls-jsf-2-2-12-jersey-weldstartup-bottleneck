...
public class AppScopedBean3186 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3186.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3186");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3186");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3186");
    }
