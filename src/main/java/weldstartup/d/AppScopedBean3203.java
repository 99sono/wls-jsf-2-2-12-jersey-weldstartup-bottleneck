...
public class AppScopedBean3203 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3203.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3203");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3203");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3203");
    }
