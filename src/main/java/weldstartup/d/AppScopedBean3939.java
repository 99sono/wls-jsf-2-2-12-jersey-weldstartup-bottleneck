...
public class AppScopedBean3939 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3939.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3939");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3939");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3939");
    }
