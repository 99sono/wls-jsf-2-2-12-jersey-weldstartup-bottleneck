...
public class AppScopedBean3558 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3558.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3558");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3558");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3558");
    }
