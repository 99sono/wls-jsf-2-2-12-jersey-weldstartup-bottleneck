...
public class AppScopedBean3279 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3279.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3279");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3279");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3279");
    }
