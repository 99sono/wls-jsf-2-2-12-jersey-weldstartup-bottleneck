...
public class AppScopedBean3761 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3761.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3761");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3761");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3761");
    }
