...
public class AppScopedBean3451 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3451.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3451");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3451");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3451");
    }
