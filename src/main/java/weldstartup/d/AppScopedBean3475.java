...
public class AppScopedBean3475 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3475.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3475");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3475");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3475");
    }
