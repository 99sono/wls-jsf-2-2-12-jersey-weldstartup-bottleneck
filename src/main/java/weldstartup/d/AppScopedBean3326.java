...
public class AppScopedBean3326 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3326.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3326");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3326");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3326");
    }
