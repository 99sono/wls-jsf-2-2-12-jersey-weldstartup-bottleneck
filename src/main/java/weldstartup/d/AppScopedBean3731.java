...
public class AppScopedBean3731 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3731.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3731");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3731");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3731");
    }
