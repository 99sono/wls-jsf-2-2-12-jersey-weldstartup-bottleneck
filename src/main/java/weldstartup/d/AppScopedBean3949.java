...
public class AppScopedBean3949 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3949.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3949");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3949");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3949");
    }
