...
public class AppScopedBean3356 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3356.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3356");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3356");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3356");
    }
