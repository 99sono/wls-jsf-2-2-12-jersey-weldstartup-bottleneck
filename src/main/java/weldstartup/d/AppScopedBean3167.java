...
public class AppScopedBean3167 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3167.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3167");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3167");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3167");
    }
