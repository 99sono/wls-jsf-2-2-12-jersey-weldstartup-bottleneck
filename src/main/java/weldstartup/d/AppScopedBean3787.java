...
public class AppScopedBean3787 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3787.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3787");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3787");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3787");
    }
