...
public class AppScopedBean3118 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3118.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3118");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3118");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3118");
    }
