...
public class AppScopedBean3209 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3209.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3209");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3209");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3209");
    }
