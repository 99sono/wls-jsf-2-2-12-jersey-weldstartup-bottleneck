...
public class AppScopedBean3833 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3833.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3833");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3833");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3833");
    }
