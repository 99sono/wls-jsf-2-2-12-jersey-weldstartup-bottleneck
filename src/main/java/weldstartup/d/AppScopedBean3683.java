...
public class AppScopedBean3683 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3683.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3683");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3683");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3683");
    }
