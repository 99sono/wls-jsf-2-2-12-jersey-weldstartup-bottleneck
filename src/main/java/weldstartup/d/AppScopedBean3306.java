...
public class AppScopedBean3306 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3306.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3306");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3306");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3306");
    }
