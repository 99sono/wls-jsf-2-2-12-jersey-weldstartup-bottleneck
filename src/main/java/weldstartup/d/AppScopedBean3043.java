...
public class AppScopedBean3043 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3043.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3043");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3043");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3043");
    }
