...
public class AppScopedBean3703 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3703.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3703");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3703");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3703");
    }
