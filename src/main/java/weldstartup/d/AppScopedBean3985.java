...
public class AppScopedBean3985 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3985.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3985");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3985");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3985");
    }
