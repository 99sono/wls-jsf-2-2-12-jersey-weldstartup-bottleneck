...
public class AppScopedBean3688 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3688.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3688");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3688");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3688");
    }
