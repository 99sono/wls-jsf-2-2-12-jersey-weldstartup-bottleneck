...
public class AppScopedBean3923 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3923.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3923");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3923");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3923");
    }
