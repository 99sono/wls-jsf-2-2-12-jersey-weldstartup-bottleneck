...
public class AppScopedBean3725 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3725.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3725");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3725");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3725");
    }
