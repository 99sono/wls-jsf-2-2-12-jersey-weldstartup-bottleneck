...
public class AppScopedBean3775 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3775.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3775");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3775");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3775");
    }
