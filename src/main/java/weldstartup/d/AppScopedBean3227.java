...
public class AppScopedBean3227 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3227.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3227");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3227");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3227");
    }
