...
public class AppScopedBean3521 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3521.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3521");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3521");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3521");
    }
