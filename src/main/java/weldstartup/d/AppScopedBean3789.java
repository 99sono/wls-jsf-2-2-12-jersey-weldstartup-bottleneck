...
public class AppScopedBean3789 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3789.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3789");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3789");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3789");
    }
