...
public class AppScopedBean3758 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3758.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3758");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3758");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3758");
    }
