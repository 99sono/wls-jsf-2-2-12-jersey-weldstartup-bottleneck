...
public class AppScopedBean3282 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3282.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3282");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3282");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3282");
    }
