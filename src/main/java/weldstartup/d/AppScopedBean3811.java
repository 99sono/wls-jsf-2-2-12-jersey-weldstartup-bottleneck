...
public class AppScopedBean3811 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3811.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3811");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3811");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3811");
    }
