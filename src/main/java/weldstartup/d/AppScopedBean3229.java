...
public class AppScopedBean3229 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3229.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3229");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3229");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3229");
    }
