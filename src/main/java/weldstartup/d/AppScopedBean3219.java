...
public class AppScopedBean3219 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3219.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3219");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3219");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3219");
    }
