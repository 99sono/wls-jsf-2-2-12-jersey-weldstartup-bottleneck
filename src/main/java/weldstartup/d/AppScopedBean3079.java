...
public class AppScopedBean3079 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3079.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3079");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3079");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3079");
    }
