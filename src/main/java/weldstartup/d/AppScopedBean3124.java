...
public class AppScopedBean3124 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3124.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3124");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3124");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3124");
    }
