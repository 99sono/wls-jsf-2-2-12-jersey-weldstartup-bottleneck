...
public class AppScopedBean3498 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3498.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3498");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3498");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3498");
    }
