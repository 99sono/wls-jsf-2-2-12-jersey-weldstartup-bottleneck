...
public class AppScopedBean3715 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3715.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3715");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3715");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3715");
    }
