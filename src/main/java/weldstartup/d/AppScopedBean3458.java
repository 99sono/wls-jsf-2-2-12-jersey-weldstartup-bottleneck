...
public class AppScopedBean3458 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3458.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3458");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3458");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3458");
    }
