...
public class AppScopedBean3909 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3909.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3909");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3909");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3909");
    }
