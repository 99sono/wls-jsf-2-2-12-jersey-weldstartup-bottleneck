...
public class AppScopedBean3367 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3367.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3367");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3367");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3367");
    }
