...
public class AppScopedBean3853 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3853.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3853");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3853");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3853");
    }
