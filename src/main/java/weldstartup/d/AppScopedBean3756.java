...
public class AppScopedBean3756 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3756.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3756");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3756");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3756");
    }
