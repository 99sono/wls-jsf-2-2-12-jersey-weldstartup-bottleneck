...
public class AppScopedBean3629 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3629.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3629");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3629");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3629");
    }
