...
public class AppScopedBean3600 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3600.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3600");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3600");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3600");
    }
