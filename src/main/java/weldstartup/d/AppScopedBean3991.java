...
public class AppScopedBean3991 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3991.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3991");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3991");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3991");
    }
