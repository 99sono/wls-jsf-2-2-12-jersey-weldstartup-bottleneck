...
public class AppScopedBean3732 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3732.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3732");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3732");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3732");
    }
