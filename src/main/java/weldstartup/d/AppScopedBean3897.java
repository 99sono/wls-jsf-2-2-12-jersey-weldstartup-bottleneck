...
public class AppScopedBean3897 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3897.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3897");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3897");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3897");
    }
