...
public class AppScopedBean3434 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3434.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3434");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3434");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3434");
    }
