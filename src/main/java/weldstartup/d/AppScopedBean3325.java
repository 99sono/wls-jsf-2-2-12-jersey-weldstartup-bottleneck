...
public class AppScopedBean3325 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3325.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3325");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3325");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3325");
    }
