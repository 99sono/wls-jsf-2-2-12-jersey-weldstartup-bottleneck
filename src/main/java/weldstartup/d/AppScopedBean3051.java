...
public class AppScopedBean3051 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3051.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3051");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3051");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3051");
    }
