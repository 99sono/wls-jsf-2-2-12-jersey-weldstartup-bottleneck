...
public class AppScopedBean3927 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3927.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3927");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3927");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3927");
    }
