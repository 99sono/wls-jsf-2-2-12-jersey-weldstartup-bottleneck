...
public class AppScopedBean3485 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3485.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3485");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3485");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3485");
    }
