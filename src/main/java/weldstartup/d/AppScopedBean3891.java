...
public class AppScopedBean3891 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3891.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3891");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3891");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3891");
    }
