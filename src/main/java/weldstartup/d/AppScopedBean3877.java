...
public class AppScopedBean3877 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3877.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3877");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3877");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3877");
    }
