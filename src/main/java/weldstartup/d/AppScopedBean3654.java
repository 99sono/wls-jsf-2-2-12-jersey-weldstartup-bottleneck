...
public class AppScopedBean3654 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3654.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3654");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3654");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3654");
    }
