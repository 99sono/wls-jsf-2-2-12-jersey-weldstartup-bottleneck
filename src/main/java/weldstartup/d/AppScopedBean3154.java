...
public class AppScopedBean3154 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3154.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3154");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3154");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3154");
    }
