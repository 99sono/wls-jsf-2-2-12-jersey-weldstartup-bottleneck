...
public class AppScopedBean3135 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3135.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3135");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3135");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3135");
    }
