...
public class AppScopedBean3786 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3786.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3786");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3786");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3786");
    }
