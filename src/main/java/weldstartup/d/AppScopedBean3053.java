...
public class AppScopedBean3053 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3053.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3053");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3053");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3053");
    }
