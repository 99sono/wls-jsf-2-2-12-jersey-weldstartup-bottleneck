...
public class AppScopedBean3223 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3223.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3223");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3223");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3223");
    }
