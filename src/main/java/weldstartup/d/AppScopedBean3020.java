...
public class AppScopedBean3020 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3020.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3020");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3020");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3020");
    }
