...
public class AppScopedBean3888 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3888.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3888");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3888");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3888");
    }
