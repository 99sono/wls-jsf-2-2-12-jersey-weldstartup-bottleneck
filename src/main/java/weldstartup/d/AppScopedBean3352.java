...
public class AppScopedBean3352 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3352.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3352");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3352");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3352");
    }
