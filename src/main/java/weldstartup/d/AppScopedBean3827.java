...
public class AppScopedBean3827 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3827.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3827");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3827");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3827");
    }
