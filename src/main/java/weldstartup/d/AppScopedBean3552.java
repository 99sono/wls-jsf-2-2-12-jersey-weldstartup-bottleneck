...
public class AppScopedBean3552 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3552.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3552");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3552");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3552");
    }
