...
public class AppScopedBean3404 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3404.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3404");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3404");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3404");
    }
