...
public class AppScopedBean3176 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3176.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3176");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3176");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3176");
    }
