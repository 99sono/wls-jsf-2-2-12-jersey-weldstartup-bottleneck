...
public class AppScopedBean3119 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3119.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3119");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3119");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3119");
    }
