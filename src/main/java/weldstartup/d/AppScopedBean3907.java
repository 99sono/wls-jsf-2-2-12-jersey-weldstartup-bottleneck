...
public class AppScopedBean3907 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3907.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3907");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3907");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3907");
    }
