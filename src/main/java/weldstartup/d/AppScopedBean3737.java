...
public class AppScopedBean3737 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3737.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3737");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3737");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3737");
    }
