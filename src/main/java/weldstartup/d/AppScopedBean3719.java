...
public class AppScopedBean3719 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3719.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3719");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3719");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3719");
    }
