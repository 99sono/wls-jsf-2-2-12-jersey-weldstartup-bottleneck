...
public class AppScopedBean3056 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3056.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3056");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3056");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3056");
    }
