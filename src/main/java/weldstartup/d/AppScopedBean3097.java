...
public class AppScopedBean3097 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3097.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3097");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3097");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3097");
    }
