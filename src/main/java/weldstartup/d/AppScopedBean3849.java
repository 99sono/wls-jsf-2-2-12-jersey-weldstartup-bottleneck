...
public class AppScopedBean3849 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3849.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3849");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3849");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3849");
    }
