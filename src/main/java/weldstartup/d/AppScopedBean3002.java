...
public class AppScopedBean3002 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3002.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3002");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3002");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3002");
    }
