...
public class AppScopedBean3163 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3163.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3163");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3163");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3163");
    }
