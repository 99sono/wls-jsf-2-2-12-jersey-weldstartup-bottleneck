...
public class AppScopedBean3573 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3573.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3573");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3573");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3573");
    }
