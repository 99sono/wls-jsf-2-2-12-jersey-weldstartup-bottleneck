...
public class AppScopedBean3816 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3816.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3816");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3816");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3816");
    }
