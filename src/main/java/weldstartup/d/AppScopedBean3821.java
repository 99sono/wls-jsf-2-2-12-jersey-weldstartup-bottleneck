...
public class AppScopedBean3821 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3821.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3821");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3821");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3821");
    }
