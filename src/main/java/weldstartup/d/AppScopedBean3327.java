...
public class AppScopedBean3327 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3327.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3327");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3327");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3327");
    }
