...
public class AppScopedBean3893 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3893.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3893");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3893");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3893");
    }
