...
public class AppScopedBean3730 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3730.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3730");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3730");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3730");
    }
