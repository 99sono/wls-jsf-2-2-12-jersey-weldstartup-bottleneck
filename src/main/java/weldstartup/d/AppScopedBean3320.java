...
public class AppScopedBean3320 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3320.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3320");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3320");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3320");
    }
