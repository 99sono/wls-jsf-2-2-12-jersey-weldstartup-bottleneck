...
public class AppScopedBean3477 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3477.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3477");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3477");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3477");
    }
