...
public class AppScopedBean3342 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3342.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3342");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3342");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3342");
    }
