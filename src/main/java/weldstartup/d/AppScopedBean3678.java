...
public class AppScopedBean3678 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3678.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3678");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3678");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3678");
    }
