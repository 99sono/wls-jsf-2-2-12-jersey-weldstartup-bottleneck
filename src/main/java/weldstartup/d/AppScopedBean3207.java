...
public class AppScopedBean3207 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3207.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3207");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3207");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3207");
    }
