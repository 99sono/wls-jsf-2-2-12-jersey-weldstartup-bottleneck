...
public class AppScopedBean3652 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3652.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3652");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3652");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3652");
    }
