...
public class AppScopedBean3896 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3896.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3896");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3896");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3896");
    }
