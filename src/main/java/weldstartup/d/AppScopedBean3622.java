...
public class AppScopedBean3622 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3622.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3622");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3622");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3622");
    }
