...
public class AppScopedBean3201 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3201.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3201");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3201");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3201");
    }
