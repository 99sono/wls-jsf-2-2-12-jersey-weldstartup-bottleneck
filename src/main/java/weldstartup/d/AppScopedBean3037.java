...
public class AppScopedBean3037 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3037.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3037");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3037");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3037");
    }
