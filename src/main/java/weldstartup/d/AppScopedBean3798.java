...
public class AppScopedBean3798 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3798.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3798");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3798");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3798");
    }
