...
public class AppScopedBean3830 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3830.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3830");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3830");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3830");
    }
