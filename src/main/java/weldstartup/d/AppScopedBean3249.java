...
public class AppScopedBean3249 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3249.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3249");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3249");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3249");
    }
