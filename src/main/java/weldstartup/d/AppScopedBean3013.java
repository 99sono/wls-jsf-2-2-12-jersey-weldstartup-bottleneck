...
public class AppScopedBean3013 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3013.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3013");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3013");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3013");
    }
