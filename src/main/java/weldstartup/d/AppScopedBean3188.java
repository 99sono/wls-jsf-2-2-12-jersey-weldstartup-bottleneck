...
public class AppScopedBean3188 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3188.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3188");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3188");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3188");
    }
