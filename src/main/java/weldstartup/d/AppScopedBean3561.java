...
public class AppScopedBean3561 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3561.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3561");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3561");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3561");
    }
