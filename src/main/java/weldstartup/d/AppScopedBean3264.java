...
public class AppScopedBean3264 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3264.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3264");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3264");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3264");
    }
