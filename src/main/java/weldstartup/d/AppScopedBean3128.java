...
public class AppScopedBean3128 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3128.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3128");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3128");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3128");
    }
