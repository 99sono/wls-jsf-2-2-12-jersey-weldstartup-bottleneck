...
public class AppScopedBean3539 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3539.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3539");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3539");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3539");
    }
