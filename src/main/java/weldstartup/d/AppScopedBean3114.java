...
public class AppScopedBean3114 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3114.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3114");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3114");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3114");
    }
