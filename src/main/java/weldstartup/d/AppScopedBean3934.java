...
public class AppScopedBean3934 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3934.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3934");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3934");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3934");
    }
