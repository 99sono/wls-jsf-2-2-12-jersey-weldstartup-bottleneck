...
public class AppScopedBean3711 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean3711.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean3711");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean3711");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean3711");
    }
