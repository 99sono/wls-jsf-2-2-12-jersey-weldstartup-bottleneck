...
public class AppScopedBean2832 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2832.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2832");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2832");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2832");
    }
