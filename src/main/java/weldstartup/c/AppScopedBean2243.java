...
public class AppScopedBean2243 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2243.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2243");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2243");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2243");
    }
