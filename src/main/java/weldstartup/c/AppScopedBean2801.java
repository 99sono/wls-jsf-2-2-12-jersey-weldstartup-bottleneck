...
public class AppScopedBean2801 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2801.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2801");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2801");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2801");
    }
