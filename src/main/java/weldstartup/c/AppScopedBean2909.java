...
public class AppScopedBean2909 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2909.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2909");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2909");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2909");
    }
