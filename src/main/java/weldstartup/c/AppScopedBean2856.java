...
public class AppScopedBean2856 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2856.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2856");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2856");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2856");
    }
