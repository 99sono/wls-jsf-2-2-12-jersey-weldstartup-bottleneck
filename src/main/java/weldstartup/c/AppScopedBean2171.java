...
public class AppScopedBean2171 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2171.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2171");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2171");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2171");
    }
