...
public class AppScopedBean2433 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2433.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2433");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2433");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2433");
    }
