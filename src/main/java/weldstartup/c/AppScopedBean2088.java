...
public class AppScopedBean2088 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2088.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2088");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2088");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2088");
    }
