...
public class AppScopedBean2777 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2777.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2777");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2777");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2777");
    }
