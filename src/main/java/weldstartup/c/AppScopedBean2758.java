...
public class AppScopedBean2758 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2758.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2758");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2758");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2758");
    }
