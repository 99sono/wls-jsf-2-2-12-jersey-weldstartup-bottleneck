...
public class AppScopedBean2752 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2752.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2752");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2752");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2752");
    }
