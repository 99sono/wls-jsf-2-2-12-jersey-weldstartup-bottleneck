...
public class AppScopedBean2223 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2223.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2223");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2223");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2223");
    }
