...
public class AppScopedBean2045 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2045.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2045");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2045");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2045");
    }
