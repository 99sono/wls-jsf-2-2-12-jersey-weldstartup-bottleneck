...
public class AppScopedBean2337 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2337.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2337");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2337");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2337");
    }
