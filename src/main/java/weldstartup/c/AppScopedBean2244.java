...
public class AppScopedBean2244 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2244.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2244");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2244");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2244");
    }
