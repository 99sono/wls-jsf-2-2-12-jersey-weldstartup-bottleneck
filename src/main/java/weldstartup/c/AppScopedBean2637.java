...
public class AppScopedBean2637 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2637.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2637");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2637");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2637");
    }
