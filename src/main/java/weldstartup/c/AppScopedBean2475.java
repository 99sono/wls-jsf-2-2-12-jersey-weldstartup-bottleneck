...
public class AppScopedBean2475 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2475.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2475");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2475");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2475");
    }
