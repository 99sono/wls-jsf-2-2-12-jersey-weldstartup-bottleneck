...
public class AppScopedBean2720 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2720.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2720");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2720");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2720");
    }
