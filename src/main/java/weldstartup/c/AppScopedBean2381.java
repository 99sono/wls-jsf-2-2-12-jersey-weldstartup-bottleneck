...
public class AppScopedBean2381 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2381.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2381");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2381");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2381");
    }
