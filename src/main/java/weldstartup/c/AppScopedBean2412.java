...
public class AppScopedBean2412 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2412.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2412");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2412");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2412");
    }
