...
public class AppScopedBean2587 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2587.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2587");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2587");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2587");
    }
