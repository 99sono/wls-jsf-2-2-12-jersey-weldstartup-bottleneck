...
public class AppScopedBean2794 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2794.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2794");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2794");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2794");
    }
