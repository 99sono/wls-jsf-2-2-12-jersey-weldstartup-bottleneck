...
public class AppScopedBean2161 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2161.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2161");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2161");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2161");
    }
