...
public class AppScopedBean2639 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2639.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2639");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2639");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2639");
    }
