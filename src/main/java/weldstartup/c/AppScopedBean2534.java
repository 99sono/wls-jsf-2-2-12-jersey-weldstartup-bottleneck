...
public class AppScopedBean2534 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2534.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2534");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2534");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2534");
    }
