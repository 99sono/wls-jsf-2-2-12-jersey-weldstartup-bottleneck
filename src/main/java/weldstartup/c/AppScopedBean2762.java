...
public class AppScopedBean2762 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2762.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2762");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2762");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2762");
    }
