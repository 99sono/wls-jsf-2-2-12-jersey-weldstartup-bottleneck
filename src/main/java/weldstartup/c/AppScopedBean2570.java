...
public class AppScopedBean2570 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2570.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2570");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2570");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2570");
    }
