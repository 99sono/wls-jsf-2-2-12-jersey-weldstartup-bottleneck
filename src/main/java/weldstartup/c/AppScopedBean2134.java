...
public class AppScopedBean2134 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2134.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2134");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2134");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2134");
    }
