...
public class AppScopedBean2662 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2662.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2662");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2662");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2662");
    }
