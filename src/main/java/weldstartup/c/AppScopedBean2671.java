...
public class AppScopedBean2671 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2671.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2671");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2671");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2671");
    }
