...
public class AppScopedBean2645 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2645.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2645");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2645");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2645");
    }
