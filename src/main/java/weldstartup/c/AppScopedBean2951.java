...
public class AppScopedBean2951 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2951.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2951");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2951");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2951");
    }
