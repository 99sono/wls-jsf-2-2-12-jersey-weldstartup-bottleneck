...
public class AppScopedBean2693 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2693.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2693");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2693");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2693");
    }
