...
public class AppScopedBean2348 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2348.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2348");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2348");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2348");
    }
