...
public class AppScopedBean2923 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2923.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2923");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2923");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2923");
    }
