...
public class AppScopedBean2620 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2620.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2620");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2620");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2620");
    }
