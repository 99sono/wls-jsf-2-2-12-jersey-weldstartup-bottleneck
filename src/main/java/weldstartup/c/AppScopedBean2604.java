...
public class AppScopedBean2604 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2604.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2604");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2604");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2604");
    }
