...
public class AppScopedBean2182 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2182.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2182");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2182");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2182");
    }
