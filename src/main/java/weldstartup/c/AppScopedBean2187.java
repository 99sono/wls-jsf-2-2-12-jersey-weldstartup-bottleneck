...
public class AppScopedBean2187 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2187.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2187");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2187");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2187");
    }
