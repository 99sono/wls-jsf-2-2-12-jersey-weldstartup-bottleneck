...
public class AppScopedBean2638 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2638.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2638");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2638");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2638");
    }
