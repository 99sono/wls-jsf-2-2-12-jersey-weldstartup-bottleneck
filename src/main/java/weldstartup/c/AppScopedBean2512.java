...
public class AppScopedBean2512 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2512.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2512");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2512");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2512");
    }
