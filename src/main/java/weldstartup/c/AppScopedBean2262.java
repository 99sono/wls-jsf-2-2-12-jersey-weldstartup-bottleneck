...
public class AppScopedBean2262 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2262.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2262");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2262");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2262");
    }
