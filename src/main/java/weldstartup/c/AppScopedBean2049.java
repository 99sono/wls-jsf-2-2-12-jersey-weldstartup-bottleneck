...
public class AppScopedBean2049 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2049.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2049");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2049");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2049");
    }
