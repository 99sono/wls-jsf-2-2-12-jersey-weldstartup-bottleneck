...
public class AppScopedBean2158 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2158.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2158");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2158");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2158");
    }
