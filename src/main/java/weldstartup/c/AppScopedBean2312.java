...
public class AppScopedBean2312 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2312.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2312");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2312");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2312");
    }
