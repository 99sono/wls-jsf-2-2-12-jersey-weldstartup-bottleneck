...
public class AppScopedBean2711 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2711.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2711");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2711");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2711");
    }
