...
public class AppScopedBean2084 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2084.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2084");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2084");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2084");
    }
