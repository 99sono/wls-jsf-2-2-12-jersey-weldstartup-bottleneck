...
public class AppScopedBean2778 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2778.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2778");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2778");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2778");
    }
