...
public class AppScopedBean2701 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2701.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2701");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2701");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2701");
    }
