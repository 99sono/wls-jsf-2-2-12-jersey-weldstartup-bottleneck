...
public class AppScopedBean2772 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2772.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2772");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2772");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2772");
    }
