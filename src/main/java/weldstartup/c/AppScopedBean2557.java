...
public class AppScopedBean2557 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2557.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2557");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2557");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2557");
    }
