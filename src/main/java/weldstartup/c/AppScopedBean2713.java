...
public class AppScopedBean2713 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2713.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2713");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2713");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2713");
    }
