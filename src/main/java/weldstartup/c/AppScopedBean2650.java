...
public class AppScopedBean2650 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2650.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2650");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2650");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2650");
    }
