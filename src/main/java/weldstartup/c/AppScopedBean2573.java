...
public class AppScopedBean2573 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2573.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2573");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2573");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2573");
    }
