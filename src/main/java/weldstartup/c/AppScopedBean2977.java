...
public class AppScopedBean2977 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2977.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2977");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2977");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2977");
    }
