...
public class AppScopedBean2081 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2081.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2081");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2081");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2081");
    }
