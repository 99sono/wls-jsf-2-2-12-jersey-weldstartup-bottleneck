...
public class AppScopedBean2437 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2437.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2437");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2437");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2437");
    }
