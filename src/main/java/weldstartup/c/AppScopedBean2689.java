...
public class AppScopedBean2689 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2689.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2689");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2689");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2689");
    }
