...
public class AppScopedBean2936 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2936.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2936");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2936");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2936");
    }
