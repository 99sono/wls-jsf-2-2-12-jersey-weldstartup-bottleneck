...
public class AppScopedBean2501 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2501.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2501");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2501");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2501");
    }
