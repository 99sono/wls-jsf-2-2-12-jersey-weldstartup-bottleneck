...
public class AppScopedBean2590 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2590.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2590");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2590");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2590");
    }
