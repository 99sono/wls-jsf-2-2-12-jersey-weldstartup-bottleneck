...
public class AppScopedBean2195 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2195.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2195");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2195");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2195");
    }
