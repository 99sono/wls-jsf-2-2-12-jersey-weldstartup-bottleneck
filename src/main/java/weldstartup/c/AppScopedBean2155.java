...
public class AppScopedBean2155 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2155.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2155");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2155");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2155");
    }
