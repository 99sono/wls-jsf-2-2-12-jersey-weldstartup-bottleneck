...
public class AppScopedBean2479 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2479.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2479");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2479");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2479");
    }
