...
public class AppScopedBean2594 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2594.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2594");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2594");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2594");
    }
