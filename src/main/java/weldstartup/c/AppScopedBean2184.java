...
public class AppScopedBean2184 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2184.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2184");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2184");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2184");
    }
