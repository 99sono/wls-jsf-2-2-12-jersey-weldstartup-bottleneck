...
public class AppScopedBean2092 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2092.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2092");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2092");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2092");
    }
