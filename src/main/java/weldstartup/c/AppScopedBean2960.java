...
public class AppScopedBean2960 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2960.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2960");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2960");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2960");
    }
