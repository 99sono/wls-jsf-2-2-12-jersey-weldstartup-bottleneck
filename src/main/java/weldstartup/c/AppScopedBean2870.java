...
public class AppScopedBean2870 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2870.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2870");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2870");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2870");
    }
