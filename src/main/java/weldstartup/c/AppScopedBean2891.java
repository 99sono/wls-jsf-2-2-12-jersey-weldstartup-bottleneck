...
public class AppScopedBean2891 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2891.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2891");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2891");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2891");
    }
