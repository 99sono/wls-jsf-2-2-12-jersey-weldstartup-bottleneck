...
public class AppScopedBean2566 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2566.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2566");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2566");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2566");
    }
