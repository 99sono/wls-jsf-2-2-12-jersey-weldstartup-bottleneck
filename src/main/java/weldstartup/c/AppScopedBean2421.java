...
public class AppScopedBean2421 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2421.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2421");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2421");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2421");
    }
