...
public class AppScopedBean2618 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2618.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2618");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2618");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2618");
    }
