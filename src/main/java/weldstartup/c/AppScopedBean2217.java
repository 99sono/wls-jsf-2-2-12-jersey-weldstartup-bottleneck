...
public class AppScopedBean2217 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2217.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2217");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2217");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2217");
    }
