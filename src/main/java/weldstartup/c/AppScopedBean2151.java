...
public class AppScopedBean2151 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2151.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2151");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2151");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2151");
    }
