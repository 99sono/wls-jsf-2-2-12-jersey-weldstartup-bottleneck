...
public class AppScopedBean2611 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2611.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2611");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2611");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2611");
    }
