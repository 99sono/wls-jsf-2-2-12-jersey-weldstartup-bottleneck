...
public class AppScopedBean2615 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2615.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2615");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2615");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2615");
    }
