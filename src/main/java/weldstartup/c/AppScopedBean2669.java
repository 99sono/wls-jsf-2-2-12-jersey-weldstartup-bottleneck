...
public class AppScopedBean2669 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2669.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2669");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2669");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2669");
    }
