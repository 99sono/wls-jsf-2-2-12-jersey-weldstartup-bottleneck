...
public class AppScopedBean2885 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2885.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2885");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2885");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2885");
    }
