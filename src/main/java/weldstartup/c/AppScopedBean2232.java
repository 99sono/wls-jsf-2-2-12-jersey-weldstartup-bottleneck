...
public class AppScopedBean2232 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2232.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2232");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2232");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2232");
    }
