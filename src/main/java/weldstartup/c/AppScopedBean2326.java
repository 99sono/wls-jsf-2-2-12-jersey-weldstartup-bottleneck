...
public class AppScopedBean2326 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2326.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2326");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2326");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2326");
    }
