...
public class AppScopedBean2384 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2384.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2384");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2384");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2384");
    }
