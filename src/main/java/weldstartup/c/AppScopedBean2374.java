...
public class AppScopedBean2374 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2374.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2374");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2374");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2374");
    }
