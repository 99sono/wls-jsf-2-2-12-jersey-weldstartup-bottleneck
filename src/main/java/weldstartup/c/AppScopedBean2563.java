...
public class AppScopedBean2563 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2563.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2563");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2563");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2563");
    }
