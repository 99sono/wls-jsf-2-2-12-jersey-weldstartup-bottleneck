...
public class AppScopedBean2368 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2368.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2368");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2368");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2368");
    }
