...
public class AppScopedBean2132 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2132.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2132");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2132");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2132");
    }
