...
public class AppScopedBean2987 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2987.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2987");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2987");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2987");
    }
