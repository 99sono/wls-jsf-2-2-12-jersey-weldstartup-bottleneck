...
public class AppScopedBean2726 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2726.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2726");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2726");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2726");
    }
