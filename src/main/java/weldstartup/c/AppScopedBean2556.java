...
public class AppScopedBean2556 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2556.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2556");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2556");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2556");
    }
