...
public class AppScopedBean2779 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2779.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2779");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2779");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2779");
    }
