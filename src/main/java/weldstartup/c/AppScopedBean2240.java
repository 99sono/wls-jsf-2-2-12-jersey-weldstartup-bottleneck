...
public class AppScopedBean2240 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2240.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2240");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2240");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2240");
    }
