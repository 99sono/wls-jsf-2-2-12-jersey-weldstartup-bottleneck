...
public class AppScopedBean2971 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2971.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2971");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2971");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2971");
    }
