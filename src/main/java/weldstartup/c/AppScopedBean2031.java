...
public class AppScopedBean2031 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2031.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2031");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2031");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2031");
    }
