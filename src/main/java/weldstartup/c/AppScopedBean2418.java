...
public class AppScopedBean2418 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2418.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2418");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2418");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2418");
    }
