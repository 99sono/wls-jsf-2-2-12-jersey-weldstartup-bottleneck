...
public class AppScopedBean2516 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2516.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2516");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2516");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2516");
    }
