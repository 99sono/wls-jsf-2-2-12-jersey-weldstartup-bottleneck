...
public class AppScopedBean2100 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2100.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2100");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2100");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2100");
    }
