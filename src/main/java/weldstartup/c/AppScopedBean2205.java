...
public class AppScopedBean2205 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2205.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2205");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2205");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2205");
    }
