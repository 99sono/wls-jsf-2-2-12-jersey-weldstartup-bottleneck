...
public class AppScopedBean2336 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2336.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2336");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2336");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2336");
    }
