...
public class AppScopedBean2096 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2096.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2096");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2096");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2096");
    }
