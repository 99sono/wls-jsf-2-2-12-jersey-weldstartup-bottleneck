...
public class AppScopedBean2001 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2001.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2001");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2001");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2001");
    }
