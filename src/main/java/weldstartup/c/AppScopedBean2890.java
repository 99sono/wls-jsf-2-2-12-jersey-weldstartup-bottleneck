...
public class AppScopedBean2890 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2890.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2890");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2890");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2890");
    }
