...
public class AppScopedBean2200 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2200.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2200");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2200");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2200");
    }
