...
public class AppScopedBean2717 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2717.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2717");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2717");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2717");
    }
