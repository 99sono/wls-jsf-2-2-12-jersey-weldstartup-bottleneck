...
public class AppScopedBean2459 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2459.class);
    ...
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2459");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2459");
    }
