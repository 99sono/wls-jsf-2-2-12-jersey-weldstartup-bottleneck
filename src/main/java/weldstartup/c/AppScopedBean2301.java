...
public class AppScopedBean2301 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2301.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2301");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2301");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2301");
    }
