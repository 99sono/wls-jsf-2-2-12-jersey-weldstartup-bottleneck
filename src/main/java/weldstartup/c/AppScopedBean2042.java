...
public class AppScopedBean2042 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2042.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2042");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2042");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2042");
    }
