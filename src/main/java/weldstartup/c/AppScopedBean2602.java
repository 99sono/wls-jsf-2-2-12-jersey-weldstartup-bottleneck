...
public class AppScopedBean2602 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2602.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2602");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2602");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2602");
    }
