...
public class AppScopedBean2706 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2706.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2706");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2706");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2706");
    }
