...
public class AppScopedBean2114 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2114.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2114");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2114");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2114");
    }
