...
public class AppScopedBean2947 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2947.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2947");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2947");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2947");
    }
