...
public class AppScopedBean2030 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2030.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2030");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2030");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2030");
    }
