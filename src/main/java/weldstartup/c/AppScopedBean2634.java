...
public class AppScopedBean2634 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2634.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2634");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2634");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2634");
    }
