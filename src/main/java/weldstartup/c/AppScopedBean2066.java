...
public class AppScopedBean2066 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2066.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2066");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2066");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2066");
    }
