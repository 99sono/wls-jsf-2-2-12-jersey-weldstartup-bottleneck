...
public class AppScopedBean2010 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2010.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2010");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2010");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2010");
    }
