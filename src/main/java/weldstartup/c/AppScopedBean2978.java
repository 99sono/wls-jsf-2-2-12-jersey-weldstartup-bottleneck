...
public class AppScopedBean2978 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2978.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2978");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2978");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2978");
    }
