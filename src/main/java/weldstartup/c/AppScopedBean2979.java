...
public class AppScopedBean2979 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2979.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2979");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2979");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2979");
    }
