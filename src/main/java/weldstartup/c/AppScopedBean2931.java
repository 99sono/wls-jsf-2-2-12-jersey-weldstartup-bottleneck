...
public class AppScopedBean2931 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2931.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2931");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2931");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2931");
    }
