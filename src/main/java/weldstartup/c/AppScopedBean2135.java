...
public class AppScopedBean2135 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2135.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2135");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2135");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2135");
    }
