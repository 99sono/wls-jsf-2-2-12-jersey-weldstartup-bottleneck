...
public class AppScopedBean2974 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2974.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2974");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2974");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2974");
    }
