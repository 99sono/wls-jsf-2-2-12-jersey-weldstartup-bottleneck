...
public class AppScopedBean2315 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2315.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2315");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2315");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2315");
    }
