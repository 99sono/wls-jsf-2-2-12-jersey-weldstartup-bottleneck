...
public class AppScopedBean2474 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2474.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2474");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2474");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2474");
    }
