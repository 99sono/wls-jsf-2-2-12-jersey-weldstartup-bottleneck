...
public class AppScopedBean2878 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2878.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2878");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2878");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2878");
    }
