...
public class AppScopedBean2690 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2690.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2690");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2690");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2690");
    }
