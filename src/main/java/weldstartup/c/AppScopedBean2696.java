...
public class AppScopedBean2696 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2696.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2696");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2696");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2696");
    }
