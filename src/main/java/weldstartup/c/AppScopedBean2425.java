...
public class AppScopedBean2425 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2425.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2425");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2425");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2425");
    }
