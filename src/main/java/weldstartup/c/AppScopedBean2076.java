...
public class AppScopedBean2076 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2076.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2076");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2076");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2076");
    }
