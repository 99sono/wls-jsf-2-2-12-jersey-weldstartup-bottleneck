...
public class AppScopedBean2120 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2120.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2120");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2120");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2120");
    }
