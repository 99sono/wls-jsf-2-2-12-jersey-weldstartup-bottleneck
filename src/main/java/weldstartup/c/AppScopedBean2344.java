...
public class AppScopedBean2344 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2344.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2344");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2344");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2344");
    }
