...
public class AppScopedBean2239 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2239.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2239");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2239");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2239");
    }
