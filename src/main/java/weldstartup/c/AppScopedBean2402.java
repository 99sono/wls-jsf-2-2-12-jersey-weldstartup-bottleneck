...
public class AppScopedBean2402 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2402.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2402");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2402");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2402");
    }
