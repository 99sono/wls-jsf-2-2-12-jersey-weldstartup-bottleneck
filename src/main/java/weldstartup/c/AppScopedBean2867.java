...
public class AppScopedBean2867 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2867.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2867");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2867");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2867");
    }
