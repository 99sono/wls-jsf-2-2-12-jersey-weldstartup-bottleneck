...
public class AppScopedBean2764 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2764.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2764");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2764");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2764");
    }
