...
public class AppScopedBean2897 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2897.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2897");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2897");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2897");
    }
