...
public class AppScopedBean2727 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2727.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2727");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2727");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2727");
    }
