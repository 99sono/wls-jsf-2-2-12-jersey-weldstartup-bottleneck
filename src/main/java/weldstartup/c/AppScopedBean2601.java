...
public class AppScopedBean2601 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2601.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2601");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2601");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2601");
    }
