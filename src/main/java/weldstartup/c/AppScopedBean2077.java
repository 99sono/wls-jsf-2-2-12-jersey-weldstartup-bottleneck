...
public class AppScopedBean2077 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2077.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2077");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2077");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2077");
    }
