...
public class AppScopedBean2065 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2065.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2065");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2065");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2065");
    }
