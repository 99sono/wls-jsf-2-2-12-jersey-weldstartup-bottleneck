...
public class AppScopedBean2644 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2644.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2644");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2644");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2644");
    }
