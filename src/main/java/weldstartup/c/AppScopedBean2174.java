...
public class AppScopedBean2174 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2174.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2174");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2174");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2174");
    }
