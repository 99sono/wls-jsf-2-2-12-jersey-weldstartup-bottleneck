...
public class AppScopedBean2526 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2526.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2526");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2526");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2526");
    }
