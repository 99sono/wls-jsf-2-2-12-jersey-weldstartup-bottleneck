...
public class AppScopedBean2889 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2889.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2889");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2889");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2889");
    }
