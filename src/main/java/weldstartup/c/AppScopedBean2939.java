...
public class AppScopedBean2939 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2939.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2939");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2939");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2939");
    }
