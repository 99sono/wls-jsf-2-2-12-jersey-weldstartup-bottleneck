...
public class AppScopedBean2014 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2014.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2014");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2014");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2014");
    }
