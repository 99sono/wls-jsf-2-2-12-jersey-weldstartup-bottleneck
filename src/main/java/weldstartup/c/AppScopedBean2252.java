...
public class AppScopedBean2252 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2252.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2252");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2252");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2252");
    }
