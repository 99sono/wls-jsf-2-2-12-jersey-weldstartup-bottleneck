...
public class AppScopedBean2883 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2883.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2883");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2883");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2883");
    }
