...
public class AppScopedBean2467 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2467.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2467");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2467");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2467");
    }
