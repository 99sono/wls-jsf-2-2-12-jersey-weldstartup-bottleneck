...
public class AppScopedBean2131 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2131.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2131");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2131");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2131");
    }
