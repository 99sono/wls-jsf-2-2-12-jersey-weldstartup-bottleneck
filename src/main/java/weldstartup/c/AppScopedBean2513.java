...
public class AppScopedBean2513 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2513.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2513");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2513");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2513");
    }
