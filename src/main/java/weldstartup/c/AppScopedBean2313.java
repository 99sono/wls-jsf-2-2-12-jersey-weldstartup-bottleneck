...
public class AppScopedBean2313 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2313.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2313");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2313");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2313");
    }
