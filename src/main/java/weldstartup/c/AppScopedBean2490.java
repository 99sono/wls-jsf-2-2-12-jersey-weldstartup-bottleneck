...
public class AppScopedBean2490 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2490.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2490");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2490");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2490");
    }
