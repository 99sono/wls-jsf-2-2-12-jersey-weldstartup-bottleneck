...
public class AppScopedBean2020 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2020.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2020");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2020");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2020");
    }
