...
public class AppScopedBean2571 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2571.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2571");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2571");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2571");
    }
