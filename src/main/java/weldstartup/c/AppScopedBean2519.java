...
public class AppScopedBean2519 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2519.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2519");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2519");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2519");
    }
