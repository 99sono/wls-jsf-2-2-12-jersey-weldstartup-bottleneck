...
public class AppScopedBean2372 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2372.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2372");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2372");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2372");
    }
