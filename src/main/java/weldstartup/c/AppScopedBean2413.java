...
public class AppScopedBean2413 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2413.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2413");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2413");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2413");
    }
