...
public class AppScopedBean2851 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2851.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2851");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2851");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2851");
    }
