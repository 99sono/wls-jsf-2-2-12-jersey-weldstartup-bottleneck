...
public class AppScopedBean2765 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2765.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2765");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2765");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2765");
    }
