...
public class AppScopedBean2945 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2945.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2945");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2945");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2945");
    }
