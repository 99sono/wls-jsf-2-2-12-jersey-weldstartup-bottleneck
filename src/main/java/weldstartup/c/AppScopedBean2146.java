...
public class AppScopedBean2146 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2146.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2146");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2146");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2146");
    }
