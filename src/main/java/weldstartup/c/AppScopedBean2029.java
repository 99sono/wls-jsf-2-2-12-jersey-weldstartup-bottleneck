...
public class AppScopedBean2029 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2029.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2029");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2029");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2029");
    }
