...
public class AppScopedBean2807 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2807.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2807");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2807");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2807");
    }
