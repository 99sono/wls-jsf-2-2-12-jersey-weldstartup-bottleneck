...
public class AppScopedBean2876 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2876.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2876");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2876");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2876");
    }
