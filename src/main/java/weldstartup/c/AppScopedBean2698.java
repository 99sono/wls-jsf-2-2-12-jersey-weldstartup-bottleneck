...
public class AppScopedBean2698 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2698.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2698");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2698");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2698");
    }
