...
public class AppScopedBean2614 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2614.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2614");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2614");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2614");
    }
