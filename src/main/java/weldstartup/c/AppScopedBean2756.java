...
public class AppScopedBean2756 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2756.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2756");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2756");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2756");
    }
