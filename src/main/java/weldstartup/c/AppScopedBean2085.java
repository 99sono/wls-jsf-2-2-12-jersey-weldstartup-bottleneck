...
public class AppScopedBean2085 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2085.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2085");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2085");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2085");
    }
