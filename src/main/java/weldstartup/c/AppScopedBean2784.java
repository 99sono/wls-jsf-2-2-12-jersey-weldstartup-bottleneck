...
public class AppScopedBean2784 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2784.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2784");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2784");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2784");
    }
