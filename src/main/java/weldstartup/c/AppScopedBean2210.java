...
public class AppScopedBean2210 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2210.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2210");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2210");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2210");
    }
