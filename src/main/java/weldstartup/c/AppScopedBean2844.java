...
public class AppScopedBean2844 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2844.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2844");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2844");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2844");
    }
