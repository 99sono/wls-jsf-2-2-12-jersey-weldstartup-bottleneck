...
public class AppScopedBean2360 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2360.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2360");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2360");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2360");
    }
