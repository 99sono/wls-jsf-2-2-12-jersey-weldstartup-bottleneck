...
public class AppScopedBean2610 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2610.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2610");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2610");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2610");
    }
