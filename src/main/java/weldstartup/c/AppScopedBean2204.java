...
public class AppScopedBean2204 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2204.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2204");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2204");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2204");
    }
