...
public class AppScopedBean2143 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2143.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2143");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2143");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2143");
    }
