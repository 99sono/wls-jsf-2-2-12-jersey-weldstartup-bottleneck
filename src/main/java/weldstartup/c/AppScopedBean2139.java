...
public class AppScopedBean2139 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2139.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2139");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2139");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2139");
    }
