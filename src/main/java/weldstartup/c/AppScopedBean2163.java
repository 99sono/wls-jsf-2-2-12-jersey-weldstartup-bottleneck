...
public class AppScopedBean2163 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2163.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2163");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2163");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2163");
    }
