...
public class AppScopedBean2531 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2531.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2531");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2531");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2531");
    }
