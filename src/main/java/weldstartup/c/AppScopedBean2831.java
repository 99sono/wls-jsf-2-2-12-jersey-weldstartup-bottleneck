...
public class AppScopedBean2831 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2831.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2831");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2831");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2831");
    }
