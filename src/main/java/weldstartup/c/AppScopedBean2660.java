...
public class AppScopedBean2660 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2660.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2660");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2660");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2660");
    }
