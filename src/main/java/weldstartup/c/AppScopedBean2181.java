...
public class AppScopedBean2181 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2181.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2181");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2181");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2181");
    }
