...
public class AppScopedBean2082 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2082.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2082");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2082");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2082");
    }
