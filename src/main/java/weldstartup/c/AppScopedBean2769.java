...
public class AppScopedBean2769 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2769.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2769");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2769");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2769");
    }
