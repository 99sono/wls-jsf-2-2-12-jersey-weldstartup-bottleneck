...
public class AppScopedBean2398 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2398.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2398");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2398");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2398");
    }
