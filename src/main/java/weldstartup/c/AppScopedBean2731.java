...
public class AppScopedBean2731 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2731.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2731");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2731");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2731");
    }
