...
public class AppScopedBean2837 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2837.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2837");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2837");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2837");
    }
