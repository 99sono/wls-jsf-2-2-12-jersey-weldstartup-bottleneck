...
public class AppScopedBean2422 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2422.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2422");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2422");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2422");
    }
