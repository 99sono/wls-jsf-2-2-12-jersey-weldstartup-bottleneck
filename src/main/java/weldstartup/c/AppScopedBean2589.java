...
public class AppScopedBean2589 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2589.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2589");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2589");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2589");
    }
