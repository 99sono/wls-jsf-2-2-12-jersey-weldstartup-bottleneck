...
public class AppScopedBean2005 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2005.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2005");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2005");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2005");
    }
