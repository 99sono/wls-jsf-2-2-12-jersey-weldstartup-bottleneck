...
public class AppScopedBean2930 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2930.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2930");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2930");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2930");
    }
