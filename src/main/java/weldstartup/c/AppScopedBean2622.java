...
public class AppScopedBean2622 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2622.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2622");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2622");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2622");
    }
