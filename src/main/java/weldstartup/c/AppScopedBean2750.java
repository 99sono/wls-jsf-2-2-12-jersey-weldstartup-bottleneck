...
public class AppScopedBean2750 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2750.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2750");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2750");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2750");
    }
