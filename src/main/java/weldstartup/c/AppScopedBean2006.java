...
public class AppScopedBean2006 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2006.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2006");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2006");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2006");
    }
