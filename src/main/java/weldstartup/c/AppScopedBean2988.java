...
public class AppScopedBean2988 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2988.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2988");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2988");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2988");
    }
