...
public class AppScopedBean2172 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2172.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2172");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2172");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2172");
    }
