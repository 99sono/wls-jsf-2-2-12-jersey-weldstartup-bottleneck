...
public class AppScopedBean2346 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2346.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2346");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2346");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2346");
    }
