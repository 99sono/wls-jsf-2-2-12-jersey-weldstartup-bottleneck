...
public class AppScopedBean2760 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2760.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2760");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2760");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2760");
    }
