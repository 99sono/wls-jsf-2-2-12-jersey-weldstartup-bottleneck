...
public class AppScopedBean2466 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2466.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2466");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2466");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2466");
    }
