...
public class AppScopedBean2345 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2345.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2345");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2345");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2345");
    }
