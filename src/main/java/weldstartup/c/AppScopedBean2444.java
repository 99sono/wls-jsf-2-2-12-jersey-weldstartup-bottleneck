...
public class AppScopedBean2444 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2444.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2444");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2444");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2444");
    }
