...
public class AppScopedBean2632 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2632.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2632");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2632");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2632");
    }
