...
public class AppScopedBean2986 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2986.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2986");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2986");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2986");
    }
