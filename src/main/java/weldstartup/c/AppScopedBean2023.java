...
public class AppScopedBean2023 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2023.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2023");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2023");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2023");
    }
