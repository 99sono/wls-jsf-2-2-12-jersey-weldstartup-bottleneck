...
public class AppScopedBean2629 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2629.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2629");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2629");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2629");
    }
