...
public class AppScopedBean2271 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2271.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2271");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2271");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2271");
    }
