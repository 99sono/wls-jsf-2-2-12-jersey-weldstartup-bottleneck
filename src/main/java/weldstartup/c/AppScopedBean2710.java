...
public class AppScopedBean2710 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2710.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2710");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2710");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2710");
    }
