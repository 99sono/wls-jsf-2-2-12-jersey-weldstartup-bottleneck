...
public class AppScopedBean2371 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2371.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2371");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2371");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2371");
    }
