...
public class AppScopedBean2362 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2362.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2362");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2362");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2362");
    }
