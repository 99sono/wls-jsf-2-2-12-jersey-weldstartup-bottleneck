...
public class AppScopedBean2358 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2358.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2358");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2358");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2358");
    }
