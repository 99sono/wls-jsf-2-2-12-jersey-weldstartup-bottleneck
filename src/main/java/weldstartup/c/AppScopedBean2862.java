...
public class AppScopedBean2862 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2862.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2862");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2862");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2862");
    }
