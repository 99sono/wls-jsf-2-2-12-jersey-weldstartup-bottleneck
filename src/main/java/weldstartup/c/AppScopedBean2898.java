...
public class AppScopedBean2898 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2898.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2898");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2898");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2898");
    }
