...
public class AppScopedBean2121 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2121.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2121");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2121");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2121");
    }
