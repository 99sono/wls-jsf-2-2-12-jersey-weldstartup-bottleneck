...
public class AppScopedBean2309 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2309.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2309");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2309");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2309");
    }
