...
public class AppScopedBean2527 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2527.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2527");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2527");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2527");
    }
