...
public class AppScopedBean2664 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2664.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2664");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2664");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2664");
    }
