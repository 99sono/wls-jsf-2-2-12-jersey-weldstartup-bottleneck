...
public class AppScopedBean2219 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2219.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2219");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2219");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2219");
    }
