...
public class AppScopedBean2281 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2281.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2281");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2281");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2281");
    }
