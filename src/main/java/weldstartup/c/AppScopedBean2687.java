...
public class AppScopedBean2687 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2687.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2687");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2687");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2687");
    }
