...
public class AppScopedBean2913 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2913.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2913");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2913");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2913");
    }
