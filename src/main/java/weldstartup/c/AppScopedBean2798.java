...
public class AppScopedBean2798 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2798.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2798");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2798");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2798");
    }
