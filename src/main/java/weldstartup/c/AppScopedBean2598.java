...
public class AppScopedBean2598 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2598.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2598");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2598");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2598");
    }
