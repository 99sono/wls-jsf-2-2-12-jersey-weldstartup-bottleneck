...
public class AppScopedBean2342 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2342.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2342");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2342");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2342");
    }
