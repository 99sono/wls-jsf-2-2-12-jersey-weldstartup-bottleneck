...
public class AppScopedBean2495 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2495.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2495");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2495");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2495");
    }
