...
public class AppScopedBean2419 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2419.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2419");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2419");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2419");
    }
