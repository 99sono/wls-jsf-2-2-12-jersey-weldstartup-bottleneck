...
public class AppScopedBean2982 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2982.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2982");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2982");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2982");
    }
