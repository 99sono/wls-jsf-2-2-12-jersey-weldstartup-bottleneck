...
public class AppScopedBean2541 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2541.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2541");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2541");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2541");
    }
