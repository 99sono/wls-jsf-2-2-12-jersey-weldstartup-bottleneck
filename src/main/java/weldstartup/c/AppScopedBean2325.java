...
public class AppScopedBean2325 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2325.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2325");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2325");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2325");
    }
