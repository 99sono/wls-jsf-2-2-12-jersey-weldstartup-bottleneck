...
public class AppScopedBean2729 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2729.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2729");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2729");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2729");
    }
