...
public class AppScopedBean2485 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2485.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2485");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2485");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2485");
    }
