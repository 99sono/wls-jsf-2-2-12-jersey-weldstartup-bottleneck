...
public class AppScopedBean2027 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2027.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2027");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2027");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2027");
    }
