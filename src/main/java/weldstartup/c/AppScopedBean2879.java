...
public class AppScopedBean2879 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2879.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2879");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2879");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2879");
    }
