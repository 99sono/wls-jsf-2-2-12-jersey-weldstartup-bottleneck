...
public class AppScopedBean2747 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2747.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2747");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2747");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2747");
    }
