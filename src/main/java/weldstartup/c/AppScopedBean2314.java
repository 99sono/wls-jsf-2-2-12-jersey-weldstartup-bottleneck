...
public class AppScopedBean2314 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2314.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2314");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2314");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2314");
    }
