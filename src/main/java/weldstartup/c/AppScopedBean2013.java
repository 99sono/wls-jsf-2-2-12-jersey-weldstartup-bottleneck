...
public class AppScopedBean2013 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2013.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2013");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2013");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2013");
    }
