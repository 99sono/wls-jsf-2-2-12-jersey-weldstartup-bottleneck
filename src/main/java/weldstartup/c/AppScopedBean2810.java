...
public class AppScopedBean2810 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2810.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2810");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2810");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2810");
    }
