...
public class AppScopedBean2017 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2017.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2017");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2017");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2017");
    }
