...
public class AppScopedBean2162 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2162.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2162");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2162");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2162");
    }
