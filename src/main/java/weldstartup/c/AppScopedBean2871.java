...
public class AppScopedBean2871 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2871.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2871");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2871");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2871");
    }
