...
public class AppScopedBean2565 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2565.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2565");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2565");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2565");
    }
