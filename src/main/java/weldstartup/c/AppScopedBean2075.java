...
public class AppScopedBean2075 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2075.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2075");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2075");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2075");
    }
