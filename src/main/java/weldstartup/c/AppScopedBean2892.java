...
public class AppScopedBean2892 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2892.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2892");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2892");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2892");
    }
