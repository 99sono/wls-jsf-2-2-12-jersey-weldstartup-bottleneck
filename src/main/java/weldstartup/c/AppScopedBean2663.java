...
public class AppScopedBean2663 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2663.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2663");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2663");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2663");
    }
