...
public class AppScopedBean2905 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2905.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2905");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2905");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2905");
    }
