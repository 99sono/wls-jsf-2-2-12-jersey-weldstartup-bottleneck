...
public class AppScopedBean2896 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2896.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2896");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2896");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2896");
    }
