...
public class AppScopedBean2159 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2159.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2159");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2159");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2159");
    }
