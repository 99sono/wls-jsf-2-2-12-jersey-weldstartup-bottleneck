...
public class AppScopedBean2993 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2993.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2993");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2993");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2993");
    }
