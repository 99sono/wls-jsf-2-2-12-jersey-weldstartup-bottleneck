...
public class AppScopedBean2481 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2481.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2481");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2481");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2481");
    }
