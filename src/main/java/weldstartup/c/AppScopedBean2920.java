...
public class AppScopedBean2920 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2920.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2920");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2920");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2920");
    }
