...
public class AppScopedBean2716 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2716.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2716");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2716");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2716");
    }
