...
public class AppScopedBean2307 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2307.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2307");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2307");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2307");
    }
