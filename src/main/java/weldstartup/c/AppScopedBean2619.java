...
public class AppScopedBean2619 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2619.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2619");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2619");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2619");
    }
