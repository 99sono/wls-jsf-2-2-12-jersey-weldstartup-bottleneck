...
public class AppScopedBean2292 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2292.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2292");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2292");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2292");
    }
