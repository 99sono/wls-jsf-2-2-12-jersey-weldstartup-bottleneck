...
public class AppScopedBean2684 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2684.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2684");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2684");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2684");
    }
