...
public class AppScopedBean2721 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2721.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2721");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2721");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2721");
    }
