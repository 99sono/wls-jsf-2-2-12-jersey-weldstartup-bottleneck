...
public class AppScopedBean2588 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2588.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2588");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2588");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2588");
    }
