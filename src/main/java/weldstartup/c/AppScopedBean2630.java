...
public class AppScopedBean2630 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2630.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2630");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2630");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2630");
    }
