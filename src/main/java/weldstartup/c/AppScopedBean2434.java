...
public class AppScopedBean2434 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2434.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2434");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2434");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2434");
    }
