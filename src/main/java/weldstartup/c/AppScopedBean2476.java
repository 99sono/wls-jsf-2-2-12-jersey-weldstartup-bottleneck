...
public class AppScopedBean2476 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2476.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2476");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2476");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2476");
    }
