...
public class AppScopedBean2492 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2492.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2492");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2492");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2492");
    }
