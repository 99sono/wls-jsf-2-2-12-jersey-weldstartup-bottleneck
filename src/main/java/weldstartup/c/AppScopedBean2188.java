...
public class AppScopedBean2188 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2188.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2188");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2188");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2188");
    }
