...
public class AppScopedBean2569 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2569.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2569");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2569");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2569");
    }
