...
public class AppScopedBean2623 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2623.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2623");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2623");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2623");
    }
