...
public class AppScopedBean2734 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2734.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2734");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2734");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2734");
    }
