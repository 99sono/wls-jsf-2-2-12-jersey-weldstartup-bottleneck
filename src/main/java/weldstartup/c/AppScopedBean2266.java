...
public class AppScopedBean2266 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2266.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2266");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2266");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2266");
    }
