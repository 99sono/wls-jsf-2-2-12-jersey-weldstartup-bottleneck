...
public class AppScopedBean2365 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2365.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2365");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2365");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2365");
    }
