...
public class AppScopedBean2400 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2400.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2400");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2400");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2400");
    }
