...
public class AppScopedBean2288 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2288.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2288");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2288");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2288");
    }
