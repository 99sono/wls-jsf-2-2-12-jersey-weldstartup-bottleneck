...
public class AppScopedBean2242 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2242.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2242");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2242");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2242");
    }
