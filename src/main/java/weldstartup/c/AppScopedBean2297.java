...
public class AppScopedBean2297 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2297.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2297");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2297");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2297");
    }
