...
public class AppScopedBean2702 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2702.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2702");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2702");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2702");
    }
