...
public class AppScopedBean2924 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2924.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2924");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2924");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2924");
    }
