...
public class AppScopedBean2287 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2287.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2287");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2287");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2287");
    }
