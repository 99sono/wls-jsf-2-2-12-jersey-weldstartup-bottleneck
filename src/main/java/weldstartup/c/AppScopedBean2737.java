...
public class AppScopedBean2737 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2737.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2737");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2737");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2737");
    }
