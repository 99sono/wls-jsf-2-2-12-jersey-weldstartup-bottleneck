...
public class AppScopedBean2052 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2052.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2052");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2052");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2052");
    }
