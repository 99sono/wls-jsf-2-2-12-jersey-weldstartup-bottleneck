...
public class AppScopedBean2227 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2227.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2227");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2227");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2227");
    }
