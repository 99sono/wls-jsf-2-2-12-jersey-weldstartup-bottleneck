...
public class AppScopedBean2099 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2099.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2099");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2099");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2099");
    }
