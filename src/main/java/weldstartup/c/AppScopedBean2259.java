...
public class AppScopedBean2259 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2259.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2259");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2259");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2259");
    }
