...
public class AppScopedBean2882 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2882.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2882");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2882");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2882");
    }
