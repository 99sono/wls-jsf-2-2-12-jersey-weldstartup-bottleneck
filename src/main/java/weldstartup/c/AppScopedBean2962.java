...
public class AppScopedBean2962 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2962.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2962");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2962");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2962");
    }
