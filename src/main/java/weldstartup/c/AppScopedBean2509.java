...
public class AppScopedBean2509 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2509.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2509");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2509");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2509");
    }
