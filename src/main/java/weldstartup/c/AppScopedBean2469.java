...
public class AppScopedBean2469 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2469.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2469");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2469");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2469");
    }
