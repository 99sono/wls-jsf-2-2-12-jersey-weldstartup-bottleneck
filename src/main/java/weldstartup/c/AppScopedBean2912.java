...
public class AppScopedBean2912 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2912.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2912");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2912");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2912");
    }
