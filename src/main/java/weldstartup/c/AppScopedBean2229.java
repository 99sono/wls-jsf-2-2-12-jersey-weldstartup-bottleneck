...
public class AppScopedBean2229 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2229.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2229");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2229");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2229");
    }
