...
public class AppScopedBean2063 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2063.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2063");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2063");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2063");
    }
