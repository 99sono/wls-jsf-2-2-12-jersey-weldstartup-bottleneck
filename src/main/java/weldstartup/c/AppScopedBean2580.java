...
public class AppScopedBean2580 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2580.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2580");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2580");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2580");
    }
