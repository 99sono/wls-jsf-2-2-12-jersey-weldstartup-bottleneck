...
public class AppScopedBean2147 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2147.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2147");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2147");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2147");
    }
