...
public class AppScopedBean2873 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2873.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2873");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2873");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2873");
    }
