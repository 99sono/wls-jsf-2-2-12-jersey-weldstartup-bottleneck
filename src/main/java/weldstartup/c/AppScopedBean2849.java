...
public class AppScopedBean2849 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2849.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2849");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2849");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2849");
    }
