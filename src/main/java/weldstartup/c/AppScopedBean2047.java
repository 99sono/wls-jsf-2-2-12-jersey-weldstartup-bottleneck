...
public class AppScopedBean2047 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2047.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2047");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2047");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2047");
    }
