...
public class AppScopedBean2463 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2463.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2463");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2463");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2463");
    }
