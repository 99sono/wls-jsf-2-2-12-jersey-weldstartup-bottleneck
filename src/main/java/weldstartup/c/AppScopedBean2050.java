...
public class AppScopedBean2050 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2050.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2050");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2050");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2050");
    }
