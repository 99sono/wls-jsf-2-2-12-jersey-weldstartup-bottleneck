...
public class AppScopedBean2053 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2053.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2053");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2053");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2053");
    }
