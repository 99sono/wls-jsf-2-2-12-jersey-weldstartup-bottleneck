...
public class AppScopedBean2806 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2806.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2806");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2806");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2806");
    }
