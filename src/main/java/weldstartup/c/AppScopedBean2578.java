...
public class AppScopedBean2578 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2578.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2578");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2578");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2578");
    }
