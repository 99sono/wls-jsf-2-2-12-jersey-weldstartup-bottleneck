...
public class AppScopedBean2707 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2707.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2707");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2707");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2707");
    }
