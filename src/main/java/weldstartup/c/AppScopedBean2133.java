...
public class AppScopedBean2133 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2133.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2133");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2133");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2133");
    }
