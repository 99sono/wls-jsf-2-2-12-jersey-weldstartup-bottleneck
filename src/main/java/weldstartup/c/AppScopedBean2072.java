...
public class AppScopedBean2072 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2072.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2072");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2072");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2072");
    }
