...
public class AppScopedBean2386 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2386.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2386");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2386");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2386");
    }
