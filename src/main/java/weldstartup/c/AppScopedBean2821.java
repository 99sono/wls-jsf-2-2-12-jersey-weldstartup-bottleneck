...
public class AppScopedBean2821 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2821.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2821");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2821");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2821");
    }
