...
public class AppScopedBean2302 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2302.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2302");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2302");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2302");
    }
