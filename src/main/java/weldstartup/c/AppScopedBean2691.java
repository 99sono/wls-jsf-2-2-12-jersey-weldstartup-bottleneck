...
public class AppScopedBean2691 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2691.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2691");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2691");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2691");
    }
