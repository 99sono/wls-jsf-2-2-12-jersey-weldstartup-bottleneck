...
public class AppScopedBean2190 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2190.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2190");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2190");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2190");
    }
