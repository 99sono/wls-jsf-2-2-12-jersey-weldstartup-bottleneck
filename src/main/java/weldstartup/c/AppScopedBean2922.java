...
public class AppScopedBean2922 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2922.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2922");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2922");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2922");
    }
