...
public class AppScopedBean2215 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2215.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2215");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2215");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2215");
    }
