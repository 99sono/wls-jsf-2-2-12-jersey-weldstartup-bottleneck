...
public class AppScopedBean2548 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2548.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2548");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2548");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2548");
    }
