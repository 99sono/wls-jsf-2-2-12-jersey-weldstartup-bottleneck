...
public class AppScopedBean2738 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2738.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2738");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2738");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2738");
    }
