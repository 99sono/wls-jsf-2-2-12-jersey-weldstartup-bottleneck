...
public class AppScopedBean2261 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2261.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2261");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2261");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2261");
    }
