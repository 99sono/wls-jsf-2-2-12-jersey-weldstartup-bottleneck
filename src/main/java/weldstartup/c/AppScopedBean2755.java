...
public class AppScopedBean2755 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2755.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2755");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2755");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2755");
    }
