...
public class AppScopedBean2682 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2682.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2682");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2682");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2682");
    }
