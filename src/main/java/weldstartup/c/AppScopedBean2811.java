...
public class AppScopedBean2811 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2811.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2811");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2811");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2811");
    }
