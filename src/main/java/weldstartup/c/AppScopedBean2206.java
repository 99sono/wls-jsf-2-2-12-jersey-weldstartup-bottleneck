...
public class AppScopedBean2206 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2206.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2206");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2206");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2206");
    }
