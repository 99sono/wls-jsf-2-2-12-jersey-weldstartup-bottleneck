...
public class AppScopedBean2626 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2626.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2626");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2626");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2626");
    }
