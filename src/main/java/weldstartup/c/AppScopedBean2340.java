...
public class AppScopedBean2340 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2340.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2340");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2340");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2340");
    }
