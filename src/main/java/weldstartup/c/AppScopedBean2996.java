...
public class AppScopedBean2996 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2996.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2996");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2996");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2996");
    }
