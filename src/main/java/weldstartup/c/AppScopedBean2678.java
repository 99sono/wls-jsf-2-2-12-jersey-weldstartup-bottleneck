...
public class AppScopedBean2678 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2678.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2678");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2678");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2678");
    }
