...
public class AppScopedBean2621 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2621.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2621");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2621");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2621");
    }
