...
public class AppScopedBean2064 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2064.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2064");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2064");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2064");
    }
