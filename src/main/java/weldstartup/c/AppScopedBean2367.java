...
public class AppScopedBean2367 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2367.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2367");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2367");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2367");
    }
