...
public class AppScopedBean2840 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2840.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2840");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2840");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2840");
    }
