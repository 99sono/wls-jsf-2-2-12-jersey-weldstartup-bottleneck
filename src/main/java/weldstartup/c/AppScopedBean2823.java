...
public class AppScopedBean2823 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2823.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2823");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2823");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2823");
    }
