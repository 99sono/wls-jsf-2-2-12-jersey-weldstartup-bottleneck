...
public class AppScopedBean2559 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2559.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2559");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2559");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2559");
    }
