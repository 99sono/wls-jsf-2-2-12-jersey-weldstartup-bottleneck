...
public class AppScopedBean2995 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2995.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2995");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2995");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2995");
    }
