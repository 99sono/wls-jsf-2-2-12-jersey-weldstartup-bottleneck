...
public class AppScopedBean2339 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2339.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2339");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2339");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2339");
    }
