...
public class AppScopedBean2683 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2683.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2683");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2683");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2683");
    }
