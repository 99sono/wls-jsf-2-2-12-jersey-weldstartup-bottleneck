...
public class AppScopedBean2414 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2414.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2414");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2414");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2414");
    }
