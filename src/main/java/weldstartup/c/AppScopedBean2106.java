...
public class AppScopedBean2106 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2106.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2106");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2106");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2106");
    }
