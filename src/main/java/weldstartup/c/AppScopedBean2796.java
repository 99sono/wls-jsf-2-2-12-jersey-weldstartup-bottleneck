...
public class AppScopedBean2796 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2796.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2796");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2796");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2796");
    }
