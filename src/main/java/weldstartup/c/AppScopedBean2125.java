...
public class AppScopedBean2125 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2125.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2125");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2125");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2125");
    }
