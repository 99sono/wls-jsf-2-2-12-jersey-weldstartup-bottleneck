...
public class AppScopedBean2854 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2854.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2854");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2854");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2854");
    }
