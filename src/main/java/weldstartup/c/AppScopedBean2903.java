...
public class AppScopedBean2903 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2903.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2903");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2903");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2903");
    }
