...
public class AppScopedBean2257 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2257.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2257");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2257");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2257");
    }
