...
public class AppScopedBean2824 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2824.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2824");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2824");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2824");
    }
