...
public class AppScopedBean2955 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2955.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2955");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2955");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2955");
    }
