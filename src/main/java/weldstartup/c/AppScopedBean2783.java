...
public class AppScopedBean2783 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2783.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2783");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2783");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2783");
    }
