...
public class AppScopedBean2303 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2303.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2303");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2303");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2303");
    }
