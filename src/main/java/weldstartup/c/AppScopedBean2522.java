...
public class AppScopedBean2522 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2522.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2522");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2522");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2522");
    }
