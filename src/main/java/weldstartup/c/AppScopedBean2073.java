...
public class AppScopedBean2073 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2073.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2073");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2073");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2073");
    }
