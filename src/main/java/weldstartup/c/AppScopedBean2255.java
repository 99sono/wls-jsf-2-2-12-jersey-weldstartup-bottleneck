...
public class AppScopedBean2255 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2255.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2255");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2255");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2255");
    }
