...
public class AppScopedBean2221 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2221.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2221");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2221");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2221");
    }
