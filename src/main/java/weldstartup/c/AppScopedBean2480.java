...
public class AppScopedBean2480 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2480.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2480");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2480");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2480");
    }
