...
public class AppScopedBean2334 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2334.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2334");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2334");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2334");
    }
