...
public class AppScopedBean2228 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2228.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2228");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2228");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2228");
    }
