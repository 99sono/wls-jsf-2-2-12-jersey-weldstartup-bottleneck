...
public class AppScopedBean2074 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2074.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2074");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2074");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2074");
    }
