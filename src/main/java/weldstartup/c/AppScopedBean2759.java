...
public class AppScopedBean2759 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2759.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2759");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2759");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2759");
    }
