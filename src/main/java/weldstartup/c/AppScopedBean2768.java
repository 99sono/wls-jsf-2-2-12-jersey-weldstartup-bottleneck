...
public class AppScopedBean2768 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2768.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2768");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2768");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2768");
    }
