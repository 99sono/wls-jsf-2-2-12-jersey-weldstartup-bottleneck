...
public class AppScopedBean2108 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2108.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2108");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2108");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2108");
    }
