...
public class AppScopedBean2904 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2904.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2904");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2904");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2904");
    }
