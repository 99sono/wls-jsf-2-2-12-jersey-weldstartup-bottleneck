...
public class AppScopedBean2757 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2757.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2757");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2757");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2757");
    }
