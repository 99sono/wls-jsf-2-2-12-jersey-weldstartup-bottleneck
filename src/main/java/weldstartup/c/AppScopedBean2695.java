...
public class AppScopedBean2695 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2695.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2695");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2695");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2695");
    }
