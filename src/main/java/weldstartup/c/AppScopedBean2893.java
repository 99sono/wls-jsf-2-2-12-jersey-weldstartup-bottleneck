...
public class AppScopedBean2893 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2893.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2893");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2893");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2893");
    }
