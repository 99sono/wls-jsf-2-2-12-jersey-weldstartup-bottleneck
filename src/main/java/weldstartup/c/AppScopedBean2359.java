...
public class AppScopedBean2359 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2359.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2359");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2359");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2359");
    }
