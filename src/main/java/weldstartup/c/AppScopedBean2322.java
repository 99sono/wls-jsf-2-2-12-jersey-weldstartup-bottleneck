...
public class AppScopedBean2322 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2322.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2322");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2322");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2322");
    }
