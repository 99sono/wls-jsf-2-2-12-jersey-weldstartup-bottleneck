...
public class AppScopedBean2907 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2907.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2907");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2907");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2907");
    }
