...
public class AppScopedBean2919 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2919.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2919");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2919");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2919");
    }
