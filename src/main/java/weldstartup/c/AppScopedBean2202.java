...
public class AppScopedBean2202 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2202.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2202");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2202");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2202");
    }
