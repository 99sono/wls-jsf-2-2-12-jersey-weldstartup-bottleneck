...
public class AppScopedBean2959 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2959.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2959");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2959");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2959");
    }
