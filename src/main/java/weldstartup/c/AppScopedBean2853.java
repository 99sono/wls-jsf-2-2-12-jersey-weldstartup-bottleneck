...
public class AppScopedBean2853 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2853.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2853");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2853");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2853");
    }
