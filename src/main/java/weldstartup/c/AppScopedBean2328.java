...
public class AppScopedBean2328 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2328.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2328");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2328");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2328");
    }
