...
public class AppScopedBean2380 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2380.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2380");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2380");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2380");
    }
