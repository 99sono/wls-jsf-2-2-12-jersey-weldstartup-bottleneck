...
public class AppScopedBean2150 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2150.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2150");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2150");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2150");
    }
