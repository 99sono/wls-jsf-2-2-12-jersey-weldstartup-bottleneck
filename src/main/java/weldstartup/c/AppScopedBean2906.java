...
public class AppScopedBean2906 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2906.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2906");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2906");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2906");
    }
