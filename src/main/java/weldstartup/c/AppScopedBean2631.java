...
public class AppScopedBean2631 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2631.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2631");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2631");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2631");
    }
