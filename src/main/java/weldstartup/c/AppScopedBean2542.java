...
public class AppScopedBean2542 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2542.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2542");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2542");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2542");
    }
