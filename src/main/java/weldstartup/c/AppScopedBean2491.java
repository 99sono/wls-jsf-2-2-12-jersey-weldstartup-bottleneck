...
public class AppScopedBean2491 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2491.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2491");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2491");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2491");
    }
