...
public class AppScopedBean2241 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2241.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2241");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2241");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2241");
    }
