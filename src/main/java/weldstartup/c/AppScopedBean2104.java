...
public class AppScopedBean2104 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2104.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2104");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2104");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2104");
    }
