...
public class AppScopedBean2742 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2742.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2742");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2742");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2742");
    }
