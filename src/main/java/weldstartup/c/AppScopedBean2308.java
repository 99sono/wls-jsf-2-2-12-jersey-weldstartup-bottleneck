...
public class AppScopedBean2308 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2308.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2308");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2308");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2308");
    }
