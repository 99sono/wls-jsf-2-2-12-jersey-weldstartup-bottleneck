...
public class AppScopedBean2142 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2142.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2142");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2142");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2142");
    }
