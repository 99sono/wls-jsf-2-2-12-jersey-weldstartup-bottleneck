...
public class AppScopedBean2754 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2754.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2754");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2754");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2754");
    }
