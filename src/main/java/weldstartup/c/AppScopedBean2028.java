...
public class AppScopedBean2028 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2028.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2028");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2028");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2028");
    }
