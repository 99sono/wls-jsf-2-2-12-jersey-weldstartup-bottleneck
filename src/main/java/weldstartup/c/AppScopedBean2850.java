...
public class AppScopedBean2850 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2850.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2850");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2850");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2850");
    }
