...
public class AppScopedBean2278 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2278.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2278");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2278");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2278");
    }
