...
public class AppScopedBean2958 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2958.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2958");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2958");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2958");
    }
