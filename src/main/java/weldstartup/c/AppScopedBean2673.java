...
public class AppScopedBean2673 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2673.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2673");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2673");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2673");
    }
