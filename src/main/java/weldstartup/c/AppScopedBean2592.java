...
public class AppScopedBean2592 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2592.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2592");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2592");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2592");
    }
