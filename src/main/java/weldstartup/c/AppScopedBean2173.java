...
public class AppScopedBean2173 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2173.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2173");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2173");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2173");
    }
