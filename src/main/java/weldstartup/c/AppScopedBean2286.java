...
public class AppScopedBean2286 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2286.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2286");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2286");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2286");
    }
