...
public class AppScopedBean2032 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2032.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2032");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2032");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2032");
    }
