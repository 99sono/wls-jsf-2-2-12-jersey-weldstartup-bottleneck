...
public class AppScopedBean2354 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2354.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2354");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2354");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2354");
    }
