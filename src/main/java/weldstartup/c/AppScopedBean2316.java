...
public class AppScopedBean2316 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2316.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2316");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2316");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2316");
    }
