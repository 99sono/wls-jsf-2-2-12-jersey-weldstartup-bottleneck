...
public class AppScopedBean2735 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2735.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2735");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2735");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2735");
    }
