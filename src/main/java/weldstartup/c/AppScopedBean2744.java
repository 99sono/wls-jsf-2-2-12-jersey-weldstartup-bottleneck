...
public class AppScopedBean2744 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2744.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2744");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2744");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2744");
    }
