...
public class AppScopedBean2054 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2054.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2054");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2054");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2054");
    }
