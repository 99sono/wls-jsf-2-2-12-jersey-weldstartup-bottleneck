...
public class AppScopedBean2506 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2506.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2506");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2506");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2506");
    }
