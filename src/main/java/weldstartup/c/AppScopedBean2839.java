...
public class AppScopedBean2839 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2839.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2839");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2839");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2839");
    }
