...
public class AppScopedBean2635 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2635.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2635");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2635");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2635");
    }
