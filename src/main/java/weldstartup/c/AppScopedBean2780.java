...
public class AppScopedBean2780 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2780.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2780");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2780");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2780");
    }
