...
public class AppScopedBean2966 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2966.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2966");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2966");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2966");
    }
