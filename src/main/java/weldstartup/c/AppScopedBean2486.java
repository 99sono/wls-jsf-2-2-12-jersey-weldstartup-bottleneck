...
public class AppScopedBean2486 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2486.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2486");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2486");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2486");
    }
