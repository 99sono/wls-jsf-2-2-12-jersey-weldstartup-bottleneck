...
public class AppScopedBean2584 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2584.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2584");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2584");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2584");
    }
