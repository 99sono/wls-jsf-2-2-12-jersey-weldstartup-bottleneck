...
public class AppScopedBean2390 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2390.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2390");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2390");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2390");
    }
