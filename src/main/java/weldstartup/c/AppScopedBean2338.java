...
public class AppScopedBean2338 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2338.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2338");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2338");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2338");
    }
