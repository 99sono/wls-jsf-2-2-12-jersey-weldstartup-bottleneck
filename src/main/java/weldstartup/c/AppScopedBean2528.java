...
public class AppScopedBean2528 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2528.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2528");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2528");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2528");
    }
