...
public class AppScopedBean2067 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2067.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2067");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2067");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2067");
    }
