...
public class AppScopedBean2647 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2647.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2647");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2647");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2647");
    }
