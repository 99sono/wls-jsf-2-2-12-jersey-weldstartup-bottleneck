...
public class AppScopedBean2091 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2091.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2091");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2091");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2091");
    }
