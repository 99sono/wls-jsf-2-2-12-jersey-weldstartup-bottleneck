...
public class AppScopedBean2499 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2499.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2499");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2499");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2499");
    }
