...
public class AppScopedBean2805 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2805.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2805");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2805");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2805");
    }
