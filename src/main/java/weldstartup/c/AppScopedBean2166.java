...
public class AppScopedBean2166 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2166.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2166");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2166");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2166");
    }
