...
public class AppScopedBean2887 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2887.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2887");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2887");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2887");
    }
