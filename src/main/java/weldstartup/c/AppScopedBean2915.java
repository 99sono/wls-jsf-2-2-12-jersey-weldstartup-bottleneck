...
public class AppScopedBean2915 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2915.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2915");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2915");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2915");
    }
