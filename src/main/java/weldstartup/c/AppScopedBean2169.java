...
public class AppScopedBean2169 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2169.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2169");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2169");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2169");
    }
