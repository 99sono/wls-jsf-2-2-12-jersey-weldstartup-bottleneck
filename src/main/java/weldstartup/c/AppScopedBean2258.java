...
public class AppScopedBean2258 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2258.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2258");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2258");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2258");
    }
