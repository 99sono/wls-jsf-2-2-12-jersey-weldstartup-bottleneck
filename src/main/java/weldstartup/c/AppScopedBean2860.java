...
public class AppScopedBean2860 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2860.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2860");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2860");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2860");
    }
