...
public class AppScopedBean2950 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2950.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2950");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2950");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2950");
    }
