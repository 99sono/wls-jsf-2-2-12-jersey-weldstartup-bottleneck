...
public class AppScopedBean2718 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2718.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2718");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2718");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2718");
    }
