...
public class AppScopedBean2688 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2688.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2688");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2688");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2688");
    }
