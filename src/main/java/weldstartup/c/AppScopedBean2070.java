...
public class AppScopedBean2070 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2070.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2070");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2070");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2070");
    }
