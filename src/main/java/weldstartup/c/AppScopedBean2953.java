...
public class AppScopedBean2953 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2953.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2953");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2953");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2953");
    }
