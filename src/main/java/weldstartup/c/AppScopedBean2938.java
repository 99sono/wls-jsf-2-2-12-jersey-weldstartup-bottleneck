...
public class AppScopedBean2938 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2938.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2938");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2938");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2938");
    }
