...
public class AppScopedBean2000 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2000.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2000");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2000");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2000");
    }
