...
public class AppScopedBean2551 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2551.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2551");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2551");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2551");
    }
