...
public class AppScopedBean2643 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2643.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2643");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2643");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2643");
    }
