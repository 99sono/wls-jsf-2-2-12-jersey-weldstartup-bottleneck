...
public class AppScopedBean2487 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2487.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2487");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2487");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2487");
    }
