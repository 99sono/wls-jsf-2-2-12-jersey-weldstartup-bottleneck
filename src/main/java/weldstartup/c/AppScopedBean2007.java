...
public class AppScopedBean2007 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2007.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2007");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2007");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2007");
    }
