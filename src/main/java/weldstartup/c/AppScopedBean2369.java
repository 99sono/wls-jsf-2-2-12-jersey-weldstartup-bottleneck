...
public class AppScopedBean2369 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2369.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2369");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2369");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2369");
    }
