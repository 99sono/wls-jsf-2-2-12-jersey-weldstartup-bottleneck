...
public class AppScopedBean2250 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2250.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2250");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2250");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2250");
    }
