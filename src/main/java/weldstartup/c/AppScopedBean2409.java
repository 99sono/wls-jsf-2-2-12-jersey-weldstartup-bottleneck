...
public class AppScopedBean2409 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2409.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2409");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2409");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2409");
    }
