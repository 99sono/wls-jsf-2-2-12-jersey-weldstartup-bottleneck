...
public class AppScopedBean2387 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2387.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2387");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2387");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2387");
    }
