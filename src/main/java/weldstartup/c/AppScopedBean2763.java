...
public class AppScopedBean2763 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2763.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2763");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2763");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2763");
    }
