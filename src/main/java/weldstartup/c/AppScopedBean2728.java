...
public class AppScopedBean2728 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2728.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2728");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2728");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2728");
    }
