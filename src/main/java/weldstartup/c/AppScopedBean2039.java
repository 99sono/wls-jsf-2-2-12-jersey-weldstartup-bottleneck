...
public class AppScopedBean2039 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2039.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2039");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2039");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2039");
    }
