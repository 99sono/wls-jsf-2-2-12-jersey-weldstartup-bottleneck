...
public class AppScopedBean2279 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2279.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2279");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2279");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2279");
    }
