...
public class AppScopedBean2537 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2537.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2537");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2537");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2537");
    }
