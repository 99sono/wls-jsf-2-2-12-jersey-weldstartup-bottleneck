...
public class AppScopedBean2351 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2351.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2351");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2351");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2351");
    }
