...
public class AppScopedBean2109 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2109.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2109");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2109");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2109");
    }
