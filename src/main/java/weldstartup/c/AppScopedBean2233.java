...
public class AppScopedBean2233 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2233.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2233");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2233");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2233");
    }
