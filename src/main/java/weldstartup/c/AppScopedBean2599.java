...
public class AppScopedBean2599 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2599.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2599");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2599");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2599");
    }
