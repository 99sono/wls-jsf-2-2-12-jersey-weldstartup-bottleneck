...
public class AppScopedBean2816 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2816.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2816");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2816");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2816");
    }
