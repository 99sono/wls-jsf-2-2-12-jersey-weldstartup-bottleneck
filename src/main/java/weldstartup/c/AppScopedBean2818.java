...
public class AppScopedBean2818 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2818.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2818");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2818");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2818");
    }
