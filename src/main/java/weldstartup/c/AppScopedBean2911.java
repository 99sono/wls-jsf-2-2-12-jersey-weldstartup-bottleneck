...
public class AppScopedBean2911 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2911.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2911");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2911");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2911");
    }
