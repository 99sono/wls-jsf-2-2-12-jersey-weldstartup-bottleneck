...
public class AppScopedBean2983 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2983.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2983");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2983");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2983");
    }
