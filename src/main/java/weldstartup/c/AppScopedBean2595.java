...
public class AppScopedBean2595 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2595.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2595");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2595");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2595");
    }
