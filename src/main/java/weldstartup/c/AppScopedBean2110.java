...
public class AppScopedBean2110 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2110.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2110");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2110");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2110");
    }
