...
public class AppScopedBean2952 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2952.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2952");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2952");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2952");
    }
