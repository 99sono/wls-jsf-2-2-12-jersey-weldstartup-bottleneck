...
public class AppScopedBean2968 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2968.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2968");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2968");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2968");
    }
