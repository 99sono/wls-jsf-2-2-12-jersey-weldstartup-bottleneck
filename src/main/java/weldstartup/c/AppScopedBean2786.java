...
public class AppScopedBean2786 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2786.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2786");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2786");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2786");
    }
