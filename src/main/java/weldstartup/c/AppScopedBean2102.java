...
public class AppScopedBean2102 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2102.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2102");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2102");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2102");
    }
