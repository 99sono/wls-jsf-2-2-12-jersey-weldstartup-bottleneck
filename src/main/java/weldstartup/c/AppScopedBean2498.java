...
public class AppScopedBean2498 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2498.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2498");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2498");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2498");
    }
