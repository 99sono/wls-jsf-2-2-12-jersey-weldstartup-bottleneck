...
public class AppScopedBean2672 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2672.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2672");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2672");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2672");
    }
