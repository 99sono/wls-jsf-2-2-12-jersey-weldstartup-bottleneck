...
public class AppScopedBean2101 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2101.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2101");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2101");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2101");
    }
