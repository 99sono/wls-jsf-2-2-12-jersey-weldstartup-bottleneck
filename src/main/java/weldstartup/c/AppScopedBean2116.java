...
public class AppScopedBean2116 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2116.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2116");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2116");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2116");
    }
