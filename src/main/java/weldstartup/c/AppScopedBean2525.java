...
public class AppScopedBean2525 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2525.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2525");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2525");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2525");
    }
