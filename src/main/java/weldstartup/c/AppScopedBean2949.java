...
public class AppScopedBean2949 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2949.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2949");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2949");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2949");
    }
