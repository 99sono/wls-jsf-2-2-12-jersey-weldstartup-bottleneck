...
public class AppScopedBean2041 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2041.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2041");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2041");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2041");
    }
