...
public class AppScopedBean2593 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2593.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2593");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2593");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2593");
    }
