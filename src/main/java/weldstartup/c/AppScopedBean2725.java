...
public class AppScopedBean2725 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2725.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2725");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2725");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2725");
    }
