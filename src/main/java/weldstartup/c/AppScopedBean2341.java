...
public class AppScopedBean2341 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2341.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2341");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2341");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2341");
    }
