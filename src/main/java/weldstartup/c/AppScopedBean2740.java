...
public class AppScopedBean2740 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2740.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2740");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2740");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2740");
    }
