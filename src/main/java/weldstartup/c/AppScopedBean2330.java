...
public class AppScopedBean2330 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2330.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2330");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2330");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2330");
    }
