...
public class AppScopedBean2265 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2265.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2265");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2265");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2265");
    }
