...
public class AppScopedBean2324 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2324.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2324");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2324");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2324");
    }
