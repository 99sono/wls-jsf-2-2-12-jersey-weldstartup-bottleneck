...
public class AppScopedBean2625 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2625.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2625");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2625");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2625");
    }
