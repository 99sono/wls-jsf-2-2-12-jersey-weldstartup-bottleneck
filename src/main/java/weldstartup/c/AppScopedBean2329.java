...
public class AppScopedBean2329 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2329.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2329");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2329");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2329");
    }
