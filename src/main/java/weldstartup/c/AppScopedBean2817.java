...
public class AppScopedBean2817 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2817.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2817");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2817");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2817");
    }
