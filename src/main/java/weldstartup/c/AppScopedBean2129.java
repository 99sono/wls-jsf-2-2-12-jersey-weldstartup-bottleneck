...
public class AppScopedBean2129 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2129.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2129");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2129");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2129");
    }
