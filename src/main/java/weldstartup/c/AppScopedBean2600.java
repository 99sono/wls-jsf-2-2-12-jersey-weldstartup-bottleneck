...
public class AppScopedBean2600 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2600.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2600");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2600");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2600");
    }
