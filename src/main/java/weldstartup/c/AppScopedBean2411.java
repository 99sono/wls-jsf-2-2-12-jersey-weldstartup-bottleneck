...
public class AppScopedBean2411 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2411.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2411");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2411");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2411");
    }
