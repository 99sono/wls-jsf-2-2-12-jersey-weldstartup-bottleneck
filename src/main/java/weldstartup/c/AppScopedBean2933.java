...
public class AppScopedBean2933 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2933.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2933");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2933");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2933");
    }
