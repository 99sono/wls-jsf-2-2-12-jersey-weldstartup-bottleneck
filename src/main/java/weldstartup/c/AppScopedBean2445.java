...
public class AppScopedBean2445 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2445.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2445");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2445");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2445");
    }
