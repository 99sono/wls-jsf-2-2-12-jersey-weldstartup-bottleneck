...
public class AppScopedBean2086 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2086.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2086");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2086");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2086");
    }
