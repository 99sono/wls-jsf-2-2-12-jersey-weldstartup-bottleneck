...
public class AppScopedBean2488 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2488.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2488");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2488");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2488");
    }
