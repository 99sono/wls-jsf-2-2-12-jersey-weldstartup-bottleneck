...
public class AppScopedBean2222 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2222.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2222");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2222");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2222");
    }
