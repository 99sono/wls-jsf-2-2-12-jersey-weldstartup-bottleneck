...
public class AppScopedBean2970 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2970.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2970");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2970");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2970");
    }
