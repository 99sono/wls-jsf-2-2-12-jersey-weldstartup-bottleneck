...
public class AppScopedBean2743 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2743.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2743");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2743");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2743");
    }
