...
public class AppScopedBean2508 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2508.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2508");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2508");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2508");
    }
