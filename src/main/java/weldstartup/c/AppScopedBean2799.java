...
public class AppScopedBean2799 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2799.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2799");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2799");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2799");
    }
