...
public class AppScopedBean2483 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2483.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2483");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2483");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2483");
    }
