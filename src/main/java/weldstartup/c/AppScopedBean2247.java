...
public class AppScopedBean2247 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2247.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2247");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2247");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2247");
    }
