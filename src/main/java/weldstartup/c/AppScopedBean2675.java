...
public class AppScopedBean2675 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2675.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2675");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2675");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2675");
    }
