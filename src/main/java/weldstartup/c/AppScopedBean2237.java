...
public class AppScopedBean2237 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2237.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2237");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2237");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2237");
    }
