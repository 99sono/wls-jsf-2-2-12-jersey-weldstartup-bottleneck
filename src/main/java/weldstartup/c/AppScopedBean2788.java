...
public class AppScopedBean2788 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2788.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2788");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2788");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2788");
    }
