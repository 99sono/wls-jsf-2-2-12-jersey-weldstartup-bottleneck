...
public class AppScopedBean2043 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2043.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2043");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2043");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2043");
    }
