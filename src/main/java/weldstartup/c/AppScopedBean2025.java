...
public class AppScopedBean2025 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2025.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2025");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2025");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2025");
    }
