...
public class AppScopedBean2963 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2963.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2963");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2963");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2963");
    }
