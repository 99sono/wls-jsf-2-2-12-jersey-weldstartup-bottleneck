...
public class AppScopedBean2103 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2103.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2103");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2103");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2103");
    }
