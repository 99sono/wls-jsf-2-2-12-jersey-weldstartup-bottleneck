...
public class AppScopedBean2829 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2829.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2829");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2829");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2829");
    }
