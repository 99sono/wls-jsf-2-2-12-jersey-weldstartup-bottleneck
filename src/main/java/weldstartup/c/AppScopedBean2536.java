...
public class AppScopedBean2536 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2536.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2536");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2536");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2536");
    }
