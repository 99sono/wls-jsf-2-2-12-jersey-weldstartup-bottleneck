...
public class AppScopedBean2812 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2812.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2812");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2812");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2812");
    }
