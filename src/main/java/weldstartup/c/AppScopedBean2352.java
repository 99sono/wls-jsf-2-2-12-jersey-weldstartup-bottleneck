...
public class AppScopedBean2352 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2352.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2352");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2352");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2352");
    }
