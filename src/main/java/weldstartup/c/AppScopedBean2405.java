...
public class AppScopedBean2405 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2405.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2405");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2405");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2405");
    }
