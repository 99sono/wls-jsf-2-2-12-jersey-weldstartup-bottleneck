...
public class AppScopedBean2377 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2377.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2377");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2377");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2377");
    }
