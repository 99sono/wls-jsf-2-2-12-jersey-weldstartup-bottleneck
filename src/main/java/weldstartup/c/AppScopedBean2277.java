...
public class AppScopedBean2277 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2277.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2277");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2277");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2277");
    }
