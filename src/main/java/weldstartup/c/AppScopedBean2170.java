...
public class AppScopedBean2170 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2170.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2170");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2170");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2170");
    }
