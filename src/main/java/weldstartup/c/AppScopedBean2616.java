...
public class AppScopedBean2616 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2616.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2616");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2616");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2616");
    }
