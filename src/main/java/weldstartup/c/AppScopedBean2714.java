...
public class AppScopedBean2714 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2714.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2714");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2714");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2714");
    }
