...
public class AppScopedBean2251 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2251.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2251");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2251");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2251");
    }
