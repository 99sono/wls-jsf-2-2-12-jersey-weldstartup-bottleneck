...
public class AppScopedBean2583 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2583.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2583");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2583");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2583");
    }
