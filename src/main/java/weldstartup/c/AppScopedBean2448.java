...
public class AppScopedBean2448 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2448.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2448");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2448");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2448");
    }
