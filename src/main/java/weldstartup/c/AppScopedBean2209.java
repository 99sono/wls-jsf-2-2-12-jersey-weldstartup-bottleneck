...
public class AppScopedBean2209 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2209.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2209");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2209");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2209");
    }
