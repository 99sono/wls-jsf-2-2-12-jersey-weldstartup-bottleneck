...
public class AppScopedBean2154 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2154.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2154");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2154");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2154");
    }
