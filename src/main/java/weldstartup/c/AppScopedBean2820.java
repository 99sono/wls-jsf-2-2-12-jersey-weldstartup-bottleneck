...
public class AppScopedBean2820 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2820.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2820");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2820");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2820");
    }
