...
public class AppScopedBean2033 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2033.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2033");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2033");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2033");
    }
