...
public class AppScopedBean2296 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2296.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2296");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2296");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2296");
    }
