...
public class AppScopedBean2406 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2406.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2406");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2406");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2406");
    }
