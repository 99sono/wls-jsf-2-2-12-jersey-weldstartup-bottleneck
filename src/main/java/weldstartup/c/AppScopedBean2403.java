...
public class AppScopedBean2403 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2403.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2403");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2403");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2403");
    }
