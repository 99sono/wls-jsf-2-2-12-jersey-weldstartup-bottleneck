...
public class AppScopedBean2653 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2653.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2653");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2653");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2653");
    }
