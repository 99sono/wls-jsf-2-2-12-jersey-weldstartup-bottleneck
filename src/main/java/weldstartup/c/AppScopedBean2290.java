...
public class AppScopedBean2290 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2290.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2290");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2290");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2290");
    }
