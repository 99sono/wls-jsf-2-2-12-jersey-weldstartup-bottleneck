...
public class AppScopedBean2283 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2283.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2283");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2283");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2283");
    }
