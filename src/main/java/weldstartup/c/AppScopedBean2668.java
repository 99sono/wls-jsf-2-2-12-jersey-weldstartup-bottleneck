...
public class AppScopedBean2668 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2668.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2668");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2668");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2668");
    }
