...
public class AppScopedBean2596 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2596.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2596");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2596");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2596");
    }
