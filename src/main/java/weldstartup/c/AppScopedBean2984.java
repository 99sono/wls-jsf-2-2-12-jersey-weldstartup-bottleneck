...
public class AppScopedBean2984 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2984.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2984");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2984");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2984");
    }
