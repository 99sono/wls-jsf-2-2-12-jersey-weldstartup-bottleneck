...
public class AppScopedBean2797 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2797.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2797");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2797");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2797");
    }
