...
public class AppScopedBean2051 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2051.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2051");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2051");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2051");
    }
