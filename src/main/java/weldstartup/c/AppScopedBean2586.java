...
public class AppScopedBean2586 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2586.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2586");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2586");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2586");
    }
