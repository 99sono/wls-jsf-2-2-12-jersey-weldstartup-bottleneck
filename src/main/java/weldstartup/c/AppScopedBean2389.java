...
public class AppScopedBean2389 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2389.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2389");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2389");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2389");
    }
