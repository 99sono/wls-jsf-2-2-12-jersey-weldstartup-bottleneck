...
public class AppScopedBean2989 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2989.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2989");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2989");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2989");
    }
