...
public class AppScopedBean2048 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2048.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2048");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2048");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2048");
    }
