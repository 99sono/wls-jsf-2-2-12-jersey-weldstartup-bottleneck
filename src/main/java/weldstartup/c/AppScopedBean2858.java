...
public class AppScopedBean2858 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2858.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2858");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2858");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2858");
    }
