...
public class AppScopedBean2276 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2276.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2276");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2276");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2276");
    }
