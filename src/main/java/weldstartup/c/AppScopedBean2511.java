...
public class AppScopedBean2511 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2511.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2511");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2511");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2511");
    }
