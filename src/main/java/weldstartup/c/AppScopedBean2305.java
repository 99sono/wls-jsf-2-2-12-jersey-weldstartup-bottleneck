...
public class AppScopedBean2305 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2305.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2305");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2305");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2305");
    }
