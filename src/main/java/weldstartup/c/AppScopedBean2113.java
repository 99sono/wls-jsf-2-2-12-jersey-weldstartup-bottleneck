...
public class AppScopedBean2113 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2113.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2113");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2113");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2113");
    }
