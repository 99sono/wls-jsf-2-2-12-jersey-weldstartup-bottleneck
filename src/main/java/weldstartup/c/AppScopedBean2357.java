...
public class AppScopedBean2357 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2357.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2357");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2357");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2357");
    }
