...
public class AppScopedBean2899 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2899.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2899");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2899");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2899");
    }
