...
public class AppScopedBean2178 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2178.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2178");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2178");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2178");
    }
