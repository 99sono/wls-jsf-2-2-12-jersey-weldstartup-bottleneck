...
public class AppScopedBean2914 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2914.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2914");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2914");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2914");
    }
