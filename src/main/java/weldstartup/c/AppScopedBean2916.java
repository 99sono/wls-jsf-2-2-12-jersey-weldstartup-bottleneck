...
public class AppScopedBean2916 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2916.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2916");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2916");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2916");
    }
