...
public class AppScopedBean2456 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2456.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2456");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2456");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2456");
    }
