...
public class AppScopedBean2465 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2465.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2465");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2465");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2465");
    }
