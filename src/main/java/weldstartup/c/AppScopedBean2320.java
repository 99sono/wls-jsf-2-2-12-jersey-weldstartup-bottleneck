...
public class AppScopedBean2320 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2320.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2320");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2320");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2320");
    }
