...
public class AppScopedBean2574 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2574.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2574");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2574");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2574");
    }
