...
public class AppScopedBean2517 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2517.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2517");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2517");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2517");
    }
