...
public class AppScopedBean2424 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2424.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2424");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2424");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2424");
    }
