...
public class AppScopedBean2865 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2865.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2865");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2865");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2865");
    }
