...
public class AppScopedBean2478 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2478.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2478");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2478");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2478");
    }
