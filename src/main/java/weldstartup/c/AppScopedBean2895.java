...
public class AppScopedBean2895 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2895.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2895");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2895");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2895");
    }
