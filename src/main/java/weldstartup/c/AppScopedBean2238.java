...
public class AppScopedBean2238 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2238.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2238");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2238");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2238");
    }
