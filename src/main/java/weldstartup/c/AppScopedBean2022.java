...
public class AppScopedBean2022 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2022.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2022");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2022");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2022");
    }
