...
public class AppScopedBean2921 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2921.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2921");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2921");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2921");
    }
