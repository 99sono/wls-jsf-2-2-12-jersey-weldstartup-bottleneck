...
public class AppScopedBean2002 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2002.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2002");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2002");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2002");
    }
