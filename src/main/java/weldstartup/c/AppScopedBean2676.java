...
public class AppScopedBean2676 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2676.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2676");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2676");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2676");
    }
