...
public class AppScopedBean2107 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2107.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2107");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2107");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2107");
    }
