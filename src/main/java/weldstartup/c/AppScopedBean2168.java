...
public class AppScopedBean2168 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2168.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2168");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2168");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2168");
    }
