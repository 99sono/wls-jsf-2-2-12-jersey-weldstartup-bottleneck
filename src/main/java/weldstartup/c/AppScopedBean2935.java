...
public class AppScopedBean2935 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2935.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2935");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2935");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2935");
    }
