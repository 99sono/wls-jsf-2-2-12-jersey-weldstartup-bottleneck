...
public class AppScopedBean2319 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2319.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2319");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2319");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2319");
    }
