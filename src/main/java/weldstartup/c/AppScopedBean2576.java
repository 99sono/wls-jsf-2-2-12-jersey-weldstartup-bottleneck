...
public class AppScopedBean2576 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2576.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2576");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2576");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2576");
    }
