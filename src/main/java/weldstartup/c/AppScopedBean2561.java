...
public class AppScopedBean2561 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2561.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2561");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2561");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2561");
    }
