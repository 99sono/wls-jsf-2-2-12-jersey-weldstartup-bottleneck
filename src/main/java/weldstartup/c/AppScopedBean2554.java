...
public class AppScopedBean2554 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2554.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2554");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2554");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2554");
    }
