...
public class AppScopedBean2825 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2825.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2825");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2825");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2825");
    }
