...
public class AppScopedBean2994 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2994.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2994");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2994");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2994");
    }
