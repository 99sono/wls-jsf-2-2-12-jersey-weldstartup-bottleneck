...
public class AppScopedBean2751 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2751.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2751");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2751");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2751");
    }
