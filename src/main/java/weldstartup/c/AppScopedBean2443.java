...
public class AppScopedBean2443 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2443.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2443");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2443");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2443");
    }
