...
public class AppScopedBean2976 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2976.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2976");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2976");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2976");
    }
