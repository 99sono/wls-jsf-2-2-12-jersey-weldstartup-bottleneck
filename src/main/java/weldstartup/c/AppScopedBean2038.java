...
public class AppScopedBean2038 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2038.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2038");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2038");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2038");
    }
