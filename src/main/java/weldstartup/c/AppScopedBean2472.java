...
public class AppScopedBean2472 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2472.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2472");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2472");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2472");
    }
