...
public class AppScopedBean2455 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2455.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2455");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2455");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2455");
    }
