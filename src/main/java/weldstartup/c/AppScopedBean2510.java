...
public class AppScopedBean2510 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2510.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2510");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2510");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2510");
    }
