...
public class AppScopedBean2224 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2224.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2224");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2224");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2224");
    }
