...
public class AppScopedBean2355 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2355.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2355");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2355");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2355");
    }
