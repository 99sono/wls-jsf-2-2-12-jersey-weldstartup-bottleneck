...
public class AppScopedBean2148 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2148.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2148");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2148");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2148");
    }
