...
public class AppScopedBean2236 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2236.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2236");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2236");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2236");
    }
