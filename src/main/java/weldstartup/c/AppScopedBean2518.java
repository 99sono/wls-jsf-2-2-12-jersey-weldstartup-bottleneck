...
public class AppScopedBean2518 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2518.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2518");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2518");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2518");
    }
