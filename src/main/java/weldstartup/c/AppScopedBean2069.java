...
public class AppScopedBean2069 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2069.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2069");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2069");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2069");
    }
