...
public class AppScopedBean2880 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2880.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2880");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2880");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2880");
    }
