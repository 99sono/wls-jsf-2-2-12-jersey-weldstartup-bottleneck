...
public class AppScopedBean2636 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2636.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2636");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2636");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2636");
    }
