...
public class AppScopedBean2957 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2957.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2957");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2957");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2957");
    }
