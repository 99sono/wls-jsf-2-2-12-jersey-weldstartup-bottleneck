...
public class AppScopedBean2847 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2847.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2847");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2847");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2847");
    }
