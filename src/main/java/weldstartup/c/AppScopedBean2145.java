...
public class AppScopedBean2145 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2145.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2145");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2145");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2145");
    }
