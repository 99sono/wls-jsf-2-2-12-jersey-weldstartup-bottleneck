...
public class AppScopedBean2505 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2505.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2505");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2505");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2505");
    }
