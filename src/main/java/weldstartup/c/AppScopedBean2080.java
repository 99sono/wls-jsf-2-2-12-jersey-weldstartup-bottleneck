...
public class AppScopedBean2080 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2080.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2080");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2080");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2080");
    }
