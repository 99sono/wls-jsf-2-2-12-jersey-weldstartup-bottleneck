...
public class AppScopedBean2776 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2776.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2776");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2776");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2776");
    }
