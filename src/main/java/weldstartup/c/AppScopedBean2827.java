...
public class AppScopedBean2827 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2827.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2827");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2827");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2827");
    }
