...
public class AppScopedBean2220 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2220.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2220");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2220");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2220");
    }
