...
public class AppScopedBean2956 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2956.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2956");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2956");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2956");
    }
