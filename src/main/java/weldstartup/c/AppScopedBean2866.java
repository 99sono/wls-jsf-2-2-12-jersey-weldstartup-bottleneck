...
public class AppScopedBean2866 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2866.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2866");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2866");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2866");
    }
