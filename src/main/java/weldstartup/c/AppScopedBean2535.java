...
public class AppScopedBean2535 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2535.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2535");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2535");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2535");
    }
