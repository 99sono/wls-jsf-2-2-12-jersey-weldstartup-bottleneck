...
public class AppScopedBean2078 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2078.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2078");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2078");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2078");
    }
