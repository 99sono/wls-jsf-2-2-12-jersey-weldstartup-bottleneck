...
public class AppScopedBean2482 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2482.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2482");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2482");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2482");
    }
