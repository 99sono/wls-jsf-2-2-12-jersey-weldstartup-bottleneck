...
public class AppScopedBean2295 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2295.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2295");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2295");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2295");
    }
