...
public class AppScopedBean2347 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2347.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2347");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2347");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2347");
    }
