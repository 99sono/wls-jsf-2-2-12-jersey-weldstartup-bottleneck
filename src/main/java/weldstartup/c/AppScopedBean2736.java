...
public class AppScopedBean2736 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2736.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2736");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2736");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2736");
    }
