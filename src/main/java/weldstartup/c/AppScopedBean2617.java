...
public class AppScopedBean2617 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2617.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2617");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2617");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2617");
    }
