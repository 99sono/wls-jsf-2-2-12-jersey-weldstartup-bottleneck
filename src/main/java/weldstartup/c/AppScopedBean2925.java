...
public class AppScopedBean2925 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2925.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2925");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2925");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2925");
    }
