...
public class AppScopedBean2661 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2661.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2661");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2661");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2661");
    }
