...
public class AppScopedBean2555 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2555.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2555");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2555");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2555");
    }
