...
public class AppScopedBean2179 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2179.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2179");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2179");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2179");
    }
