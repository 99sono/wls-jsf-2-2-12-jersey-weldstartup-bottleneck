...
public class AppScopedBean2112 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2112.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2112");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2112");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2112");
    }
