...
public class AppScopedBean2123 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2123.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2123");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2123");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2123");
    }
