...
public class AppScopedBean2863 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2863.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2863");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2863");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2863");
    }
