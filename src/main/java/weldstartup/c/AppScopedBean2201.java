...
public class AppScopedBean2201 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2201.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2201");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2201");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2201");
    }
