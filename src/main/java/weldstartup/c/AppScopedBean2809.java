...
public class AppScopedBean2809 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2809.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2809");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2809");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2809");
    }
