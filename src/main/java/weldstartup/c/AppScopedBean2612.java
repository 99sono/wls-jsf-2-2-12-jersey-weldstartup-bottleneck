...
public class AppScopedBean2612 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2612.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2612");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2612");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2612");
    }
