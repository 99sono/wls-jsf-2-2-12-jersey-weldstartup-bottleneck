...
public class AppScopedBean2861 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2861.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2861");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2861");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2861");
    }
