...
public class AppScopedBean2273 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2273.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2273");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2273");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2273");
    }
