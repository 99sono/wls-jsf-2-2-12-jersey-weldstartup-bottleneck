...
public class AppScopedBean2156 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2156.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2156");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2156");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2156");
    }
