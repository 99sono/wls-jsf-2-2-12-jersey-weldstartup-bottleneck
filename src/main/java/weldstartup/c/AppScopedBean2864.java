...
public class AppScopedBean2864 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2864.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2864");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2864");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2864");
    }
