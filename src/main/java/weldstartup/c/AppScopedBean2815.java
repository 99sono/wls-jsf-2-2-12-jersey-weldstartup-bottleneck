...
public class AppScopedBean2815 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2815.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2815");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2815");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2815");
    }
