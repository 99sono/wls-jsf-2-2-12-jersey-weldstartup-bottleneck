...
public class AppScopedBean2802 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2802.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2802");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2802");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2802");
    }
