...
public class AppScopedBean2138 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2138.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2138");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2138");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2138");
    }
