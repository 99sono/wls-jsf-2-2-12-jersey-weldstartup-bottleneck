...
public class AppScopedBean2855 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2855.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2855");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2855");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2855");
    }
