...
public class AppScopedBean2192 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2192.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2192");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2192");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2192");
    }
