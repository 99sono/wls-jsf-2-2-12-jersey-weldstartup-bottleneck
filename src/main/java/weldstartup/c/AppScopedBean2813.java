...
public class AppScopedBean2813 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2813.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2813");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2813");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2813");
    }
