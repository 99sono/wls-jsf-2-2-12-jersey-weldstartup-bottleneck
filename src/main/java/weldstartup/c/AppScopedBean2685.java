...
public class AppScopedBean2685 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2685.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2685");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2685");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2685");
    }
