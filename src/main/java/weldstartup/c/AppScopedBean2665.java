...
public class AppScopedBean2665 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2665.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2665");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2665");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2665");
    }
