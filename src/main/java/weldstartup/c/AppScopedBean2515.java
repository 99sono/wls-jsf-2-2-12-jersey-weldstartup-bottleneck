...
public class AppScopedBean2515 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2515.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2515");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2515");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2515");
    }
