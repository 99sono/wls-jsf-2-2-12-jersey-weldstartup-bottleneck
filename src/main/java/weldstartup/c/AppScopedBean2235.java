...
public class AppScopedBean2235 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2235.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2235");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2235");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2235");
    }
