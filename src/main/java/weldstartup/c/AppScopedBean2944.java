...
public class AppScopedBean2944 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2944.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2944");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2944");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2944");
    }
