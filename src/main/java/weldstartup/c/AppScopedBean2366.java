...
public class AppScopedBean2366 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2366.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2366");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2366");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2366");
    }
