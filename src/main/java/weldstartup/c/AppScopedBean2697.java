...
public class AppScopedBean2697 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2697.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2697");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2697");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2697");
    }
