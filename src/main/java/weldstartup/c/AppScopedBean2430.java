...
public class AppScopedBean2430 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2430.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2430");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2430");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2430");
    }
