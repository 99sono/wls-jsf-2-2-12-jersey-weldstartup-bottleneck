...
public class AppScopedBean2884 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2884.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2884");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2884");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2884");
    }
