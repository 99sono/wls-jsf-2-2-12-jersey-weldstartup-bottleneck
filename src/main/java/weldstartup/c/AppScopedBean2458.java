...
public class AppScopedBean2458 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2458.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2458");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2458");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2458");
    }
