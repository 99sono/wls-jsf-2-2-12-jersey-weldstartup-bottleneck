...
public class AppScopedBean2128 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2128.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2128");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2128");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2128");
    }
