...
public class AppScopedBean2767 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2767.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2767");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2767");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2767");
    }
