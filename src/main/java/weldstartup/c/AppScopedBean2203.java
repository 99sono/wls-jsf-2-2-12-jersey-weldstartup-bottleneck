...
public class AppScopedBean2203 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2203.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2203");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2203");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2203");
    }
