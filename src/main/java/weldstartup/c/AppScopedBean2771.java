...
public class AppScopedBean2771 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2771.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2771");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2771");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2771");
    }
