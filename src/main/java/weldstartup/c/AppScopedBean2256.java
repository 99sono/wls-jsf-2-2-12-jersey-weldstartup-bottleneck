...
public class AppScopedBean2256 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2256.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2256");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2256");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2256");
    }
