...
public class AppScopedBean2294 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2294.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2294");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2294");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2294");
    }
