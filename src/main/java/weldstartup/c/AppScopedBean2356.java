...
public class AppScopedBean2356 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2356.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2356");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2356");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2356");
    }
