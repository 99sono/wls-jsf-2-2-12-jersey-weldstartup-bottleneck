...
public class AppScopedBean2609 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2609.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2609");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2609");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2609");
    }
