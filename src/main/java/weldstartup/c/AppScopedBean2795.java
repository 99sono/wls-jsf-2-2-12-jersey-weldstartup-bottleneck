...
public class AppScopedBean2795 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2795.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2795");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2795");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2795");
    }
