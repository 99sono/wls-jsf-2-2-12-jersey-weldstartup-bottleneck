...
public class AppScopedBean2408 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2408.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2408");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2408");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2408");
    }
