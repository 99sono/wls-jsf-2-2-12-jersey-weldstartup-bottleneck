...
public class AppScopedBean2723 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2723.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2723");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2723");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2723");
    }
