...
public class AppScopedBean2012 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2012.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2012");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2012");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2012");
    }
