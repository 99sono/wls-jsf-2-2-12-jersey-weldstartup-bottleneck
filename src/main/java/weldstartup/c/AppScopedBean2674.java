...
public class AppScopedBean2674 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2674.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2674");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2674");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2674");
    }
