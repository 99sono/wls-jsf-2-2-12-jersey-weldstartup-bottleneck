...
public class AppScopedBean2656 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2656.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2656");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2656");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2656");
    }
