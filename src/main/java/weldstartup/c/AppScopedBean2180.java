...
public class AppScopedBean2180 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2180.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2180");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2180");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2180");
    }
