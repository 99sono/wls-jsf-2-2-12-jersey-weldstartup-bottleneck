...
public class AppScopedBean2040 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2040.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2040");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2040");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2040");
    }
