...
public class AppScopedBean2021 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2021.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2021");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2021");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2021");
    }
