...
public class AppScopedBean2379 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2379.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2379");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2379");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2379");
    }
