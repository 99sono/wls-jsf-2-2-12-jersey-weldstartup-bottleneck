...
public class AppScopedBean2016 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2016.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2016");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2016");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2016");
    }
