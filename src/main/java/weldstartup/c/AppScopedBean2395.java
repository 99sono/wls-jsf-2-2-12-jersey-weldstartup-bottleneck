...
public class AppScopedBean2395 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2395.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2395");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2395");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2395");
    }
