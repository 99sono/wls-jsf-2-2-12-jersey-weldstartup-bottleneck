...
public class AppScopedBean2473 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2473.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2473");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2473");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2473");
    }
