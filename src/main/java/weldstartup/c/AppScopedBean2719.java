...
public class AppScopedBean2719 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2719.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2719");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2719");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2719");
    }
