...
public class AppScopedBean2961 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2961.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2961");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2961");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2961");
    }
