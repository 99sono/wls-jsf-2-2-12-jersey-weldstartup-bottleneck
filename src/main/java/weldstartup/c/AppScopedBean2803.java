...
public class AppScopedBean2803 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2803.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2803");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2803");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2803");
    }
