...
public class AppScopedBean2504 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2504.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2504");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2504");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2504");
    }
