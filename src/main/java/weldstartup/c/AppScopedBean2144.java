...
public class AppScopedBean2144 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2144.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2144");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2144");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2144");
    }
