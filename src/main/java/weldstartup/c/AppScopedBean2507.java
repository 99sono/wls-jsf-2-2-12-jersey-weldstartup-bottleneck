...
public class AppScopedBean2507 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2507.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2507");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2507");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2507");
    }
