...
public class AppScopedBean2333 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2333.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2333");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2333");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2333");
    }
