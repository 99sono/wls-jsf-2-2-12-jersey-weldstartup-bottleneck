...
public class AppScopedBean2057 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2057.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2057");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2057");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2057");
    }
