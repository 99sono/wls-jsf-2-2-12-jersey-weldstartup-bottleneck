...
public class AppScopedBean2975 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2975.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2975");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2975");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2975");
    }
