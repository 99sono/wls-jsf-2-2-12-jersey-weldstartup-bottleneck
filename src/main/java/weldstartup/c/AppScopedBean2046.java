...
public class AppScopedBean2046 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2046.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2046");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2046");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2046");
    }
