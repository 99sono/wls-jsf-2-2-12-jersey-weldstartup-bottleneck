...
public class AppScopedBean2546 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2546.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2546");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2546");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2546");
    }
