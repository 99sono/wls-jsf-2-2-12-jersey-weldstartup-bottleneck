...
public class AppScopedBean2068 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2068.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2068");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2068");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2068");
    }
