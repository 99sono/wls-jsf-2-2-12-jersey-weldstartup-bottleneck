...
public class AppScopedBean2791 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2791.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2791");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2791");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2791");
    }
