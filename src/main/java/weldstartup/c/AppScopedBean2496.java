...
public class AppScopedBean2496 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2496.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2496");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2496");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2496");
    }
