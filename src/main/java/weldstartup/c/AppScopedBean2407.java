...
public class AppScopedBean2407 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2407.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2407");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2407");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2407");
    }
