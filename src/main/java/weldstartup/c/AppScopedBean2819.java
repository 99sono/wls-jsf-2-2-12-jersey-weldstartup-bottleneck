...
public class AppScopedBean2819 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2819.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2819");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2819");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2819");
    }
