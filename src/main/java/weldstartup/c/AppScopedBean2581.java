...
public class AppScopedBean2581 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2581.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2581");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2581");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2581");
    }
