...
public class AppScopedBean2539 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2539.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2539");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2539");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2539");
    }
