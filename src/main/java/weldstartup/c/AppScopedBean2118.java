...
public class AppScopedBean2118 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2118.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2118");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2118");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2118");
    }
