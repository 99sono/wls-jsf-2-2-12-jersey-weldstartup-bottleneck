...
public class AppScopedBean2941 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2941.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2941");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2941");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2941");
    }
