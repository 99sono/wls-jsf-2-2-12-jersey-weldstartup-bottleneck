...
public class AppScopedBean2704 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2704.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2704");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2704");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2704");
    }
