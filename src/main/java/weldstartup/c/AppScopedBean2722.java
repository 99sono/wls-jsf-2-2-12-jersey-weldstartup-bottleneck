...
public class AppScopedBean2722 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2722.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2722");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2722");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2722");
    }
