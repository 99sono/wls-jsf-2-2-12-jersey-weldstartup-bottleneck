...
public class AppScopedBean2910 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2910.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2910");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2910");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2910");
    }
