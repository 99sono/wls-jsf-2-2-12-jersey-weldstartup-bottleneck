...
public class AppScopedBean2954 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2954.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2954");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2954");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2954");
    }
