...
public class AppScopedBean2715 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2715.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2715");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2715");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2715");
    }
