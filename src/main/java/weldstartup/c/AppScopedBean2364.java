...
public class AppScopedBean2364 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2364.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2364");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2364");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2364");
    }
