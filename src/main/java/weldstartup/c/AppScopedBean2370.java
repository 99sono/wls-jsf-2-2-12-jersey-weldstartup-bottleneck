...
public class AppScopedBean2370 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2370.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2370");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2370");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2370");
    }
