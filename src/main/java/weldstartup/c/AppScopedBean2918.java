...
public class AppScopedBean2918 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2918.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2918");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2918");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2918");
    }
