...
public class AppScopedBean2165 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2165.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2165");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2165");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2165");
    }
