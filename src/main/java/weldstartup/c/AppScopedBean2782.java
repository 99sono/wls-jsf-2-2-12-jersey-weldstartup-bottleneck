...
public class AppScopedBean2782 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2782.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2782");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2782");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2782");
    }
