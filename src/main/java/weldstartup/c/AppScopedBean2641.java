...
public class AppScopedBean2641 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2641.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2641");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2641");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2641");
    }
