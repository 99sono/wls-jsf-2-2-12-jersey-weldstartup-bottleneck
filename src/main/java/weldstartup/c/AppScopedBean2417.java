...
public class AppScopedBean2417 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2417.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2417");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2417");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2417");
    }
