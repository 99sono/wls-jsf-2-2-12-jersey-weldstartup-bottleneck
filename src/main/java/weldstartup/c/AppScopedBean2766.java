...
public class AppScopedBean2766 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2766.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2766");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2766");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2766");
    }
