...
public class AppScopedBean2973 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2973.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2973");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2973");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2973");
    }
