...
public class AppScopedBean2547 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2547.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2547");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2547");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2547");
    }
