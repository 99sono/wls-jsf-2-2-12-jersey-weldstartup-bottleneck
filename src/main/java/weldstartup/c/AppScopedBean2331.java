...
public class AppScopedBean2331 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2331.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2331");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2331");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2331");
    }
