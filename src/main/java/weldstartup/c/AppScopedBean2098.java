...
public class AppScopedBean2098 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2098.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2098");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2098");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2098");
    }
