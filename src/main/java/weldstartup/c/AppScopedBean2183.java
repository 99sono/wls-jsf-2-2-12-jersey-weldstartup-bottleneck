...
public class AppScopedBean2183 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2183.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2183");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2183");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2183");
    }
