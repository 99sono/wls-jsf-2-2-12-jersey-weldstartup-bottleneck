...
public class AppScopedBean2442 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2442.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2442");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2442");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2442");
    }
