...
public class AppScopedBean2489 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2489.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2489");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2489");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2489");
    }
