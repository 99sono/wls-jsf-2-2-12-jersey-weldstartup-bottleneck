...
public class AppScopedBean2477 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2477.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2477");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2477");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2477");
    }
