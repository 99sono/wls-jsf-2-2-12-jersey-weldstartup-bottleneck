...
public class AppScopedBean2652 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2652.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2652");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2652");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2652");
    }
