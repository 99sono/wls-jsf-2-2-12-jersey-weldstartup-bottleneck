...
public class AppScopedBean2264 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2264.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2264");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2264");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2264");
    }
