...
public class AppScopedBean2415 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2415.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2415");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2415");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2415");
    }
