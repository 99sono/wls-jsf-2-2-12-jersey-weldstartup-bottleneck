...
public class AppScopedBean2214 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2214.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2214");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2214");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2214");
    }
