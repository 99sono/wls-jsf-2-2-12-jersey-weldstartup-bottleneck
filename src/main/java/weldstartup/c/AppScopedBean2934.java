...
public class AppScopedBean2934 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2934.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2934");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2934");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2934");
    }
