...
public class AppScopedBean2452 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2452.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2452");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2452");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2452");
    }
