...
public class AppScopedBean2894 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2894.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2894");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2894");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2894");
    }
