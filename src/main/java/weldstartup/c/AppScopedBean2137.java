...
public class AppScopedBean2137 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2137.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2137");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2137");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2137");
    }
