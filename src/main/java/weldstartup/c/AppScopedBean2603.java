...
public class AppScopedBean2603 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2603.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2603");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2603");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2603");
    }
