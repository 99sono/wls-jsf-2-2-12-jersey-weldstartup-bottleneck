...
public class AppScopedBean2260 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2260.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2260");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2260");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2260");
    }
