...
public class AppScopedBean2062 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2062.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2062");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2062");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2062");
    }
