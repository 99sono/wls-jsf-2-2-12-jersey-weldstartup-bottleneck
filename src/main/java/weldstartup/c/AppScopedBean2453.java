...
public class AppScopedBean2453 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2453.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2453");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2453");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2453");
    }
