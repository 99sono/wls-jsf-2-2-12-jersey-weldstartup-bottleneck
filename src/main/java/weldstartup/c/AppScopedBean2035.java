...
public class AppScopedBean2035 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2035.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2035");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2035");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2035");
    }
