...
public class AppScopedBean2753 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2753.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2753");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2753");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2753");
    }
