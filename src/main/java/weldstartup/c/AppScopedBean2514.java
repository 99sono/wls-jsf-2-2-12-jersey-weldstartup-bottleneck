...
public class AppScopedBean2514 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2514.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2514");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2514");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2514");
    }
