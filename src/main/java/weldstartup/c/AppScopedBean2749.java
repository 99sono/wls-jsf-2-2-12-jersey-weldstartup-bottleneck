...
public class AppScopedBean2749 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2749.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2749");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2749");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2749");
    }
