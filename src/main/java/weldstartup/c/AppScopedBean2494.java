...
public class AppScopedBean2494 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2494.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2494");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2494");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2494");
    }
