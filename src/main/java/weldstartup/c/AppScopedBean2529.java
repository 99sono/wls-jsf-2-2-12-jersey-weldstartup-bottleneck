...
public class AppScopedBean2529 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2529.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2529");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2529");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2529");
    }
