...
public class AppScopedBean2932 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2932.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2932");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2932");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2932");
    }
