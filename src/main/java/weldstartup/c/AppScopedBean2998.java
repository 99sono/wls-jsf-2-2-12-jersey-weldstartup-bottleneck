...
public class AppScopedBean2998 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2998.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2998");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2998");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2998");
    }
