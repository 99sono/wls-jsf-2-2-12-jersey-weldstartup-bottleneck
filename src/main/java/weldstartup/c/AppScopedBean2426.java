...
public class AppScopedBean2426 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2426.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2426");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2426");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2426");
    }
