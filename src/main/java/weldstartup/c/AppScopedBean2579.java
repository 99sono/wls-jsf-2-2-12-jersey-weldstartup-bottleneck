...
public class AppScopedBean2579 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2579.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2579");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2579");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2579");
    }
