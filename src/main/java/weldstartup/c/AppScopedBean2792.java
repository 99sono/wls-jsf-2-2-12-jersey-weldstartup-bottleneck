...
public class AppScopedBean2792 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2792.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2792");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2792");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2792");
    }
