...
public class AppScopedBean2393 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2393.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2393");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2393");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2393");
    }
