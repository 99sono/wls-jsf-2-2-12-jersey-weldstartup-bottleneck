...
public class AppScopedBean2834 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2834.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2834");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2834");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2834");
    }
