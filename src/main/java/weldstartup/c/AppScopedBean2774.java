...
public class AppScopedBean2774 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2774.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2774");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2774");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2774");
    }
