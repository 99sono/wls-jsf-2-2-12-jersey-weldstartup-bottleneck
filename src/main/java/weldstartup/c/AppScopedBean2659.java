...
public class AppScopedBean2659 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2659.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2659");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2659");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2659");
    }
