...
public class AppScopedBean2089 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2089.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2089");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2089");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2089");
    }
