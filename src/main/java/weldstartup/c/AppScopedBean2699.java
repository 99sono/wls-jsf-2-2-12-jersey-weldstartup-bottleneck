...
public class AppScopedBean2699 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2699.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2699");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2699");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2699");
    }
