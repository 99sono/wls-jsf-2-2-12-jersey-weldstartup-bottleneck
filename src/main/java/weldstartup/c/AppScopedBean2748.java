...
public class AppScopedBean2748 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2748.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2748");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2748");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2748");
    }
