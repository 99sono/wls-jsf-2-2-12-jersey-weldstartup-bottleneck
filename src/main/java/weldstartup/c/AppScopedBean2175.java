...
public class AppScopedBean2175 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2175.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2175");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2175");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2175");
    }
