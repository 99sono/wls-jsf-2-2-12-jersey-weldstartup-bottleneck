...
public class AppScopedBean2391 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2391.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2391");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2391");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2391");
    }
