...
public class AppScopedBean2197 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2197.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2197");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2197");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2197");
    }
