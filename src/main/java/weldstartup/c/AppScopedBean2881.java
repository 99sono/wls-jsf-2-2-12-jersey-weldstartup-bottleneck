...
public class AppScopedBean2881 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2881.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2881");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2881");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2881");
    }
