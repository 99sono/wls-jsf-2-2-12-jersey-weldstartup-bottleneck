...
public class AppScopedBean2130 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2130.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2130");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2130");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2130");
    }
