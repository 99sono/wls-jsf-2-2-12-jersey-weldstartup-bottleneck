...
public class AppScopedBean2694 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2694.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2694");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2694");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2694");
    }
