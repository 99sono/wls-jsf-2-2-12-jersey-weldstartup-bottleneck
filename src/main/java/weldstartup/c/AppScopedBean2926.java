...
public class AppScopedBean2926 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2926.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2926");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2926");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2926");
    }
