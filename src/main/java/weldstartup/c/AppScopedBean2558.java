...
public class AppScopedBean2558 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2558.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2558");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2558");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2558");
    }
