...
public class AppScopedBean2655 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2655.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2655");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2655");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2655");
    }
