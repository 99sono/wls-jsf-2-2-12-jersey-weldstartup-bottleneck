...
public class AppScopedBean2055 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2055.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2055");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2055");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2055");
    }
