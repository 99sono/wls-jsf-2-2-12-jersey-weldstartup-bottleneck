...
public class AppScopedBean2083 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2083.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2083");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2083");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2083");
    }
