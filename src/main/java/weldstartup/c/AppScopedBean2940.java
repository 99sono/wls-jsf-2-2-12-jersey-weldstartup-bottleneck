...
public class AppScopedBean2940 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2940.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2940");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2940");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2940");
    }
