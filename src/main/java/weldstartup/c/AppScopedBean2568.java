...
public class AppScopedBean2568 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2568.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2568");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2568");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2568");
    }
