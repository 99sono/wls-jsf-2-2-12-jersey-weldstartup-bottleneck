...
public class AppScopedBean2318 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2318.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2318");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2318");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2318");
    }
