...
public class AppScopedBean2658 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2658.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2658");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2658");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2658");
    }
