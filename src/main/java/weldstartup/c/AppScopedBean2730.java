...
public class AppScopedBean2730 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2730.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2730");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2730");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2730");
    }
