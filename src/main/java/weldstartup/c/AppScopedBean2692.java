...
public class AppScopedBean2692 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2692.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2692");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2692");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2692");
    }
