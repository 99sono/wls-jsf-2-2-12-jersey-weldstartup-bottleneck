...
public class AppScopedBean2447 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2447.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2447");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2447");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2447");
    }
