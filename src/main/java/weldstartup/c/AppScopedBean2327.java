...
public class AppScopedBean2327 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2327.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2327");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2327");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2327");
    }
