...
public class AppScopedBean2790 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2790.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2790");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2790");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2790");
    }
