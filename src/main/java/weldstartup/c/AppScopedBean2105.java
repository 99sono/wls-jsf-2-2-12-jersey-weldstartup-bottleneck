...
public class AppScopedBean2105 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2105.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2105");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2105");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2105");
    }
