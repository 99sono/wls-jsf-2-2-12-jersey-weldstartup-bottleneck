...
public class AppScopedBean2874 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2874.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2874");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2874");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2874");
    }
