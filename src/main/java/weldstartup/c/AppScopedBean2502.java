...
public class AppScopedBean2502 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2502.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2502");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2502");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2502");
    }
