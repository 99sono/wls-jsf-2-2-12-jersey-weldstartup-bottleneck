...
public class AppScopedBean2901 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2901.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2901");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2901");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2901");
    }
