...
public class AppScopedBean2775 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2775.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2775");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2775");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2775");
    }
