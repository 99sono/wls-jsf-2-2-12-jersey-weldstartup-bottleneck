...
public class AppScopedBean2245 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2245.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2245");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2245");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2245");
    }
