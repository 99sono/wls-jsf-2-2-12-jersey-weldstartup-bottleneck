...
public class AppScopedBean2985 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2985.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2985");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2985");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2985");
    }
