...
public class AppScopedBean2789 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2789.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2789");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2789");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2789");
    }
