...
public class AppScopedBean2705 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2705.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2705");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2705");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2705");
    }
