...
public class AppScopedBean2732 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2732.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2732");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2732");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2732");
    }
