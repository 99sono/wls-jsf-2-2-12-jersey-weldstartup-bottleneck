...
public class AppScopedBean2886 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2886.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2886");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2886");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2886");
    }
