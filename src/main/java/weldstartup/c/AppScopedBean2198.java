...
public class AppScopedBean2198 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2198.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2198");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2198");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2198");
    }
