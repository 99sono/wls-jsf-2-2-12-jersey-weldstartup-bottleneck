...
public class AppScopedBean2321 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2321.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2321");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2321");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2321");
    }
