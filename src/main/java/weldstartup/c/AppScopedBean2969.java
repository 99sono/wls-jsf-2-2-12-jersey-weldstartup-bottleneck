...
public class AppScopedBean2969 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2969.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2969");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2969");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2969");
    }
