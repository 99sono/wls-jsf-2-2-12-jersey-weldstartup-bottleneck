...
public class AppScopedBean2627 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2627.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2627");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2627");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2627");
    }
