...
public class AppScopedBean2361 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2361.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2361");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2361");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2361");
    }
