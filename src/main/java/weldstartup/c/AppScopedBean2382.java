...
public class AppScopedBean2382 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2382.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2382");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2382");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2382");
    }
