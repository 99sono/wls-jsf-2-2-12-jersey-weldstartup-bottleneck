...
public class AppScopedBean2375 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2375.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2375");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2375");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2375");
    }
