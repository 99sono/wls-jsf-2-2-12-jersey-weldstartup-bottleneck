...
public class AppScopedBean2097 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2097.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2097");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2097");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2097");
    }
