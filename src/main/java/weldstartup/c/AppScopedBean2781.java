...
public class AppScopedBean2781 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2781.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2781");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2781");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2781");
    }
