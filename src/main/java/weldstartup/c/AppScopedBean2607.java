...
public class AppScopedBean2607 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2607.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2607");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2607");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2607");
    }
