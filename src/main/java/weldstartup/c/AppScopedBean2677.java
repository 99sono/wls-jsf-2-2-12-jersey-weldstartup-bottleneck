...
public class AppScopedBean2677 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2677.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2677");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2677");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2677");
    }
