...
public class AppScopedBean2900 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2900.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2900");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2900");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2900");
    }
