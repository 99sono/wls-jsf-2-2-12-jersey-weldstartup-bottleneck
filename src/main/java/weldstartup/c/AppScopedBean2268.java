...
public class AppScopedBean2268 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2268.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2268");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2268");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2268");
    }
