...
public class AppScopedBean2193 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2193.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2193");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2193");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2193");
    }
