...
public class AppScopedBean2207 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2207.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2207");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2207");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2207");
    }
