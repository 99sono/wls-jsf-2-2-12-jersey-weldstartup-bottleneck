...
public class AppScopedBean2460 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2460.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2460");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2460");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2460");
    }
