...
public class AppScopedBean2497 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2497.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2497");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2497");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2497");
    }
