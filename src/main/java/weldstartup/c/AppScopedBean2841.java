...
public class AppScopedBean2841 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2841.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2841");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2841");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2841");
    }
