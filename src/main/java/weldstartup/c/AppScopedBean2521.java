...
public class AppScopedBean2521 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2521.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2521");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2521");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2521");
    }
