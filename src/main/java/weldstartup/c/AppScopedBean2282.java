...
public class AppScopedBean2282 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2282.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2282");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2282");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2282");
    }
