...
public class AppScopedBean2435 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2435.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2435");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2435");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2435");
    }
