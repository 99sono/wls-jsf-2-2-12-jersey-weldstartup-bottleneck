...
public class AppScopedBean2523 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2523.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2523");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2523");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2523");
    }
