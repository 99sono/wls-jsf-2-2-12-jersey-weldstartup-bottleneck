...
public class AppScopedBean2943 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2943.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2943");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2943");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2943");
    }
