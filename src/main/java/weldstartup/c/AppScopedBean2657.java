...
public class AppScopedBean2657 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2657.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2657");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2657");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2657");
    }
