...
public class AppScopedBean2575 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2575.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2575");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2575");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2575");
    }
