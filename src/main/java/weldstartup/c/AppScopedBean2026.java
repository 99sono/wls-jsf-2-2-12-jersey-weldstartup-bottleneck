...
public class AppScopedBean2026 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2026.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2026");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2026");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2026");
    }
