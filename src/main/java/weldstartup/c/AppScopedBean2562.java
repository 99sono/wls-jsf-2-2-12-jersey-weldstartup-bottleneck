...
public class AppScopedBean2562 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2562.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2562");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2562");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2562");
    }
