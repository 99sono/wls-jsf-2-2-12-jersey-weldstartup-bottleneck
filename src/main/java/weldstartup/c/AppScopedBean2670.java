...
public class AppScopedBean2670 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2670.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2670");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2670");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2670");
    }
