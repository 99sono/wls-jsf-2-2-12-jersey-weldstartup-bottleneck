...
public class AppScopedBean2378 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2378.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2378");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2378");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2378");
    }
