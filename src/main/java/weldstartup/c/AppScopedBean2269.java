...
public class AppScopedBean2269 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2269.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2269");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2269");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2269");
    }
