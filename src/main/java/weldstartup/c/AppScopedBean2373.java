...
public class AppScopedBean2373 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2373.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2373");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2373");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2373");
    }
