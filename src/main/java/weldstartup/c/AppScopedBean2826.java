...
public class AppScopedBean2826 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2826.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2826");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2826");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2826");
    }
