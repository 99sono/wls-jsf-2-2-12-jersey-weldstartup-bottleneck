...
public class AppScopedBean2079 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2079.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2079");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2079");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2079");
    }
