...
public class AppScopedBean2011 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2011.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2011");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2011");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2011");
    }
