...
public class AppScopedBean2981 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2981.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2981");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2981");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2981");
    }
