...
public class AppScopedBean2353 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2353.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2353");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2353");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2353");
    }
