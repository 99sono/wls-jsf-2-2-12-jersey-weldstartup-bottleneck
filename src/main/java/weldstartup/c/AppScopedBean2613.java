...
public class AppScopedBean2613 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2613.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2613");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2613");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2613");
    }
