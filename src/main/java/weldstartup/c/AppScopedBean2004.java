...
public class AppScopedBean2004 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2004.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2004");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2004");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2004");
    }
