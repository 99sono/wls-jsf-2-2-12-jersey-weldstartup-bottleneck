...
public class AppScopedBean2741 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2741.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2741");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2741");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2741");
    }
