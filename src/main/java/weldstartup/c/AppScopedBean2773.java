...
public class AppScopedBean2773 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2773.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2773");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2773");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2773");
    }
