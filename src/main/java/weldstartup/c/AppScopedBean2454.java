...
public class AppScopedBean2454 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2454.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2454");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2454");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2454");
    }
