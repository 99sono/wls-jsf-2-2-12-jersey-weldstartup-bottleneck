...
public class AppScopedBean2122 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2122.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2122");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2122");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2122");
    }
