...
public class AppScopedBean2929 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2929.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2929");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2929");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2929");
    }
