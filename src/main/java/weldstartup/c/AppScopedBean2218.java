...
public class AppScopedBean2218 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2218.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2218");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2218");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2218");
    }
