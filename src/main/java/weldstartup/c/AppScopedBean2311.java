...
public class AppScopedBean2311 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2311.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2311");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2311");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2311");
    }
