...
public class AppScopedBean2441 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2441.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2441");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2441");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2441");
    }
