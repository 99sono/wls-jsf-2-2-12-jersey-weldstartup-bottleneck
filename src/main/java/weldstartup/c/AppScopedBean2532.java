...
public class AppScopedBean2532 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2532.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2532");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2532");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2532");
    }
