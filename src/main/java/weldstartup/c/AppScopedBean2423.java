...
public class AppScopedBean2423 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2423.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2423");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2423");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2423");
    }
