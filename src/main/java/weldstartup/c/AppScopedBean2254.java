...
public class AppScopedBean2254 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2254.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2254");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2254");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2254");
    }
