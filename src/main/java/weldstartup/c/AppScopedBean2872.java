...
public class AppScopedBean2872 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2872.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2872");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2872");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2872");
    }
