...
public class AppScopedBean2225 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2225.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2225");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2225");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2225");
    }
