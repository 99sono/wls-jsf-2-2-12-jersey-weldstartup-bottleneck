...
public class AppScopedBean2724 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2724.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2724");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2724");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2724");
    }
