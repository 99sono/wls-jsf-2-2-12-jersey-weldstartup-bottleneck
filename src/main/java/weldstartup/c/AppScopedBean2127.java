...
public class AppScopedBean2127 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2127.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2127");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2127");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2127");
    }
