...
public class AppScopedBean2666 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2666.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2666");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2666");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2666");
    }
