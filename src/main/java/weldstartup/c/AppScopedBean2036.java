...
public class AppScopedBean2036 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2036.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2036");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2036");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2036");
    }
