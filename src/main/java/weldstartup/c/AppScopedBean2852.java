...
public class AppScopedBean2852 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2852.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2852");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2852");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2852");
    }
