...
public class AppScopedBean2484 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2484.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2484");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2484");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2484");
    }
