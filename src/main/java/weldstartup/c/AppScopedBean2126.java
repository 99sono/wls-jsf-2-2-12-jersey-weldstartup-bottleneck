...
public class AppScopedBean2126 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2126.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2126");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2126");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2126");
    }
