...
public class AppScopedBean2136 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2136.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2136");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2136");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2136");
    }
