...
public class AppScopedBean2439 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2439.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2439");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2439");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2439");
    }
