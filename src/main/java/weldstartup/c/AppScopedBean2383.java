...
public class AppScopedBean2383 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2383.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2383");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2383");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2383");
    }
