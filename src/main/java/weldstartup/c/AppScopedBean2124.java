...
public class AppScopedBean2124 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2124.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2124");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2124");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2124");
    }
