...
public class AppScopedBean2115 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2115.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2115");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2115");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2115");
    }
