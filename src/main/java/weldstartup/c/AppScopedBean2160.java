...
public class AppScopedBean2160 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2160.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2160");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2160");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2160");
    }
