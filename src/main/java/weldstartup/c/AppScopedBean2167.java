...
public class AppScopedBean2167 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2167.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2167");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2167");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2167");
    }
