...
public class AppScopedBean2018 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2018.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2018");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2018");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2018");
    }
