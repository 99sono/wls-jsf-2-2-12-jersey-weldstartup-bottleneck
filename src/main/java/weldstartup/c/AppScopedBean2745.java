...
public class AppScopedBean2745 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2745.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2745");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2745");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2745");
    }
