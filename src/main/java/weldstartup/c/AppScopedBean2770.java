...
public class AppScopedBean2770 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2770.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2770");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2770");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2770");
    }
