...
public class AppScopedBean2709 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2709.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2709");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2709");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2709");
    }
