...
public class AppScopedBean2942 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2942.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2942");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2942");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2942");
    }
