...
public class AppScopedBean2530 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2530.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2530");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2530");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2530");
    }
