...
public class AppScopedBean2606 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2606.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2606");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2606");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2606");
    }
