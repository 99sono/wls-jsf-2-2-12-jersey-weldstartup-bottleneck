...
public class AppScopedBean2185 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2185.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2185");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2185");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2185");
    }
