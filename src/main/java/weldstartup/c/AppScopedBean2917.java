...
public class AppScopedBean2917 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2917.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2917");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2917");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2917");
    }
