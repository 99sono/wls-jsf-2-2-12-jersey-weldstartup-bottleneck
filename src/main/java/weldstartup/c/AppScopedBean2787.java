...
public class AppScopedBean2787 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2787.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2787");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2787");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2787");
    }
