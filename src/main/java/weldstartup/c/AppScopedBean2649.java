...
public class AppScopedBean2649 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2649.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2649");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2649");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2649");
    }
