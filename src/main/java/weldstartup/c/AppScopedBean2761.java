...
public class AppScopedBean2761 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2761.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2761");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2761");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2761");
    }
