...
public class AppScopedBean2680 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2680.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2680");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2680");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2680");
    }
