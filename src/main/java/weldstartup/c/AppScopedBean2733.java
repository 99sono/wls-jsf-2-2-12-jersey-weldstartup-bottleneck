...
public class AppScopedBean2733 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2733.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2733");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2733");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2733");
    }
