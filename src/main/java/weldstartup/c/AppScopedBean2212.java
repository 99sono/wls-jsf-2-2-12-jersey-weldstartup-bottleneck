...
public class AppScopedBean2212 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2212.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2212");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2212");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2212");
    }
