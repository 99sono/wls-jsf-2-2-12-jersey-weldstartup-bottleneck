...
public class AppScopedBean2376 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2376.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2376");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2376");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2376");
    }
