...
public class AppScopedBean2842 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2842.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2842");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2842");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2842");
    }
