...
public class AppScopedBean2024 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2024.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2024");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2024");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2024");
    }
