...
public class AppScopedBean2306 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2306.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2306");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2306");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2306");
    }
