...
public class AppScopedBean2640 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2640.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2640");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2640");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2640");
    }
