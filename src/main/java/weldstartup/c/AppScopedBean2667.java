...
public class AppScopedBean2667 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2667.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2667");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2667");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2667");
    }
