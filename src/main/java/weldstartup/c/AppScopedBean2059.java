...
public class AppScopedBean2059 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2059.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2059");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2059");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2059");
    }
