...
public class AppScopedBean2927 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2927.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2927");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2927");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2927");
    }
