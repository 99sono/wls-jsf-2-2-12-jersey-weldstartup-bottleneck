...
public class AppScopedBean2997 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2997.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2997");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2997");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2997");
    }
