...
public class AppScopedBean2335 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2335.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2335");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2335");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2335");
    }
