...
public class AppScopedBean2560 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2560.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2560");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2560");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2560");
    }
