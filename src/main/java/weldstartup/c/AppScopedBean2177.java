...
public class AppScopedBean2177 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2177.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2177");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2177");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2177");
    }
