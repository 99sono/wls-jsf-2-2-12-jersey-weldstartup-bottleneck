...
public class AppScopedBean2946 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2946.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2946");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2946");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2946");
    }
