...
public class AppScopedBean2703 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2703.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2703");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2703");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2703");
    }
