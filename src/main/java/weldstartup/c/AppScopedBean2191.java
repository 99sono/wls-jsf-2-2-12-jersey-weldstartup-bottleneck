...
public class AppScopedBean2191 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2191.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2191");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2191");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2191");
    }
