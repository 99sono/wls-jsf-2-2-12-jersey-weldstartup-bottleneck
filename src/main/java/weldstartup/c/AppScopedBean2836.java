...
public class AppScopedBean2836 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2836.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2836");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2836");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2836");
    }
