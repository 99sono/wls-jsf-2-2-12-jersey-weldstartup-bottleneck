...
public class AppScopedBean2249 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2249.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2249");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2249");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2249");
    }
