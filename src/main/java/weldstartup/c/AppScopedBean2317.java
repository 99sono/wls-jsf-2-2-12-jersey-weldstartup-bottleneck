...
public class AppScopedBean2317 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2317.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2317");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2317");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2317");
    }
