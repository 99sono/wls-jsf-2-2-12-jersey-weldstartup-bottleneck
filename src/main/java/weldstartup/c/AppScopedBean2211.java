...
public class AppScopedBean2211 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2211.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2211");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2211");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2211");
    }
