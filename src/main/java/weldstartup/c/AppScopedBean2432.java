...
public class AppScopedBean2432 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2432.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2432");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2432");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2432");
    }
