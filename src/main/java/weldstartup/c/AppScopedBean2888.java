...
public class AppScopedBean2888 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2888.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2888");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2888");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2888");
    }
