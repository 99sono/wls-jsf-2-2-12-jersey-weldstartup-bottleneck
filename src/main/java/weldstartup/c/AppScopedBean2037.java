...
public class AppScopedBean2037 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2037.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2037");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2037");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2037");
    }
