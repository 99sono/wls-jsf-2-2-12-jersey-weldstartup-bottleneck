...
public class AppScopedBean2833 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2833.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2833");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2833");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2833");
    }
