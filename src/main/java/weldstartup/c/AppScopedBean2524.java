...
public class AppScopedBean2524 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2524.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2524");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2524");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2524");
    }
