...
public class AppScopedBean2990 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2990.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2990");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2990");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2990");
    }
