...
public class AppScopedBean2231 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2231.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2231");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2231");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2231");
    }
