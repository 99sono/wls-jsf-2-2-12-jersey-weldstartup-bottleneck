...
public class AppScopedBean2246 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2246.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2246");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2246");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2246");
    }
