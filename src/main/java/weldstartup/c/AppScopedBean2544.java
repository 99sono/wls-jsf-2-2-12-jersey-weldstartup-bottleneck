...
public class AppScopedBean2544 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2544.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2544");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2544");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2544");
    }
