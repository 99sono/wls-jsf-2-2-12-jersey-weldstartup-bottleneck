...
public class AppScopedBean2270 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2270.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2270");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2270");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2270");
    }
