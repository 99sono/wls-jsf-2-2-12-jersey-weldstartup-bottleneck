...
public class AppScopedBean2679 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2679.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2679");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2679");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2679");
    }
