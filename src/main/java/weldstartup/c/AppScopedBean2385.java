...
public class AppScopedBean2385 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2385.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2385");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2385");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2385");
    }
