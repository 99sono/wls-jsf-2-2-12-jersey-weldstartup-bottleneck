...
public class AppScopedBean2552 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2552.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2552");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2552");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2552");
    }
