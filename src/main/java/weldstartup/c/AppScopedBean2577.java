...
public class AppScopedBean2577 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2577.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2577");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2577");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2577");
    }
