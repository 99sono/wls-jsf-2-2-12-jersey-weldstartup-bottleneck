...
public class AppScopedBean2310 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2310.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2310");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2310");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2310");
    }
