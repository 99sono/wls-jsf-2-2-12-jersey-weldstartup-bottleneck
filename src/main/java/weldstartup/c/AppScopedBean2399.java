...
public class AppScopedBean2399 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2399.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2399");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2399");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2399");
    }
