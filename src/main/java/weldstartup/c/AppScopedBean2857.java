...
public class AppScopedBean2857 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2857.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2857");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2857");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2857");
    }
