...
public class AppScopedBean2540 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2540.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2540");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2540");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2540");
    }
