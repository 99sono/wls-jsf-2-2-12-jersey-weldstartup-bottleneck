...
public class AppScopedBean2648 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2648.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2648");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2648");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2648");
    }
