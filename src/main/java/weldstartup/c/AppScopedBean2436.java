...
public class AppScopedBean2436 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2436.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2436");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2436");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2436");
    }
