...
public class AppScopedBean2440 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2440.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2440");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2440");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2440");
    }
