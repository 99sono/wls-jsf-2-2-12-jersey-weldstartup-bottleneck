...
public class AppScopedBean2908 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2908.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2908");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2908");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2908");
    }
