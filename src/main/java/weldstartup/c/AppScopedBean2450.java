...
public class AppScopedBean2450 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2450.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2450");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2450");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2450");
    }
