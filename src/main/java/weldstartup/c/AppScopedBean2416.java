...
public class AppScopedBean2416 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2416.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2416");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2416");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2416");
    }
