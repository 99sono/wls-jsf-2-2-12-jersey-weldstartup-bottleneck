...
public class AppScopedBean2608 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2608.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2608");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2608");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2608");
    }
