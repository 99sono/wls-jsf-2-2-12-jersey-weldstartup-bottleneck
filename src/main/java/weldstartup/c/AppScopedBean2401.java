...
public class AppScopedBean2401 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2401.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2401");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2401");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2401");
    }
