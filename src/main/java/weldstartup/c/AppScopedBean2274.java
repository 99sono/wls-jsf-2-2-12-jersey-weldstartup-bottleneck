...
public class AppScopedBean2274 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2274.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2274");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2274");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2274");
    }
