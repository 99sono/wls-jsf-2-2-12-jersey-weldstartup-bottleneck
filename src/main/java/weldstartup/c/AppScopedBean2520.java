...
public class AppScopedBean2520 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2520.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2520");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2520");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2520");
    }
