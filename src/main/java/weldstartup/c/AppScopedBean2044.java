...
public class AppScopedBean2044 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2044.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2044");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2044");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2044");
    }
