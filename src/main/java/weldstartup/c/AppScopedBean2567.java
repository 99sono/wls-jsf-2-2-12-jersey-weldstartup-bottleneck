...
public class AppScopedBean2567 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2567.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2567");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2567");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2567");
    }
