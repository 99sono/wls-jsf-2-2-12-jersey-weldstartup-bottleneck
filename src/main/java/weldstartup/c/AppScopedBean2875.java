...
public class AppScopedBean2875 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2875.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2875");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2875");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2875");
    }
