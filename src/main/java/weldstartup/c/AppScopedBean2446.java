...
public class AppScopedBean2446 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2446.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2446");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2446");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2446");
    }
