...
public class AppScopedBean2003 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2003.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2003");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2003");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2003");
    }
