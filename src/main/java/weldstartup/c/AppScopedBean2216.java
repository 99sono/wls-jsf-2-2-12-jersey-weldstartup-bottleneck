...
public class AppScopedBean2216 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2216.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2216");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2216");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2216");
    }
