...
public class AppScopedBean2141 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2141.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2141");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2141");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2141");
    }
