...
public class AppScopedBean2793 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2793.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2793");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2793");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2793");
    }
