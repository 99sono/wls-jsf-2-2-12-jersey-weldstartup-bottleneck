...
public class AppScopedBean2830 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2830.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2830");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2830");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2830");
    }
