...
public class AppScopedBean2226 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2226.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2226");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2226");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2226");
    }
