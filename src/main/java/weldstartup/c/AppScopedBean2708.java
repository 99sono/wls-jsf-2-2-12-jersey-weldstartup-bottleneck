...
public class AppScopedBean2708 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2708.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2708");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2708");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2708");
    }
