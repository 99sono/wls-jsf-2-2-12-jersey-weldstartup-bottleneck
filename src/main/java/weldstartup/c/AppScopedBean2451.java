...
public class AppScopedBean2451 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2451.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2451");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2451");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2451");
    }
