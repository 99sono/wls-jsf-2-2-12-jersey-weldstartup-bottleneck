...
public class AppScopedBean2965 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2965.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2965");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2965");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2965");
    }
