...
public class AppScopedBean2464 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2464.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2464");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2464");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2464");
    }
