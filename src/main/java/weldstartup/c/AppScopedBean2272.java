...
public class AppScopedBean2272 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2272.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2272");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2272");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2272");
    }
