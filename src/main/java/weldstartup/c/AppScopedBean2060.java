...
public class AppScopedBean2060 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2060.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2060");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2060");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2060");
    }
