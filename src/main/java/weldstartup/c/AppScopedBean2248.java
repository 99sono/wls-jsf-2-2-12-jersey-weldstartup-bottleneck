...
public class AppScopedBean2248 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2248.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2248");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2248");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2248");
    }
