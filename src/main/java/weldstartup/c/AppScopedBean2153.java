...
public class AppScopedBean2153 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2153.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2153");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2153");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2153");
    }
