...
public class AppScopedBean2253 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2253.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2253");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2253");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2253");
    }
