...
public class AppScopedBean2164 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2164.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2164");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2164");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2164");
    }
