...
public class AppScopedBean2300 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2300.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2300");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2300");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2300");
    }
