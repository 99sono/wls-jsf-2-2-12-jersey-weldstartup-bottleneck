...
public class AppScopedBean2700 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2700.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2700");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2700");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2700");
    }
