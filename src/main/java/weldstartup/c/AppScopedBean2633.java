...
public class AppScopedBean2633 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2633.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2633");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2633");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2633");
    }
