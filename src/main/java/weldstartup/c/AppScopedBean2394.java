...
public class AppScopedBean2394 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2394.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2394");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2394");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2394");
    }
