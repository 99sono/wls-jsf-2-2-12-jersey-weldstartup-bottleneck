...
public class AppScopedBean2363 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2363.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2363");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2363");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2363");
    }
