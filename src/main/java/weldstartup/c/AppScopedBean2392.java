...
public class AppScopedBean2392 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2392.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2392");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2392");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2392");
    }
