...
public class AppScopedBean2739 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2739.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2739");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2739");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2739");
    }
