...
public class AppScopedBean2597 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2597.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2597");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2597");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2597");
    }
