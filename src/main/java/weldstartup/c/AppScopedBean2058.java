...
public class AppScopedBean2058 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2058.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2058");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2058");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2058");
    }
