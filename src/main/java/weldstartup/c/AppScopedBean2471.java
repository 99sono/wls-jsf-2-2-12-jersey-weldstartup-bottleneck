...
public class AppScopedBean2471 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2471.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2471");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2471");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2471");
    }
