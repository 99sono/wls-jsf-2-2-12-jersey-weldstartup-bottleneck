...
public class AppScopedBean2582 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2582.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2582");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2582");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2582");
    }
