...
public class AppScopedBean2117 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2117.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2117");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2117");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2117");
    }
