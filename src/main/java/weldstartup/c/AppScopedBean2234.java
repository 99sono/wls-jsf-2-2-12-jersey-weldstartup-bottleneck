...
public class AppScopedBean2234 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2234.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2234");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2234");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2234");
    }
