...
public class AppScopedBean2263 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2263.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2263");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2263");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2263");
    }
