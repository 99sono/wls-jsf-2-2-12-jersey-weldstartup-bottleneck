...
public class AppScopedBean2500 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2500.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2500");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2500");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2500");
    }
