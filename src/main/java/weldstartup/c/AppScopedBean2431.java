...
public class AppScopedBean2431 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2431.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2431");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2431");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2431");
    }
