...
public class AppScopedBean2194 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2194.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2194");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2194");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2194");
    }
