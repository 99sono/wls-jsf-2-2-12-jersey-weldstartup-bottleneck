...
public class AppScopedBean2937 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2937.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2937");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2937");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2937");
    }
