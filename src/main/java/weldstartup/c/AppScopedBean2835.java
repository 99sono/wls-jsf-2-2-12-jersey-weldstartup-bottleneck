...
public class AppScopedBean2835 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2835.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2835");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2835");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2835");
    }
