...
public class AppScopedBean2176 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2176.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2176");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2176");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2176");
    }
