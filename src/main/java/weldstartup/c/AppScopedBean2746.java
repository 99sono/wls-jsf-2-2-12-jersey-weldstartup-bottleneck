...
public class AppScopedBean2746 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2746.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2746");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2746");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2746");
    }
