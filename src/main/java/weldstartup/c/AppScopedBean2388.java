...
public class AppScopedBean2388 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2388.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2388");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2388");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2388");
    }
