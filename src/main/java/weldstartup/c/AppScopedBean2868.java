...
public class AppScopedBean2868 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2868.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2868");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2868");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2868");
    }
