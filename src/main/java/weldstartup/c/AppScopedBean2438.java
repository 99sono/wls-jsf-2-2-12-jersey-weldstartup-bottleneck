...
public class AppScopedBean2438 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2438.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2438");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2438");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2438");
    }
