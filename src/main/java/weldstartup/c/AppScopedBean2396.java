...
public class AppScopedBean2396 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2396.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2396");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2396");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2396");
    }
