...
public class AppScopedBean2564 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2564.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2564");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2564");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2564");
    }
