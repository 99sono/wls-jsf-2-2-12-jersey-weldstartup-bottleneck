...
public class AppScopedBean2397 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2397.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2397");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2397");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2397");
    }
