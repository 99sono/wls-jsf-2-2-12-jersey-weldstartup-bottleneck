...
public class AppScopedBean2503 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2503.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2503");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2503");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2503");
    }
