...
public class AppScopedBean2843 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2843.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2843");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2843");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2843");
    }
