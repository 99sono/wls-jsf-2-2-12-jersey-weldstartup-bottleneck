...
public class AppScopedBean2838 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2838.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2838");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2838");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2838");
    }
