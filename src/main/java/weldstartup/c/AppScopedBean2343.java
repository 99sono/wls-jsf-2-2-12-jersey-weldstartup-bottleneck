...
public class AppScopedBean2343 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2343.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2343");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2343");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2343");
    }
