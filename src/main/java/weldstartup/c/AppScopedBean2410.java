...
public class AppScopedBean2410 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2410.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2410");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2410");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2410");
    }
