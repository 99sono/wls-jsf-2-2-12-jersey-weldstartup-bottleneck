...
public class AppScopedBean2449 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2449.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2449");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2449");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2449");
    }
