...
public class AppScopedBean2814 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2814.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2814");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2814");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2814");
    }
