...
public class AppScopedBean2681 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2681.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2681");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2681");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2681");
    }
