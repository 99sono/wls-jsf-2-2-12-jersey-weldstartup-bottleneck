...
public class AppScopedBean2545 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2545.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2545");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2545");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2545");
    }
