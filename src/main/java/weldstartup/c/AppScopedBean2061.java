...
public class AppScopedBean2061 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2061.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2061");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2061");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2061");
    }
