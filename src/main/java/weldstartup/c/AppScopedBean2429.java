...
public class AppScopedBean2429 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2429.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2429");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2429");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2429");
    }
