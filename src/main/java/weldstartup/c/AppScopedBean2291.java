...
public class AppScopedBean2291 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2291.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2291");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2291");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2291");
    }
