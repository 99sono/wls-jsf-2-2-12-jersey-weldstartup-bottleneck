...
public class AppScopedBean2267 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2267.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2267");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2267");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2267");
    }
