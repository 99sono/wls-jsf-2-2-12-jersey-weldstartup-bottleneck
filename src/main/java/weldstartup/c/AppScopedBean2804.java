...
public class AppScopedBean2804 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2804.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2804");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2804");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2804");
    }
