...
public class AppScopedBean2591 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2591.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2591");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2591");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2591");
    }
