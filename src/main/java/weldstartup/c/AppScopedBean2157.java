...
public class AppScopedBean2157 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2157.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2157");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2157");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2157");
    }
