...
public class AppScopedBean2071 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2071.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2071");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2071");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2071");
    }
