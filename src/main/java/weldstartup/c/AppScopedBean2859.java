...
public class AppScopedBean2859 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2859.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2859");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2859");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2859");
    }
