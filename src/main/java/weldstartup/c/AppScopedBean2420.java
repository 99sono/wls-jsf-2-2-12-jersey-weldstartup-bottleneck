...
public class AppScopedBean2420 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2420.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2420");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2420");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2420");
    }
