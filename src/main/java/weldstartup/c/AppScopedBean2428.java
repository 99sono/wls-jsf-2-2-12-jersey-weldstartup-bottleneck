...
public class AppScopedBean2428 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2428.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2428");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2428");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2428");
    }
