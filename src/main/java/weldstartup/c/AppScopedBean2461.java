...
public class AppScopedBean2461 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2461.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2461");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2461");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2461");
    }
