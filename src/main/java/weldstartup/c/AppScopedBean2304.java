...
public class AppScopedBean2304 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2304.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2304");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2304");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2304");
    }
