...
public class AppScopedBean2009 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2009.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2009");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2009");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2009");
    }
