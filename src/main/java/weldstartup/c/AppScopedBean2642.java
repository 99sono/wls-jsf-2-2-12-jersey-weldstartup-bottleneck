...
public class AppScopedBean2642 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2642.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2642");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2642");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2642");
    }
