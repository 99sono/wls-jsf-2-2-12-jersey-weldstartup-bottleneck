...
public class AppScopedBean2119 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2119.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2119");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2119");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2119");
    }
