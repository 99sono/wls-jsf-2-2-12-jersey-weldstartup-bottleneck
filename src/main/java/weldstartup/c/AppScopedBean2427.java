...
public class AppScopedBean2427 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2427.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2427");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2427");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2427");
    }
