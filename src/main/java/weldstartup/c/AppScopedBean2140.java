...
public class AppScopedBean2140 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2140.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2140");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2140");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2140");
    }
