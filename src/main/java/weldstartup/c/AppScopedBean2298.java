...
public class AppScopedBean2298 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2298.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2298");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2298");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2298");
    }
