...
public class AppScopedBean2785 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2785.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2785");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2785");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2785");
    }
