...
public class AppScopedBean2349 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2349.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2349");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2349");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2349");
    }
