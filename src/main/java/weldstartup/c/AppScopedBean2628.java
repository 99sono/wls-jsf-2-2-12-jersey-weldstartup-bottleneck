...
public class AppScopedBean2628 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2628.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2628");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2628");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2628");
    }
