...
public class AppScopedBean2538 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2538.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2538");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2538");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2538");
    }
