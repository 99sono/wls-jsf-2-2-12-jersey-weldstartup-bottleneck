...
public class AppScopedBean2350 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2350.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2350");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2350");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2350");
    }
