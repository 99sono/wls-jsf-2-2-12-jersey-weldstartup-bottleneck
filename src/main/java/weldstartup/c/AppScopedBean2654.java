...
public class AppScopedBean2654 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2654.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2654");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2654");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2654");
    }
