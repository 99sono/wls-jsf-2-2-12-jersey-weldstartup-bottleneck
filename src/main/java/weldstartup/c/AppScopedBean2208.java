...
public class AppScopedBean2208 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2208.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2208");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2208");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2208");
    }
