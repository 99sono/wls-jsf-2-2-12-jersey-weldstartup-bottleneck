...
public class AppScopedBean2848 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2848.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2848");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2848");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2848");
    }
