...
public class AppScopedBean2230 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2230.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2230");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2230");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2230");
    }
