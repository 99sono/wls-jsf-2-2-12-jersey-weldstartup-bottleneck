...
public class AppScopedBean2008 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2008.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2008");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2008");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2008");
    }
