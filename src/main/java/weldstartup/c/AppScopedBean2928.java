...
public class AppScopedBean2928 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2928.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2928");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2928");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2928");
    }
