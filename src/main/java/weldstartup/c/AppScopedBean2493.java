...
public class AppScopedBean2493 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2493.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2493");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2493");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2493");
    }
