...
public class AppScopedBean2289 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2289.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2289");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2289");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2289");
    }
