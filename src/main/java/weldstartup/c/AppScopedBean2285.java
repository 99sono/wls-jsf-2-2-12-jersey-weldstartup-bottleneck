...
public class AppScopedBean2285 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2285.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2285");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2285");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2285");
    }
