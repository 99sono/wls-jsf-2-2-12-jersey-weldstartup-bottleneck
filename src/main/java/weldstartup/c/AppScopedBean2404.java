...
public class AppScopedBean2404 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2404.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2404");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2404");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2404");
    }
