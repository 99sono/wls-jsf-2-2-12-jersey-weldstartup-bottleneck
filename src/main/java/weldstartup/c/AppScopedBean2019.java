...
public class AppScopedBean2019 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2019.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2019");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2019");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2019");
    }
