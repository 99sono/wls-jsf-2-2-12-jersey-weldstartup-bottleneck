...
public class AppScopedBean2972 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2972.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2972");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2972");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2972");
    }
