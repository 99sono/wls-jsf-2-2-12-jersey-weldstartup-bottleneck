...
public class AppScopedBean2646 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2646.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2646");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2646");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2646");
    }
