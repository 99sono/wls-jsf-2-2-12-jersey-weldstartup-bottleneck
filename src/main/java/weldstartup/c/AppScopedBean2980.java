...
public class AppScopedBean2980 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2980.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2980");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2980");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2980");
    }
