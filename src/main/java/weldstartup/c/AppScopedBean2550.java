...
public class AppScopedBean2550 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2550.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2550");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2550");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2550");
    }
