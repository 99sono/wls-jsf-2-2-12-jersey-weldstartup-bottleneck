...
public class AppScopedBean2189 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2189.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2189");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2189");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2189");
    }
