...
public class AppScopedBean2094 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2094.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2094");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2094");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2094");
    }
