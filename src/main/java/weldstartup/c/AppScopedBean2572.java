...
public class AppScopedBean2572 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2572.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2572");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2572");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2572");
    }
