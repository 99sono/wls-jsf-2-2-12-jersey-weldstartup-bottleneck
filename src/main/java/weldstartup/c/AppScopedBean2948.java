...
public class AppScopedBean2948 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2948.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2948");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2948");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2948");
    }
