...
public class AppScopedBean2712 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2712.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2712");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2712");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2712");
    }
