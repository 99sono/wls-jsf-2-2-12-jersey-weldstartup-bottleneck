...
public class AppScopedBean2991 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2991.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2991");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2991");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2991");
    }
