...
public class AppScopedBean2822 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2822.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2822");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2822");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2822");
    }
