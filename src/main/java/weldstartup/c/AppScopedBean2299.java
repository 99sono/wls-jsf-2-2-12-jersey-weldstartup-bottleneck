...
public class AppScopedBean2299 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2299.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2299");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2299");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2299");
    }
