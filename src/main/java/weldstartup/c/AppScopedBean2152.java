...
public class AppScopedBean2152 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2152.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2152");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2152");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2152");
    }
