...
public class AppScopedBean2196 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2196.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2196");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2196");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2196");
    }
