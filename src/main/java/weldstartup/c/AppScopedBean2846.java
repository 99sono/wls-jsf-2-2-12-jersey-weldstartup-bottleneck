...
public class AppScopedBean2846 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2846.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2846");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2846");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2846");
    }
