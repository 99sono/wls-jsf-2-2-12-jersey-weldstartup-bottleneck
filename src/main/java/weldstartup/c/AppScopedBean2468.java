...
public class AppScopedBean2468 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2468.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2468");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2468");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2468");
    }
