...
public class AppScopedBean2543 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2543.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2543");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2543");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2543");
    }
