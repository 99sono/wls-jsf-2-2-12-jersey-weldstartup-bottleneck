...
public class AppScopedBean2533 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2533.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2533");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2533");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2533");
    }
