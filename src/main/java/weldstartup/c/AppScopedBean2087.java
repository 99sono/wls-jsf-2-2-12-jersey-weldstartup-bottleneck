...
public class AppScopedBean2087 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2087.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2087");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2087");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2087");
    }
