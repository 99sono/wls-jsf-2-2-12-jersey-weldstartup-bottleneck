...
public class AppScopedBean2186 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2186.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2186");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2186");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2186");
    }
