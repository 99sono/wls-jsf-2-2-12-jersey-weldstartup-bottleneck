...
public class AppScopedBean2585 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2585.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2585");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2585");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2585");
    }
