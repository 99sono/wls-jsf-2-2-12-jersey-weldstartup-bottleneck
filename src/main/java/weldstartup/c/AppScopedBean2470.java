...
public class AppScopedBean2470 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2470.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2470");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2470");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2470");
    }
