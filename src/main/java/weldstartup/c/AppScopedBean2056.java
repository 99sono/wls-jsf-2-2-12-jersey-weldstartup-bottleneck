...
public class AppScopedBean2056 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2056.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2056");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2056");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2056");
    }
