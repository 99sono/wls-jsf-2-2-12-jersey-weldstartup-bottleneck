...
public class AppScopedBean2845 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2845.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2845");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2845");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2845");
    }
