...
public class AppScopedBean2877 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2877.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2877");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2877");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2877");
    }
