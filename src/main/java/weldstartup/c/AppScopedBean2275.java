...
public class AppScopedBean2275 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2275.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2275");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2275");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2275");
    }
