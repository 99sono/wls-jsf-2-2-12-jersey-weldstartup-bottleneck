...
public class AppScopedBean2651 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2651.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2651");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2651");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2651");
    }
