...
public class AppScopedBean2015 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2015.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2015");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2015");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2015");
    }
