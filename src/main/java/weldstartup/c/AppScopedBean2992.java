...
public class AppScopedBean2992 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2992.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2992");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2992");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2992");
    }
