...
public class AppScopedBean2093 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2093.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2093");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2093");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2093");
    }
