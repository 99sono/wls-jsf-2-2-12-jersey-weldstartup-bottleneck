...
public class AppScopedBean2964 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2964.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2964");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2964");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2964");
    }
