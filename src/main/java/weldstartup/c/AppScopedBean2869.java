...
public class AppScopedBean2869 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2869.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2869");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2869");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2869");
    }
