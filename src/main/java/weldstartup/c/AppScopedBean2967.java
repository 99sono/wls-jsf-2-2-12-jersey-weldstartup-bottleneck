...
public class AppScopedBean2967 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2967.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2967");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2967");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2967");
    }
