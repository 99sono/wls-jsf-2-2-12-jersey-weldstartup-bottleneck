...
public class AppScopedBean2999 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2999.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2999");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2999");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2999");
    }
