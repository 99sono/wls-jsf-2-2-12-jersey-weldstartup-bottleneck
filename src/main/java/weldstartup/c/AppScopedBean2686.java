...
public class AppScopedBean2686 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2686.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2686");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2686");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2686");
    }
