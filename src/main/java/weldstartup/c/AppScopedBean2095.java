...
public class AppScopedBean2095 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2095.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2095");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2095");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2095");
    }
