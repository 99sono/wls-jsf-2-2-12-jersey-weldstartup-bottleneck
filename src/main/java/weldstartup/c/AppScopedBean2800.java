...
public class AppScopedBean2800 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2800.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2800");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2800");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2800");
    }
