...
public class AppScopedBean2149 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2149.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2149");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2149");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2149");
    }
