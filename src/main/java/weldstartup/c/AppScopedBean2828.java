...
public class AppScopedBean2828 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2828.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2828");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2828");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2828");
    }
