...
public class AppScopedBean2293 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2293.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2293");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2293");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2293");
    }
