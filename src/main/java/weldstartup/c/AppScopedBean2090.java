...
public class AppScopedBean2090 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2090.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2090");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2090");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2090");
    }
