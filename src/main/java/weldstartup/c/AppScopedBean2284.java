...
public class AppScopedBean2284 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2284.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2284");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2284");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2284");
    }
