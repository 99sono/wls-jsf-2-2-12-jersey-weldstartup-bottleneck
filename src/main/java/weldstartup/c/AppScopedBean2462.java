...
public class AppScopedBean2462 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2462.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2462");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2462");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2462");
    }
