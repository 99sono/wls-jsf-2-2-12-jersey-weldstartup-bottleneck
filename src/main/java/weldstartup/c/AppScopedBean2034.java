...
public class AppScopedBean2034 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean2034.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean2034");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean2034");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean2034");
    }
