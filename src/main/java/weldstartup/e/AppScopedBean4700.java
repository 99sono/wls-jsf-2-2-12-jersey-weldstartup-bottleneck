...
public class AppScopedBean4700 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4700.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4700");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4700");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4700");
    }
