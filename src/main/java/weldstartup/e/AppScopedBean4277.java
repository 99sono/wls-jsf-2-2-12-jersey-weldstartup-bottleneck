...
public class AppScopedBean4277 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4277.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4277");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4277");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4277");
    }
