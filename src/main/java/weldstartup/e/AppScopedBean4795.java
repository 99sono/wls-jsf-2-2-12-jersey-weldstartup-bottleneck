...
public class AppScopedBean4795 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4795.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4795");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4795");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4795");
    }
