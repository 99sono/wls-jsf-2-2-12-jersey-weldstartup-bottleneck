...
public class AppScopedBean4978 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4978.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4978");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4978");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4978");
    }
