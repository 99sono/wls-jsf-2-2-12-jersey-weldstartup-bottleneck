...
public class AppScopedBean4138 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4138.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4138");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4138");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4138");
    }
