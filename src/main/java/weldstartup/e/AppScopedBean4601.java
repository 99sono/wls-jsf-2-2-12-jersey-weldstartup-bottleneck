...
public class AppScopedBean4601 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4601.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4601");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4601");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4601");
    }
