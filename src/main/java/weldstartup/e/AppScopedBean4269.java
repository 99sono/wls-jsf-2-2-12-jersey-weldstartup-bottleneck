...
public class AppScopedBean4269 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4269.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4269");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4269");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4269");
    }
