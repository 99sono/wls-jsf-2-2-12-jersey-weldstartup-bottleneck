...
public class AppScopedBean4667 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4667.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4667");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4667");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4667");
    }
