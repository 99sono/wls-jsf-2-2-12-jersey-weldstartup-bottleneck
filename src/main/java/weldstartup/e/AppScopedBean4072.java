...
public class AppScopedBean4072 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4072.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4072");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4072");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4072");
    }
