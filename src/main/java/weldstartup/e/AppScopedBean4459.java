...
public class AppScopedBean4459 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4459.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4459");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4459");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4459");
    }
