...
public class AppScopedBean4107 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4107.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4107");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4107");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4107");
    }
