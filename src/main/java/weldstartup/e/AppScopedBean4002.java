...
public class AppScopedBean4002 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4002.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4002");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4002");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4002");
    }
