...
public class AppScopedBean4083 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4083.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4083");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4083");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4083");
    }
