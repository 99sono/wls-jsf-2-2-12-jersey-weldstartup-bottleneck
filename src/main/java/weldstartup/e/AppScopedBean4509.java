...
public class AppScopedBean4509 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4509.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4509");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4509");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4509");
    }
