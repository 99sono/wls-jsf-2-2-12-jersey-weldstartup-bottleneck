...
public class AppScopedBean4905 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4905.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4905");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4905");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4905");
    }
