...
public class AppScopedBean4689 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4689.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4689");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4689");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4689");
    }
