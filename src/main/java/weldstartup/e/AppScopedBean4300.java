...
public class AppScopedBean4300 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4300.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4300");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4300");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4300");
    }
