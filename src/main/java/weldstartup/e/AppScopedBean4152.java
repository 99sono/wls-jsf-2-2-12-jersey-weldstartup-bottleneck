...
public class AppScopedBean4152 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4152.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4152");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4152");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4152");
    }
