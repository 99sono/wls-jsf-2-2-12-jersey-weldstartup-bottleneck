...
public class AppScopedBean4334 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4334.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4334");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4334");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4334");
    }
