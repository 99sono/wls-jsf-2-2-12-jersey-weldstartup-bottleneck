...
public class AppScopedBean4879 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4879.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4879");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4879");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4879");
    }
