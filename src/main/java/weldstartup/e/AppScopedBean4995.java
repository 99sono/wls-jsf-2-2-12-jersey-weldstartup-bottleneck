...
public class AppScopedBean4995 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4995.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4995");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4995");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4995");
    }
