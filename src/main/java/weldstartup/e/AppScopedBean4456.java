...
public class AppScopedBean4456 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4456.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4456");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4456");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4456");
    }
