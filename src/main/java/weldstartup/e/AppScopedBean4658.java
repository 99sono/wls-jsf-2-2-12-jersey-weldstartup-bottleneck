...
public class AppScopedBean4658 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4658.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4658");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4658");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4658");
    }
