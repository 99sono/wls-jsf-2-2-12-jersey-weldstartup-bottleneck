...
public class AppScopedBean4803 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4803.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4803");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4803");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4803");
    }
