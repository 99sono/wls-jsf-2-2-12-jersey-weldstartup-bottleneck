...
public class AppScopedBean4330 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4330.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4330");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4330");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4330");
    }
