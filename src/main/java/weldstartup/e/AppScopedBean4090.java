...
public class AppScopedBean4090 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4090.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4090");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4090");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4090");
    }
