...
public class AppScopedBean4407 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4407.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4407");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4407");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4407");
    }
