...
public class AppScopedBean4232 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4232.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4232");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4232");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4232");
    }
