...
public class AppScopedBean4173 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4173.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4173");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4173");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4173");
    }
