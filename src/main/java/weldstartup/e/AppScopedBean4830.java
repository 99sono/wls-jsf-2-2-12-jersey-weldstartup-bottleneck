...
public class AppScopedBean4830 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4830.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4830");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4830");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4830");
    }
