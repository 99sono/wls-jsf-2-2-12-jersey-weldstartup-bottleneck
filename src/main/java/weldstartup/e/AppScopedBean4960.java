...
public class AppScopedBean4960 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4960.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4960");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4960");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4960");
    }
