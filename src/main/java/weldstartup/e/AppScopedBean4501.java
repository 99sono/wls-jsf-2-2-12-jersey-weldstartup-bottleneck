...
public class AppScopedBean4501 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4501.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4501");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4501");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4501");
    }
