...
public class AppScopedBean4554 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4554.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4554");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4554");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4554");
    }
