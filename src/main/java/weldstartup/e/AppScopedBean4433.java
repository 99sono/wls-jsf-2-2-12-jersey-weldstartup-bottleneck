...
public class AppScopedBean4433 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4433.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4433");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4433");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4433");
    }
