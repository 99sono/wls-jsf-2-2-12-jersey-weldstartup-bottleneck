...
public class AppScopedBean4909 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4909.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4909");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4909");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4909");
    }
