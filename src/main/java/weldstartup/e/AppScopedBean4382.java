...
public class AppScopedBean4382 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4382.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4382");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4382");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4382");
    }
