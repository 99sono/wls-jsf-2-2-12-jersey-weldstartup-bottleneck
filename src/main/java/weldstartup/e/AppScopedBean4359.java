...
public class AppScopedBean4359 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4359.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4359");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4359");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4359");
    }
