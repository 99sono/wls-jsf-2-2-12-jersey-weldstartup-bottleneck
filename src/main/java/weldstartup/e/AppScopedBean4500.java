...
public class AppScopedBean4500 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4500.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4500");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4500");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4500");
    }
