...
public class AppScopedBean4017 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4017.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4017");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4017");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4017");
    }
