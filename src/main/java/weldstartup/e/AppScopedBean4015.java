...
public class AppScopedBean4015 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4015.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4015");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4015");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4015");
    }
