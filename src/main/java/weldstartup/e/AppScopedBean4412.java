...
public class AppScopedBean4412 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4412.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4412");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4412");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4412");
    }
