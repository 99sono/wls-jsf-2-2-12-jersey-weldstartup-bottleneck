...
public class AppScopedBean4333 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4333.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4333");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4333");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4333");
    }
