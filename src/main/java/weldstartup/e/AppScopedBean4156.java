...
public class AppScopedBean4156 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4156.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4156");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4156");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4156");
    }
