...
public class AppScopedBean4956 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4956.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4956");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4956");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4956");
    }
