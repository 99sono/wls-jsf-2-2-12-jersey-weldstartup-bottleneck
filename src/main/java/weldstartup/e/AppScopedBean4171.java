...
public class AppScopedBean4171 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4171.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4171");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4171");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4171");
    }
