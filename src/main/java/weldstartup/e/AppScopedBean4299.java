...
public class AppScopedBean4299 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4299.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4299");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4299");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4299");
    }
