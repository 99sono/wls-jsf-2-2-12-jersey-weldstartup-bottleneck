...
public class AppScopedBean4961 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4961.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4961");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4961");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4961");
    }
