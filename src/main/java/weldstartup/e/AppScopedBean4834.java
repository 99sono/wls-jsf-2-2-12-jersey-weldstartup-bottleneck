...
public class AppScopedBean4834 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4834.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4834");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4834");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4834");
    }
