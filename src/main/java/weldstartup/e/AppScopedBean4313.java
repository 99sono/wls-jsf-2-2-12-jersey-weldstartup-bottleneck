...
public class AppScopedBean4313 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4313.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4313");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4313");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4313");
    }
