...
public class AppScopedBean4089 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4089.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4089");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4089");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4089");
    }
