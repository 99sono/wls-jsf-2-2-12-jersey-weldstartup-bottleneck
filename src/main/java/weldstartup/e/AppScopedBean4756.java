...
public class AppScopedBean4756 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4756.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4756");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4756");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4756");
    }
