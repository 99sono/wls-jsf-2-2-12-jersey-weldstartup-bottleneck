...
public class AppScopedBean4783 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4783.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4783");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4783");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4783");
    }
