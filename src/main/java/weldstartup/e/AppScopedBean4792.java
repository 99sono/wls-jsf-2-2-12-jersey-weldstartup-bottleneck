...
public class AppScopedBean4792 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4792.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4792");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4792");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4792");
    }
