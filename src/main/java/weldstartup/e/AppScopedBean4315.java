...
public class AppScopedBean4315 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4315.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4315");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4315");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4315");
    }
