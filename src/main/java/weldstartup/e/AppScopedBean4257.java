...
public class AppScopedBean4257 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4257.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4257");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4257");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4257");
    }
