...
public class AppScopedBean4864 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4864.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4864");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4864");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4864");
    }
