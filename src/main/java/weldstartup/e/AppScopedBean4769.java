...
public class AppScopedBean4769 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4769.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4769");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4769");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4769");
    }
