...
public class AppScopedBean4398 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4398.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4398");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4398");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4398");
    }
