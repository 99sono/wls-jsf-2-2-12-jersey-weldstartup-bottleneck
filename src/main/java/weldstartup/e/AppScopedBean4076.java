...
public class AppScopedBean4076 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4076.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4076");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4076");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4076");
    }
