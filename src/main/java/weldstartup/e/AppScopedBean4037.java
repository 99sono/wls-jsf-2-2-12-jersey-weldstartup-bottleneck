...
public class AppScopedBean4037 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4037.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4037");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4037");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4037");
    }
