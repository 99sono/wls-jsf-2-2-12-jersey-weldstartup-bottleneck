...
public class AppScopedBean4431 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4431.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4431");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4431");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4431");
    }
