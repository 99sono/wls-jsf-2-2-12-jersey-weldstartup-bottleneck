...
public class AppScopedBean4914 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4914.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4914");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4914");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4914");
    }
