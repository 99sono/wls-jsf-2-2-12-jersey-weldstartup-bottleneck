...
public class AppScopedBean4890 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4890.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4890");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4890");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4890");
    }
