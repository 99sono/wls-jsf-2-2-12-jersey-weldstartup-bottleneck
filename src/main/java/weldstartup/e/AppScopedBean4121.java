...
public class AppScopedBean4121 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4121.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4121");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4121");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4121");
    }
