...
public class AppScopedBean4929 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4929.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4929");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4929");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4929");
    }
