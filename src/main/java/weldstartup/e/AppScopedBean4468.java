...
public class AppScopedBean4468 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4468.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4468");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4468");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4468");
    }
