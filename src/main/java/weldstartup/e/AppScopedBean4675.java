...
public class AppScopedBean4675 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4675.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4675");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4675");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4675");
    }
