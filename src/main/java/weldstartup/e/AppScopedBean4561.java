...
public class AppScopedBean4561 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4561.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4561");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4561");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4561");
    }
