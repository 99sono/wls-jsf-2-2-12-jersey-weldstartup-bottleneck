...
public class AppScopedBean4309 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4309.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4309");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4309");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4309");
    }
