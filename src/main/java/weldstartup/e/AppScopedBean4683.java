...
public class AppScopedBean4683 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4683.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4683");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4683");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4683");
    }
