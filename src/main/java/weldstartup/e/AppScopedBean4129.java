...
public class AppScopedBean4129 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4129.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4129");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4129");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4129");
    }
