...
public class AppScopedBean4452 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4452.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4452");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4452");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4452");
    }
