...
public class AppScopedBean4120 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4120.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4120");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4120");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4120");
    }
