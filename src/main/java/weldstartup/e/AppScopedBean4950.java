...
public class AppScopedBean4950 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4950.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4950");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4950");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4950");
    }
