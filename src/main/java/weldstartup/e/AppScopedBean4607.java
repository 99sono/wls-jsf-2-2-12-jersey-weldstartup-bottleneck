...
public class AppScopedBean4607 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4607.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4607");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4607");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4607");
    }
