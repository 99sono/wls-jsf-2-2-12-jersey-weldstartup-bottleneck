...
public class AppScopedBean4487 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4487.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4487");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4487");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4487");
    }
