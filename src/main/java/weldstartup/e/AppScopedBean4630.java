...
public class AppScopedBean4630 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4630.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4630");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4630");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4630");
    }
