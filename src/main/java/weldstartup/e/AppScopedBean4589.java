...
public class AppScopedBean4589 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4589.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4589");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4589");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4589");
    }
