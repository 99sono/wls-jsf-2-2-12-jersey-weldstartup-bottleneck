...
public class AppScopedBean4549 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4549.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4549");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4549");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4549");
    }
