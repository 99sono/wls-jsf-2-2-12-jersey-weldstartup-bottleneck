...
public class AppScopedBean4616 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4616.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4616");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4616");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4616");
    }
