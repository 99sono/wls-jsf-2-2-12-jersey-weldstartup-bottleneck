...
public class AppScopedBean4733 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4733.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4733");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4733");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4733");
    }
