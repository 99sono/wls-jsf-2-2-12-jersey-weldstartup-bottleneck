...
public class AppScopedBean4573 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4573.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4573");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4573");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4573");
    }
