...
public class AppScopedBean4730 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4730.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4730");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4730");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4730");
    }
