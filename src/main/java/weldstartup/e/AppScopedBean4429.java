...
public class AppScopedBean4429 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4429.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4429");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4429");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4429");
    }
