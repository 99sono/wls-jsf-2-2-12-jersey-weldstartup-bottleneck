...
public class AppScopedBean4403 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4403.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4403");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4403");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4403");
    }
