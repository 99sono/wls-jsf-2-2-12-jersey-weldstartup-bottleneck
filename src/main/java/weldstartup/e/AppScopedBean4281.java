...
public class AppScopedBean4281 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4281.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4281");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4281");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4281");
    }
