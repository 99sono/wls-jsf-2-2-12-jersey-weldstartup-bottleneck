...
public class AppScopedBean4462 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4462.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4462");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4462");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4462");
    }
