...
public class AppScopedBean4967 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4967.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4967");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4967");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4967");
    }
