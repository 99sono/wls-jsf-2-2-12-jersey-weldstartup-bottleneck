...
public class AppScopedBean4656 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4656.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4656");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4656");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4656");
    }
