...
public class AppScopedBean4477 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4477.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4477");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4477");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4477");
    }
