...
public class AppScopedBean4030 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4030.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4030");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4030");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4030");
    }
