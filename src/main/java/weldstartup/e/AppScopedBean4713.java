...
public class AppScopedBean4713 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4713.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4713");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4713");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4713");
    }
