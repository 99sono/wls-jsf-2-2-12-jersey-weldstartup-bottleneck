...
public class AppScopedBean4041 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4041.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4041");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4041");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4041");
    }
