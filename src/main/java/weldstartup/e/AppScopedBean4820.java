...
public class AppScopedBean4820 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4820.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4820");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4820");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4820");
    }
