...
public class AppScopedBean4818 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4818.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4818");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4818");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4818");
    }
