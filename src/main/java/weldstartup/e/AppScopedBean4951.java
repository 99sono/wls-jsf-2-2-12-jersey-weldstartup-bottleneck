...
public class AppScopedBean4951 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4951.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4951");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4951");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4951");
    }
