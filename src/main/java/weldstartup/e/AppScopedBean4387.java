...
public class AppScopedBean4387 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4387.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4387");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4387");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4387");
    }
