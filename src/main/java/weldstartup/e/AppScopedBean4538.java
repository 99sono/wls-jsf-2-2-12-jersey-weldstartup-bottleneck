...
public class AppScopedBean4538 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4538.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4538");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4538");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4538");
    }
