...
public class AppScopedBean4916 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4916.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4916");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4916");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4916");
    }
