...
public class AppScopedBean4188 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4188.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4188");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4188");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4188");
    }
