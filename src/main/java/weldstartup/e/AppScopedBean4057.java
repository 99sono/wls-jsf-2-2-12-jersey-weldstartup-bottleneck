...
public class AppScopedBean4057 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4057.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4057");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4057");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4057");
    }
