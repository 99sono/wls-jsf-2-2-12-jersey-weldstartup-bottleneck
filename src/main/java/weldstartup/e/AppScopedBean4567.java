...
public class AppScopedBean4567 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4567.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4567");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4567");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4567");
    }
