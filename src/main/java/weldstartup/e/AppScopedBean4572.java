...
public class AppScopedBean4572 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4572.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4572");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4572");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4572");
    }
