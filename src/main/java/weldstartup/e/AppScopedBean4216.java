...
public class AppScopedBean4216 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4216.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4216");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4216");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4216");
    }
