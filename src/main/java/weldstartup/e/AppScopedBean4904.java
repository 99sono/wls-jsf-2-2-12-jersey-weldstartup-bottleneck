...
public class AppScopedBean4904 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4904.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4904");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4904");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4904");
    }
