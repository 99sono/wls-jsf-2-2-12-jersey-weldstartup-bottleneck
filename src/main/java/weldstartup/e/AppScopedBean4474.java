...
public class AppScopedBean4474 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4474.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4474");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4474");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4474");
    }
