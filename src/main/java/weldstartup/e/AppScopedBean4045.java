...
public class AppScopedBean4045 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4045.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4045");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4045");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4045");
    }
