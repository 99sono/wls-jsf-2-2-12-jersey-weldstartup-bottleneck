...
public class AppScopedBean4190 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4190.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4190");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4190");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4190");
    }
