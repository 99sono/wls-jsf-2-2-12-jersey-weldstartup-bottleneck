...
public class AppScopedBean4032 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4032.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4032");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4032");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4032");
    }
