...
public class AppScopedBean4038 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4038.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4038");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4038");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4038");
    }
