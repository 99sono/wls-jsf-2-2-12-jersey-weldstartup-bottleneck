...
public class AppScopedBean4358 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4358.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4358");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4358");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4358");
    }
