...
public class AppScopedBean4391 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4391.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4391");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4391");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4391");
    }
