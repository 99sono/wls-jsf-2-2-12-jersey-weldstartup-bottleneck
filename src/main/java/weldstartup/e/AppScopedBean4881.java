...
public class AppScopedBean4881 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4881.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4881");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4881");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4881");
    }
