...
public class AppScopedBean4678 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4678.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4678");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4678");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4678");
    }
