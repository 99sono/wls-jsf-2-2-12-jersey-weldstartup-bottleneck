...
public class AppScopedBean4519 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4519.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4519");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4519");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4519");
    }
