...
public class AppScopedBean4521 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4521.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4521");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4521");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4521");
    }
