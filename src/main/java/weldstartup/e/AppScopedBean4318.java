...
public class AppScopedBean4318 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4318.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4318");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4318");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4318");
    }
