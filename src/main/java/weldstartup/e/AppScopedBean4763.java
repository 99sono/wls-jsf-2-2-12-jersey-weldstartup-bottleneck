...
public class AppScopedBean4763 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4763.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4763");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4763");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4763");
    }
