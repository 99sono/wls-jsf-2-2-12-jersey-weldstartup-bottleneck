...
public class AppScopedBean4428 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4428.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4428");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4428");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4428");
    }
