...
public class AppScopedBean4096 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4096.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4096");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4096");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4096");
    }
