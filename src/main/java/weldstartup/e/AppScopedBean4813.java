...
public class AppScopedBean4813 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4813.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4813");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4813");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4813");
    }
