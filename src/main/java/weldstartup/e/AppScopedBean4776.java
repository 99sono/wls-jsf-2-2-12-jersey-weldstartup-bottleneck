...
public class AppScopedBean4776 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4776.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4776");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4776");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4776");
    }
