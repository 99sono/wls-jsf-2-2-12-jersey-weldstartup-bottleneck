...
public class AppScopedBean4831 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4831.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4831");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4831");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4831");
    }
