...
public class AppScopedBean4361 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4361.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4361");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4361");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4361");
    }
