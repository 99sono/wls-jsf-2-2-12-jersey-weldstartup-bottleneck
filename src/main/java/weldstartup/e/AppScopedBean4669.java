...
public class AppScopedBean4669 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4669.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4669");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4669");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4669");
    }
