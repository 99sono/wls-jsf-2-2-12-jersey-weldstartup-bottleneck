...
public class AppScopedBean4066 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4066.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4066");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4066");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4066");
    }
