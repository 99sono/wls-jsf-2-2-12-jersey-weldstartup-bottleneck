...
public class AppScopedBean4958 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4958.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4958");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4958");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4958");
    }
