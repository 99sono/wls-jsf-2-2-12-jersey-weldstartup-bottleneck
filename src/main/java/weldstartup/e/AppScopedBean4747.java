...
public class AppScopedBean4747 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4747.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4747");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4747");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4747");
    }
