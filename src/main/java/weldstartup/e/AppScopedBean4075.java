...
public class AppScopedBean4075 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4075.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4075");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4075");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4075");
    }
