...
public class AppScopedBean4624 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4624.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4624");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4624");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4624");
    }
