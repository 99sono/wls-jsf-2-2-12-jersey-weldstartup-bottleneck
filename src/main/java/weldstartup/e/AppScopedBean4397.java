...
public class AppScopedBean4397 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4397.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4397");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4397");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4397");
    }
