...
public class AppScopedBean4741 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4741.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4741");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4741");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4741");
    }
