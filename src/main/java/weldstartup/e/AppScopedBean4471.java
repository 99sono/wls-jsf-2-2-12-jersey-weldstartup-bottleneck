...
public class AppScopedBean4471 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4471.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4471");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4471");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4471");
    }
