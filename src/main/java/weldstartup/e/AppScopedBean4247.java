...
public class AppScopedBean4247 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4247.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4247");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4247");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4247");
    }
