...
public class AppScopedBean4591 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4591.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4591");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4591");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4591");
    }
