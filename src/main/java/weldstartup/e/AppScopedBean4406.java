...
public class AppScopedBean4406 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4406.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4406");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4406");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4406");
    }
