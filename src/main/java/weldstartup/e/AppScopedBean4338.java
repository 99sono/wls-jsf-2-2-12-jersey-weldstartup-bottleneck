...
public class AppScopedBean4338 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4338.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4338");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4338");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4338");
    }
