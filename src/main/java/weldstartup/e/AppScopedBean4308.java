...
public class AppScopedBean4308 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4308.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4308");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4308");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4308");
    }
