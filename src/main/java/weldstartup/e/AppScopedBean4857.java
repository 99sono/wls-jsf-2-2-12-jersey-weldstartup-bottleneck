...
public class AppScopedBean4857 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4857.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4857");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4857");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4857");
    }
