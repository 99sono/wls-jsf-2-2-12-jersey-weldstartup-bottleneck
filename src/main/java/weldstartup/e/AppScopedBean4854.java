...
public class AppScopedBean4854 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4854.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4854");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4854");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4854");
    }
