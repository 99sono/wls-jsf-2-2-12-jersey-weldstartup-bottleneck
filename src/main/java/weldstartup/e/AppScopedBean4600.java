...
public class AppScopedBean4600 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4600.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4600");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4600");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4600");
    }
