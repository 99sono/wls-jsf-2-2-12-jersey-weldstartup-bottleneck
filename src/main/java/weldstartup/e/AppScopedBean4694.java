...
public class AppScopedBean4694 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4694.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4694");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4694");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4694");
    }
