...
public class AppScopedBean4469 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4469.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4469");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4469");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4469");
    }
