...
public class AppScopedBean4659 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4659.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4659");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4659");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4659");
    }
