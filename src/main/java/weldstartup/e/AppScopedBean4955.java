...
public class AppScopedBean4955 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4955.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4955");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4955");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4955");
    }
