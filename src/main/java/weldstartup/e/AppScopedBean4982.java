...
public class AppScopedBean4982 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4982.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4982");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4982");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4982");
    }
