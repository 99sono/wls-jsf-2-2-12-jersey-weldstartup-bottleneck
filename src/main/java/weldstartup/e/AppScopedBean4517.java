...
public class AppScopedBean4517 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4517.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4517");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4517");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4517");
    }
