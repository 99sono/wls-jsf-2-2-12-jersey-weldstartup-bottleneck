...
public class AppScopedBean4420 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4420.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4420");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4420");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4420");
    }
