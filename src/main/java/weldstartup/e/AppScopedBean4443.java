...
public class AppScopedBean4443 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4443.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4443");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4443");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4443");
    }
