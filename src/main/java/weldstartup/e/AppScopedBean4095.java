...
public class AppScopedBean4095 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4095.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4095");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4095");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4095");
    }
