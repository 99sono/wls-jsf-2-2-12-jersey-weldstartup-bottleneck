...
public class AppScopedBean4707 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4707.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4707");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4707");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4707");
    }
