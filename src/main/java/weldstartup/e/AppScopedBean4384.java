...
public class AppScopedBean4384 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4384.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4384");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4384");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4384");
    }
