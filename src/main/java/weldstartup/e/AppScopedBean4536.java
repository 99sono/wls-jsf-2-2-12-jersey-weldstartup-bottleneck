...
public class AppScopedBean4536 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4536.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4536");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4536");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4536");
    }
