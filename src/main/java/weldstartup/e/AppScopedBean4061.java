...
public class AppScopedBean4061 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4061.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4061");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4061");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4061");
    }
