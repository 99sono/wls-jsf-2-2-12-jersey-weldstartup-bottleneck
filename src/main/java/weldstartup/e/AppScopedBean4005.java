...
public class AppScopedBean4005 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4005.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4005");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4005");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4005");
    }
