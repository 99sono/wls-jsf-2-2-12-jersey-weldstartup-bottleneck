...
public class AppScopedBean4118 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4118.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4118");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4118");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4118");
    }
