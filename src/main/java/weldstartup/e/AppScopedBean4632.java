...
public class AppScopedBean4632 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4632.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4632");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4632");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4632");
    }
