...
public class AppScopedBean4610 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4610.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4610");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4610");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4610");
    }
