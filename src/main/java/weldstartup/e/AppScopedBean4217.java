...
public class AppScopedBean4217 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4217.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4217");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4217");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4217");
    }
