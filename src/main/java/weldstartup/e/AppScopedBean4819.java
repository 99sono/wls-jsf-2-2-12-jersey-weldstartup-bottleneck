...
public class AppScopedBean4819 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4819.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4819");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4819");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4819");
    }
