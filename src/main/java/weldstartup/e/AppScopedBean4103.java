...
public class AppScopedBean4103 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4103.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4103");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4103");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4103");
    }
