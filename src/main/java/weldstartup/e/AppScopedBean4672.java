...
public class AppScopedBean4672 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4672.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4672");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4672");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4672");
    }
