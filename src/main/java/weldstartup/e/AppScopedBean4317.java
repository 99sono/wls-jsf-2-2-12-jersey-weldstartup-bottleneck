...
public class AppScopedBean4317 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4317.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4317");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4317");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4317");
    }
