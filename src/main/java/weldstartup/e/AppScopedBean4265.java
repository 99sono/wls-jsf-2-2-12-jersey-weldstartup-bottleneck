...
public class AppScopedBean4265 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4265.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4265");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4265");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4265");
    }
