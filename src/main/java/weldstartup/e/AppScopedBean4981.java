...
public class AppScopedBean4981 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4981.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4981");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4981");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4981");
    }
