...
public class AppScopedBean4876 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4876.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4876");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4876");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4876");
    }
