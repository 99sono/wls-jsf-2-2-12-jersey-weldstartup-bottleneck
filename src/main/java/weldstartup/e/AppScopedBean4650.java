...
public class AppScopedBean4650 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4650.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4650");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4650");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4650");
    }
