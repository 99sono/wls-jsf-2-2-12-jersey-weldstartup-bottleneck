...
public class AppScopedBean4638 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4638.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4638");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4638");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4638");
    }
