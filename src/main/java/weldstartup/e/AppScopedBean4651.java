...
public class AppScopedBean4651 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4651.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4651");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4651");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4651");
    }
