...
public class AppScopedBean4760 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4760.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4760");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4760");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4760");
    }
