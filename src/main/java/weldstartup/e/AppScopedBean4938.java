...
public class AppScopedBean4938 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4938.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4938");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4938");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4938");
    }
