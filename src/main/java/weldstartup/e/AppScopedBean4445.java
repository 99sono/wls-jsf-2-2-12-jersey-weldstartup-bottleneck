...
public class AppScopedBean4445 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4445.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4445");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4445");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4445");
    }
