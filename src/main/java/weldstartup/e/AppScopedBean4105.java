...
public class AppScopedBean4105 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4105.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4105");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4105");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4105");
    }
