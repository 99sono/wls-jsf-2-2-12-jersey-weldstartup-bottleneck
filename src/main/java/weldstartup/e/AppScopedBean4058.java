...
public class AppScopedBean4058 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4058.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4058");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4058");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4058");
    }
