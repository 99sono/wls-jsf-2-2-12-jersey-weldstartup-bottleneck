...
public class AppScopedBean4418 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4418.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4418");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4418");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4418");
    }
