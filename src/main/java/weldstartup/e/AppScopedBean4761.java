...
public class AppScopedBean4761 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4761.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4761");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4761");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4761");
    }
