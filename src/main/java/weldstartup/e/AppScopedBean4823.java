...
public class AppScopedBean4823 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4823.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4823");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4823");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4823");
    }
