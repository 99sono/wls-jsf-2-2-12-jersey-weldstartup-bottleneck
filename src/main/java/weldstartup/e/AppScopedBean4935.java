...
public class AppScopedBean4935 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4935.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4935");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4935");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4935");
    }
