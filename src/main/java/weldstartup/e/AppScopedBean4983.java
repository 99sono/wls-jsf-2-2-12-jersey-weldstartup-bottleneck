...
public class AppScopedBean4983 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4983.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4983");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4983");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4983");
    }
