...
public class AppScopedBean4245 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4245.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4245");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4245");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4245");
    }
