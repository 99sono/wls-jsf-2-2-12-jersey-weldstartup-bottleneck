...
public class AppScopedBean4704 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4704.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4704");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4704");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4704");
    }
