...
public class AppScopedBean4377 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4377.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4377");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4377");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4377");
    }
