...
public class AppScopedBean4623 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4623.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4623");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4623");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4623");
    }
