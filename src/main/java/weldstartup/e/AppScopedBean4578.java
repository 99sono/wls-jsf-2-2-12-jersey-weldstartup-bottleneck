...
public class AppScopedBean4578 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4578.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4578");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4578");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4578");
    }
