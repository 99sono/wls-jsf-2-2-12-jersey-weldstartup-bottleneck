...
public class AppScopedBean4513 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4513.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4513");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4513");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4513");
    }
