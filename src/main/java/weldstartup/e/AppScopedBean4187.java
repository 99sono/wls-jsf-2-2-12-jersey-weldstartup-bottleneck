...
public class AppScopedBean4187 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4187.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4187");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4187");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4187");
    }
