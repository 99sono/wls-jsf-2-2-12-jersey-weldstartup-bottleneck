...
public class AppScopedBean4074 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4074.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4074");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4074");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4074");
    }
