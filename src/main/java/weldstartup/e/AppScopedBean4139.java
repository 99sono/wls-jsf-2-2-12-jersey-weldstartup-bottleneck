...
public class AppScopedBean4139 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4139.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4139");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4139");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4139");
    }
