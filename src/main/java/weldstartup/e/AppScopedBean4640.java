...
public class AppScopedBean4640 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4640.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4640");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4640");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4640");
    }
