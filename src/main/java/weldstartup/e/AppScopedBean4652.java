...
public class AppScopedBean4652 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4652.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4652");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4652");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4652");
    }
