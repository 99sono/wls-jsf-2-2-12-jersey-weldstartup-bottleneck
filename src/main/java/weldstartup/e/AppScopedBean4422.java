...
public class AppScopedBean4422 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4422.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4422");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4422");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4422");
    }
