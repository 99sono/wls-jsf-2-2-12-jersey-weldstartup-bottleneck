...
public class AppScopedBean4062 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4062.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4062");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4062");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4062");
    }
