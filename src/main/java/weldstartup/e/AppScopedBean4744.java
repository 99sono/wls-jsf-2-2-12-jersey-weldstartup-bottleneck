...
public class AppScopedBean4744 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4744.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4744");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4744");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4744");
    }
