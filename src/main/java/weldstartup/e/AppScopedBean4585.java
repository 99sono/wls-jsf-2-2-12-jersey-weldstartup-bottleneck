...
public class AppScopedBean4585 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4585.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4585");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4585");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4585");
    }
