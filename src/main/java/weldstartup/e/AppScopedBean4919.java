...
public class AppScopedBean4919 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4919.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4919");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4919");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4919");
    }
