...
public class AppScopedBean4522 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4522.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4522");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4522");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4522");
    }
