...
public class AppScopedBean4146 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4146.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4146");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4146");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4146");
    }
