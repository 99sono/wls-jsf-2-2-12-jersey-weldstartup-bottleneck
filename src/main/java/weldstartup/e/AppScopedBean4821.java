...
public class AppScopedBean4821 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4821.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4821");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4821");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4821");
    }
