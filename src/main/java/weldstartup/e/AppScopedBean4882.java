...
public class AppScopedBean4882 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4882.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4882");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4882");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4882");
    }
