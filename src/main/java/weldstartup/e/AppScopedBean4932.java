...
public class AppScopedBean4932 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4932.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4932");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4932");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4932");
    }
