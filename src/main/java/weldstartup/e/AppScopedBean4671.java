...
public class AppScopedBean4671 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4671.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4671");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4671");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4671");
    }
