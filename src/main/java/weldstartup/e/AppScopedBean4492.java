...
public class AppScopedBean4492 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4492.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4492");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4492");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4492");
    }
