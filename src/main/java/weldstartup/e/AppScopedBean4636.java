...
public class AppScopedBean4636 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4636.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4636");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4636");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4636");
    }
