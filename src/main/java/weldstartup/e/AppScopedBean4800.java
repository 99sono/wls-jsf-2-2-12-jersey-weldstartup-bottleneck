...
public class AppScopedBean4800 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4800.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4800");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4800");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4800");
    }
