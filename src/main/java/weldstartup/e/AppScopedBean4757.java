...
public class AppScopedBean4757 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4757.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4757");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4757");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4757");
    }
