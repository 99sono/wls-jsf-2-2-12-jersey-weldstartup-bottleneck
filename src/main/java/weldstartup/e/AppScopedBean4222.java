...
public class AppScopedBean4222 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4222.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4222");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4222");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4222");
    }
