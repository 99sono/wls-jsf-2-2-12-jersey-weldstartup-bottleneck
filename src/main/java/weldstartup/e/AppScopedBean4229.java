...
public class AppScopedBean4229 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4229.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4229");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4229");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4229");
    }
