...
public class AppScopedBean4894 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4894.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4894");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4894");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4894");
    }
