...
public class AppScopedBean4826 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4826.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4826");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4826");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4826");
    }
