...
public class AppScopedBean4810 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4810.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4810");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4810");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4810");
    }
