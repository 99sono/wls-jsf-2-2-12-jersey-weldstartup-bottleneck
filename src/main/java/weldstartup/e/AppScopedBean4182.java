...
public class AppScopedBean4182 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4182.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4182");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4182");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4182");
    }
