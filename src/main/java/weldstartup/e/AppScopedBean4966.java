...
public class AppScopedBean4966 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4966.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4966");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4966");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4966");
    }
