...
public class AppScopedBean4952 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4952.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4952");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4952");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4952");
    }
