...
public class AppScopedBean4350 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4350.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4350");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4350");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4350");
    }
