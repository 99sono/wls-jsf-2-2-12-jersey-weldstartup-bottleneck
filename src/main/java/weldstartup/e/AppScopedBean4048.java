...
public class AppScopedBean4048 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4048.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4048");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4048");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4048");
    }
