...
public class AppScopedBean4697 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4697.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4697");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4697");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4697");
    }
