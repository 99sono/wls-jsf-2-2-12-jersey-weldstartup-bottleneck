...
public class AppScopedBean4160 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4160.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4160");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4160");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4160");
    }
