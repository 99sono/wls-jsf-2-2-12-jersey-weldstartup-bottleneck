...
public class AppScopedBean4742 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4742.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4742");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4742");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4742");
    }
