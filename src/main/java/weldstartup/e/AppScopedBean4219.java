...
public class AppScopedBean4219 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4219.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4219");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4219");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4219");
    }
