...
public class AppScopedBean4360 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4360.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4360");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4360");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4360");
    }
