...
public class AppScopedBean4091 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4091.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4091");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4091");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4091");
    }
