...
public class AppScopedBean4179 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4179.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4179");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4179");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4179");
    }
