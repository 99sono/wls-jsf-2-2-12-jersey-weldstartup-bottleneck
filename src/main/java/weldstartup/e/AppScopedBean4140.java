...
public class AppScopedBean4140 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4140.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4140");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4140");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4140");
    }
