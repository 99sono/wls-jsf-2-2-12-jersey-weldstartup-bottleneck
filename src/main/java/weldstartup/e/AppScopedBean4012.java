...
public class AppScopedBean4012 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4012.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4012");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4012");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4012");
    }
