...
public class AppScopedBean4664 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4664.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4664");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4664");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4664");
    }
