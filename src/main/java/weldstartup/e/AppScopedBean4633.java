...
public class AppScopedBean4633 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4633.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4633");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4633");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4633");
    }
