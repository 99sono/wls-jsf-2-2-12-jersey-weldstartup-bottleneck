...
public class AppScopedBean4354 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4354.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4354");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4354");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4354");
    }
