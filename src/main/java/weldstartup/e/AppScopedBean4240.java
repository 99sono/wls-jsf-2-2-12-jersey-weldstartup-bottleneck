...
public class AppScopedBean4240 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4240.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4240");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4240");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4240");
    }
