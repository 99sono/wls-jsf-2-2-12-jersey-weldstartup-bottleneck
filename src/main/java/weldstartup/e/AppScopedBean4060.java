...
public class AppScopedBean4060 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4060.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4060");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4060");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4060");
    }
