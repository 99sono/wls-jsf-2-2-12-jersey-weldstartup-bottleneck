...
public class AppScopedBean4405 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4405.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4405");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4405");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4405");
    }
