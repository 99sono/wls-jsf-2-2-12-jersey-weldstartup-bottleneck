...
public class AppScopedBean4490 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4490.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4490");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4490");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4490");
    }
