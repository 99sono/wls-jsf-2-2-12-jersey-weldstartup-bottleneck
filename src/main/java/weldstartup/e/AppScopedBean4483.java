...
public class AppScopedBean4483 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4483.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4483");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4483");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4483");
    }
