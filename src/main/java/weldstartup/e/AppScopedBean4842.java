...
public class AppScopedBean4842 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4842.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4842");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4842");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4842");
    }
