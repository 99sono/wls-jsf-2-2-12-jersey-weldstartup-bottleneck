...
public class AppScopedBean4807 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4807.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4807");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4807");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4807");
    }
