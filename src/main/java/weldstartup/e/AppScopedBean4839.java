...
public class AppScopedBean4839 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4839.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4839");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4839");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4839");
    }
