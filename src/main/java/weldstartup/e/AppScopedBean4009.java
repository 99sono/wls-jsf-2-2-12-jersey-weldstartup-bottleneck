...
public class AppScopedBean4009 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4009.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4009");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4009");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4009");
    }
