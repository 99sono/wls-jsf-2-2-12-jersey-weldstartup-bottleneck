...
public class AppScopedBean4155 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4155.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4155");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4155");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4155");
    }
