...
public class AppScopedBean4367 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4367.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4367");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4367");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4367");
    }
