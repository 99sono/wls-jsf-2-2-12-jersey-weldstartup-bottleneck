...
public class AppScopedBean4706 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4706.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4706");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4706");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4706");
    }
