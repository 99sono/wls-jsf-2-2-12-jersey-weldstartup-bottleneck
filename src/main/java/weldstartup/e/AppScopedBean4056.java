...
public class AppScopedBean4056 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4056.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4056");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4056");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4056");
    }
