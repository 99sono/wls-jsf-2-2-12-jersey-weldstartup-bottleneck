...
public class AppScopedBean4641 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4641.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4641");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4641");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4641");
    }
