...
public class AppScopedBean4603 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4603.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4603");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4603");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4603");
    }
