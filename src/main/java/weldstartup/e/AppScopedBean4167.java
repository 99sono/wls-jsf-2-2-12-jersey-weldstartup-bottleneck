...
public class AppScopedBean4167 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4167.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4167");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4167");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4167");
    }
