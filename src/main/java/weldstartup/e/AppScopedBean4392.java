...
public class AppScopedBean4392 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4392.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4392");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4392");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4392");
    }
