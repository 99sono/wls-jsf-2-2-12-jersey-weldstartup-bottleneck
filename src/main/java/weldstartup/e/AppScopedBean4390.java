...
public class AppScopedBean4390 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4390.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4390");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4390");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4390");
    }
