...
public class AppScopedBean4957 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4957.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4957");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4957");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4957");
    }
