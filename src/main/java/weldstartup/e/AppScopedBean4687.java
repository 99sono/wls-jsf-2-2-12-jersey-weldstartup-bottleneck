...
public class AppScopedBean4687 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4687.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4687");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4687");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4687");
    }
