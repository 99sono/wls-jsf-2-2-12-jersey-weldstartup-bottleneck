...
public class AppScopedBean4817 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4817.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4817");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4817");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4817");
    }
