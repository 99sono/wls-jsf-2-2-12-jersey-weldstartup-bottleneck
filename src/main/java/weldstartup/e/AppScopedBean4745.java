...
public class AppScopedBean4745 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4745.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4745");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4745");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4745");
    }
