...
public class AppScopedBean4847 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4847.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4847");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4847");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4847");
    }
