...
public class AppScopedBean4502 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4502.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4502");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4502");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4502");
    }
