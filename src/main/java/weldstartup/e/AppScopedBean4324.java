...
public class AppScopedBean4324 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4324.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4324");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4324");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4324");
    }
