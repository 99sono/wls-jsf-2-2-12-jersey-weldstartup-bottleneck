...
public class AppScopedBean4351 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4351.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4351");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4351");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4351");
    }
