...
public class AppScopedBean4220 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4220.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4220");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4220");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4220");
    }
