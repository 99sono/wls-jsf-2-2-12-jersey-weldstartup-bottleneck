...
public class AppScopedBean4710 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4710.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4710");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4710");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4710");
    }
