...
public class AppScopedBean4449 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4449.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4449");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4449");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4449");
    }
