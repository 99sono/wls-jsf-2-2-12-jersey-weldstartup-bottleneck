...
public class AppScopedBean4937 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4937.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4937");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4937");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4937");
    }
