...
public class AppScopedBean4441 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4441.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4441");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4441");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4441");
    }
