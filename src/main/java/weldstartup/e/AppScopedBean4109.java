...
public class AppScopedBean4109 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4109.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4109");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4109");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4109");
    }
