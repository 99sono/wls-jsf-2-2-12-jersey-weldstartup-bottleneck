...
public class AppScopedBean4507 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4507.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4507");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4507");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4507");
    }
