...
public class AppScopedBean4402 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4402.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4402");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4402");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4402");
    }
