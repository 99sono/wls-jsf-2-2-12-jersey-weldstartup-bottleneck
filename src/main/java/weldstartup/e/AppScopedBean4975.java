...
public class AppScopedBean4975 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4975.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4975");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4975");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4975");
    }
