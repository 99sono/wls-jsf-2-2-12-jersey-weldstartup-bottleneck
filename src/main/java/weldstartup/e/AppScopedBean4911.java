...
public class AppScopedBean4911 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4911.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4911");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4911");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4911");
    }
