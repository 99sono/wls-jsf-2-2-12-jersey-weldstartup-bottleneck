...
public class AppScopedBean4577 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4577.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4577");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4577");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4577");
    }
