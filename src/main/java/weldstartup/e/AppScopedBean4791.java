...
public class AppScopedBean4791 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4791.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4791");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4791");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4791");
    }
