...
public class AppScopedBean4425 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4425.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4425");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4425");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4425");
    }
