...
public class AppScopedBean4444 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4444.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4444");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4444");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4444");
    }
