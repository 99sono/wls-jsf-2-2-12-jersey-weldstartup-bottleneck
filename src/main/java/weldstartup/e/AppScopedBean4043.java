...
public class AppScopedBean4043 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4043.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4043");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4043");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4043");
    }
