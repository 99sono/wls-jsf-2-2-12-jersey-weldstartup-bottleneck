...
public class AppScopedBean4794 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4794.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4794");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4794");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4794");
    }
