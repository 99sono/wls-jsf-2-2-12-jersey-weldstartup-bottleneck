...
public class AppScopedBean4702 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4702.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4702");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4702");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4702");
    }
