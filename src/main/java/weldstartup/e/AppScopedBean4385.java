...
public class AppScopedBean4385 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4385.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4385");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4385");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4385");
    }
