...
public class AppScopedBean4829 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4829.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4829");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4829");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4829");
    }
