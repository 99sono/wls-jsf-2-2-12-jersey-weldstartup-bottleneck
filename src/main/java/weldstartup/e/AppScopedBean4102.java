...
public class AppScopedBean4102 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4102.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4102");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4102");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4102");
    }
