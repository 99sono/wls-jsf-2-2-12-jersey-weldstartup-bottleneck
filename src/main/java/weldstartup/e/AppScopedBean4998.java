...
public class AppScopedBean4998 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4998.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4998");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4998");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4998");
    }
