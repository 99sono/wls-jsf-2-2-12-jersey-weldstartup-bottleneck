...
public class AppScopedBean4295 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4295.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4295");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4295");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4295");
    }
