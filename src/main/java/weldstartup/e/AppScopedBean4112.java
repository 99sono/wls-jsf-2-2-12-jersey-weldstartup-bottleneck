...
public class AppScopedBean4112 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4112.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4112");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4112");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4112");
    }
