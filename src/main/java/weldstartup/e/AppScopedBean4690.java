...
public class AppScopedBean4690 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4690.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4690");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4690");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4690");
    }
