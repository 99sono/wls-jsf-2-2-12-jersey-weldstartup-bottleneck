...
public class AppScopedBean4106 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4106.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4106");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4106");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4106");
    }
