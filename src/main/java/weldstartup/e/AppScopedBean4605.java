...
public class AppScopedBean4605 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4605.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4605");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4605");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4605");
    }
