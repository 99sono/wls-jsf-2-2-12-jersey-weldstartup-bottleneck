...
public class AppScopedBean4271 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4271.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4271");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4271");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4271");
    }
