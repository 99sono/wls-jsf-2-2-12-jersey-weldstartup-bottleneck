...
public class AppScopedBean4303 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4303.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4303");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4303");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4303");
    }
