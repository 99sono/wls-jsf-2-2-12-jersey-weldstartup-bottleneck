...
public class AppScopedBean4723 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4723.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4723");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4723");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4723");
    }
