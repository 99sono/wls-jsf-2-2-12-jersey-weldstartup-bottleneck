...
public class AppScopedBean4762 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4762.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4762");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4762");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4762");
    }
