...
public class AppScopedBean4920 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4920.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4920");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4920");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4920");
    }
