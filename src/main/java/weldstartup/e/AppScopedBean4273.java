...
public class AppScopedBean4273 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4273.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4273");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4273");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4273");
    }
