...
public class AppScopedBean4132 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4132.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4132");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4132");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4132");
    }
