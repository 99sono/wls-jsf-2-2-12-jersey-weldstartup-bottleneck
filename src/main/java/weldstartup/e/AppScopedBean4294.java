...
public class AppScopedBean4294 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4294.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4294");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4294");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4294");
    }
