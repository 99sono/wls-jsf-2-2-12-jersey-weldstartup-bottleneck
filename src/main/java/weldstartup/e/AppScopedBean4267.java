...
public class AppScopedBean4267 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4267.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4267");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4267");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4267");
    }
