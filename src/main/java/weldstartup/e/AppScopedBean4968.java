...
public class AppScopedBean4968 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4968.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4968");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4968");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4968");
    }
