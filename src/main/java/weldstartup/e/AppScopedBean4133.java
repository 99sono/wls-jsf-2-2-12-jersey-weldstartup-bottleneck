...
public class AppScopedBean4133 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4133.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4133");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4133");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4133");
    }
