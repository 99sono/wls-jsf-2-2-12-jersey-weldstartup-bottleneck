...
public class AppScopedBean4615 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4615.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4615");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4615");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4615");
    }
