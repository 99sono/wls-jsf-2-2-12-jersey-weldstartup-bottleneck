...
public class AppScopedBean4614 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4614.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4614");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4614");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4614");
    }
