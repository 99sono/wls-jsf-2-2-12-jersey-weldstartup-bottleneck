...
public class AppScopedBean4805 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4805.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4805");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4805");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4805");
    }
