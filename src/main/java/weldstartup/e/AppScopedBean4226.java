...
public class AppScopedBean4226 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4226.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4226");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4226");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4226");
    }
