...
public class AppScopedBean4941 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4941.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4941");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4941");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4941");
    }
