...
public class AppScopedBean4661 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4661.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4661");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4661");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4661");
    }
