...
public class AppScopedBean4714 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4714.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4714");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4714");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4714");
    }
