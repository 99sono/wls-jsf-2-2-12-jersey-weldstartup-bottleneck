...
public class AppScopedBean4168 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4168.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4168");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4168");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4168");
    }
