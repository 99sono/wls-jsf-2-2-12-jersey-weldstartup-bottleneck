...
public class AppScopedBean4286 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4286.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4286");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4286");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4286");
    }
