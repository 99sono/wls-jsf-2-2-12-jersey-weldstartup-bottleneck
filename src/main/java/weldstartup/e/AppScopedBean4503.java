...
public class AppScopedBean4503 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4503.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4503");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4503");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4503");
    }
