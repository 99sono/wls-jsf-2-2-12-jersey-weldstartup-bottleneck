...
public class AppScopedBean4987 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4987.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4987");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4987");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4987");
    }
