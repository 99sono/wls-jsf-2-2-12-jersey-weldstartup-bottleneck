...
public class AppScopedBean4236 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4236.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4236");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4236");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4236");
    }
