...
public class AppScopedBean4569 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4569.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4569");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4569");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4569");
    }
