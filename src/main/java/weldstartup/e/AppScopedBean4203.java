...
public class AppScopedBean4203 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4203.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4203");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4203");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4203");
    }
