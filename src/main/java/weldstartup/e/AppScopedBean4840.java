...
public class AppScopedBean4840 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4840.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4840");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4840");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4840");
    }
