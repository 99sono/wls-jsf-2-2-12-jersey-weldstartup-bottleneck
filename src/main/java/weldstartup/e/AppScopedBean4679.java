...
public class AppScopedBean4679 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4679.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4679");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4679");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4679");
    }
