...
public class AppScopedBean4910 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4910.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4910");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4910");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4910");
    }
