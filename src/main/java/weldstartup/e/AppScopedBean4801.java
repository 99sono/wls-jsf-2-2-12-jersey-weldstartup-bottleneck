...
public class AppScopedBean4801 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4801.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4801");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4801");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4801");
    }
