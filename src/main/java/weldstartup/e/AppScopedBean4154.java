...
public class AppScopedBean4154 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4154.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4154");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4154");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4154");
    }
