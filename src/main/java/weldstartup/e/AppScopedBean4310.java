...
public class AppScopedBean4310 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4310.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4310");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4310");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4310");
    }
