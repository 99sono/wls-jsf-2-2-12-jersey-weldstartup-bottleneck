...
public class AppScopedBean4915 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4915.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4915");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4915");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4915");
    }
