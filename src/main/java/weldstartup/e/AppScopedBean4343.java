...
public class AppScopedBean4343 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4343.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4343");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4343");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4343");
    }
