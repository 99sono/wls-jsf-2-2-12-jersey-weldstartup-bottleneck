...
public class AppScopedBean4166 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4166.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4166");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4166");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4166");
    }
