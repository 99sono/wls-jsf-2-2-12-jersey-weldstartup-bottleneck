...
public class AppScopedBean4946 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4946.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4946");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4946");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4946");
    }
