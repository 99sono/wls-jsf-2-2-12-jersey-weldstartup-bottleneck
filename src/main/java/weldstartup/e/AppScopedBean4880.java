...
public class AppScopedBean4880 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4880.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4880");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4880");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4880");
    }
