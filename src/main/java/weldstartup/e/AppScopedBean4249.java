...
public class AppScopedBean4249 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4249.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4249");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4249");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4249");
    }
