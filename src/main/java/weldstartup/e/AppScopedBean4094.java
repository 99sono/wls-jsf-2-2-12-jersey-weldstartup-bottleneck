...
public class AppScopedBean4094 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4094.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4094");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4094");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4094");
    }
