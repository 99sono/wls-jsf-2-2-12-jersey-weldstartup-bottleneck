...
public class AppScopedBean4918 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4918.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4918");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4918");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4918");
    }
