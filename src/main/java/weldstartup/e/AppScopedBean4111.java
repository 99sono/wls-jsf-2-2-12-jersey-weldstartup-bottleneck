...
public class AppScopedBean4111 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4111.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4111");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4111");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4111");
    }
