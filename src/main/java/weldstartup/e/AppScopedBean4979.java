...
public class AppScopedBean4979 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4979.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4979");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4979");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4979");
    }
