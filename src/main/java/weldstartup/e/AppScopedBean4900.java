...
public class AppScopedBean4900 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4900.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4900");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4900");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4900");
    }
