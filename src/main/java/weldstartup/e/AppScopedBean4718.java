...
public class AppScopedBean4718 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4718.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4718");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4718");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4718");
    }
