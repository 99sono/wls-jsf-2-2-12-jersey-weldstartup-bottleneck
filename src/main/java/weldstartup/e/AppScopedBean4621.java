...
public class AppScopedBean4621 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4621.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4621");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4621");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4621");
    }
