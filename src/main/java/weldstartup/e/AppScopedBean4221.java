...
public class AppScopedBean4221 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4221.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4221");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4221");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4221");
    }
