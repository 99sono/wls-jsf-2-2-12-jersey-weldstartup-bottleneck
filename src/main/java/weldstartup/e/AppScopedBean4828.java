...
public class AppScopedBean4828 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4828.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4828");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4828");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4828");
    }
