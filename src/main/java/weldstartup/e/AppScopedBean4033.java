...
public class AppScopedBean4033 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4033.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4033");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4033");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4033");
    }
