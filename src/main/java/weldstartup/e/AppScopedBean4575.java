...
public class AppScopedBean4575 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4575.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4575");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4575");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4575");
    }
