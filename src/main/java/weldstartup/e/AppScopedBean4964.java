...
public class AppScopedBean4964 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4964.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4964");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4964");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4964");
    }
