...
public class AppScopedBean4208 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4208.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4208");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4208");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4208");
    }
