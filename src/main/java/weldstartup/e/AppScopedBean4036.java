...
public class AppScopedBean4036 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4036.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4036");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4036");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4036");
    }
