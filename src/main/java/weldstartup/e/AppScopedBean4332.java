...
public class AppScopedBean4332 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4332.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4332");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4332");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4332");
    }
