...
public class AppScopedBean4363 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4363.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4363");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4363");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4363");
    }
