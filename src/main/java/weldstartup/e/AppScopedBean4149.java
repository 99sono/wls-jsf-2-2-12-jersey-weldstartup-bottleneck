...
public class AppScopedBean4149 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4149.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4149");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4149");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4149");
    }
