...
public class AppScopedBean4484 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4484.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4484");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4484");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4484");
    }
