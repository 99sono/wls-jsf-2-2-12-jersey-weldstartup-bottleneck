...
public class AppScopedBean4948 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4948.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4948");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4948");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4948");
    }
