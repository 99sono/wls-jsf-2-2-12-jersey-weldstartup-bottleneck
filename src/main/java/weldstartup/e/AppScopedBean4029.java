...
public class AppScopedBean4029 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4029.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4029");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4029");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4029");
    }
