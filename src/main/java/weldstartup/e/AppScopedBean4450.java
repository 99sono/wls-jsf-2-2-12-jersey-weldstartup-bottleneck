...
public class AppScopedBean4450 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4450.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4450");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4450");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4450");
    }
