...
public class AppScopedBean4475 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4475.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4475");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4475");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4475");
    }
