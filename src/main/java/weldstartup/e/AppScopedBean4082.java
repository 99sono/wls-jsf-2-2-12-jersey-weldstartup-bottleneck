...
public class AppScopedBean4082 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4082.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4082");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4082");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4082");
    }
