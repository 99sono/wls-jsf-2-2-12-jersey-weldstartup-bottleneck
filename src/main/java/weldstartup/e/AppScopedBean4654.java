...
public class AppScopedBean4654 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4654.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4654");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4654");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4654");
    }
