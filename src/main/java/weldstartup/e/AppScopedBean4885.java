...
public class AppScopedBean4885 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4885.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4885");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4885");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4885");
    }
