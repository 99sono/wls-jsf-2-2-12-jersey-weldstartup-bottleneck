...
public class AppScopedBean4728 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4728.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4728");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4728");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4728");
    }
