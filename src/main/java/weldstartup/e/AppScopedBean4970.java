...
public class AppScopedBean4970 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4970.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4970");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4970");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4970");
    }
