...
public class AppScopedBean4021 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4021.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4021");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4021");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4021");
    }
