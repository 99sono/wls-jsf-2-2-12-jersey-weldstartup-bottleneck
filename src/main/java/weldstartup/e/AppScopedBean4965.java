...
public class AppScopedBean4965 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4965.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4965");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4965");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4965");
    }
