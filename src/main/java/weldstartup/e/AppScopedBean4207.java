...
public class AppScopedBean4207 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4207.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4207");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4207");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4207");
    }
