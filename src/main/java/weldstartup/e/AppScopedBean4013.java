...
public class AppScopedBean4013 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4013.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4013");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4013");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4013");
    }
