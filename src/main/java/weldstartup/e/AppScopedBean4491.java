...
public class AppScopedBean4491 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4491.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4491");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4491");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4491");
    }
