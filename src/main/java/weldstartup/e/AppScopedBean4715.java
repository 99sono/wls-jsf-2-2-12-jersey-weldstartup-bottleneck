...
public class AppScopedBean4715 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4715.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4715");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4715");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4715");
    }
