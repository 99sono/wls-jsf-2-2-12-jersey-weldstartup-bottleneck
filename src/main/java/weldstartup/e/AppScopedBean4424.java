...
public class AppScopedBean4424 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4424.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4424");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4424");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4424");
    }
