...
public class AppScopedBean4515 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4515.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4515");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4515");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4515");
    }
