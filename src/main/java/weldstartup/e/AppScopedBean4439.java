...
public class AppScopedBean4439 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4439.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4439");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4439");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4439");
    }
