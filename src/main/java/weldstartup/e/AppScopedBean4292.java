...
public class AppScopedBean4292 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4292.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4292");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4292");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4292");
    }
