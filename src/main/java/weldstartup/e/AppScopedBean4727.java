...
public class AppScopedBean4727 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4727.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4727");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4727");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4727");
    }
