...
public class AppScopedBean4342 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4342.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4342");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4342");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4342");
    }
