...
public class AppScopedBean4054 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4054.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4054");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4054");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4054");
    }
