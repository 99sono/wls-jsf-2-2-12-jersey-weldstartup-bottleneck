...
public class AppScopedBean4973 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4973.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4973");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4973");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4973");
    }
