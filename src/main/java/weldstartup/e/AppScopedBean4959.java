...
public class AppScopedBean4959 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4959.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4959");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4959");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4959");
    }
