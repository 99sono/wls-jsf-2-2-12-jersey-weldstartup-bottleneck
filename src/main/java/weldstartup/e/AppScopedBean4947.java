...
public class AppScopedBean4947 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4947.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4947");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4947");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4947");
    }
