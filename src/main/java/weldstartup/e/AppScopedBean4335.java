...
public class AppScopedBean4335 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4335.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4335");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4335");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4335");
    }
