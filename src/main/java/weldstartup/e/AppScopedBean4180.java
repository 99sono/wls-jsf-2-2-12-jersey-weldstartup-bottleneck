...
public class AppScopedBean4180 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4180.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4180");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4180");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4180");
    }
