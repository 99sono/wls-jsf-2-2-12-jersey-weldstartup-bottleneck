...
public class AppScopedBean4200 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4200.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4200");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4200");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4200");
    }
