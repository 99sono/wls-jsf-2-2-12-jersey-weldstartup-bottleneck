...
public class AppScopedBean4063 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4063.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4063");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4063");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4063");
    }
