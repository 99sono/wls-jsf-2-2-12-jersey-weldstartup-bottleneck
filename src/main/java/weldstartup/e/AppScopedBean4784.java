...
public class AppScopedBean4784 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4784.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4784");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4784");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4784");
    }
