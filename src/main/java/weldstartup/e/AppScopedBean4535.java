...
public class AppScopedBean4535 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4535.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4535");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4535");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4535");
    }
