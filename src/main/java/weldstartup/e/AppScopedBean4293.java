...
public class AppScopedBean4293 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4293.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4293");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4293");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4293");
    }
