...
public class AppScopedBean4599 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4599.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4599");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4599");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4599");
    }
