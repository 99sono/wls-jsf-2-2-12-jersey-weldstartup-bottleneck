...
public class AppScopedBean4436 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4436.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4436");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4436");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4436");
    }
