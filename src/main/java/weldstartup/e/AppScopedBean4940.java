...
public class AppScopedBean4940 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4940.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4940");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4940");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4940");
    }
