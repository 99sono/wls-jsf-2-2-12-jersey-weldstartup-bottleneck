...
public class AppScopedBean4934 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4934.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4934");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4934");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4934");
    }
