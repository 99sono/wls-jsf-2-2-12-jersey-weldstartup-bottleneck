...
public class AppScopedBean4453 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4453.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4453");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4453");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4453");
    }
