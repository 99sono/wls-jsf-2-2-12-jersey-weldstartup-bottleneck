...
public class AppScopedBean4119 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4119.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4119");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4119");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4119");
    }
