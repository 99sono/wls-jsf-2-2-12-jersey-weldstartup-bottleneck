...
public class AppScopedBean4869 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4869.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4869");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4869");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4869");
    }
