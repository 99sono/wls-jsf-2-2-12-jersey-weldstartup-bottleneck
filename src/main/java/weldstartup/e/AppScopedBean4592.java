...
public class AppScopedBean4592 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4592.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4592");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4592");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4592");
    }
