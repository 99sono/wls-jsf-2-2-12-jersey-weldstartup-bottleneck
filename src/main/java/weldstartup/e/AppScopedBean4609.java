...
public class AppScopedBean4609 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4609.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4609");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4609");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4609");
    }
