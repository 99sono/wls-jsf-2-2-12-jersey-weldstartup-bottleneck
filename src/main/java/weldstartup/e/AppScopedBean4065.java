...
public class AppScopedBean4065 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4065.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4065");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4065");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4065");
    }
