...
public class AppScopedBean4466 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4466.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4466");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4466");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4466");
    }
