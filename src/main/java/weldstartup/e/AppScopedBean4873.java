...
public class AppScopedBean4873 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4873.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4873");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4873");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4873");
    }
