...
public class AppScopedBean4042 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4042.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4042");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4042");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4042");
    }
