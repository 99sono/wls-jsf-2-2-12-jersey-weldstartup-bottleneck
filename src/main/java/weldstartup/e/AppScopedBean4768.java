...
public class AppScopedBean4768 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4768.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4768");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4768");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4768");
    }
