...
public class AppScopedBean4375 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4375.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4375");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4375");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4375");
    }
