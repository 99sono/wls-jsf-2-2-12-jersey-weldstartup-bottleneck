...
public class AppScopedBean4235 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4235.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4235");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4235");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4235");
    }
