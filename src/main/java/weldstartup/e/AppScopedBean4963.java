...
public class AppScopedBean4963 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4963.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4963");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4963");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4963");
    }
