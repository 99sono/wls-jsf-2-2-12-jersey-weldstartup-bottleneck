...
public class AppScopedBean4472 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4472.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4472");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4472");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4472");
    }
