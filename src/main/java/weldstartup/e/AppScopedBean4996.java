...
public class AppScopedBean4996 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4996.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4996");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4996");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4996");
    }
