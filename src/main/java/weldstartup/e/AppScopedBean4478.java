...
public class AppScopedBean4478 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4478.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4478");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4478");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4478");
    }
