...
public class AppScopedBean4108 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4108.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4108");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4108");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4108");
    }
