...
public class AppScopedBean4902 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4902.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4902");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4902");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4902");
    }
