...
public class AppScopedBean4380 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4380.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4380");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4380");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4380");
    }
