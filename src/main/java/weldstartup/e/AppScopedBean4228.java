...
public class AppScopedBean4228 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4228.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4228");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4228");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4228");
    }
