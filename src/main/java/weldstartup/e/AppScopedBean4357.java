...
public class AppScopedBean4357 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4357.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4357");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4357");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4357");
    }
