...
public class AppScopedBean4020 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4020.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4020");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4020");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4020");
    }
