...
public class AppScopedBean4883 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4883.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4883");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4883");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4883");
    }
