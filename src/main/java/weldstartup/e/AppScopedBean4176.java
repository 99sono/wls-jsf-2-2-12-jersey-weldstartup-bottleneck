...
public class AppScopedBean4176 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4176.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4176");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4176");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4176");
    }
