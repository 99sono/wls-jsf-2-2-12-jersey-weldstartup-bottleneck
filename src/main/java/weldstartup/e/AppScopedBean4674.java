...
public class AppScopedBean4674 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4674.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4674");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4674");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4674");
    }
