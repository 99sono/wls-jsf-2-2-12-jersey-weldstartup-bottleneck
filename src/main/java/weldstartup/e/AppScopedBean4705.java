...
public class AppScopedBean4705 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4705.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4705");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4705");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4705");
    }
