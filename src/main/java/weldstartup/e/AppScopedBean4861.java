...
public class AppScopedBean4861 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4861.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4861");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4861");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4861");
    }
