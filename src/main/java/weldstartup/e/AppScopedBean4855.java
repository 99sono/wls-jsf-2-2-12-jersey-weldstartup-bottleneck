...
public class AppScopedBean4855 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4855.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4855");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4855");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4855");
    }
