...
public class AppScopedBean4494 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4494.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4494");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4494");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4494");
    }
