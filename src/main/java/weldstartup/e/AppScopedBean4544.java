...
public class AppScopedBean4544 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4544.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4544");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4544");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4544");
    }
