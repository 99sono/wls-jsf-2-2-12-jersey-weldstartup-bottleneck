...
public class AppScopedBean4852 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4852.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4852");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4852");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4852");
    }
