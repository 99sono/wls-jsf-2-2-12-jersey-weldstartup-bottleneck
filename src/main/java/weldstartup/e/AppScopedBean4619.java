...
public class AppScopedBean4619 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4619.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4619");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4619");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4619");
    }
