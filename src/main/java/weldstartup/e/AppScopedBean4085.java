...
public class AppScopedBean4085 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4085.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4085");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4085");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4085");
    }
