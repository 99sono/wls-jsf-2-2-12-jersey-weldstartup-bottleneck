...
public class AppScopedBean4175 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4175.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4175");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4175");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4175");
    }
