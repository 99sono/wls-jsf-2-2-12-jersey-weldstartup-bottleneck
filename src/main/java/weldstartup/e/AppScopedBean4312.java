...
public class AppScopedBean4312 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4312.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4312");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4312");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4312");
    }
