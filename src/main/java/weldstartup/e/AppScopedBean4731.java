...
public class AppScopedBean4731 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4731.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4731");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4731");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4731");
    }
