...
public class AppScopedBean4576 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4576.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4576");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4576");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4576");
    }
