...
public class AppScopedBean4371 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4371.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4371");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4371");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4371");
    }
