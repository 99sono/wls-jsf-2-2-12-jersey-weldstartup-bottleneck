...
public class AppScopedBean4945 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4945.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4945");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4945");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4945");
    }
