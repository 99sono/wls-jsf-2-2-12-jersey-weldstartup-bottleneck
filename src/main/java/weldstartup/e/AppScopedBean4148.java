...
public class AppScopedBean4148 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4148.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4148");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4148");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4148");
    }
