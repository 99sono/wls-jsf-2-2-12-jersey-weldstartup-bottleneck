...
public class AppScopedBean4010 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4010.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4010");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4010");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4010");
    }
