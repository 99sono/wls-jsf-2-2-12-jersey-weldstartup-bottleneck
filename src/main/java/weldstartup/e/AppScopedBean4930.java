...
public class AppScopedBean4930 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4930.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4930");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4930");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4930");
    }
