...
public class AppScopedBean4301 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4301.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4301");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4301");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4301");
    }
