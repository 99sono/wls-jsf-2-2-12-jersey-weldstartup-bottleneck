...
public class AppScopedBean4681 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4681.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4681");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4681");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4681");
    }
