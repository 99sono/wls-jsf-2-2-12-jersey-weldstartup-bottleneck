...
public class AppScopedBean4799 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4799.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4799");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4799");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4799");
    }
