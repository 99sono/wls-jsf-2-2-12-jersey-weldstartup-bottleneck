...
public class AppScopedBean4552 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4552.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4552");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4552");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4552");
    }
