...
public class AppScopedBean4649 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4649.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4649");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4649");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4649");
    }
