...
public class AppScopedBean4238 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4238.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4238");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4238");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4238");
    }
