...
public class AppScopedBean4211 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4211.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4211");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4211");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4211");
    }
