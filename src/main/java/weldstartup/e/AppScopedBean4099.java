...
public class AppScopedBean4099 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4099.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4099");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4099");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4099");
    }
