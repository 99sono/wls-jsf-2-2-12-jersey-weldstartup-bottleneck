...
public class AppScopedBean4767 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4767.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4767");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4767");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4767");
    }
