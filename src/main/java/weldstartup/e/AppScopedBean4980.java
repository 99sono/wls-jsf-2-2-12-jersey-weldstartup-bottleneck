...
public class AppScopedBean4980 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4980.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4980");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4980");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4980");
    }
