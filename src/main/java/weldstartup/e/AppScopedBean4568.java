...
public class AppScopedBean4568 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4568.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4568");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4568");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4568");
    }
