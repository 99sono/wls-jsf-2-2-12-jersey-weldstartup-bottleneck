...
public class AppScopedBean4356 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4356.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4356");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4356");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4356");
    }
