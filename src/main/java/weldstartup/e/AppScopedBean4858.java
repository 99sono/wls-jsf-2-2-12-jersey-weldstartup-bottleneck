...
public class AppScopedBean4858 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4858.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4858");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4858");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4858");
    }
