...
public class AppScopedBean4504 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4504.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4504");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4504");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4504");
    }
