...
public class AppScopedBean4272 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4272.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4272");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4272");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4272");
    }
