...
public class AppScopedBean4381 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4381.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4381");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4381");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4381");
    }
