...
public class AppScopedBean4993 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4993.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4993");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4993");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4993");
    }
