...
public class AppScopedBean4597 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4597.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4597");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4597");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4597");
    }
