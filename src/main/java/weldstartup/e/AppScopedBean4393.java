...
public class AppScopedBean4393 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4393.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4393");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4393");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4393");
    }
