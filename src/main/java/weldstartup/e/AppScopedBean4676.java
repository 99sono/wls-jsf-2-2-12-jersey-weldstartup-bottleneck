...
public class AppScopedBean4676 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4676.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4676");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4676");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4676");
    }
