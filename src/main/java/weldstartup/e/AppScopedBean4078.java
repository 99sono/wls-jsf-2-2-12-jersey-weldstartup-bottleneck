...
public class AppScopedBean4078 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4078.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4078");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4078");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4078");
    }
