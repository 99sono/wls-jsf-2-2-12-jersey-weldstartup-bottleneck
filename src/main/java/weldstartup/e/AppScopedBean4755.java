...
public class AppScopedBean4755 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4755.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4755");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4755");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4755");
    }
