...
public class AppScopedBean4523 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4523.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4523");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4523");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4523");
    }
