...
public class AppScopedBean4912 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4912.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4912");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4912");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4912");
    }
