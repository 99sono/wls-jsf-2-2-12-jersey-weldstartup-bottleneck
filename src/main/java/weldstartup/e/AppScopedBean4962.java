...
public class AppScopedBean4962 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4962.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4962");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4962");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4962");
    }
