...
public class AppScopedBean4409 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4409.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4409");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4409");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4409");
    }
