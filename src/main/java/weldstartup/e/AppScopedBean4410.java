...
public class AppScopedBean4410 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4410.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4410");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4410");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4410");
    }
