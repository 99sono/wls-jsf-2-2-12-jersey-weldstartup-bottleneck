...
public class AppScopedBean4991 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4991.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4991");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4991");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4991");
    }
