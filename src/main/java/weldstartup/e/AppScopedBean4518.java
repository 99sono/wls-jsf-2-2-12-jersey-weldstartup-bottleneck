...
public class AppScopedBean4518 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4518.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4518");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4518");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4518");
    }
