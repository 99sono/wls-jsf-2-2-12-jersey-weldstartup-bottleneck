...
public class AppScopedBean4282 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4282.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4282");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4282");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4282");
    }
