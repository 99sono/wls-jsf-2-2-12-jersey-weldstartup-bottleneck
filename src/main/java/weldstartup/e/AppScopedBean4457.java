...
public class AppScopedBean4457 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4457.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4457");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4457");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4457");
    }
