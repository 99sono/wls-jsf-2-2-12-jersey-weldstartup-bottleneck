...
public class AppScopedBean4716 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4716.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4716");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4716");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4716");
    }
