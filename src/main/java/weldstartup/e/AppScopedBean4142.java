...
public class AppScopedBean4142 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4142.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4142");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4142");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4142");
    }
