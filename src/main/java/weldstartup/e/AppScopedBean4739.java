...
public class AppScopedBean4739 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4739.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4739");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4739");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4739");
    }
