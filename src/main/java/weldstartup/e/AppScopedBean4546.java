...
public class AppScopedBean4546 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4546.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4546");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4546");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4546");
    }
