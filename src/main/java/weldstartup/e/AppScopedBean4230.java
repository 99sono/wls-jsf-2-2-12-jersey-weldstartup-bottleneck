...
public class AppScopedBean4230 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4230.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4230");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4230");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4230");
    }
