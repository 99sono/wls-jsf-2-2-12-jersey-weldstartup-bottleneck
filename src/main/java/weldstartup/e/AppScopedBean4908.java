...
public class AppScopedBean4908 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4908.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4908");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4908");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4908");
    }
