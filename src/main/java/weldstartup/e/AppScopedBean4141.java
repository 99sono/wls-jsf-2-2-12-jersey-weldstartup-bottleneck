...
public class AppScopedBean4141 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4141.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4141");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4141");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4141");
    }
