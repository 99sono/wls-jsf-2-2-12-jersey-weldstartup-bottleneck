...
public class AppScopedBean4778 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4778.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4778");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4778");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4778");
    }
