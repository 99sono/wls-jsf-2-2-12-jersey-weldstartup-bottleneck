...
public class AppScopedBean4897 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4897.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4897");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4897");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4897");
    }
