...
public class AppScopedBean4888 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4888.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4888");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4888");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4888");
    }
