...
public class AppScopedBean4415 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4415.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4415");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4415");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4415");
    }
