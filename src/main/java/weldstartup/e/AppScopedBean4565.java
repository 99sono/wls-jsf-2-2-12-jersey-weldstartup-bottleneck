...
public class AppScopedBean4565 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4565.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4565");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4565");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4565");
    }
