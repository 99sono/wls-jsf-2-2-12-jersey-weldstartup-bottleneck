...
public class AppScopedBean4670 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4670.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4670");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4670");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4670");
    }
