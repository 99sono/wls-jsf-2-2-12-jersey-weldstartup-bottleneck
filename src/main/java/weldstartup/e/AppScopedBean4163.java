...
public class AppScopedBean4163 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4163.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4163");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4163");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4163");
    }
