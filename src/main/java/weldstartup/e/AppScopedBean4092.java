...
public class AppScopedBean4092 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4092.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4092");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4092");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4092");
    }
