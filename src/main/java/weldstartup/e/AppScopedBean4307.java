...
public class AppScopedBean4307 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4307.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4307");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4307");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4307");
    }
