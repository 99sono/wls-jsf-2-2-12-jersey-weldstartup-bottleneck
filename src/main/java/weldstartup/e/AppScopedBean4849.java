...
public class AppScopedBean4849 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4849.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4849");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4849");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4849");
    }
