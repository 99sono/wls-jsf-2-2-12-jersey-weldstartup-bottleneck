...
public class AppScopedBean4703 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4703.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4703");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4703");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4703");
    }
