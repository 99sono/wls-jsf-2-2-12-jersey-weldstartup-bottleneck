...
public class AppScopedBean4708 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4708.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4708");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4708");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4708");
    }
