...
public class AppScopedBean4161 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4161.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4161");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4161");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4161");
    }
