...
public class AppScopedBean4833 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4833.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4833");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4833");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4833");
    }
