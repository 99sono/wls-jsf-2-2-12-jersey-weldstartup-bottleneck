...
public class AppScopedBean4242 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4242.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4242");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4242");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4242");
    }
