...
public class AppScopedBean4989 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4989.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4989");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4989");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4989");
    }
