...
public class AppScopedBean4344 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4344.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4344");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4344");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4344");
    }
