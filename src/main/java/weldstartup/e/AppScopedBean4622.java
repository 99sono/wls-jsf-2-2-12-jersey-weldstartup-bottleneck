...
public class AppScopedBean4622 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4622.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4622");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4622");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4622");
    }
