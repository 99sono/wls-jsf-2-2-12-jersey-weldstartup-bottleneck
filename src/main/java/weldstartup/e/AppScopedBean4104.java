...
public class AppScopedBean4104 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4104.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4104");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4104");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4104");
    }
