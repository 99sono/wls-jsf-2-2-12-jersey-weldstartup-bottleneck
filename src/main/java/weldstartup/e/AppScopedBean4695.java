...
public class AppScopedBean4695 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4695.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4695");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4695");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4695");
    }
