...
public class AppScopedBean4499 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4499.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4499");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4499");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4499");
    }
