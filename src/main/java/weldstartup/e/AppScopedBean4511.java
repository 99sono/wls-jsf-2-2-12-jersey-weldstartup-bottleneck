...
public class AppScopedBean4511 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4511.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4511");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4511");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4511");
    }
