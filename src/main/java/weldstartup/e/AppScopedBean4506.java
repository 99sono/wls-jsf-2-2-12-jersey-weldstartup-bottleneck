...
public class AppScopedBean4506 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4506.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4506");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4506");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4506");
    }
