...
public class AppScopedBean4788 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4788.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4788");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4788");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4788");
    }
