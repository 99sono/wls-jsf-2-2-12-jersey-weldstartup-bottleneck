...
public class AppScopedBean4386 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4386.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4386");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4386");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4386");
    }
