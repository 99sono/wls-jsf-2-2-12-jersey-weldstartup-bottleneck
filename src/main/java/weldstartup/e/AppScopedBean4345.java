...
public class AppScopedBean4345 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4345.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4345");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4345");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4345");
    }
