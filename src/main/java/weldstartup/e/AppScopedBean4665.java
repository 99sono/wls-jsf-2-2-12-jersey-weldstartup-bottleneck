...
public class AppScopedBean4665 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4665.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4665");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4665");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4665");
    }
