...
public class AppScopedBean4789 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4789.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4789");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4789");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4789");
    }
