...
public class AppScopedBean4248 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4248.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4248");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4248");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4248");
    }
