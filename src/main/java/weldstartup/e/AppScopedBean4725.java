...
public class AppScopedBean4725 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4725.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4725");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4725");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4725");
    }
