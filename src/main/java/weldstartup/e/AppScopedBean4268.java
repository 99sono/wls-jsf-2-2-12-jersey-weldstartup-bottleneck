...
public class AppScopedBean4268 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4268.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4268");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4268");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4268");
    }
