...
public class AppScopedBean4635 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4635.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4635");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4635");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4635");
    }
