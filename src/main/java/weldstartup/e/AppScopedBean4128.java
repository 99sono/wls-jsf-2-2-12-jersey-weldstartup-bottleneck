...
public class AppScopedBean4128 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4128.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4128");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4128");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4128");
    }
