...
public class AppScopedBean4586 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4586.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4586");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4586");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4586");
    }
