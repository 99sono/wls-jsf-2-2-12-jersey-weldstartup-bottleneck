...
public class AppScopedBean4574 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4574.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4574");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4574");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4574");
    }
