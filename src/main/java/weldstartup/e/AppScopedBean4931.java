...
public class AppScopedBean4931 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4931.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4931");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4931");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4931");
    }
