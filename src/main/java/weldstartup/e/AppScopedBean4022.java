...
public class AppScopedBean4022 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4022.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4022");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4022");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4022");
    }
