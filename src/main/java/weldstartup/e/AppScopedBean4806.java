...
public class AppScopedBean4806 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4806.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4806");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4806");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4806");
    }
