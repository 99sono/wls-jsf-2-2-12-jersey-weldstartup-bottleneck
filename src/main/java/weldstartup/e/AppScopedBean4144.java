...
public class AppScopedBean4144 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4144.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4144");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4144");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4144");
    }
