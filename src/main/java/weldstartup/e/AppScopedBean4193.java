...
public class AppScopedBean4193 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4193.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4193");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4193");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4193");
    }
