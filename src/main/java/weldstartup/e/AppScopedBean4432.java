...
public class AppScopedBean4432 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4432.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4432");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4432");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4432");
    }
