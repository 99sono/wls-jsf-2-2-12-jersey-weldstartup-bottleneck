...
public class AppScopedBean4408 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4408.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4408");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4408");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4408");
    }
