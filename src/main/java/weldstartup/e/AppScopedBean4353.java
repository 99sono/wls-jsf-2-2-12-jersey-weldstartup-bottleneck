...
public class AppScopedBean4353 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4353.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4353");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4353");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4353");
    }
