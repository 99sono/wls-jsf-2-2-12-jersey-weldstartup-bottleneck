...
public class AppScopedBean4796 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4796.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4796");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4796");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4796");
    }
