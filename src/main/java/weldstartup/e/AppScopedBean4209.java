...
public class AppScopedBean4209 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4209.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4209");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4209");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4209");
    }
