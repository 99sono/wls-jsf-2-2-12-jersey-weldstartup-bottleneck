...
public class AppScopedBean4237 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4237.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4237");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4237");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4237");
    }
