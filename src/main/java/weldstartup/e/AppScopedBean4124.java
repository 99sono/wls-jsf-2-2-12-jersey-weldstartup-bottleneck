...
public class AppScopedBean4124 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4124.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4124");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4124");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4124");
    }
