...
public class AppScopedBean4853 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4853.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4853");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4853");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4853");
    }
