...
public class AppScopedBean4413 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4413.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4413");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4413");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4413");
    }
