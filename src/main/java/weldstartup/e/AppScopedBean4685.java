...
public class AppScopedBean4685 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4685.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4685");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4685");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4685");
    }
