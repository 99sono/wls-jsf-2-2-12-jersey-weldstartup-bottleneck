...
public class AppScopedBean4527 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4527.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4527");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4527");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4527");
    }
