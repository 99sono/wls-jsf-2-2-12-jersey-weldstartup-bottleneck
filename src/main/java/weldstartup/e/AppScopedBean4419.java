...
public class AppScopedBean4419 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4419.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4419");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4419");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4419");
    }
