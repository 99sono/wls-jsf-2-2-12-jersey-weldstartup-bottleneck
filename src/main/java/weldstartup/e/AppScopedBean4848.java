...
public class AppScopedBean4848 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4848.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4848");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4848");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4848");
    }
