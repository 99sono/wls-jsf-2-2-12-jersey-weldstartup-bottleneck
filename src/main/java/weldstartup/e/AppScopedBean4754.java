...
public class AppScopedBean4754 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4754.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4754");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4754");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4754");
    }
