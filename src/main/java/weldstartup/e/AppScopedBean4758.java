...
public class AppScopedBean4758 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4758.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4758");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4758");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4758");
    }
