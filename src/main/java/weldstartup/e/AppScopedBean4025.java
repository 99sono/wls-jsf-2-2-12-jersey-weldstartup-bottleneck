...
public class AppScopedBean4025 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4025.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4025");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4025");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4025");
    }
