...
public class AppScopedBean4774 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4774.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4774");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4774");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4774");
    }
