...
public class AppScopedBean4901 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4901.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4901");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4901");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4901");
    }
