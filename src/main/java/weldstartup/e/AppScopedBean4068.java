...
public class AppScopedBean4068 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4068.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4068");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4068");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4068");
    }
