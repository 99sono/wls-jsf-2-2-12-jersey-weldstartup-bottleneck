...
public class AppScopedBean4566 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4566.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4566");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4566");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4566");
    }
