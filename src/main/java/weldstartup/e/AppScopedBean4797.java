...
public class AppScopedBean4797 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4797.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4797");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4797");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4797");
    }
