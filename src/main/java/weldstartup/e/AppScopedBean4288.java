...
public class AppScopedBean4288 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4288.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4288");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4288");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4288");
    }
