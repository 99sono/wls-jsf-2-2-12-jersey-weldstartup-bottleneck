...
public class AppScopedBean4185 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4185.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4185");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4185");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4185");
    }
