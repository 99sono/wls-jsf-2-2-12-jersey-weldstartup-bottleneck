...
public class AppScopedBean4743 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4743.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4743");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4743");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4743");
    }
