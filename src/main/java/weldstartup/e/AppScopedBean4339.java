...
public class AppScopedBean4339 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4339.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4339");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4339");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4339");
    }
