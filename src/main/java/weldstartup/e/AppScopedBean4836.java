...
public class AppScopedBean4836 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4836.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4836");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4836");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4836");
    }
