...
public class AppScopedBean4936 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4936.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4936");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4936");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4936");
    }
