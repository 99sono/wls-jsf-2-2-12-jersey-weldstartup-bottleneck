...
public class AppScopedBean4735 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4735.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4735");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4735");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4735");
    }
