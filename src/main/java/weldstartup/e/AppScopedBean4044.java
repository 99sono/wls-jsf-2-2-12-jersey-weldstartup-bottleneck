...
public class AppScopedBean4044 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4044.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4044");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4044");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4044");
    }
