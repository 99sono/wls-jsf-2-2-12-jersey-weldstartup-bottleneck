...
public class AppScopedBean4953 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4953.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4953");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4953");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4953");
    }
