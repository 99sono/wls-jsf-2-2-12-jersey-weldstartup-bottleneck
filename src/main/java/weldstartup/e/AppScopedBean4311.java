...
public class AppScopedBean4311 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4311.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4311");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4311");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4311");
    }
