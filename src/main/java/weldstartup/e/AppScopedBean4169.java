...
public class AppScopedBean4169 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4169.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4169");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4169");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4169");
    }
