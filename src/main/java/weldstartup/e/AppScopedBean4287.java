...
public class AppScopedBean4287 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4287.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4287");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4287");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4287");
    }
