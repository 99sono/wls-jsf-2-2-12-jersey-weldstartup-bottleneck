...
public class AppScopedBean4933 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4933.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4933");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4933");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4933");
    }
