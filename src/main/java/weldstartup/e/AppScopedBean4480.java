...
public class AppScopedBean4480 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4480.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4480");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4480");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4480");
    }
