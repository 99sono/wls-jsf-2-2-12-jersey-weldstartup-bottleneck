...
public class AppScopedBean4162 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4162.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4162");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4162");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4162");
    }
