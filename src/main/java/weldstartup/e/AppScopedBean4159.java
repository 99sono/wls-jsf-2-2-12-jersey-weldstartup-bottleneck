...
public class AppScopedBean4159 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4159.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4159");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4159");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4159");
    }
