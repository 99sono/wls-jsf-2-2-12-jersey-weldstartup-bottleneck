...
public class AppScopedBean4116 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4116.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4116");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4116");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4116");
    }
