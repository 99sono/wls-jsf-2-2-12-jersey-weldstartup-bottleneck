...
public class AppScopedBean4563 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4563.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4563");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4563");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4563");
    }
