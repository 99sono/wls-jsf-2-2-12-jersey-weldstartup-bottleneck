...
public class AppScopedBean4802 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4802.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4802");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4802");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4802");
    }
