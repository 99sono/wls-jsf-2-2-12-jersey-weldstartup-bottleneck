...
public class AppScopedBean4990 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4990.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4990");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4990");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4990");
    }
