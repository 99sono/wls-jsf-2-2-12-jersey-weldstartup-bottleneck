...
public class AppScopedBean4646 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4646.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4646");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4646");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4646");
    }
