...
public class AppScopedBean4533 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4533.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4533");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4533");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4533");
    }
