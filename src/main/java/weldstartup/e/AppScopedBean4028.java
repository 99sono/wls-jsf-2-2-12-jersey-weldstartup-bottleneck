...
public class AppScopedBean4028 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4028.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4028");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4028");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4028");
    }
