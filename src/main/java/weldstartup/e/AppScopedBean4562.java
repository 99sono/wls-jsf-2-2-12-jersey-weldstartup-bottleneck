...
public class AppScopedBean4562 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4562.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4562");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4562");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4562");
    }
