...
public class AppScopedBean4782 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4782.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4782");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4782");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4782");
    }
