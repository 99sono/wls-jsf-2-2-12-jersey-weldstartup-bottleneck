...
public class AppScopedBean4992 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4992.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4992");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4992");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4992");
    }
