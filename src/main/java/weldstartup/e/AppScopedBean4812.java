...
public class AppScopedBean4812 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4812.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4812");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4812");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4812");
    }
