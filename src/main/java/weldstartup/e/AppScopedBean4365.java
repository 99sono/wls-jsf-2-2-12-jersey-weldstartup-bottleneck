...
public class AppScopedBean4365 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4365.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4365");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4365");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4365");
    }
