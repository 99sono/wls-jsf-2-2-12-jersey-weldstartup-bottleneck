...
public class AppScopedBean4321 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4321.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4321");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4321");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4321");
    }
