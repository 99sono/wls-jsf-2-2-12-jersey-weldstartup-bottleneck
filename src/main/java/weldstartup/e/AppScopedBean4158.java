...
public class AppScopedBean4158 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4158.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4158");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4158");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4158");
    }
