...
public class AppScopedBean4971 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4971.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4971");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4971");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4971");
    }
