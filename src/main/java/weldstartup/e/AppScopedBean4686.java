...
public class AppScopedBean4686 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4686.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4686");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4686");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4686");
    }
