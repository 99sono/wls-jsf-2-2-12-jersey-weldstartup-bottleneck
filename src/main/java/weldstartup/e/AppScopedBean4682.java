...
public class AppScopedBean4682 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4682.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4682");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4682");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4682");
    }
