...
public class AppScopedBean4394 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4394.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4394");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4394");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4394");
    }
