...
public class AppScopedBean4261 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4261.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4261");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4261");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4261");
    }
