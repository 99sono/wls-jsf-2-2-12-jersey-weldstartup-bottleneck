...
public class AppScopedBean4541 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4541.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4541");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4541");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4541");
    }
