...
public class AppScopedBean4668 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4668.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4668");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4668");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4668");
    }
