...
public class AppScopedBean4594 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4594.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4594");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4594");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4594");
    }
