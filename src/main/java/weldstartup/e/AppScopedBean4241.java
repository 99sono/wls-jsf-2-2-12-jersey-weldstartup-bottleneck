...
public class AppScopedBean4241 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4241.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4241");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4241");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4241");
    }
