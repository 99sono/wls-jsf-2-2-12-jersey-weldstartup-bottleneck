...
public class AppScopedBean4008 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4008.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4008");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4008");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4008");
    }
