...
public class AppScopedBean4732 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4732.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4732");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4732");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4732");
    }
