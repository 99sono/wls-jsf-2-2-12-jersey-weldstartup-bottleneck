...
public class AppScopedBean4239 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4239.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4239");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4239");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4239");
    }
