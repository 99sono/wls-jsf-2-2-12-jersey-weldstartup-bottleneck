...
public class AppScopedBean4740 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4740.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4740");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4740");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4740");
    }
