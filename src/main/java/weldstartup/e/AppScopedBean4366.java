...
public class AppScopedBean4366 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4366.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4366");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4366");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4366");
    }
