...
public class AppScopedBean4476 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4476.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4476");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4476");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4476");
    }
