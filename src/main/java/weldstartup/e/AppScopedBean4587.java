...
public class AppScopedBean4587 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4587.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4587");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4587");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4587");
    }
