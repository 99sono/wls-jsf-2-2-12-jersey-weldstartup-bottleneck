...
public class AppScopedBean4482 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4482.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4482");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4482");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4482");
    }
