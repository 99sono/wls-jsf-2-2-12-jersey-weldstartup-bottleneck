...
public class AppScopedBean4505 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4505.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4505");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4505");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4505");
    }
