...
public class AppScopedBean4440 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4440.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4440");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4440");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4440");
    }
