...
public class AppScopedBean4863 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4863.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4863");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4863");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4863");
    }
