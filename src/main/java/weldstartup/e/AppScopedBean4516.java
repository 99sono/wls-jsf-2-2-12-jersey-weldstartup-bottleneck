...
public class AppScopedBean4516 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4516.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4516");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4516");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4516");
    }
