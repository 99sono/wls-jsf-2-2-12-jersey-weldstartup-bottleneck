...
public class AppScopedBean4510 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4510.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4510");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4510");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4510");
    }
