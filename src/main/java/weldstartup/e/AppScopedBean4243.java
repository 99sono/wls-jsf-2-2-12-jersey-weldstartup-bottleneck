...
public class AppScopedBean4243 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4243.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4243");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4243");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4243");
    }
