...
public class AppScopedBean4884 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4884.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4884");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4884");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4884");
    }
