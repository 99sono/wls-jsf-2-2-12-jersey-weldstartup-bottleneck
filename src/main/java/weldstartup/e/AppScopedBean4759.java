...
public class AppScopedBean4759 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4759.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4759");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4759");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4759");
    }
