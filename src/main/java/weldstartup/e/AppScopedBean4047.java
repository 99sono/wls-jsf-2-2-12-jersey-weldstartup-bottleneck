...
public class AppScopedBean4047 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4047.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4047");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4047");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4047");
    }
