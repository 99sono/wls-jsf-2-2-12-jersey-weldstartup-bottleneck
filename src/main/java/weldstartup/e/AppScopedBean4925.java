...
public class AppScopedBean4925 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4925.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4925");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4925");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4925");
    }
