...
public class AppScopedBean4125 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4125.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4125");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4125");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4125");
    }
