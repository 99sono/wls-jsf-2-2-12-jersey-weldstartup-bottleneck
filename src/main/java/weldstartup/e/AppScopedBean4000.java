...
public class AppScopedBean4000 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4000.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4000");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4000");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4000");
    }
