...
public class AppScopedBean4434 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4434.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4434");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4434");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4434");
    }
