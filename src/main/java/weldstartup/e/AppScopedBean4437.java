...
public class AppScopedBean4437 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4437.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4437");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4437");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4437");
    }
