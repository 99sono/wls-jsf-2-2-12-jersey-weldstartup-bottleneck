...
public class AppScopedBean4027 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4027.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4027");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4027");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4027");
    }
