...
public class AppScopedBean4079 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4079.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4079");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4079");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4079");
    }
