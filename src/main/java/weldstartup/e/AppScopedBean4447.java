...
public class AppScopedBean4447 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4447.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4447");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4447");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4447");
    }
