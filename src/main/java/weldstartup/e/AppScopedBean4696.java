...
public class AppScopedBean4696 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4696.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4696");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4696");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4696");
    }
