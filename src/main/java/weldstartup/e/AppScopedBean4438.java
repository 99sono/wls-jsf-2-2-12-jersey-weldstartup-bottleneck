...
public class AppScopedBean4438 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4438.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4438");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4438");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4438");
    }
