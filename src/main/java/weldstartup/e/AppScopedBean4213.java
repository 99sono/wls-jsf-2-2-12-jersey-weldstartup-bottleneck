...
public class AppScopedBean4213 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4213.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4213");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4213");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4213");
    }
