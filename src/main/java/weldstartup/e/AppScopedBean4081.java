...
public class AppScopedBean4081 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4081.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4081");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4081");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4081");
    }
