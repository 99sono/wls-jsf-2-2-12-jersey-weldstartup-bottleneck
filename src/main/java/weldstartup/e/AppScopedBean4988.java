...
public class AppScopedBean4988 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4988.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4988");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4988");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4988");
    }
