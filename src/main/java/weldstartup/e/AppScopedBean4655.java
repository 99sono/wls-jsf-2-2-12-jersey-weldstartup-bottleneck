...
public class AppScopedBean4655 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4655.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4655");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4655");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4655");
    }
