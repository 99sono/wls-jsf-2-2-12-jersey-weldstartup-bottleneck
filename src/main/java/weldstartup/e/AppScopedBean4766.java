...
public class AppScopedBean4766 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4766.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4766");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4766");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4766");
    }
