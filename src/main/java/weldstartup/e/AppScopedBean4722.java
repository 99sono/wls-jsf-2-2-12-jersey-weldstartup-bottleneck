...
public class AppScopedBean4722 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4722.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4722");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4722");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4722");
    }
