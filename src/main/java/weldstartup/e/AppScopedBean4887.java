...
public class AppScopedBean4887 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4887.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4887");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4887");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4887");
    }
