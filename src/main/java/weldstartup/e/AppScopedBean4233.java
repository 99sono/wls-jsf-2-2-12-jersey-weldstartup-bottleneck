...
public class AppScopedBean4233 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4233.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4233");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4233");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4233");
    }
