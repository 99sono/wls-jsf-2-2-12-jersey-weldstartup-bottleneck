...
public class AppScopedBean4127 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4127.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4127");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4127");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4127");
    }
