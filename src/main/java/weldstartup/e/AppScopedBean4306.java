...
public class AppScopedBean4306 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4306.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4306");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4306");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4306");
    }
