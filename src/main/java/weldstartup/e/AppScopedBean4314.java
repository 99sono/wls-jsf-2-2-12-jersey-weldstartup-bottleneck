...
public class AppScopedBean4314 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4314.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4314");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4314");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4314");
    }
