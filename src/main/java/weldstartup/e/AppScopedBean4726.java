...
public class AppScopedBean4726 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4726.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4726");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4726");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4726");
    }
