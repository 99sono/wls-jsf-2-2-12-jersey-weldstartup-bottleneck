...
public class AppScopedBean4548 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4548.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4548");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4548");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4548");
    }
