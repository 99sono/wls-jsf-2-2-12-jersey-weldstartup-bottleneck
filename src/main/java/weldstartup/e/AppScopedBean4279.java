...
public class AppScopedBean4279 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4279.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4279");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4279");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4279");
    }
