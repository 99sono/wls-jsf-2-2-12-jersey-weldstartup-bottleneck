...
public class AppScopedBean4414 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4414.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4414");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4414");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4414");
    }
