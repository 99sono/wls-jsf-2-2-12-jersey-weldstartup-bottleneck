...
public class AppScopedBean4100 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4100.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4100");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4100");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4100");
    }
