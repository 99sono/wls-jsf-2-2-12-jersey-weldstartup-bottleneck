...
public class AppScopedBean4302 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4302.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4302");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4302");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4302");
    }
