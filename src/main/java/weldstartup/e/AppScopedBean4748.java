...
public class AppScopedBean4748 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4748.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4748");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4748");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4748");
    }
