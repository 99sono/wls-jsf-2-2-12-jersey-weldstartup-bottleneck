...
public class AppScopedBean4555 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4555.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4555");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4555");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4555");
    }
