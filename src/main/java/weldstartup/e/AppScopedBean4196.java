...
public class AppScopedBean4196 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4196.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4196");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4196");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4196");
    }
