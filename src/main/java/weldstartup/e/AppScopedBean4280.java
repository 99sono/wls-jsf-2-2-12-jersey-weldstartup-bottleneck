...
public class AppScopedBean4280 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4280.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4280");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4280");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4280");
    }
