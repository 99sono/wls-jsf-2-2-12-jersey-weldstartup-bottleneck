...
public class AppScopedBean4545 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4545.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4545");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4545");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4545");
    }
