...
public class AppScopedBean4206 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4206.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4206");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4206");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4206");
    }
