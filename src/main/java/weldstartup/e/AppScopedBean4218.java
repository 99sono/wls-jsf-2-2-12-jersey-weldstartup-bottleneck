...
public class AppScopedBean4218 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4218.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4218");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4218");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4218");
    }
