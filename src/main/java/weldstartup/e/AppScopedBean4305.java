...
public class AppScopedBean4305 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4305.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4305");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4305");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4305");
    }
