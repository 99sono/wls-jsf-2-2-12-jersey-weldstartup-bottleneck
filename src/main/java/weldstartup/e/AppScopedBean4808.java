...
public class AppScopedBean4808 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4808.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4808");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4808");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4808");
    }
