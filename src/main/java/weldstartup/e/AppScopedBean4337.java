...
public class AppScopedBean4337 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4337.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4337");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4337");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4337");
    }
