...
public class AppScopedBean4631 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4631.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4631");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4631");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4631");
    }
