...
public class AppScopedBean4583 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4583.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4583");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4583");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4583");
    }
