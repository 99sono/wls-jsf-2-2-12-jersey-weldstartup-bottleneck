...
public class AppScopedBean4560 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4560.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4560");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4560");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4560");
    }
