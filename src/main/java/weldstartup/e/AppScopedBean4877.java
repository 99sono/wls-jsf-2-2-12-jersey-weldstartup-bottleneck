...
public class AppScopedBean4877 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4877.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4877");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4877");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4877");
    }
