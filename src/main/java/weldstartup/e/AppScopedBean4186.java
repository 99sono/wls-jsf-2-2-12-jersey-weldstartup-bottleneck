...
public class AppScopedBean4186 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4186.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4186");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4186");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4186");
    }
