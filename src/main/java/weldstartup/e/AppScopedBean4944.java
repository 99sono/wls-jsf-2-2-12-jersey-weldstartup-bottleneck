...
public class AppScopedBean4944 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4944.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4944");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4944");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4944");
    }
