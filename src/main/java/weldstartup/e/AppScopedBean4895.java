...
public class AppScopedBean4895 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4895.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4895");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4895");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4895");
    }
