...
public class AppScopedBean4442 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4442.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4442");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4442");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4442");
    }
