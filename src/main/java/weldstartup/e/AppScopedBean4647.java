...
public class AppScopedBean4647 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4647.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4647");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4647");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4647");
    }
