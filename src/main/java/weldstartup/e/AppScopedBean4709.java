...
public class AppScopedBean4709 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4709.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4709");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4709");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4709");
    }
