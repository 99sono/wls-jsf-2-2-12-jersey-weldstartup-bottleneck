...
public class AppScopedBean4612 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4612.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4612");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4612");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4612");
    }
