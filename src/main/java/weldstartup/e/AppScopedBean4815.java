...
public class AppScopedBean4815 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4815.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4815");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4815");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4815");
    }
