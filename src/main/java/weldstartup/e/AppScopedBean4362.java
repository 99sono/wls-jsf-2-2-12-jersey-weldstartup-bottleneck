...
public class AppScopedBean4362 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4362.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4362");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4362");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4362");
    }
