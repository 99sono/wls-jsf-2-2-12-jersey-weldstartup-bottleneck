...
public class AppScopedBean4898 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4898.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4898");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4898");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4898");
    }
