...
public class AppScopedBean4201 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4201.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4201");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4201");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4201");
    }
