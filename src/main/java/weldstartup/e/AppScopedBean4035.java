...
public class AppScopedBean4035 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4035.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4035");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4035");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4035");
    }
