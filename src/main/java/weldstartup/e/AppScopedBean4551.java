...
public class AppScopedBean4551 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4551.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4551");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4551");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4551");
    }
