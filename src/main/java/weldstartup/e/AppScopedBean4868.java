...
public class AppScopedBean4868 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4868.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4868");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4868");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4868");
    }
