...
public class AppScopedBean4645 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4645.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4645");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4645");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4645");
    }
