...
public class AppScopedBean4974 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4974.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4974");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4974");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4974");
    }
