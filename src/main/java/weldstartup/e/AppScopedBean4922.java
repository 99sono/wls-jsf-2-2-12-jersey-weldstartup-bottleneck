...
public class AppScopedBean4922 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4922.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4922");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4922");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4922");
    }
