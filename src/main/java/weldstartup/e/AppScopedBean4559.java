...
public class AppScopedBean4559 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4559.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4559");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4559");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4559");
    }
