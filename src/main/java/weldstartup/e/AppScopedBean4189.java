...
public class AppScopedBean4189 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4189.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4189");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4189");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4189");
    }
