...
public class AppScopedBean4699 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4699.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4699");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4699");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4699");
    }
