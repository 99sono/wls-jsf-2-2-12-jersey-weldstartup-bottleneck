...
public class AppScopedBean4787 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4787.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4787");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4787");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4787");
    }
