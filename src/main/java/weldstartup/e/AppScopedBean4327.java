...
public class AppScopedBean4327 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4327.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4327");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4327");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4327");
    }
