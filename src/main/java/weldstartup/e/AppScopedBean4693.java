...
public class AppScopedBean4693 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4693.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4693");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4693");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4693");
    }
