...
public class AppScopedBean4780 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4780.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4780");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4780");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4780");
    }
