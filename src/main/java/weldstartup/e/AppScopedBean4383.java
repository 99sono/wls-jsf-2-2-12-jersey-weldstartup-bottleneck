...
public class AppScopedBean4383 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4383.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4383");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4383");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4383");
    }
