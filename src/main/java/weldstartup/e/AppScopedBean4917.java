...
public class AppScopedBean4917 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4917.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4917");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4917");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4917");
    }
