...
public class AppScopedBean4147 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4147.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4147");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4147");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4147");
    }
