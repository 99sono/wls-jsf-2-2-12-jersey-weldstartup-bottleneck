...
public class AppScopedBean4625 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4625.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4625");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4625");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4625");
    }
