...
public class AppScopedBean4637 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4637.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4637");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4637");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4637");
    }
