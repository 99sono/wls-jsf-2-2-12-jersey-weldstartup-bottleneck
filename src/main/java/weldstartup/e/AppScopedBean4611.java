...
public class AppScopedBean4611 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4611.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4611");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4611");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4611");
    }
