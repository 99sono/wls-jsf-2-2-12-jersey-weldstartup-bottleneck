...
public class AppScopedBean4178 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4178.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4178");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4178");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4178");
    }
