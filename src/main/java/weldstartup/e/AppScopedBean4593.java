...
public class AppScopedBean4593 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4593.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4593");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4593");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4593");
    }
