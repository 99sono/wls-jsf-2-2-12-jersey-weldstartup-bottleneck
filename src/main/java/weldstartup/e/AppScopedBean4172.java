...
public class AppScopedBean4172 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4172.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4172");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4172");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4172");
    }
