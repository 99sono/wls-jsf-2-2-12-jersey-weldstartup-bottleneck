...
public class AppScopedBean4512 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4512.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4512");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4512");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4512");
    }
