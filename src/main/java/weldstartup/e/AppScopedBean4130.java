...
public class AppScopedBean4130 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4130.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4130");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4130");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4130");
    }
