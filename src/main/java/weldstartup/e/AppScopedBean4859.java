...
public class AppScopedBean4859 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4859.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4859");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4859");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4859");
    }
