...
public class AppScopedBean4084 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4084.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4084");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4084");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4084");
    }
