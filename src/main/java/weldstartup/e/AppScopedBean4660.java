...
public class AppScopedBean4660 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4660.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4660");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4660");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4660");
    }
