...
public class AppScopedBean4837 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4837.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4837");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4837");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4837");
    }
