...
public class AppScopedBean4170 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4170.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4170");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4170");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4170");
    }
