...
public class AppScopedBean4115 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4115.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4115");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4115");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4115");
    }
