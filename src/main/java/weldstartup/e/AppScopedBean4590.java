...
public class AppScopedBean4590 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4590.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4590");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4590");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4590");
    }
