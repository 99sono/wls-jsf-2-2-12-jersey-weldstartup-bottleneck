...
public class AppScopedBean4781 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4781.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4781");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4781");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4781");
    }
