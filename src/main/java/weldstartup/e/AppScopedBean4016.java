...
public class AppScopedBean4016 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4016.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4016");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4016");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4016");
    }
