...
public class AppScopedBean4721 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4721.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4721");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4721");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4721");
    }
