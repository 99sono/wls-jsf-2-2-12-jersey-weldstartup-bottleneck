...
public class AppScopedBean4531 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4531.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4531");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4531");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4531");
    }
