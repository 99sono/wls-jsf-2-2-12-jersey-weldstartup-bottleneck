...
public class AppScopedBean4976 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4976.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4976");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4976");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4976");
    }
