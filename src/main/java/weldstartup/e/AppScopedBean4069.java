...
public class AppScopedBean4069 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4069.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4069");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4069");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4069");
    }
