...
public class AppScopedBean4157 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4157.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4157");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4157");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4157");
    }
