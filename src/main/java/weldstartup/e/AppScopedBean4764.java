...
public class AppScopedBean4764 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4764.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4764");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4764");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4764");
    }
