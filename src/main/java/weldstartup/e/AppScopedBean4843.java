...
public class AppScopedBean4843 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4843.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4843");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4843");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4843");
    }
