...
public class AppScopedBean4822 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4822.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4822");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4822");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4822");
    }
