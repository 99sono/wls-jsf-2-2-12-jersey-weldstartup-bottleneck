...
public class AppScopedBean4194 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4194.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4194");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4194");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4194");
    }
