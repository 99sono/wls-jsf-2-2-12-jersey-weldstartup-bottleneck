...
public class AppScopedBean4913 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4913.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4913");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4913");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4913");
    }
