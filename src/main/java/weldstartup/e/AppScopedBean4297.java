...
public class AppScopedBean4297 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4297.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4297");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4297");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4297");
    }
