...
public class AppScopedBean4628 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4628.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4628");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4628");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4628");
    }
