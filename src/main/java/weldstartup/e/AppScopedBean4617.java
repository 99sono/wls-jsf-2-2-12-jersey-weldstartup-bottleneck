...
public class AppScopedBean4617 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4617.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4617");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4617");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4617");
    }
