...
public class AppScopedBean4891 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4891.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4891");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4891");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4891");
    }
