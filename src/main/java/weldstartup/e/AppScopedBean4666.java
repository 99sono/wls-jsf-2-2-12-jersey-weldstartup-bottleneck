...
public class AppScopedBean4666 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4666.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4666");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4666");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4666");
    }
