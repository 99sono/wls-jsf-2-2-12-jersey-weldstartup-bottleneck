...
public class AppScopedBean4547 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4547.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4547");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4547");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4547");
    }
