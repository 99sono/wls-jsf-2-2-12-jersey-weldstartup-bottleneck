...
public class AppScopedBean4657 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4657.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4657");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4657");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4657");
    }
