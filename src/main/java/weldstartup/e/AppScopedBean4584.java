...
public class AppScopedBean4584 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4584.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4584");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4584");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4584");
    }
