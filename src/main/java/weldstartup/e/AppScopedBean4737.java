...
public class AppScopedBean4737 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4737.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4737");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4737");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4737");
    }
