...
public class AppScopedBean4388 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4388.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4388");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4388");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4388");
    }
