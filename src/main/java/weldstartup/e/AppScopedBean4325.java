...
public class AppScopedBean4325 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4325.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4325");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4325");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4325");
    }
