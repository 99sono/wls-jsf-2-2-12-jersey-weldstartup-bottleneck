...
public class AppScopedBean4455 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4455.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4455");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4455");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4455");
    }
