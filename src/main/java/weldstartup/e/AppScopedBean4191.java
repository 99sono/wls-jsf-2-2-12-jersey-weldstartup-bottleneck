...
public class AppScopedBean4191 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4191.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4191");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4191");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4191");
    }
