...
public class AppScopedBean4326 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4326.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4326");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4326");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4326");
    }
