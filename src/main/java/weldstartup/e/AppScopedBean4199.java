...
public class AppScopedBean4199 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4199.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4199");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4199");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4199");
    }
