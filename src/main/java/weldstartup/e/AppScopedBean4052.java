...
public class AppScopedBean4052 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4052.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4052");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4052");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4052");
    }
