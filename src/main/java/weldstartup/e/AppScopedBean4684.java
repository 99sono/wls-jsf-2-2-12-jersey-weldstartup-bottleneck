...
public class AppScopedBean4684 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4684.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4684");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4684");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4684");
    }
