...
public class AppScopedBean4290 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4290.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4290");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4290");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4290");
    }
