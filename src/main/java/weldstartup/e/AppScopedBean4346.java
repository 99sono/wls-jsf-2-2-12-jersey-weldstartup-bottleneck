...
public class AppScopedBean4346 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4346.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4346");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4346");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4346");
    }
