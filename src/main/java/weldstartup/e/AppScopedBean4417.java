...
public class AppScopedBean4417 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4417.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4417");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4417");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4417");
    }
