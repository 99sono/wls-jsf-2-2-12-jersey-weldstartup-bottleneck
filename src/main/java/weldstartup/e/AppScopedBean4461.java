...
public class AppScopedBean4461 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4461.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4461");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4461");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4461");
    }
