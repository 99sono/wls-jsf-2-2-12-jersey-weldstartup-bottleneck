...
public class AppScopedBean4771 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4771.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4771");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4771");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4771");
    }
