...
public class AppScopedBean4997 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4997.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4997");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4997");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4997");
    }
