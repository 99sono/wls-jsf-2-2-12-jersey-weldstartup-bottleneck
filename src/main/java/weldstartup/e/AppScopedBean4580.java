...
public class AppScopedBean4580 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4580.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4580");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4580");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4580");
    }
