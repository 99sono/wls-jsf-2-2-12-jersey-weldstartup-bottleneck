...
public class AppScopedBean4893 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4893.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4893");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4893");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4893");
    }
