...
public class AppScopedBean4376 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4376.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4376");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4376");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4376");
    }
