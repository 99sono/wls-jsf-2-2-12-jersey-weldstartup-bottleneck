...
public class AppScopedBean4943 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4943.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4943");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4943");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4943");
    }
