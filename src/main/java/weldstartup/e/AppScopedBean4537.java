...
public class AppScopedBean4537 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4537.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4537");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4537");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4537");
    }
