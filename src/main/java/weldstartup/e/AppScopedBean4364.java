...
public class AppScopedBean4364 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4364.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4364");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4364");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4364");
    }
