...
public class AppScopedBean4924 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4924.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4924");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4924");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4924");
    }
