...
public class AppScopedBean4481 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4481.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4481");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4481");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4481");
    }
