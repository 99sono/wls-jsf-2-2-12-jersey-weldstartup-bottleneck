...
public class AppScopedBean4262 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4262.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4262");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4262");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4262");
    }
