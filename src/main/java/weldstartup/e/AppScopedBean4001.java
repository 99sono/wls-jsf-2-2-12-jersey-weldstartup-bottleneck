...
public class AppScopedBean4001 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4001.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4001");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4001");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4001");
    }
