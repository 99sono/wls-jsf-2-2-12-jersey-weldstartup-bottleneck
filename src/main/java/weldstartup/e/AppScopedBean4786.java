...
public class AppScopedBean4786 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4786.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4786");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4786");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4786");
    }
