...
public class AppScopedBean4396 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4396.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4396");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4396");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4396");
    }
