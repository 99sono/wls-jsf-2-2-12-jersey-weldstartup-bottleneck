...
public class AppScopedBean4423 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4423.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4423");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4423");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4423");
    }
