...
public class AppScopedBean4254 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4254.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4254");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4254");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4254");
    }
