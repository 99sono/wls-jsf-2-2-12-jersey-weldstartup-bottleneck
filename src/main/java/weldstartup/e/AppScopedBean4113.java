...
public class AppScopedBean4113 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4113.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4113");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4113");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4113");
    }
