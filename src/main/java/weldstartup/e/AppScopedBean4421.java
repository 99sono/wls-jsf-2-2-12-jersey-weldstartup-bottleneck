...
public class AppScopedBean4421 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4421.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4421");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4421");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4421");
    }
