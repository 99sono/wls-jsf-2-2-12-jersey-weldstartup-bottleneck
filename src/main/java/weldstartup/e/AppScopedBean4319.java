...
public class AppScopedBean4319 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4319.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4319");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4319");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4319");
    }
