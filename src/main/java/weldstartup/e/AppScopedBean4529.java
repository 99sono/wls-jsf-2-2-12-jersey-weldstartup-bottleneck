...
public class AppScopedBean4529 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4529.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4529");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4529");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4529");
    }
