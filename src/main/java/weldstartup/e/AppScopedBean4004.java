...
public class AppScopedBean4004 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4004.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4004");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4004");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4004");
    }
