...
public class AppScopedBean4400 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4400.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4400");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4400");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4400");
    }
