...
public class AppScopedBean4087 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4087.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4087");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4087");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4087");
    }
