...
public class AppScopedBean4040 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4040.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4040");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4040");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4040");
    }
