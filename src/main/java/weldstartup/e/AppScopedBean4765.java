...
public class AppScopedBean4765 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4765.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4765");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4765");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4765");
    }
