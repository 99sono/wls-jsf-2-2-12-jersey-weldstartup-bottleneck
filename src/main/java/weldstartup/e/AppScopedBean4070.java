...
public class AppScopedBean4070 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4070.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4070");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4070");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4070");
    }
