...
public class AppScopedBean4401 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4401.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4401");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4401");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4401");
    }
