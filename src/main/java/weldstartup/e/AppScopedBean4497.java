...
public class AppScopedBean4497 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4497.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4497");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4497");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4497");
    }
