...
public class AppScopedBean4875 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4875.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4875");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4875");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4875");
    }
