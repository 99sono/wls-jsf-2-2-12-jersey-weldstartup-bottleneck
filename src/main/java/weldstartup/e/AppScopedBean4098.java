...
public class AppScopedBean4098 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4098.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4098");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4098");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4098");
    }
