...
public class AppScopedBean4192 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4192.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4192");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4192");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4192");
    }
