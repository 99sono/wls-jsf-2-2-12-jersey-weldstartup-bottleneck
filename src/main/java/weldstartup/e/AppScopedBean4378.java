...
public class AppScopedBean4378 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4378.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4378");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4378");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4378");
    }
