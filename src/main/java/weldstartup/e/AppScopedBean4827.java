...
public class AppScopedBean4827 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4827.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4827");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4827");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4827");
    }
