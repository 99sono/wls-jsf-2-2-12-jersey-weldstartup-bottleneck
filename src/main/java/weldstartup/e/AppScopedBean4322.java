...
public class AppScopedBean4322 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4322.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4322");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4322");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4322");
    }
