...
public class AppScopedBean4564 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4564.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4564");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4564");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4564");
    }
