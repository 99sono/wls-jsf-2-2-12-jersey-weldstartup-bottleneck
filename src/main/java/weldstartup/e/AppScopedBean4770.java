...
public class AppScopedBean4770 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4770.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4770");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4770");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4770");
    }
