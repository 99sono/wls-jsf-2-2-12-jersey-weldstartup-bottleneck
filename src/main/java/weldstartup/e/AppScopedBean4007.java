...
public class AppScopedBean4007 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4007.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4007");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4007");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4007");
    }
