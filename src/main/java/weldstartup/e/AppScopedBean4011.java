...
public class AppScopedBean4011 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4011.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4011");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4011");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4011");
    }
