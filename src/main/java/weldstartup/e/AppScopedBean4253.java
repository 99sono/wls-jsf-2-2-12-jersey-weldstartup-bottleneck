...
public class AppScopedBean4253 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4253.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4253");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4253");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4253");
    }
