...
public class AppScopedBean4629 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4629.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4629");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4629");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4629");
    }
