...
public class AppScopedBean4227 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4227.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4227");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4227");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4227");
    }
