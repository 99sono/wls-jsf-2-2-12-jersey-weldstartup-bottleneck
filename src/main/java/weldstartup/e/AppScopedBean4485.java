...
public class AppScopedBean4485 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4485.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4485");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4485");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4485");
    }
