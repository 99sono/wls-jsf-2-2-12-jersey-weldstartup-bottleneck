...
public class AppScopedBean4534 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4534.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4534");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4534");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4534");
    }
