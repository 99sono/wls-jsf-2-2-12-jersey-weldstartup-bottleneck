...
public class AppScopedBean4571 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4571.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4571");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4571");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4571");
    }
