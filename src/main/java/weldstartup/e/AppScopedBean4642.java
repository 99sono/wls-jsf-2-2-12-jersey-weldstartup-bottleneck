...
public class AppScopedBean4642 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4642.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4642");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4642");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4642");
    }
