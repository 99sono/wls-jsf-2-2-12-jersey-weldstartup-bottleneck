...
public class AppScopedBean4717 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4717.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4717");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4717");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4717");
    }
