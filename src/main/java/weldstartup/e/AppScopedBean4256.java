...
public class AppScopedBean4256 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4256.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4256");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4256");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4256");
    }
