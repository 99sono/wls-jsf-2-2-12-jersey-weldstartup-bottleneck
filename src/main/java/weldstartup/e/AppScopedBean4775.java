...
public class AppScopedBean4775 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4775.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4775");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4775");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4775");
    }
