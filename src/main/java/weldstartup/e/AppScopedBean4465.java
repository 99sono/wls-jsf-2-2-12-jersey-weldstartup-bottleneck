...
public class AppScopedBean4465 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4465.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4465");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4465");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4465");
    }
