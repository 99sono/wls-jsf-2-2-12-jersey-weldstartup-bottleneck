...
public class AppScopedBean4276 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4276.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4276");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4276");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4276");
    }
