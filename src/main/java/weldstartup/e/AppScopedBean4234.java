...
public class AppScopedBean4234 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4234.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4234");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4234");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4234");
    }
