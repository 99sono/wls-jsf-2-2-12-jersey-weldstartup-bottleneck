...
public class AppScopedBean4543 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4543.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4543");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4543");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4543");
    }
