...
public class AppScopedBean4606 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4606.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4606");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4606");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4606");
    }
