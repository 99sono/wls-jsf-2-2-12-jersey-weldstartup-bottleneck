...
public class AppScopedBean4865 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4865.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4865");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4865");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4865");
    }
