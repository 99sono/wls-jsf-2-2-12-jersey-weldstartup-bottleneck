...
public class AppScopedBean4999 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4999.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4999");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4999");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4999");
    }
