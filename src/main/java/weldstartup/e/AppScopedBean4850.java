...
public class AppScopedBean4850 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4850.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4850");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4850");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4850");
    }
