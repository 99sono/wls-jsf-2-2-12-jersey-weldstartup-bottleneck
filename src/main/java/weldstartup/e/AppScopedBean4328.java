...
public class AppScopedBean4328 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4328.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4328");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4328");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4328");
    }
