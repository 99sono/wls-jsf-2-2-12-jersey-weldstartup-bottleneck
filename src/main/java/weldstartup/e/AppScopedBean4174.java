...
public class AppScopedBean4174 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4174.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4174");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4174");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4174");
    }
