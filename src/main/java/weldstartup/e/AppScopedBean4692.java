...
public class AppScopedBean4692 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4692.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4692");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4692");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4692");
    }
