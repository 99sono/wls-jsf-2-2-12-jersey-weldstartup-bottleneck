...
public class AppScopedBean4283 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4283.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4283");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4283");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4283");
    }
