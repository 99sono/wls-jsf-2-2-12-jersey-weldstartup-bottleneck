...
public class AppScopedBean4260 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4260.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4260");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4260");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4260");
    }
