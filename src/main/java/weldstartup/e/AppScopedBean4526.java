...
public class AppScopedBean4526 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4526.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4526");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4526");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4526");
    }
