...
public class AppScopedBean4673 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4673.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4673");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4673");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4673");
    }
