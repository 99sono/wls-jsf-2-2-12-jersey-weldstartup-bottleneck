...
public class AppScopedBean4588 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4588.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4588");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4588");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4588");
    }
