...
public class AppScopedBean4024 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4024.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4024");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4024");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4024");
    }
