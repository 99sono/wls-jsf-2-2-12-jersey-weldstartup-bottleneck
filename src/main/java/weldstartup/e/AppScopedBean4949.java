...
public class AppScopedBean4949 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4949.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4949");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4949");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4949");
    }
