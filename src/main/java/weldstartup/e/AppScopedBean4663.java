...
public class AppScopedBean4663 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4663.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4663");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4663");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4663");
    }
