...
public class AppScopedBean4838 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4838.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4838");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4838");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4838");
    }
