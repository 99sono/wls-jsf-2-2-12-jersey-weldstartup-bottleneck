...
public class AppScopedBean4215 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4215.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4215");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4215");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4215");
    }
