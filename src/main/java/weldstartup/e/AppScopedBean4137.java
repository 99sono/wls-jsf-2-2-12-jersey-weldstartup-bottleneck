...
public class AppScopedBean4137 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4137.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4137");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4137");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4137");
    }
