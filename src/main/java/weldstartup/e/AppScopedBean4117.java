...
public class AppScopedBean4117 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4117.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4117");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4117");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4117");
    }
