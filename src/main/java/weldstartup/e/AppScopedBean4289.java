...
public class AppScopedBean4289 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4289.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4289");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4289");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4289");
    }
