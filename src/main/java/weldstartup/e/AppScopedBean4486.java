...
public class AppScopedBean4486 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4486.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4486");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4486");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4486");
    }
