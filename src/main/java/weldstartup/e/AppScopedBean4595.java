...
public class AppScopedBean4595 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4595.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4595");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4595");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4595");
    }
