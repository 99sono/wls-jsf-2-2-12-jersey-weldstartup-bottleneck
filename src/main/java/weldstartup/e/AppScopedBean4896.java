...
public class AppScopedBean4896 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4896.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4896");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4896");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4896");
    }
