...
public class AppScopedBean4123 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4123.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4123");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4123");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4123");
    }
