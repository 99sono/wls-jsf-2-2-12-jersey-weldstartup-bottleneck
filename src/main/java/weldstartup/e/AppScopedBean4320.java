...
public class AppScopedBean4320 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4320.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4320");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4320");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4320");
    }
