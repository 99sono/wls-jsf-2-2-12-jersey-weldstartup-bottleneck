...
public class AppScopedBean4508 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4508.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4508");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4508");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4508");
    }
