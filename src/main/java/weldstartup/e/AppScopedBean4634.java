...
public class AppScopedBean4634 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4634.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4634");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4634");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4634");
    }
