...
public class AppScopedBean4291 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4291.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4291");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4291");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4291");
    }
