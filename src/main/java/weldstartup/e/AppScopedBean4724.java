...
public class AppScopedBean4724 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4724.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4724");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4724");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4724");
    }
