...
public class AppScopedBean4135 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4135.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4135");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4135");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4135");
    }
