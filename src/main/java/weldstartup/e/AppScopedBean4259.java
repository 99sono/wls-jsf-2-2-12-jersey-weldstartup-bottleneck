...
public class AppScopedBean4259 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4259.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4259");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4259");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4259");
    }
