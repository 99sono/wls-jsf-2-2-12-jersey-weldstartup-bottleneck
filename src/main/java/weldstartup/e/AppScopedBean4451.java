...
public class AppScopedBean4451 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4451.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4451");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4451");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4451");
    }
