...
public class AppScopedBean4604 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4604.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4604");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4604");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4604");
    }
