...
public class AppScopedBean4341 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4341.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4341");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4341");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4341");
    }
