...
public class AppScopedBean4231 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4231.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4231");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4231");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4231");
    }
