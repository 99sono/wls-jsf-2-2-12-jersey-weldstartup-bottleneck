...
public class AppScopedBean4205 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4205.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4205");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4205");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4205");
    }
