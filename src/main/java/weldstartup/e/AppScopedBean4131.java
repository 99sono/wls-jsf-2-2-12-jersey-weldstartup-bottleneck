...
public class AppScopedBean4131 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4131.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4131");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4131");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4131");
    }
