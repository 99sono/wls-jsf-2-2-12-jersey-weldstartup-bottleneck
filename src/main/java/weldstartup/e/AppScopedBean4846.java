...
public class AppScopedBean4846 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4846.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4846");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4846");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4846");
    }
