...
public class AppScopedBean4720 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4720.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4720");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4720");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4720");
    }
