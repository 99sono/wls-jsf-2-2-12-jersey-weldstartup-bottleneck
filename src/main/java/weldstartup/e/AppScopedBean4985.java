...
public class AppScopedBean4985 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4985.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4985");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4985");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4985");
    }
