...
public class AppScopedBean4263 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4263.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4263");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4263");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4263");
    }
