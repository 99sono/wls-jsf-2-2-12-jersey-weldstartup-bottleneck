...
public class AppScopedBean4874 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4874.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4874");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4874");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4874");
    }
