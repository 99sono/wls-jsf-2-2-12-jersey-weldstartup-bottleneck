...
public class AppScopedBean4736 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4736.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4736");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4736");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4736");
    }
