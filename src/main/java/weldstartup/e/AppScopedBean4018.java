...
public class AppScopedBean4018 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4018.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4018");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4018");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4018");
    }
