...
public class AppScopedBean4316 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4316.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4316");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4316");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4316");
    }
