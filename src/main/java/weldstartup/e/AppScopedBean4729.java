...
public class AppScopedBean4729 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4729.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4729");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4729");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4729");
    }
