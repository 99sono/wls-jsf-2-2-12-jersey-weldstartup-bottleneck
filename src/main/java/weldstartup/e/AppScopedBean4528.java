...
public class AppScopedBean4528 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4528.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4528");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4528");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4528");
    }
