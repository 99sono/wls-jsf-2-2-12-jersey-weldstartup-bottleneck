...
public class AppScopedBean4463 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4463.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4463");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4463");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4463");
    }
