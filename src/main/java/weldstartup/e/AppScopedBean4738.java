...
public class AppScopedBean4738 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4738.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4738");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4738");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4738");
    }
