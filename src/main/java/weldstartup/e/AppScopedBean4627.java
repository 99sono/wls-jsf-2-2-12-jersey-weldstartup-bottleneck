...
public class AppScopedBean4627 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4627.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4627");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4627");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4627");
    }
