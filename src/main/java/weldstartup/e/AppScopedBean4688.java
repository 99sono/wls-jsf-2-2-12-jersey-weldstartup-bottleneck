...
public class AppScopedBean4688 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4688.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4688");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4688");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4688");
    }
