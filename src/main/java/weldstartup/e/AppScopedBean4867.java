...
public class AppScopedBean4867 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4867.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4867");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4867");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4867");
    }
