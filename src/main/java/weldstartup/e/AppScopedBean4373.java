...
public class AppScopedBean4373 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4373.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4373");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4373");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4373");
    }
