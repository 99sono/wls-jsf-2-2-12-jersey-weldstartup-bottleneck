...
public class AppScopedBean4750 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4750.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4750");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4750");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4750");
    }
