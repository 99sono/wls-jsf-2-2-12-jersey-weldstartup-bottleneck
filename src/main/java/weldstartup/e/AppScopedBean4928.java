...
public class AppScopedBean4928 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4928.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4928");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4928");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4928");
    }
