...
public class AppScopedBean4860 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4860.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4860");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4860");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4860");
    }
