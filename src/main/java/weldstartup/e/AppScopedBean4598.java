...
public class AppScopedBean4598 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4598.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4598");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4598");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4598");
    }
