...
public class AppScopedBean4878 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4878.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4878");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4878");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4878");
    }
