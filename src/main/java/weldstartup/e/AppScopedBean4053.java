...
public class AppScopedBean4053 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4053.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4053");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4053");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4053");
    }
