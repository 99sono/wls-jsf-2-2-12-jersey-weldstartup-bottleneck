...
public class AppScopedBean4539 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4539.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4539");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4539");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4539");
    }
