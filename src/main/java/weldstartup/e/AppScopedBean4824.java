...
public class AppScopedBean4824 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4824.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4824");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4824");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4824");
    }
