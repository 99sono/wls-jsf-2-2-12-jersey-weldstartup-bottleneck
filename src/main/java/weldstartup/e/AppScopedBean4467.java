...
public class AppScopedBean4467 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4467.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4467");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4467");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4467");
    }
