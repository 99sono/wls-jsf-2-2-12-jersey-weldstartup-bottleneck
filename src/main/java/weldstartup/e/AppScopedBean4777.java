...
public class AppScopedBean4777 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4777.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4777");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4777");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4777");
    }
