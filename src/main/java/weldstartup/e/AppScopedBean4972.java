...
public class AppScopedBean4972 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4972.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4972");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4972");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4972");
    }
