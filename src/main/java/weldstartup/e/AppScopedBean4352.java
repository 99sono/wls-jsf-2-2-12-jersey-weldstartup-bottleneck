...
public class AppScopedBean4352 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4352.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4352");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4352");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4352");
    }
