...
public class AppScopedBean4825 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4825.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4825");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4825");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4825");
    }
