...
public class AppScopedBean4582 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4582.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4582");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4582");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4582");
    }
