...
public class AppScopedBean4370 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4370.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4370");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4370");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4370");
    }
