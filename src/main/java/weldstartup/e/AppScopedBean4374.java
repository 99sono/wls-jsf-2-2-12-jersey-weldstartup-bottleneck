...
public class AppScopedBean4374 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4374.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4374");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4374");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4374");
    }
