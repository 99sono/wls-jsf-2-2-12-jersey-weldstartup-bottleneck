...
public class AppScopedBean4198 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4198.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4198");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4198");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4198");
    }
