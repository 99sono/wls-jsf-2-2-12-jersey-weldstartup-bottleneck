...
public class AppScopedBean4329 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4329.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4329");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4329");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4329");
    }
