...
public class AppScopedBean4871 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4871.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4871");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4871");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4871");
    }
