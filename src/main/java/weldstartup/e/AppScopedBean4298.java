...
public class AppScopedBean4298 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4298.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4298");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4298");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4298");
    }
