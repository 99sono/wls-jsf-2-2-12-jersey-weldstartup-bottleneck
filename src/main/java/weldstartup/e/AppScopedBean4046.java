...
public class AppScopedBean4046 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4046.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4046");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4046");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4046");
    }
