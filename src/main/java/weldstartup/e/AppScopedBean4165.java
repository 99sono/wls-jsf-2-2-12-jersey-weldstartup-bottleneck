...
public class AppScopedBean4165 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4165.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4165");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4165");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4165");
    }
