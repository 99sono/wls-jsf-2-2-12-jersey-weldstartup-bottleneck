...
public class AppScopedBean4304 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4304.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4304");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4304");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4304");
    }
