...
public class AppScopedBean4372 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4372.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4372");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4372");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4372");
    }
