...
public class AppScopedBean4197 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4197.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4197");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4197");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4197");
    }
