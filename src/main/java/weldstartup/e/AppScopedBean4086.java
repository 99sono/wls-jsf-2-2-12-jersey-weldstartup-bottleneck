...
public class AppScopedBean4086 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4086.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4086");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4086");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4086");
    }
