...
public class AppScopedBean4224 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4224.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4224");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4224");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4224");
    }
