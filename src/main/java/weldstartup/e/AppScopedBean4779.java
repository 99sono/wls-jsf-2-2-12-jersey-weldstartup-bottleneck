...
public class AppScopedBean4779 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4779.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4779");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4779");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4779");
    }
