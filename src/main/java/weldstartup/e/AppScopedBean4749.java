...
public class AppScopedBean4749 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4749.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4749");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4749");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4749");
    }
