...
public class AppScopedBean4698 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4698.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4698");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4698");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4698");
    }
