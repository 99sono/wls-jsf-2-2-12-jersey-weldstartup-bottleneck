...
public class AppScopedBean4446 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4446.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4446");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4446");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4446");
    }
