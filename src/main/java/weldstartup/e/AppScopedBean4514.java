...
public class AppScopedBean4514 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4514.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4514");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4514");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4514");
    }
