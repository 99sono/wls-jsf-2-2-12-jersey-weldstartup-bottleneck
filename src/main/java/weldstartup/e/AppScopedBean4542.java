...
public class AppScopedBean4542 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4542.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4542");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4542");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4542");
    }
