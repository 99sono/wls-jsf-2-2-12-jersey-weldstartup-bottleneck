...
public class AppScopedBean4077 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4077.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4077");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4077");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4077");
    }
