...
public class AppScopedBean4389 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4389.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4389");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4389");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4389");
    }
