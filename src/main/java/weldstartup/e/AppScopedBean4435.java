...
public class AppScopedBean4435 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4435.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4435");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4435");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4435");
    }
