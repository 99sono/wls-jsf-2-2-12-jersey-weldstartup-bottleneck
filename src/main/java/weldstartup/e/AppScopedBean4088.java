...
public class AppScopedBean4088 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4088.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4088");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4088");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4088");
    }
