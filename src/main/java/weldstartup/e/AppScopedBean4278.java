...
public class AppScopedBean4278 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4278.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4278");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4278");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4278");
    }
