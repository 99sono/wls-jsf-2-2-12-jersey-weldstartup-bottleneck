...
public class AppScopedBean4856 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4856.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4856");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4856");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4856");
    }
