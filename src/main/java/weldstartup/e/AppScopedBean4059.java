...
public class AppScopedBean4059 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4059.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4059");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4059");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4059");
    }
