...
public class AppScopedBean4752 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4752.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4752");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4752");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4752");
    }
