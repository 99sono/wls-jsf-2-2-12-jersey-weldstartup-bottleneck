...
public class AppScopedBean4870 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4870.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4870");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4870");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4870");
    }
