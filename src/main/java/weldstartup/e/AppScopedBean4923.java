...
public class AppScopedBean4923 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4923.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4923");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4923");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4923");
    }
