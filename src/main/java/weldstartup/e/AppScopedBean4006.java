...
public class AppScopedBean4006 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4006.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4006");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4006");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4006");
    }
