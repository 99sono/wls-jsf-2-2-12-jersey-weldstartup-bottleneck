...
public class AppScopedBean4570 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4570.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4570");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4570");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4570");
    }
