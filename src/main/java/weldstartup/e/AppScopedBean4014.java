...
public class AppScopedBean4014 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4014.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4014");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4014");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4014");
    }
