...
public class AppScopedBean4712 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4712.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4712");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4712");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4712");
    }
