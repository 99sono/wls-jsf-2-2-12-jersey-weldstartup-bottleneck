...
public class AppScopedBean4067 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4067.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4067");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4067");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4067");
    }
