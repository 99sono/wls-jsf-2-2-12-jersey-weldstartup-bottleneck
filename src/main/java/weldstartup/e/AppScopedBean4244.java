...
public class AppScopedBean4244 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4244.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4244");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4244");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4244");
    }
