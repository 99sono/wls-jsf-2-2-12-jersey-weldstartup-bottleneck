...
public class AppScopedBean4556 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4556.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4556");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4556");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4556");
    }
