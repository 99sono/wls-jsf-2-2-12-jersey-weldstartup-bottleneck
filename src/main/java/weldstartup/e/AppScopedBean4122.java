...
public class AppScopedBean4122 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4122.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4122");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4122");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4122");
    }
