...
public class AppScopedBean4073 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4073.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4073");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4073");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4073");
    }
