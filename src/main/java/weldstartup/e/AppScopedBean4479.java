...
public class AppScopedBean4479 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4479.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4479");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4479");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4479");
    }
