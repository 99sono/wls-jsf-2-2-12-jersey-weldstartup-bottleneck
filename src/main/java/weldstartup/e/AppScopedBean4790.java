...
public class AppScopedBean4790 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4790.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4790");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4790");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4790");
    }
