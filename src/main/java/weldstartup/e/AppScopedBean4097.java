...
public class AppScopedBean4097 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4097.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4097");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4097");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4097");
    }
