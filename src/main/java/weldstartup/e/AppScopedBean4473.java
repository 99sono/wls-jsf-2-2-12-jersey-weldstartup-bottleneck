...
public class AppScopedBean4473 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4473.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4473");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4473");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4473");
    }
