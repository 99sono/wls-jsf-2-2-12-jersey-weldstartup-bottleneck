...
public class AppScopedBean4379 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4379.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4379");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4379");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4379");
    }
