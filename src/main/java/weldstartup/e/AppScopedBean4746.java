...
public class AppScopedBean4746 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4746.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4746");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4746");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4746");
    }
