...
public class AppScopedBean4448 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4448.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4448");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4448");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4448");
    }
