...
public class AppScopedBean4427 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4427.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4427");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4427");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4427");
    }
