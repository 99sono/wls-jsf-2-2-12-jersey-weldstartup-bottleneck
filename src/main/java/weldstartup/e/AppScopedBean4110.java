...
public class AppScopedBean4110 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4110.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4110");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4110");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4110");
    }
