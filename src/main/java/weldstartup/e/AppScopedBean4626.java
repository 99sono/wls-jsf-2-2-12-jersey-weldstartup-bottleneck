...
public class AppScopedBean4626 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4626.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4626");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4626");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4626");
    }
