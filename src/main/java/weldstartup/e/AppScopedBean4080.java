...
public class AppScopedBean4080 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4080.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4080");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4080");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4080");
    }
