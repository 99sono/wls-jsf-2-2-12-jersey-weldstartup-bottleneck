...
public class AppScopedBean4184 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4184.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4184");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4184");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4184");
    }
