...
public class AppScopedBean4470 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4470.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4470");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4470");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4470");
    }
