...
public class AppScopedBean4195 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4195.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4195");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4195");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4195");
    }
