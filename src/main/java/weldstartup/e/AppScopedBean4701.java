...
public class AppScopedBean4701 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4701.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4701");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4701");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4701");
    }
