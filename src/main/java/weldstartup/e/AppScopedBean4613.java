...
public class AppScopedBean4613 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4613.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4613");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4613");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4613");
    }
