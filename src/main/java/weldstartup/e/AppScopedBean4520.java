...
public class AppScopedBean4520 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4520.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4520");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4520");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4520");
    }
