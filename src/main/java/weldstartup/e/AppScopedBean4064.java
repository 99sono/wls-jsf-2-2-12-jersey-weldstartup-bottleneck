...
public class AppScopedBean4064 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4064.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4064");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4064");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4064");
    }
