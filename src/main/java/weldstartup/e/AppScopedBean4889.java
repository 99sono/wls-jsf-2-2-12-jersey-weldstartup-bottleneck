...
public class AppScopedBean4889 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4889.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4889");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4889");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4889");
    }
