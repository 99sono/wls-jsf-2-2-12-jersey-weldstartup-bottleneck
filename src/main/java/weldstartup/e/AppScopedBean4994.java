...
public class AppScopedBean4994 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4994.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4994");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4994");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4994");
    }
