...
public class AppScopedBean4620 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4620.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4620");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4620");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4620");
    }
