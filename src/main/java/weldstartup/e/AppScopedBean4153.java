...
public class AppScopedBean4153 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4153.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4153");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4153");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4153");
    }
