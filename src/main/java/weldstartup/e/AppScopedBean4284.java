...
public class AppScopedBean4284 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4284.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4284");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4284");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4284");
    }
