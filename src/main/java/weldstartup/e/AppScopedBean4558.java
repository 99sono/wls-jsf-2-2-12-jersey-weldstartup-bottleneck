...
public class AppScopedBean4558 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4558.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4558");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4558");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4558");
    }
