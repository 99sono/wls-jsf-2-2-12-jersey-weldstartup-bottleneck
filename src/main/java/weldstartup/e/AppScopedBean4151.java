...
public class AppScopedBean4151 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4151.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4151");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4151");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4151");
    }
