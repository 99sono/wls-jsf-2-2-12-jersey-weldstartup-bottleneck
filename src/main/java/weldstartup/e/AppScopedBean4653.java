...
public class AppScopedBean4653 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4653.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4653");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4653");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4653");
    }
