...
public class AppScopedBean4177 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4177.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4177");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4177");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4177");
    }
