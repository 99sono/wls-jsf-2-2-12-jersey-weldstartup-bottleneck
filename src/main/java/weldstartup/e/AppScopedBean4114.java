...
public class AppScopedBean4114 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4114.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4114");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4114");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4114");
    }
