...
public class AppScopedBean4460 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4460.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4460");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4460");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4460");
    }
