...
public class AppScopedBean4785 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4785.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4785");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4785");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4785");
    }
