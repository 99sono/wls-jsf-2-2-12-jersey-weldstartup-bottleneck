...
public class AppScopedBean4872 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4872.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4872");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4872");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4872");
    }
