...
public class AppScopedBean4662 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4662.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4662");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4662");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4662");
    }
