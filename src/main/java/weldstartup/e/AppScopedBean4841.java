...
public class AppScopedBean4841 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4841.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4841");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4841");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4841");
    }
