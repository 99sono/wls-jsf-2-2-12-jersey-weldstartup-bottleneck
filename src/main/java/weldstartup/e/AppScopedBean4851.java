...
public class AppScopedBean4851 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4851.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4851");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4851");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4851");
    }
