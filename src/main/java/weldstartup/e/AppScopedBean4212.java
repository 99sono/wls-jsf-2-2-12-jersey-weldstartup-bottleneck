...
public class AppScopedBean4212 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4212.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4212");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4212");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4212");
    }
