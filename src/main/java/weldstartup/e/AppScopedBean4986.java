...
public class AppScopedBean4986 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4986.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4986");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4986");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4986");
    }
