...
public class AppScopedBean4643 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4643.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4643");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4643");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4643");
    }
