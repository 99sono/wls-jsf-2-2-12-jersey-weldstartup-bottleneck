...
public class AppScopedBean4019 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4019.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4019");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4019");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4019");
    }
