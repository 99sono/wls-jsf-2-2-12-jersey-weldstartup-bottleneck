...
public class AppScopedBean4524 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4524.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4524");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4524");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4524");
    }
