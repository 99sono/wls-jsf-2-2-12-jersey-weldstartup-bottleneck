...
public class AppScopedBean4525 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4525.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4525");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4525");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4525");
    }
