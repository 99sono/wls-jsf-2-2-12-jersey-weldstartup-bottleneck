...
public class AppScopedBean4034 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4034.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4034");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4034");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4034");
    }
