...
public class AppScopedBean4050 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4050.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4050");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4050");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4050");
    }
