...
public class AppScopedBean4340 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4340.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4340");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4340");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4340");
    }
