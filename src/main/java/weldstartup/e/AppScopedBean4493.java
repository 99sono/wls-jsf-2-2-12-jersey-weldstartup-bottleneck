...
public class AppScopedBean4493 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4493.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4493");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4493");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4493");
    }
