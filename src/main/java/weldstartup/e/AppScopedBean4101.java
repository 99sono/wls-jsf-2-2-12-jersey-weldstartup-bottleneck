...
public class AppScopedBean4101 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4101.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4101");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4101");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4101");
    }
