...
public class AppScopedBean4618 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4618.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4618");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4618");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4618");
    }
