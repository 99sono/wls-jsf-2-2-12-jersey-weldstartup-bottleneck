...
public class AppScopedBean4906 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4906.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4906");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4906");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4906");
    }
