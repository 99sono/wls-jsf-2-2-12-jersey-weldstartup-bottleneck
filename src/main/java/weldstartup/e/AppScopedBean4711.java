...
public class AppScopedBean4711 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4711.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4711");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4711");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4711");
    }
