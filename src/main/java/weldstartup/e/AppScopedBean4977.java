...
public class AppScopedBean4977 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4977.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4977");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4977");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4977");
    }
