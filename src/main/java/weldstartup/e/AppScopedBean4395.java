...
public class AppScopedBean4395 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4395.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4395");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4395");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4395");
    }
