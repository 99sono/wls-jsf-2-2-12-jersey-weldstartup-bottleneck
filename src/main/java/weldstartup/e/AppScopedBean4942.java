...
public class AppScopedBean4942 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4942.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4942");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4942");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4942");
    }
