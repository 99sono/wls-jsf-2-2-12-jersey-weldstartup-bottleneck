...
public class AppScopedBean4275 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4275.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4275");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4275");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4275");
    }
