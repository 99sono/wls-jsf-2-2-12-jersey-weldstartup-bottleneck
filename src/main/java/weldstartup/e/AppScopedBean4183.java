...
public class AppScopedBean4183 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4183.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4183");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4183");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4183");
    }
