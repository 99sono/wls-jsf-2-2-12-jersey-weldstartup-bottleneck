...
public class AppScopedBean4844 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4844.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4844");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4844");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4844");
    }
