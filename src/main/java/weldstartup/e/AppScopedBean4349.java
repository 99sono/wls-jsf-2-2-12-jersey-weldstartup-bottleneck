...
public class AppScopedBean4349 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4349.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4349");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4349");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4349");
    }
