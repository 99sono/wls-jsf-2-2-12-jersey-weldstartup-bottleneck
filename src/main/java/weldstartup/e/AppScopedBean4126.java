...
public class AppScopedBean4126 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4126.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4126");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4126");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4126");
    }
