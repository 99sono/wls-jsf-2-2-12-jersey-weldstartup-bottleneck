...
public class AppScopedBean4134 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4134.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4134");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4134");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4134");
    }
