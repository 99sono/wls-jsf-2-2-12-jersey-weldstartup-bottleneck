...
public class AppScopedBean4550 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4550.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4550");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4550");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4550");
    }
