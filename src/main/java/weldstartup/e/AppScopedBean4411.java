...
public class AppScopedBean4411 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4411.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4411");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4411");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4411");
    }
