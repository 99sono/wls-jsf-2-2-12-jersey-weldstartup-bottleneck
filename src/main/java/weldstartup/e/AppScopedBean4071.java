...
public class AppScopedBean4071 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4071.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4071");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4071");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4071");
    }
