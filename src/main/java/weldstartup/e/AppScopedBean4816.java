...
public class AppScopedBean4816 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4816.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4816");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4816");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4816");
    }
