...
public class AppScopedBean4644 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4644.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4644");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4644");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4644");
    }
