...
public class AppScopedBean4751 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4751.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4751");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4751");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4751");
    }
