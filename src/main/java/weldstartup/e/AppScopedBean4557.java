...
public class AppScopedBean4557 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4557.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4557");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4557");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4557");
    }
