...
public class AppScopedBean4164 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4164.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4164");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4164");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4164");
    }
