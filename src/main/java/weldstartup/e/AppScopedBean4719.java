...
public class AppScopedBean4719 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4719.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4719");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4719");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4719");
    }
