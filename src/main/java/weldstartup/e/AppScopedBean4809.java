...
public class AppScopedBean4809 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4809.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4809");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4809");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4809");
    }
