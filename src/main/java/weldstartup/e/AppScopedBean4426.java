...
public class AppScopedBean4426 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4426.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4426");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4426");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4426");
    }
