...
public class AppScopedBean4143 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4143.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4143");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4143");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4143");
    }
