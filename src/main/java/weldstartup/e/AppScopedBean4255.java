...
public class AppScopedBean4255 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4255.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4255");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4255");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4255");
    }
