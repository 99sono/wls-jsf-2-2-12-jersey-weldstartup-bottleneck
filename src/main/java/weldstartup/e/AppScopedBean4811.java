...
public class AppScopedBean4811 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4811.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4811");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4811");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4811");
    }
