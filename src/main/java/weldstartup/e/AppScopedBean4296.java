...
public class AppScopedBean4296 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4296.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4296");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4296");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4296");
    }
