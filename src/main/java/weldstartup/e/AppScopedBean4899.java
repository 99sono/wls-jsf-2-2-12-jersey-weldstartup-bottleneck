...
public class AppScopedBean4899 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4899.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4899");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4899");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4899");
    }
