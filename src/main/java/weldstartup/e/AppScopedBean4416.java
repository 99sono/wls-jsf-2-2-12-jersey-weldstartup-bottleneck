...
public class AppScopedBean4416 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4416.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4416");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4416");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4416");
    }
