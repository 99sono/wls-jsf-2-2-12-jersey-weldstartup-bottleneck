...
public class AppScopedBean4639 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4639.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4639");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4639");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4639");
    }
