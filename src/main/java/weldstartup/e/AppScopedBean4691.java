...
public class AppScopedBean4691 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4691.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4691");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4691");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4691");
    }
