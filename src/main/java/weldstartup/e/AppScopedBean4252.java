...
public class AppScopedBean4252 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4252.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4252");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4252");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4252");
    }
