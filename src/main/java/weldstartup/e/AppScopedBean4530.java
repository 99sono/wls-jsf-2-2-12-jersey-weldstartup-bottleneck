...
public class AppScopedBean4530 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4530.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4530");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4530");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4530");
    }
