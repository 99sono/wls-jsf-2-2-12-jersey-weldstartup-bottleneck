...
public class AppScopedBean4246 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4246.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4246");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4246");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4246");
    }
