...
public class AppScopedBean4003 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4003.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4003");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4003");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4003");
    }
