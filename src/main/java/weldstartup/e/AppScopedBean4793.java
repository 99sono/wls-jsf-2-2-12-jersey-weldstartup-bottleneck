...
public class AppScopedBean4793 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4793.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4793");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4793");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4793");
    }
