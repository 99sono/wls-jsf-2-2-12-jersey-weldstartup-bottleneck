...
public class AppScopedBean4832 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4832.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4832");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4832");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4832");
    }
