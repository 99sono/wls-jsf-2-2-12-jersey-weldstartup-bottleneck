...
public class AppScopedBean4892 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4892.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4892");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4892");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4892");
    }
