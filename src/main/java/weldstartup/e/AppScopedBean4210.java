...
public class AppScopedBean4210 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4210.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4210");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4210");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4210");
    }
