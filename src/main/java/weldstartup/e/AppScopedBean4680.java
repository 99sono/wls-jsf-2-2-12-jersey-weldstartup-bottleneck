...
public class AppScopedBean4680 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4680.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4680");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4680");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4680");
    }
