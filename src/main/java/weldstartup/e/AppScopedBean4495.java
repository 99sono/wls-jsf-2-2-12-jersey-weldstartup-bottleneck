...
public class AppScopedBean4495 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4495.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4495");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4495");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4495");
    }
