...
public class AppScopedBean4734 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4734.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4734");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4734");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4734");
    }
