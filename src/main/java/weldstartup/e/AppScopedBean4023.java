...
public class AppScopedBean4023 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4023.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4023");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4023");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4023");
    }
