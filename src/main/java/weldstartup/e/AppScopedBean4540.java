...
public class AppScopedBean4540 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4540.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4540");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4540");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4540");
    }
