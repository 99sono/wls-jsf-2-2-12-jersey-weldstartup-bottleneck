...
public class AppScopedBean4814 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4814.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4814");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4814");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4814");
    }
