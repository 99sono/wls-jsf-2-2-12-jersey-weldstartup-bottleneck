...
public class AppScopedBean4399 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4399.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4399");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4399");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4399");
    }
