...
public class AppScopedBean4264 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4264.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4264");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4264");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4264");
    }
