...
public class AppScopedBean4596 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4596.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4596");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4596");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4596");
    }
