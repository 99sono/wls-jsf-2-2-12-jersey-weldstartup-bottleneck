...
public class AppScopedBean4323 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4323.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4323");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4323");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4323");
    }
