...
public class AppScopedBean4430 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4430.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4430");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4430");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4430");
    }
