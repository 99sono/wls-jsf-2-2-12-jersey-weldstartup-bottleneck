...
public class AppScopedBean4251 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4251.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4251");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4251");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4251");
    }
