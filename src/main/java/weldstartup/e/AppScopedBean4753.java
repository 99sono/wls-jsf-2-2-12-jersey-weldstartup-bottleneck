...
public class AppScopedBean4753 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4753.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4753");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4753");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4753");
    }
