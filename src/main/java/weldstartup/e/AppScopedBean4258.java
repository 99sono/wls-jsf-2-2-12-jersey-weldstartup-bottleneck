...
public class AppScopedBean4258 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4258.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4258");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4258");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4258");
    }
