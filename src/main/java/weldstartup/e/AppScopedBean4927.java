...
public class AppScopedBean4927 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4927.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4927");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4927");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4927");
    }
