...
public class AppScopedBean4903 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4903.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4903");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4903");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4903");
    }
