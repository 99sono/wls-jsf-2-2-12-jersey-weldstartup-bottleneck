...
public class AppScopedBean4532 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4532.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4532");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4532");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4532");
    }
