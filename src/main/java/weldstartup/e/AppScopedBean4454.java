...
public class AppScopedBean4454 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4454.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4454");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4454");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4454");
    }
