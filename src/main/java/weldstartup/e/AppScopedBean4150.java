...
public class AppScopedBean4150 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4150.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4150");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4150");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4150");
    }
