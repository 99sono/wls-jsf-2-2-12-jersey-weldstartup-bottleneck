...
public class AppScopedBean4266 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4266.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4266");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4266");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4266");
    }
