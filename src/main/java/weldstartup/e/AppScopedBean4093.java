...
public class AppScopedBean4093 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4093.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4093");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4093");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4093");
    }
