...
public class AppScopedBean4496 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4496.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4496");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4496");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4496");
    }
