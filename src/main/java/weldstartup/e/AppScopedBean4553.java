...
public class AppScopedBean4553 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4553.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4553");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4553");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4553");
    }
