...
public class AppScopedBean4204 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4204.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4204");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4204");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4204");
    }
