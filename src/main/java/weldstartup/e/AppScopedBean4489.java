...
public class AppScopedBean4489 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4489.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4489");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4489");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4489");
    }
