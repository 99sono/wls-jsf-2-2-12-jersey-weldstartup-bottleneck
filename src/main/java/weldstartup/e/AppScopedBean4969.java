...
public class AppScopedBean4969 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4969.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4969");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4969");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4969");
    }
