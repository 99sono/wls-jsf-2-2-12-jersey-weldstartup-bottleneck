...
public class AppScopedBean4055 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4055.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4055");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4055");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4055");
    }
