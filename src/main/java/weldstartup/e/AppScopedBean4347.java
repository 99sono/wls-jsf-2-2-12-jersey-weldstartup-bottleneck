...
public class AppScopedBean4347 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4347.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4347");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4347");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4347");
    }
