...
public class AppScopedBean4404 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4404.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4404");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4404");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4404");
    }
