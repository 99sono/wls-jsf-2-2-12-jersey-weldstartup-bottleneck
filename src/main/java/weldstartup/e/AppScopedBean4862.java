...
public class AppScopedBean4862 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4862.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4862");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4862");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4862");
    }
