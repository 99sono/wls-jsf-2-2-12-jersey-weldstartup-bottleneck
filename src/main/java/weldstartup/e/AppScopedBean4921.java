...
public class AppScopedBean4921 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4921.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4921");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4921");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4921");
    }
