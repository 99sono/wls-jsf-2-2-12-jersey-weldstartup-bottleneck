...
public class AppScopedBean4181 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4181.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4181");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4181");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4181");
    }
