...
public class AppScopedBean4369 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4369.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4369");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4369");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4369");
    }
