...
public class AppScopedBean4270 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4270.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4270");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4270");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4270");
    }
