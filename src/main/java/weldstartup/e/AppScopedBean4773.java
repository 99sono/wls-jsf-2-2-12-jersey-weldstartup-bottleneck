...
public class AppScopedBean4773 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4773.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4773");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4773");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4773");
    }
