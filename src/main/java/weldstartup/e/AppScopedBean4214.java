...
public class AppScopedBean4214 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4214.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4214");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4214");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4214");
    }
