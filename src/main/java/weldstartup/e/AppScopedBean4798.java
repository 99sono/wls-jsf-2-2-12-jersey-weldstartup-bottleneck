...
public class AppScopedBean4798 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4798.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4798");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4798");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4798");
    }
