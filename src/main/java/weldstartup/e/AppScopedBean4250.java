...
public class AppScopedBean4250 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4250.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4250");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4250");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4250");
    }
