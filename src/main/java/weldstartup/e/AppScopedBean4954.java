...
public class AppScopedBean4954 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4954.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4954");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4954");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4954");
    }
