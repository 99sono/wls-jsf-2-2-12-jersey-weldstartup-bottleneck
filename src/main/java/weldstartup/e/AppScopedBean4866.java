...
public class AppScopedBean4866 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4866.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4866");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4866");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4866");
    }
