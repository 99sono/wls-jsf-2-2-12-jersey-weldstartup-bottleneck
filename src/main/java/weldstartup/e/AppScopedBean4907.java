...
public class AppScopedBean4907 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4907.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4907");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4907");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4907");
    }
