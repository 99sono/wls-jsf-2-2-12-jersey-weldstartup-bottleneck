...
public class AppScopedBean4772 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4772.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4772");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4772");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4772");
    }
