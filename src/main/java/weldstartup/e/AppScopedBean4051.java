...
public class AppScopedBean4051 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4051.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4051");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4051");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4051");
    }
