...
public class AppScopedBean4145 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4145.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4145");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4145");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4145");
    }
