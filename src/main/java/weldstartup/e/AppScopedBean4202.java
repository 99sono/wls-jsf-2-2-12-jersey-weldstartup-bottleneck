...
public class AppScopedBean4202 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4202.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4202");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4202");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4202");
    }
