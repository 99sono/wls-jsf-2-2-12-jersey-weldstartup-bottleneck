...
public class AppScopedBean4049 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4049.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4049");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4049");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4049");
    }
