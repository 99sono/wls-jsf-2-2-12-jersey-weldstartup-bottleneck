...
public class AppScopedBean4285 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4285.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4285");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4285");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4285");
    }
