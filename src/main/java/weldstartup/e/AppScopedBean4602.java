...
public class AppScopedBean4602 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4602.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4602");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4602");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4602");
    }
