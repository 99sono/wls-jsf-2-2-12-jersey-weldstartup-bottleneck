...
public class AppScopedBean4368 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4368.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4368");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4368");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4368");
    }
