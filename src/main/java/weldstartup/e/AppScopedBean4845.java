...
public class AppScopedBean4845 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4845.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4845");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4845");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4845");
    }
