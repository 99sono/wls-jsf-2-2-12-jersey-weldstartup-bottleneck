...
public class AppScopedBean4804 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4804.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4804");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4804");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4804");
    }
