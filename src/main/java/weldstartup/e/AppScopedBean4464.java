...
public class AppScopedBean4464 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4464.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4464");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4464");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4464");
    }
