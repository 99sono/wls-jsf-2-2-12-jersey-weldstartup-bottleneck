...
public class AppScopedBean4579 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4579.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4579");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4579");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4579");
    }
