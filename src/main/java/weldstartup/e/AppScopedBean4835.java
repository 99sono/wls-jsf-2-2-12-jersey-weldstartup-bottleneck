...
public class AppScopedBean4835 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4835.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4835");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4835");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4835");
    }
