...
public class AppScopedBean4886 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4886.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4886");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4886");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4886");
    }
