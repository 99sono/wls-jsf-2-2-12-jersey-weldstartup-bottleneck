...
public class AppScopedBean4488 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4488.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4488");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4488");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4488");
    }
