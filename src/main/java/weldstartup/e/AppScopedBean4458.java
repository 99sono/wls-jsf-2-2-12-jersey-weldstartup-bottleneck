...
public class AppScopedBean4458 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4458.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4458");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4458");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4458");
    }
