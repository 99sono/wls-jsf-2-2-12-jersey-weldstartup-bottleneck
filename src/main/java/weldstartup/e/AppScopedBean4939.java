...
public class AppScopedBean4939 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4939.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4939");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4939");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4939");
    }
