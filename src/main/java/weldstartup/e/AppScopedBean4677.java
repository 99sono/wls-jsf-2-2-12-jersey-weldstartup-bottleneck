...
public class AppScopedBean4677 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4677.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4677");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4677");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4677");
    }
