...
public class AppScopedBean4039 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4039.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4039");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4039");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4039");
    }
