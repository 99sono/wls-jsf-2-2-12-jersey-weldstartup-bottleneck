...
public class AppScopedBean4336 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4336.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4336");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4336");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4336");
    }
