...
public class AppScopedBean4331 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4331.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4331");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4331");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4331");
    }
