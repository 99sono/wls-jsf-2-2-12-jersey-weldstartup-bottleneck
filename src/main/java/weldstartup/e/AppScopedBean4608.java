...
public class AppScopedBean4608 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4608.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4608");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4608");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4608");
    }
