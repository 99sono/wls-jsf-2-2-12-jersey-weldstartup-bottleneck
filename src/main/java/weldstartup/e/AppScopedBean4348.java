...
public class AppScopedBean4348 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4348.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4348");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4348");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4348");
    }
