...
public class AppScopedBean4274 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4274.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4274");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4274");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4274");
    }
