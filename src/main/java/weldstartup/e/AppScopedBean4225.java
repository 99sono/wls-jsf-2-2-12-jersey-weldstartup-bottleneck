...
public class AppScopedBean4225 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4225.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4225");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4225");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4225");
    }
