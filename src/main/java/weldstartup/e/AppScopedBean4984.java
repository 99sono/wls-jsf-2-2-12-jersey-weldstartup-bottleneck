...
public class AppScopedBean4984 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4984.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4984");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4984");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4984");
    }
