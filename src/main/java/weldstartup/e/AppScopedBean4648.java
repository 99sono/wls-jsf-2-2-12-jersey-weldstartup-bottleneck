...
public class AppScopedBean4648 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4648.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4648");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4648");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4648");
    }
