...
public class AppScopedBean4926 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4926.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4926");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4926");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4926");
    }
