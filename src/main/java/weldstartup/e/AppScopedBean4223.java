...
public class AppScopedBean4223 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4223.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4223");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4223");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4223");
    }
