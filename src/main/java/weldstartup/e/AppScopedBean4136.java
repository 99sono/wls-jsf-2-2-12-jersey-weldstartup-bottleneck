...
public class AppScopedBean4136 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4136.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4136");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4136");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4136");
    }
