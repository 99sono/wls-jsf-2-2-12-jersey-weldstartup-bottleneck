...
public class AppScopedBean4355 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4355.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4355");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4355");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4355");
    }
