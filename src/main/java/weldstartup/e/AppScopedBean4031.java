...
public class AppScopedBean4031 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4031.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4031");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4031");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4031");
    }
