...
public class AppScopedBean4026 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4026.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4026");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4026");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4026");
    }
