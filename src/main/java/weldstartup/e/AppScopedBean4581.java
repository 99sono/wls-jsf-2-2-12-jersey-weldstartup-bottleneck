...
public class AppScopedBean4581 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4581.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4581");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4581");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4581");
    }
