...
public class AppScopedBean4498 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean4498.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean4498");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean4498");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean4498");
    }
