...
public class AppScopedBean1755 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1755.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1755");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1755");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1755");
    }
