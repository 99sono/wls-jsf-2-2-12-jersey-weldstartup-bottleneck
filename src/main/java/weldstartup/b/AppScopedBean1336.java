...
public class AppScopedBean1336 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1336.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1336");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1336");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1336");
    }
