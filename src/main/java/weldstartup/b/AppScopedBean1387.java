...
public class AppScopedBean1387 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1387.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1387");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1387");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1387");
    }
