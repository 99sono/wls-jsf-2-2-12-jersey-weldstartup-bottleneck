...
public class AppScopedBean1669 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1669.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1669");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1669");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1669");
    }
