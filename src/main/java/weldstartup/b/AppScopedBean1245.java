...
public class AppScopedBean1245 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1245.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1245");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1245");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1245");
    }
