...
public class AppScopedBean1700 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1700.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1700");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1700");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1700");
    }
