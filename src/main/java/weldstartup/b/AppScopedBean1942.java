...
public class AppScopedBean1942 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1942.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1942");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1942");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1942");
    }
