...
public class AppScopedBean1120 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1120.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1120");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1120");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1120");
    }
