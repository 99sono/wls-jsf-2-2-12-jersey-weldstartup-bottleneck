...
public class AppScopedBean1638 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1638.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1638");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1638");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1638");
    }
