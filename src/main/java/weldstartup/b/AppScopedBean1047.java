...
public class AppScopedBean1047 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1047.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1047");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1047");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1047");
    }
