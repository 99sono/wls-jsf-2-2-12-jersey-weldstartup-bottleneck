...
public class AppScopedBean1626 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1626.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1626");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1626");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1626");
    }
