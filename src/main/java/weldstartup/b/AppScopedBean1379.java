...
public class AppScopedBean1379 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1379.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1379");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1379");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1379");
    }
