...
public class AppScopedBean1414 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1414.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1414");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1414");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1414");
    }
