...
public class AppScopedBean1995 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1995.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1995");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1995");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1995");
    }
