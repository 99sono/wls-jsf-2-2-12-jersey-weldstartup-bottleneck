...
public class AppScopedBean1463 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1463.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1463");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1463");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1463");
    }
