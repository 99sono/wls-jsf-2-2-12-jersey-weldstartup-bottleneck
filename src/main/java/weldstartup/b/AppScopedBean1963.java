...
public class AppScopedBean1963 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1963.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1963");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1963");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1963");
    }
