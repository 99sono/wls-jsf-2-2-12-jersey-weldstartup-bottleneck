...
public class AppScopedBean1250 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1250.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1250");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1250");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1250");
    }
