...
public class AppScopedBean1076 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1076.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1076");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1076");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1076");
    }
