...
public class AppScopedBean1806 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1806.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1806");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1806");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1806");
    }
