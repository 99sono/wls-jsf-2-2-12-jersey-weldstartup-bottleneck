...
public class AppScopedBean1599 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1599.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1599");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1599");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1599");
    }
