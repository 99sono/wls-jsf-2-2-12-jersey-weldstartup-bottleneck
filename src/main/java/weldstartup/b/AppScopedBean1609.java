...
public class AppScopedBean1609 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1609.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1609");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1609");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1609");
    }
