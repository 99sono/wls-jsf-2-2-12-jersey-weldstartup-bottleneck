...
public class AppScopedBean1654 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1654.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1654");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1654");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1654");
    }
