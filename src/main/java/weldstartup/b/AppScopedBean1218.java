...
public class AppScopedBean1218 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1218.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1218");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1218");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1218");
    }
