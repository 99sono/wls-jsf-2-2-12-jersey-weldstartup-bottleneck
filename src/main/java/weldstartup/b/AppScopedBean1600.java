...
public class AppScopedBean1600 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1600.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1600");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1600");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1600");
    }
