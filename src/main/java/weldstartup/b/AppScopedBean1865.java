...
public class AppScopedBean1865 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1865.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1865");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1865");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1865");
    }
