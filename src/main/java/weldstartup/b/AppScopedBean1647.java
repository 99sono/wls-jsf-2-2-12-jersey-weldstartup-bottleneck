...
public class AppScopedBean1647 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1647.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1647");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1647");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1647");
    }
