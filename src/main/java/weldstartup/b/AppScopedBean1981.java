...
public class AppScopedBean1981 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1981.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1981");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1981");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1981");
    }
