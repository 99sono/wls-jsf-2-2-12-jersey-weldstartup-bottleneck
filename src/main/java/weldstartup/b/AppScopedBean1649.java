...
public class AppScopedBean1649 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1649.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1649");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1649");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1649");
    }
