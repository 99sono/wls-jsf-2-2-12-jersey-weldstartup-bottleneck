...
public class AppScopedBean1769 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1769.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1769");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1769");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1769");
    }
