...
public class AppScopedBean1219 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1219.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1219");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1219");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1219");
    }
