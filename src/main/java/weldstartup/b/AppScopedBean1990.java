...
public class AppScopedBean1990 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1990.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1990");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1990");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1990");
    }
