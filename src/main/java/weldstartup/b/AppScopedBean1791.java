...
public class AppScopedBean1791 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1791.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1791");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1791");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1791");
    }
