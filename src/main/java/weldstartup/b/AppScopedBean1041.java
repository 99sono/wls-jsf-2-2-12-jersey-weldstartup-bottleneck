...
public class AppScopedBean1041 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1041.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1041");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1041");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1041");
    }
