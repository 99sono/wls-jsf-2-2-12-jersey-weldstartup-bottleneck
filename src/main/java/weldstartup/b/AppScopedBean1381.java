...
public class AppScopedBean1381 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1381.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1381");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1381");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1381");
    }
