...
public class AppScopedBean1288 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1288.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1288");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1288");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1288");
    }
