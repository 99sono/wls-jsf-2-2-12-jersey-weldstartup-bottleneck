...
public class AppScopedBean1329 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1329.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1329");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1329");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1329");
    }
