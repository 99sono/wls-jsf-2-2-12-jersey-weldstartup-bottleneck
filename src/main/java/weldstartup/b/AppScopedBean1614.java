...
public class AppScopedBean1614 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1614.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1614");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1614");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1614");
    }
