...
public class AppScopedBean1774 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1774.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1774");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1774");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1774");
    }
