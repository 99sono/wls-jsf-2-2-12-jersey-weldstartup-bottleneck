...
public class AppScopedBean1504 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1504.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1504");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1504");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1504");
    }
