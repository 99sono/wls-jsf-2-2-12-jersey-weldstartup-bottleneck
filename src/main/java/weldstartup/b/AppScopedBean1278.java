...
public class AppScopedBean1278 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1278.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1278");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1278");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1278");
    }
