...
public class AppScopedBean1285 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1285.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1285");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1285");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1285");
    }
