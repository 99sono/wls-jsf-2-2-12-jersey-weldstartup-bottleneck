...
public class AppScopedBean1332 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1332.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1332");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1332");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1332");
    }
