...
public class AppScopedBean1088 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1088.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1088");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1088");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1088");
    }
