...
public class AppScopedBean1856 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1856.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1856");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1856");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1856");
    }
