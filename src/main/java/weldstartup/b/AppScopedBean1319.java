...
public class AppScopedBean1319 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1319.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1319");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1319");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1319");
    }
