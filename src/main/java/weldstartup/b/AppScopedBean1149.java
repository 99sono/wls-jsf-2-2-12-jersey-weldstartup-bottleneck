...
public class AppScopedBean1149 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1149.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1149");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1149");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1149");
    }
