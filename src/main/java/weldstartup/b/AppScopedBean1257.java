...
public class AppScopedBean1257 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1257.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1257");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1257");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1257");
    }
