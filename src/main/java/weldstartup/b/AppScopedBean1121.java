...
public class AppScopedBean1121 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1121.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1121");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1121");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1121");
    }
