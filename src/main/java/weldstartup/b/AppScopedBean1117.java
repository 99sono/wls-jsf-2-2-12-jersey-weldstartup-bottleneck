...
public class AppScopedBean1117 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1117.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1117");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1117");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1117");
    }
