...
public class AppScopedBean1781 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1781.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1781");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1781");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1781");
    }
