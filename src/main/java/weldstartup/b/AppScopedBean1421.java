...
public class AppScopedBean1421 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1421.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1421");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1421");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1421");
    }
