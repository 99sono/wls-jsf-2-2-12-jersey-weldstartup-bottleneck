...
public class AppScopedBean1025 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1025.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1025");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1025");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1025");
    }
