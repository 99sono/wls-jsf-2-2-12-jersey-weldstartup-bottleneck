...
public class AppScopedBean1576 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1576.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1576");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1576");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1576");
    }
