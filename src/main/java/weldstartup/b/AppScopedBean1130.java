...
public class AppScopedBean1130 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1130.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1130");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1130");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1130");
    }
