...
public class AppScopedBean1444 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1444.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1444");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1444");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1444");
    }
