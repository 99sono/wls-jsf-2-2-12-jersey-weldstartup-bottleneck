...
public class AppScopedBean1704 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1704.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1704");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1704");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1704");
    }
