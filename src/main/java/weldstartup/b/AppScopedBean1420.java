...
public class AppScopedBean1420 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1420.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1420");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1420");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1420");
    }
