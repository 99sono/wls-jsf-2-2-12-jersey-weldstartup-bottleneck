...
public class AppScopedBean1111 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1111.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1111");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1111");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1111");
    }
