...
public class AppScopedBean1736 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1736.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1736");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1736");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1736");
    }
