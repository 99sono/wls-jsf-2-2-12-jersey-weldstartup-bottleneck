...
public class AppScopedBean1993 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1993.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1993");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1993");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1993");
    }
