...
public class AppScopedBean1846 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1846.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1846");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1846");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1846");
    }
