...
public class AppScopedBean1123 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1123.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1123");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1123");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1123");
    }
