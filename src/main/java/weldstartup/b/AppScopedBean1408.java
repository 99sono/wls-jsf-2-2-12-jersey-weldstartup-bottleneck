...
public class AppScopedBean1408 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1408.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1408");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1408");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1408");
    }
