...
public class AppScopedBean1653 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1653.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1653");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1653");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1653");
    }
