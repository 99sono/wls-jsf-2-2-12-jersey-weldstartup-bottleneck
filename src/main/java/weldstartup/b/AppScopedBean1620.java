...
public class AppScopedBean1620 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1620.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1620");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1620");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1620");
    }
