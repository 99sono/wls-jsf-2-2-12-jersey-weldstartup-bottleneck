...
public class AppScopedBean1765 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1765.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1765");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1765");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1765");
    }
