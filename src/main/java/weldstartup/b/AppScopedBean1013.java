...
public class AppScopedBean1013 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1013.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1013");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1013");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1013");
    }
