...
public class AppScopedBean1607 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1607.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1607");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1607");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1607");
    }
