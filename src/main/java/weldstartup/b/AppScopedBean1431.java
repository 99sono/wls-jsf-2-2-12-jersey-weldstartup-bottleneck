...
public class AppScopedBean1431 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1431.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1431");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1431");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1431");
    }
