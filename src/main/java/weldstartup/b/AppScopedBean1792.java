...
public class AppScopedBean1792 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1792.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1792");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1792");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1792");
    }
