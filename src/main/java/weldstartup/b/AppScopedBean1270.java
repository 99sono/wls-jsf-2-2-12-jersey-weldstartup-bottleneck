...
public class AppScopedBean1270 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1270.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1270");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1270");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1270");
    }
