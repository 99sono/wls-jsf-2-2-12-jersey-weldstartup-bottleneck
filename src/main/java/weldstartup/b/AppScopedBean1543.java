...
public class AppScopedBean1543 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1543.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1543");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1543");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1543");
    }
