...
public class AppScopedBean1124 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1124.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1124");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1124");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1124");
    }
