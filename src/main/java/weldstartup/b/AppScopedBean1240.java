...
public class AppScopedBean1240 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1240.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1240");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1240");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1240");
    }
