...
public class AppScopedBean1416 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1416.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1416");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1416");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1416");
    }
