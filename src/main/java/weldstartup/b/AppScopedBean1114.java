...
public class AppScopedBean1114 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1114.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1114");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1114");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1114");
    }
