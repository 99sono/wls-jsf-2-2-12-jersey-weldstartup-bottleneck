...
public class AppScopedBean1832 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1832.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1832");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1832");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1832");
    }
