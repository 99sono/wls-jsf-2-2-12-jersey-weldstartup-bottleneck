...
public class AppScopedBean1360 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1360.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1360");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1360");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1360");
    }
