...
public class AppScopedBean1280 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1280.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1280");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1280");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1280");
    }
