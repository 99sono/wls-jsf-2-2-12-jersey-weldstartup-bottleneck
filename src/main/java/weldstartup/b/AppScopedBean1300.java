...
public class AppScopedBean1300 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1300.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1300");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1300");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1300");
    }
