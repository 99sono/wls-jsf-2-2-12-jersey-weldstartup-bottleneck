...
public class AppScopedBean1627 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1627.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1627");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1627");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1627");
    }
