...
public class AppScopedBean1410 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1410.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1410");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1410");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1410");
    }
