...
public class AppScopedBean1059 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1059.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1059");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1059");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1059");
    }
