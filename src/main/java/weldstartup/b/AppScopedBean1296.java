...
public class AppScopedBean1296 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1296.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1296");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1296");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1296");
    }
