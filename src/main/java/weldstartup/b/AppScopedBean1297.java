...
public class AppScopedBean1297 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1297.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1297");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1297");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1297");
    }
