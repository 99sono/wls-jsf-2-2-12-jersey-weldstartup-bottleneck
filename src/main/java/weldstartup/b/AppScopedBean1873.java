...
public class AppScopedBean1873 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1873.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1873");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1873");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1873");
    }
