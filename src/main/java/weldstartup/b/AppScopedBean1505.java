...
public class AppScopedBean1505 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1505.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1505");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1505");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1505");
    }
