...
public class AppScopedBean1204 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1204.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1204");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1204");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1204");
    }
