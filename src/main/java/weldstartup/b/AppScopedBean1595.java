...
public class AppScopedBean1595 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1595.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1595");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1595");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1595");
    }
