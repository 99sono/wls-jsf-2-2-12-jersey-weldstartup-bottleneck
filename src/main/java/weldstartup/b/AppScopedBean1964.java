...
public class AppScopedBean1964 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1964.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1964");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1964");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1964");
    }
