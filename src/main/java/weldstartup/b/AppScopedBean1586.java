...
public class AppScopedBean1586 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1586.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1586");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1586");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1586");
    }
