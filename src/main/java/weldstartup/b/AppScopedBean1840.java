...
public class AppScopedBean1840 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1840.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1840");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1840");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1840");
    }
