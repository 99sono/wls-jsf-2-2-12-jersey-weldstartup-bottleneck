...
public class AppScopedBean1452 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1452.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1452");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1452");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1452");
    }
