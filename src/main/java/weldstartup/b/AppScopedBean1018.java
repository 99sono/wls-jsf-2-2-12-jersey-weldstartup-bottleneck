...
public class AppScopedBean1018 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1018.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1018");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1018");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1018");
    }
