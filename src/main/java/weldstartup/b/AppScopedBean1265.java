...
public class AppScopedBean1265 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1265.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1265");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1265");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1265");
    }
