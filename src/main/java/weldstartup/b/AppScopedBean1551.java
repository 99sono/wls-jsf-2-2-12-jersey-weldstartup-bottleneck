...
public class AppScopedBean1551 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1551.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1551");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1551");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1551");
    }
