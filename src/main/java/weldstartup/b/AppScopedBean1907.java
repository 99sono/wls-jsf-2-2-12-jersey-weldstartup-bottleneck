...
public class AppScopedBean1907 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1907.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1907");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1907");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1907");
    }
