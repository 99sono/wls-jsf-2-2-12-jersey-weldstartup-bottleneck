...
public class AppScopedBean1090 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1090.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1090");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1090");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1090");
    }
