...
public class AppScopedBean1175 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1175.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1175");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1175");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1175");
    }
