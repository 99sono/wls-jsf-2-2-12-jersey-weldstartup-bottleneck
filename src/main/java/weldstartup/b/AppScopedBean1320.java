...
public class AppScopedBean1320 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1320.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1320");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1320");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1320");
    }
