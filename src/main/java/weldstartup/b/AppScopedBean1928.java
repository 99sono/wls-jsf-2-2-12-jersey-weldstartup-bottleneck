...
public class AppScopedBean1928 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1928.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1928");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1928");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1928");
    }
