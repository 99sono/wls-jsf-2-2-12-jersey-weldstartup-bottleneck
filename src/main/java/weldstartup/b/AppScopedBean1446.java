...
public class AppScopedBean1446 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1446.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1446");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1446");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1446");
    }
