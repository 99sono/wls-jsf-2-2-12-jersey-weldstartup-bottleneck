...
public class AppScopedBean1612 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1612.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1612");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1612");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1612");
    }
