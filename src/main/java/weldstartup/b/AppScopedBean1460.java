...
public class AppScopedBean1460 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1460.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1460");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1460");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1460");
    }
