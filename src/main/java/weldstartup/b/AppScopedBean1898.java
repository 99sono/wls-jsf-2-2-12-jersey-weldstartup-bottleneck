...
public class AppScopedBean1898 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1898.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1898");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1898");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1898");
    }
