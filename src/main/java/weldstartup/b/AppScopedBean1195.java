...
public class AppScopedBean1195 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1195.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1195");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1195");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1195");
    }
