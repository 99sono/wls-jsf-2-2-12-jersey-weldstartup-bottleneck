...
public class AppScopedBean1722 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1722.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1722");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1722");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1722");
    }
