...
public class AppScopedBean1398 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1398.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1398");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1398");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1398");
    }
