...
public class AppScopedBean1207 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1207.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1207");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1207");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1207");
    }
