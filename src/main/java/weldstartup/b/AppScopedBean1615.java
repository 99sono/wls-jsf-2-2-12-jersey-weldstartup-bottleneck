...
public class AppScopedBean1615 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1615.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1615");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1615");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1615");
    }
