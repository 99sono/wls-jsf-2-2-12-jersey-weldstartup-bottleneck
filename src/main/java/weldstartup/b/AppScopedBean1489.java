...
public class AppScopedBean1489 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1489.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1489");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1489");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1489");
    }
