...
public class AppScopedBean1456 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1456.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1456");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1456");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1456");
    }
