...
public class AppScopedBean1929 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1929.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1929");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1929");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1929");
    }
