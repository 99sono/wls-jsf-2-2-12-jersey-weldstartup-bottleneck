...
public class AppScopedBean1119 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1119.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1119");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1119");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1119");
    }
