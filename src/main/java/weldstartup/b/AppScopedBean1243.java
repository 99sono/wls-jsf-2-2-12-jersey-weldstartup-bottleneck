...
public class AppScopedBean1243 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1243.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1243");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1243");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1243");
    }
