...
public class AppScopedBean1205 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1205.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1205");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1205");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1205");
    }
