...
public class AppScopedBean1892 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1892.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1892");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1892");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1892");
    }
