...
public class AppScopedBean1522 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1522.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1522");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1522");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1522");
    }
