...
public class AppScopedBean1203 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1203.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1203");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1203");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1203");
    }
