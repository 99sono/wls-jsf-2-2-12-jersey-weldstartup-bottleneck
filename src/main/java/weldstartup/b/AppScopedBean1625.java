...
public class AppScopedBean1625 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1625.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1625");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1625");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1625");
    }
