...
public class AppScopedBean1664 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1664.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1664");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1664");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1664");
    }
