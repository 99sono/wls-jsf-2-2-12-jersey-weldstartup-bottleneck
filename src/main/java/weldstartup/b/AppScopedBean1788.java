...
public class AppScopedBean1788 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1788.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1788");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1788");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1788");
    }
