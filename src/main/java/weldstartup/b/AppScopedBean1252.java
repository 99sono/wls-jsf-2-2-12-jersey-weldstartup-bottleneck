...
public class AppScopedBean1252 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1252.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1252");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1252");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1252");
    }
