...
public class AppScopedBean1172 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1172.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1172");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1172");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1172");
    }
