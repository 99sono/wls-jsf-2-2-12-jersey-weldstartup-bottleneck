...
public class AppScopedBean1828 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1828.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1828");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1828");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1828");
    }
