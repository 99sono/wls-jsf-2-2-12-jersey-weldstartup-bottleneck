...
public class AppScopedBean1221 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1221.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1221");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1221");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1221");
    }
