...
public class AppScopedBean1888 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1888.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1888");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1888");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1888");
    }
