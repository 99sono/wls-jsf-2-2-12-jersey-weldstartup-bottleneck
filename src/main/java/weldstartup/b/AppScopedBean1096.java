...
public class AppScopedBean1096 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1096.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1096");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1096");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1096");
    }
