...
public class AppScopedBean1556 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1556.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1556");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1556");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1556");
    }
