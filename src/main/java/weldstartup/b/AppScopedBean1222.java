...
public class AppScopedBean1222 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1222.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1222");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1222");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1222");
    }
