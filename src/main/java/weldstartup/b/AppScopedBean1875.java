...
public class AppScopedBean1875 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1875.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1875");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1875");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1875");
    }
