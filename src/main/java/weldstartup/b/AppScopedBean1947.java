...
public class AppScopedBean1947 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1947.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1947");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1947");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1947");
    }
