...
public class AppScopedBean1530 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1530.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1530");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1530");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1530");
    }
