...
public class AppScopedBean1573 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1573.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1573");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1573");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1573");
    }
