...
public class AppScopedBean1325 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1325.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1325");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1325");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1325");
    }
