...
public class AppScopedBean1006 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1006.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1006");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1006");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1006");
    }
