...
public class AppScopedBean1023 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1023.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1023");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1023");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1023");
    }
