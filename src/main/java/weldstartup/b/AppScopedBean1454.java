...
public class AppScopedBean1454 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1454.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1454");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1454");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1454");
    }
