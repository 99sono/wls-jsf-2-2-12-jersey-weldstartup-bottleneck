...
public class AppScopedBean1510 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1510.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1510");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1510");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1510");
    }
