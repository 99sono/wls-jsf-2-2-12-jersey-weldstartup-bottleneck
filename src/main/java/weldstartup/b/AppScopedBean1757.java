...
public class AppScopedBean1757 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1757.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1757");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1757");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1757");
    }
