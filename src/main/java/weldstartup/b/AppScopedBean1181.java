...
public class AppScopedBean1181 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1181.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1181");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1181");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1181");
    }
