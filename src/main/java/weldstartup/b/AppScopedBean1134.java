...
public class AppScopedBean1134 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1134.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1134");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1134");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1134");
    }
