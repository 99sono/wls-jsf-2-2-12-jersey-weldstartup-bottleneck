...
public class AppScopedBean1490 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1490.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1490");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1490");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1490");
    }
