...
public class AppScopedBean1957 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1957.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1957");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1957");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1957");
    }
