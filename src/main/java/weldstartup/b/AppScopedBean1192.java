...
public class AppScopedBean1192 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1192.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1192");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1192");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1192");
    }
