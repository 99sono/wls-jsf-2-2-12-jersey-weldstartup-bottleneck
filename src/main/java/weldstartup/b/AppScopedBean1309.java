...
public class AppScopedBean1309 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1309.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1309");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1309");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1309");
    }
