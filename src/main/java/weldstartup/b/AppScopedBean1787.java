...
public class AppScopedBean1787 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1787.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1787");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1787");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1787");
    }
