...
public class AppScopedBean1858 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1858.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1858");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1858");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1858");
    }
