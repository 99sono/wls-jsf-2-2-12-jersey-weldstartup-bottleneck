...
public class AppScopedBean1694 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1694.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1694");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1694");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1694");
    }
