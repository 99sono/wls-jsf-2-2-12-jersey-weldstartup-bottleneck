...
public class AppScopedBean1441 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1441.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1441");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1441");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1441");
    }
