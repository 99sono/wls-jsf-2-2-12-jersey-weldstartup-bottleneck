...
public class AppScopedBean1465 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1465.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1465");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1465");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1465");
    }
