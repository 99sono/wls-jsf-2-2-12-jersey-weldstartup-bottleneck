...
public class AppScopedBean1642 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1642.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1642");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1642");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1642");
    }
