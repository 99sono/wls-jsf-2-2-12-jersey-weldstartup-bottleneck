...
public class AppScopedBean1008 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1008.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1008");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1008");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1008");
    }
