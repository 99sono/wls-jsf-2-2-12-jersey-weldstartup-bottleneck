...
public class AppScopedBean1197 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1197.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1197");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1197");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1197");
    }
