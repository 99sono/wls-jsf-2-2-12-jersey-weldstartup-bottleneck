...
public class AppScopedBean1651 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1651.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1651");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1651");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1651");
    }
