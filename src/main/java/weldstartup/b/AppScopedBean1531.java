...
public class AppScopedBean1531 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1531.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1531");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1531");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1531");
    }
