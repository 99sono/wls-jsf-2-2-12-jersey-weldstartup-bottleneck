...
public class AppScopedBean1194 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1194.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1194");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1194");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1194");
    }
