...
public class AppScopedBean1877 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1877.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1877");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1877");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1877");
    }
