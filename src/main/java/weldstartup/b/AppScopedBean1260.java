...
public class AppScopedBean1260 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1260.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1260");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1260");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1260");
    }
