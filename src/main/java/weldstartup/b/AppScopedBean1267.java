...
public class AppScopedBean1267 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1267.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1267");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1267");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1267");
    }
