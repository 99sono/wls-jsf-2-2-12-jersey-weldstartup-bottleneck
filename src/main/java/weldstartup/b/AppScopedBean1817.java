...
public class AppScopedBean1817 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1817.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1817");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1817");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1817");
    }
