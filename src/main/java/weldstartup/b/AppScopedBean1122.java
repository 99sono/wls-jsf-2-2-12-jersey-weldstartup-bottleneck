...
public class AppScopedBean1122 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1122.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1122");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1122");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1122");
    }
