...
public class AppScopedBean1953 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1953.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1953");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1953");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1953");
    }
