...
public class AppScopedBean1767 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1767.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1767");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1767");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1767");
    }
