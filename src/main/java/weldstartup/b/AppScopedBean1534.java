...
public class AppScopedBean1534 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1534.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1534");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1534");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1534");
    }
