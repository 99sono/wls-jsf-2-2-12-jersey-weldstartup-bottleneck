...
public class AppScopedBean1949 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1949.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1949");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1949");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1949");
    }
