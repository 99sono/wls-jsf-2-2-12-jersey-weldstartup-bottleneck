...
public class AppScopedBean1816 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1816.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1816");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1816");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1816");
    }
