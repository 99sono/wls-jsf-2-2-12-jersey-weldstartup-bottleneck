...
public class AppScopedBean1707 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1707.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1707");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1707");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1707");
    }
