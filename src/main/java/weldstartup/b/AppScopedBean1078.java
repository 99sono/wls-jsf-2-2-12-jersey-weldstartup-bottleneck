...
public class AppScopedBean1078 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1078.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1078");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1078");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1078");
    }
