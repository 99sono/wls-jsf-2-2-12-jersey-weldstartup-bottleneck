...
public class AppScopedBean1533 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1533.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1533");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1533");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1533");
    }
