...
public class AppScopedBean1952 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1952.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1952");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1952");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1952");
    }
