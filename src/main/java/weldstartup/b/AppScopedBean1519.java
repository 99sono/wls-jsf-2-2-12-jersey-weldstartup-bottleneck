...
public class AppScopedBean1519 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1519.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1519");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1519");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1519");
    }
