...
public class AppScopedBean1256 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1256.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1256");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1256");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1256");
    }
