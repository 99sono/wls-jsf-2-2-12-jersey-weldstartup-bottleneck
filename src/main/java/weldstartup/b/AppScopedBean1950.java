...
public class AppScopedBean1950 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1950.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1950");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1950");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1950");
    }
