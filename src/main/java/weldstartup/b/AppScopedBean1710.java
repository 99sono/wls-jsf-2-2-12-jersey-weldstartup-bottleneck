...
public class AppScopedBean1710 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1710.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1710");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1710");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1710");
    }
