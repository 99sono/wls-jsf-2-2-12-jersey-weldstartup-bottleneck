...
public class AppScopedBean1937 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1937.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1937");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1937");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1937");
    }
