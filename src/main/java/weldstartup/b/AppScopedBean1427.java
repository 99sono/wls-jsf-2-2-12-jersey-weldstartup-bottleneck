...
public class AppScopedBean1427 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1427.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1427");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1427");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1427");
    }
