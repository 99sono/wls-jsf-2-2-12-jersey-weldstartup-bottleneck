...
public class AppScopedBean1918 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1918.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1918");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1918");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1918");
    }
