...
public class AppScopedBean1601 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1601.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1601");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1601");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1601");
    }
