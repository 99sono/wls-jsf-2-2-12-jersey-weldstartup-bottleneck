...
public class AppScopedBean1885 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1885.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1885");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1885");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1885");
    }
