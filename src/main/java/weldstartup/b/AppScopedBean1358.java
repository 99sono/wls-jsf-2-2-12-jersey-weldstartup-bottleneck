...
public class AppScopedBean1358 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1358.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1358");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1358");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1358");
    }
