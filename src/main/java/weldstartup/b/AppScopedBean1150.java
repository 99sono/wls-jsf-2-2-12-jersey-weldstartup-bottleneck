...
public class AppScopedBean1150 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1150.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1150");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1150");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1150");
    }
