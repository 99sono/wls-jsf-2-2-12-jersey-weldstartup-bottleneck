...
public class AppScopedBean1021 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1021.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1021");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1021");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1021");
    }
