...
public class AppScopedBean1244 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1244.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1244");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1244");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1244");
    }
