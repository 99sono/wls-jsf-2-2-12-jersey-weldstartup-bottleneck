...
public class AppScopedBean1039 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1039.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1039");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1039");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1039");
    }
