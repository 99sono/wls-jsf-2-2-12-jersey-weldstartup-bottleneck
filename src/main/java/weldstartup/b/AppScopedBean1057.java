...
public class AppScopedBean1057 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1057.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1057");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1057");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1057");
    }
