...
public class AppScopedBean1415 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1415.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1415");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1415");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1415");
    }
