...
public class AppScopedBean1135 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1135.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1135");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1135");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1135");
    }
