...
public class AppScopedBean1796 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1796.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1796");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1796");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1796");
    }
