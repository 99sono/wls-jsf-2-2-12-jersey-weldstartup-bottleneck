...
public class AppScopedBean1255 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1255.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1255");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1255");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1255");
    }
