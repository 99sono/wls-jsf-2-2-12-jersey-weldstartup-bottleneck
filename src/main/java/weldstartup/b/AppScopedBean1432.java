...
public class AppScopedBean1432 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1432.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1432");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1432");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1432");
    }
