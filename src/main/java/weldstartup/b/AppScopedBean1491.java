...
public class AppScopedBean1491 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1491.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1491");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1491");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1491");
    }
