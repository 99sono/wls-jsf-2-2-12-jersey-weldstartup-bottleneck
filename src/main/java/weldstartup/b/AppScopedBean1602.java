...
public class AppScopedBean1602 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1602.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1602");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1602");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1602");
    }
