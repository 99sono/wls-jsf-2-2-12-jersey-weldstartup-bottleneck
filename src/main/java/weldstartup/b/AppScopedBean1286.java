...
public class AppScopedBean1286 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1286.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1286");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1286");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1286");
    }
