...
public class AppScopedBean1756 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1756.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1756");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1756");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1756");
    }
