...
public class AppScopedBean1798 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1798.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1798");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1798");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1798");
    }
