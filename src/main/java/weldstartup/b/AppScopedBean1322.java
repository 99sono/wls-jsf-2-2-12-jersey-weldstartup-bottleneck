...
public class AppScopedBean1322 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1322.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1322");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1322");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1322");
    }
