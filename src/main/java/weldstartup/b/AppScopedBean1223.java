...
public class AppScopedBean1223 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1223.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1223");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1223");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1223");
    }
