...
public class AppScopedBean1794 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1794.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1794");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1794");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1794");
    }
