...
public class AppScopedBean1808 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1808.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1808");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1808");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1808");
    }
