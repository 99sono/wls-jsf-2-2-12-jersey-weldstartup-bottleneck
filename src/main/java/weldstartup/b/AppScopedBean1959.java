...
public class AppScopedBean1959 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1959.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1959");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1959");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1959");
    }
