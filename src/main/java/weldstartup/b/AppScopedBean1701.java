...
public class AppScopedBean1701 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1701.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1701");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1701");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1701");
    }
