...
public class AppScopedBean1876 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1876.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1876");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1876");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1876");
    }
