...
public class AppScopedBean1943 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1943.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1943");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1943");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1943");
    }
