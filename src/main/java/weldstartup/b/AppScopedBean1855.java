...
public class AppScopedBean1855 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1855.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1855");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1855");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1855");
    }
