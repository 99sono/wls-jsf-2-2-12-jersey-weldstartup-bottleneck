...
public class AppScopedBean1324 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1324.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1324");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1324");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1324");
    }
