...
public class AppScopedBean1227 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1227.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1227");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1227");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1227");
    }
