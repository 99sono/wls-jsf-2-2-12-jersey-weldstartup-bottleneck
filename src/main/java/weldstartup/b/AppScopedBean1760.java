...
public class AppScopedBean1760 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1760.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1760");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1760");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1760");
    }
