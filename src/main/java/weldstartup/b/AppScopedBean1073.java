...
public class AppScopedBean1073 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1073.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1073");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1073");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1073");
    }
