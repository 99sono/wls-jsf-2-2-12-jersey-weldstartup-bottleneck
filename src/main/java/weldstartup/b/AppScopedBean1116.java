...
public class AppScopedBean1116 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1116.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1116");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1116");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1116");
    }
