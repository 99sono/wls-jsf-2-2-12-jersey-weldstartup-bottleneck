...
public class AppScopedBean1893 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1893.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1893");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1893");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1893");
    }
