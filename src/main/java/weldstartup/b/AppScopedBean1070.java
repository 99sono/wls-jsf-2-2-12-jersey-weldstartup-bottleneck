...
public class AppScopedBean1070 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1070.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1070");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1070");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1070");
    }
