...
public class AppScopedBean1584 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1584.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1584");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1584");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1584");
    }
