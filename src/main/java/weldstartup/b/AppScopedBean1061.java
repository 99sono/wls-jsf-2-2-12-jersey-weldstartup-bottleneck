...
public class AppScopedBean1061 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1061.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1061");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1061");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1061");
    }
