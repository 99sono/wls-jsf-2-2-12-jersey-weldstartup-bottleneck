...
public class AppScopedBean1323 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1323.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1323");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1323");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1323");
    }
