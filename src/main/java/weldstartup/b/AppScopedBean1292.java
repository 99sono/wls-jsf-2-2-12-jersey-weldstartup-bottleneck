...
public class AppScopedBean1292 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1292.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1292");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1292");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1292");
    }
