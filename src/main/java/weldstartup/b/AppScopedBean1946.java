...
public class AppScopedBean1946 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1946.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1946");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1946");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1946");
    }
