...
public class AppScopedBean1359 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1359.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1359");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1359");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1359");
    }
