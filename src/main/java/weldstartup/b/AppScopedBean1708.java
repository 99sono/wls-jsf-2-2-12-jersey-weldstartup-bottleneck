...
public class AppScopedBean1708 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1708.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1708");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1708");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1708");
    }
