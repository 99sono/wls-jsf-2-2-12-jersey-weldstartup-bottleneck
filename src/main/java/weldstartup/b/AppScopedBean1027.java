...
public class AppScopedBean1027 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1027.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1027");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1027");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1027");
    }
