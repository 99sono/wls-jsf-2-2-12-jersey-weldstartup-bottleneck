...
public class AppScopedBean1289 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1289.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1289");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1289");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1289");
    }
