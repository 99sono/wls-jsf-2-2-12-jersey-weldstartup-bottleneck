...
public class AppScopedBean1349 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1349.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1349");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1349");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1349");
    }
