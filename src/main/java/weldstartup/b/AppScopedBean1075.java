...
public class AppScopedBean1075 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1075.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1075");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1075");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1075");
    }
