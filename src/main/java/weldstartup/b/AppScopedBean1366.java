...
public class AppScopedBean1366 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1366.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1366");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1366");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1366");
    }
