...
public class AppScopedBean1975 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1975.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1975");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1975");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1975");
    }
