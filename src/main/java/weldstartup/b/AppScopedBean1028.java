...
public class AppScopedBean1028 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1028.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1028");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1028");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1028");
    }
