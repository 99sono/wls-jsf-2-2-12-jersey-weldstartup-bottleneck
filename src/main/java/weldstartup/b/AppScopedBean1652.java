...
public class AppScopedBean1652 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1652.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1652");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1652");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1652");
    }
