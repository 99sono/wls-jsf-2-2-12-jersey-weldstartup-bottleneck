...
public class AppScopedBean1539 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1539.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1539");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1539");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1539");
    }
