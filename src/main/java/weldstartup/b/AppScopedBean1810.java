...
public class AppScopedBean1810 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1810.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1810");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1810");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1810");
    }
