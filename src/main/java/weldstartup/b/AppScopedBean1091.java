...
public class AppScopedBean1091 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1091.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1091");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1091");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1091");
    }
