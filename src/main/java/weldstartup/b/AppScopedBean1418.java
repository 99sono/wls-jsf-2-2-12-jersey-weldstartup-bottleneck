...
public class AppScopedBean1418 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1418.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1418");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1418");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1418");
    }
