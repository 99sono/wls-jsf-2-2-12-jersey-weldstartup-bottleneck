...
public class AppScopedBean1773 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1773.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1773");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1773");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1773");
    }
