...
public class AppScopedBean1772 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1772.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1772");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1772");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1772");
    }
