...
public class AppScopedBean1718 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1718.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1718");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1718");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1718");
    }
