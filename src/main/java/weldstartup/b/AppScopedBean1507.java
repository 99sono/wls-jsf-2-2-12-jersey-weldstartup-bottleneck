...
public class AppScopedBean1507 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1507.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1507");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1507");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1507");
    }
