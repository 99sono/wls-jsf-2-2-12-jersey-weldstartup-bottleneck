...
public class AppScopedBean1365 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1365.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1365");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1365");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1365");
    }
