...
public class AppScopedBean1036 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1036.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1036");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1036");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1036");
    }
