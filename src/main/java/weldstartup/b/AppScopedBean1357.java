...
public class AppScopedBean1357 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1357.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1357");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1357");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1357");
    }
