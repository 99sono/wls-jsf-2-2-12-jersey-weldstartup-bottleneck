...
public class AppScopedBean1388 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1388.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1388");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1388");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1388");
    }
