...
public class AppScopedBean1940 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1940.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1940");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1940");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1940");
    }
