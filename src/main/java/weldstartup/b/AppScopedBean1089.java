...
public class AppScopedBean1089 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1089.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1089");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1089");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1089");
    }
