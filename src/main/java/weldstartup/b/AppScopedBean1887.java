...
public class AppScopedBean1887 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1887.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1887");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1887");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1887");
    }
