...
public class AppScopedBean1679 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1679.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1679");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1679");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1679");
    }
