...
public class AppScopedBean1184 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1184.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1184");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1184");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1184");
    }
