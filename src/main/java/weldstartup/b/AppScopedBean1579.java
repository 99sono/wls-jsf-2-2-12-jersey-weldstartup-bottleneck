...
public class AppScopedBean1579 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1579.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1579");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1579");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1579");
    }
