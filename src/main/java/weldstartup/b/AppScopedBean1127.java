...
public class AppScopedBean1127 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1127.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1127");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1127");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1127");
    }
