...
public class AppScopedBean1712 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1712.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1712");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1712");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1712");
    }
