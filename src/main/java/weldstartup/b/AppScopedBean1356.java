...
public class AppScopedBean1356 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1356.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1356");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1356");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1356");
    }
