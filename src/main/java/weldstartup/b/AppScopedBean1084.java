...
public class AppScopedBean1084 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1084.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1084");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1084");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1084");
    }
