...
public class AppScopedBean1304 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1304.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1304");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1304");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1304");
    }
