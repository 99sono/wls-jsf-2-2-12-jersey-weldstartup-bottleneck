...
public class AppScopedBean1344 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1344.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1344");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1344");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1344");
    }
