...
public class AppScopedBean1014 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1014.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1014");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1014");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1014");
    }
