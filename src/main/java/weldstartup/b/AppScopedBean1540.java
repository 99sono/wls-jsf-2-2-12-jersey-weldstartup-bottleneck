...
public class AppScopedBean1540 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1540.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1540");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1540");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1540");
    }
