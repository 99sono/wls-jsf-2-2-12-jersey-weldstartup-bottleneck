...
public class AppScopedBean1435 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1435.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1435");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1435");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1435");
    }
