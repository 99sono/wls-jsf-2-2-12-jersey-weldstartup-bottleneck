...
public class AppScopedBean1281 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1281.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1281");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1281");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1281");
    }
