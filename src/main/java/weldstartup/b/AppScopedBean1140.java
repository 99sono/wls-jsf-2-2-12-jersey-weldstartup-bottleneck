...
public class AppScopedBean1140 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1140.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1140");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1140");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1140");
    }
