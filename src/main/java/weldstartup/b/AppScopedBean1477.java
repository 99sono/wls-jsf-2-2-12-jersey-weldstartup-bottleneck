...
public class AppScopedBean1477 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1477.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1477");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1477");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1477");
    }
