...
public class AppScopedBean1829 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1829.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1829");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1829");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1829");
    }
