...
public class AppScopedBean1845 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1845.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1845");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1845");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1845");
    }
