...
public class AppScopedBean1350 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1350.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1350");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1350");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1350");
    }
