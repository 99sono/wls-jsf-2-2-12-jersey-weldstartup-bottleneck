...
public class AppScopedBean1927 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1927.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1927");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1927");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1927");
    }
