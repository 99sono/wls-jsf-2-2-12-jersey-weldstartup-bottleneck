...
public class AppScopedBean1516 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1516.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1516");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1516");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1516");
    }
