...
public class AppScopedBean1797 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1797.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1797");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1797");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1797");
    }
