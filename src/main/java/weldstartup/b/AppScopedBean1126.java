...
public class AppScopedBean1126 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1126.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1126");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1126");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1126");
    }
