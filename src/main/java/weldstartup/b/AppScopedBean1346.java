...
public class AppScopedBean1346 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1346.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1346");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1346");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1346");
    }
