...
public class AppScopedBean1337 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1337.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1337");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1337");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1337");
    }
