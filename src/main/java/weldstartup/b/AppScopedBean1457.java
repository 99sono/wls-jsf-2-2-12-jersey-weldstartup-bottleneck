...
public class AppScopedBean1457 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1457.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1457");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1457");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1457");
    }
