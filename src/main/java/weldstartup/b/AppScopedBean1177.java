...
public class AppScopedBean1177 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1177.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1177");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1177");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1177");
    }
