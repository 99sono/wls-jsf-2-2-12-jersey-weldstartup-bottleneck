...
public class AppScopedBean1967 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1967.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1967");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1967");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1967");
    }
