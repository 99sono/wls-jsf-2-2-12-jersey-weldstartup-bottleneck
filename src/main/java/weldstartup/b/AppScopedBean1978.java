...
public class AppScopedBean1978 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1978.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1978");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1978");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1978");
    }
