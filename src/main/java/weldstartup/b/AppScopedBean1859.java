...
public class AppScopedBean1859 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1859.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1859");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1859");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1859");
    }
