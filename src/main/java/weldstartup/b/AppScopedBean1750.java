...
public class AppScopedBean1750 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1750.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1750");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1750");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1750");
    }
