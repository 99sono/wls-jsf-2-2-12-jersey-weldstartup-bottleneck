...
public class AppScopedBean1984 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1984.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1984");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1984");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1984");
    }
