...
public class AppScopedBean1189 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1189.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1189");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1189");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1189");
    }
