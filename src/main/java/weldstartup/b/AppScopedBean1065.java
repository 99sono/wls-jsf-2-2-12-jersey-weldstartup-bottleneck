...
public class AppScopedBean1065 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1065.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1065");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1065");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1065");
    }
