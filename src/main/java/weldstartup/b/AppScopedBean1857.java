...
public class AppScopedBean1857 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1857.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1857");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1857");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1857");
    }
