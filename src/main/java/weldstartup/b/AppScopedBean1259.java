...
public class AppScopedBean1259 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1259.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1259");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1259");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1259");
    }
