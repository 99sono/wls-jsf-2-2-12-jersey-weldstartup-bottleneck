...
public class AppScopedBean1970 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1970.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1970");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1970");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1970");
    }
