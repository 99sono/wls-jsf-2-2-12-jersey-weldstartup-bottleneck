...
public class AppScopedBean1373 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1373.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1373");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1373");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1373");
    }
