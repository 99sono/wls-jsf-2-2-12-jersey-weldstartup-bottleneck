...
public class AppScopedBean1921 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1921.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1921");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1921");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1921");
    }
