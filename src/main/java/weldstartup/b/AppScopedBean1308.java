...
public class AppScopedBean1308 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1308.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1308");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1308");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1308");
    }
