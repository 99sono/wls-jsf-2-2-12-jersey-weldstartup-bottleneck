...
public class AppScopedBean1688 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1688.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1688");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1688");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1688");
    }
