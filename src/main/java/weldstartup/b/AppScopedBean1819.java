...
public class AppScopedBean1819 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1819.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1819");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1819");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1819");
    }
