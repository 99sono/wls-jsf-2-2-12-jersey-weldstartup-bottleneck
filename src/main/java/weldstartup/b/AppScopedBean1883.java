...
public class AppScopedBean1883 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1883.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1883");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1883");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1883");
    }
