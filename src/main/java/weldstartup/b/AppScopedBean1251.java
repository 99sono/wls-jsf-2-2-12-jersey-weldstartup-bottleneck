...
public class AppScopedBean1251 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1251.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1251");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1251");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1251");
    }
