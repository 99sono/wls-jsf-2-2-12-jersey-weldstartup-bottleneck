...
public class AppScopedBean1552 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1552.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1552");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1552");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1552");
    }
