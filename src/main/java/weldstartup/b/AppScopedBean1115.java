...
public class AppScopedBean1115 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1115.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1115");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1115");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1115");
    }
