...
public class AppScopedBean1903 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1903.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1903");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1903");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1903");
    }
