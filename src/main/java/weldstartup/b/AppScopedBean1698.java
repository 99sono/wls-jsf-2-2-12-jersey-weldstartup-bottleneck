...
public class AppScopedBean1698 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1698.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1698");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1698");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1698");
    }
