...
public class AppScopedBean1005 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1005.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1005");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1005");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1005");
    }
