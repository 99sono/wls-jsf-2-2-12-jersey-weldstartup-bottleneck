...
public class AppScopedBean1202 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1202.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1202");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1202");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1202");
    }
