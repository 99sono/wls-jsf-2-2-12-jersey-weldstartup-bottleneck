...
public class AppScopedBean1777 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1777.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1777");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1777");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1777");
    }
