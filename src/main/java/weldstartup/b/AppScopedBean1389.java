...
public class AppScopedBean1389 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1389.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1389");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1389");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1389");
    }
