...
public class AppScopedBean1897 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1897.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1897");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1897");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1897");
    }
