...
public class AppScopedBean1024 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1024.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1024");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1024");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1024");
    }
