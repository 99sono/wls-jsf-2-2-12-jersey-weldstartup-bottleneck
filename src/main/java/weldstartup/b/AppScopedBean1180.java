...
public class AppScopedBean1180 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1180.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1180");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1180");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1180");
    }
