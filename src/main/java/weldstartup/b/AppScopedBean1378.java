...
public class AppScopedBean1378 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1378.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1378");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1378");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1378");
    }
