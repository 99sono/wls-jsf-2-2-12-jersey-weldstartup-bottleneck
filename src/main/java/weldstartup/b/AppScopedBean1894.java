...
public class AppScopedBean1894 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1894.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1894");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1894");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1894");
    }
