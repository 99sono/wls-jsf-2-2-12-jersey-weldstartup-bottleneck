...
public class AppScopedBean1973 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1973.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1973");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1973");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1973");
    }
