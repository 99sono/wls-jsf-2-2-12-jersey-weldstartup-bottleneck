...
public class AppScopedBean1450 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1450.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1450");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1450");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1450");
    }
