...
public class AppScopedBean1374 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1374.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1374");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1374");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1374");
    }
