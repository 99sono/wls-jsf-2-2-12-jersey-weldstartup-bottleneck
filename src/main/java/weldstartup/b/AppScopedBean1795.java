...
public class AppScopedBean1795 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1795.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1795");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1795");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1795");
    }
