...
public class AppScopedBean1729 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1729.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1729");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1729");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1729");
    }
