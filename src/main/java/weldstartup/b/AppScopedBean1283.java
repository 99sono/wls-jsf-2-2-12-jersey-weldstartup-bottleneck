...
public class AppScopedBean1283 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1283.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1283");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1283");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1283");
    }
