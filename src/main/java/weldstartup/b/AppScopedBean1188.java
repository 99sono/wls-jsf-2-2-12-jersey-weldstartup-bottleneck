...
public class AppScopedBean1188 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1188.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1188");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1188");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1188");
    }
