...
public class AppScopedBean1958 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1958.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1958");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1958");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1958");
    }
