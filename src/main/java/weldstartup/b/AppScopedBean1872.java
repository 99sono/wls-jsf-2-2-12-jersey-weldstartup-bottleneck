...
public class AppScopedBean1872 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1872.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1872");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1872");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1872");
    }
