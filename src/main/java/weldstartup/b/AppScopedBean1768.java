...
public class AppScopedBean1768 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1768.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1768");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1768");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1768");
    }
