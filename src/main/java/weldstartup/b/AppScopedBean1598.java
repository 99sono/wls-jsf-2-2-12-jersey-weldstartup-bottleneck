...
public class AppScopedBean1598 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1598.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1598");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1598");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1598");
    }
