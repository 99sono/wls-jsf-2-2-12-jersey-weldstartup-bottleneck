...
public class AppScopedBean1470 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1470.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1470");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1470");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1470");
    }
