...
public class AppScopedBean1948 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1948.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1948");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1948");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1948");
    }
