...
public class AppScopedBean1498 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1498.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1498");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1498");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1498");
    }
