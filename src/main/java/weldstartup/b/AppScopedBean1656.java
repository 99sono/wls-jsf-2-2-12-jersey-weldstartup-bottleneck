...
public class AppScopedBean1656 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1656.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1656");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1656");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1656");
    }
