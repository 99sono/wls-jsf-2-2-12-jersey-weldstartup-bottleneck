...
public class AppScopedBean1138 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1138.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1138");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1138");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1138");
    }
