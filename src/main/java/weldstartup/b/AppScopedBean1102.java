...
public class AppScopedBean1102 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1102.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1102");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1102");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1102");
    }
