...
public class AppScopedBean1545 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1545.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1545");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1545");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1545");
    }
