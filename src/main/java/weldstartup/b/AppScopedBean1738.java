...
public class AppScopedBean1738 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1738.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1738");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1738");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1738");
    }
