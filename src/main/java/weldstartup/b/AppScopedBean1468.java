...
public class AppScopedBean1468 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1468.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1468");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1468");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1468");
    }
