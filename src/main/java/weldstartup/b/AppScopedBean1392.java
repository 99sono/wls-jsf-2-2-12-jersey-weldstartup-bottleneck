...
public class AppScopedBean1392 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1392.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1392");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1392");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1392");
    }
