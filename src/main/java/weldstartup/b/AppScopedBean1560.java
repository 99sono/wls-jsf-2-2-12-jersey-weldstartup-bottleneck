...
public class AppScopedBean1560 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1560.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1560");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1560");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1560");
    }
