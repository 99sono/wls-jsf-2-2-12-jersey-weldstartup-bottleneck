...
public class AppScopedBean1606 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1606.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1606");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1606");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1606");
    }
