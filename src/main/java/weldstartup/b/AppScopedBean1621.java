...
public class AppScopedBean1621 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1621.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1621");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1621");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1621");
    }
