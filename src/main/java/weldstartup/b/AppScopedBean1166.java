...
public class AppScopedBean1166 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1166.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1166");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1166");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1166");
    }
