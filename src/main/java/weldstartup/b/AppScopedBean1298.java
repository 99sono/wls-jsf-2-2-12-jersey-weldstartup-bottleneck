...
public class AppScopedBean1298 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1298.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1298");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1298");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1298");
    }
