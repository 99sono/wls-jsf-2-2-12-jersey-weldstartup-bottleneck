...
public class AppScopedBean1158 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1158.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1158");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1158");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1158");
    }
