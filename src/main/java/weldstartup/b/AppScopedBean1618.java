...
public class AppScopedBean1618 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1618.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1618");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1618");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1618");
    }
