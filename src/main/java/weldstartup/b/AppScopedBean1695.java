...
public class AppScopedBean1695 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1695.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1695");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1695");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1695");
    }
