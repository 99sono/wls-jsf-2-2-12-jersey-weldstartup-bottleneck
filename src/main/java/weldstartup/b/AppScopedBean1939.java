...
public class AppScopedBean1939 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1939.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1939");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1939");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1939");
    }
