...
public class AppScopedBean1422 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1422.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1422");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1422");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1422");
    }
