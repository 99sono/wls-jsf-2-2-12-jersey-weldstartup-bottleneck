...
public class AppScopedBean1380 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1380.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1380");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1380");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1380");
    }
