...
public class AppScopedBean1107 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1107.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1107");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1107");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1107");
    }
