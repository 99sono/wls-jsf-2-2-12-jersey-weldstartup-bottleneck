...
public class AppScopedBean1226 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1226.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1226");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1226");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1226");
    }
