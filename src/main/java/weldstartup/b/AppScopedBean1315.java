...
public class AppScopedBean1315 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1315.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1315");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1315");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1315");
    }
