...
public class AppScopedBean1834 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1834.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1834");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1834");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1834");
    }
