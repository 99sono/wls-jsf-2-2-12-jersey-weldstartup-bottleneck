...
public class AppScopedBean1310 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1310.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1310");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1310");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1310");
    }
