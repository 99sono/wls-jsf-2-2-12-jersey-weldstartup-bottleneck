...
public class AppScopedBean1752 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1752.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1752");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1752");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1752");
    }
