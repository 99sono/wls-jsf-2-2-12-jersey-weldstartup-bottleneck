...
public class AppScopedBean1670 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1670.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1670");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1670");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1670");
    }
