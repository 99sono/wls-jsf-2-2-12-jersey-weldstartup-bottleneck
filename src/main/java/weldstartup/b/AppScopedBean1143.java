...
public class AppScopedBean1143 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1143.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1143");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1143");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1143");
    }
