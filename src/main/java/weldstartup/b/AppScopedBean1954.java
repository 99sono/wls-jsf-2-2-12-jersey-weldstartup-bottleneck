...
public class AppScopedBean1954 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1954.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1954");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1954");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1954");
    }
