...
public class AppScopedBean1715 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1715.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1715");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1715");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1715");
    }
