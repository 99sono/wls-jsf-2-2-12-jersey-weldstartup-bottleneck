...
public class AppScopedBean1113 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1113.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1113");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1113");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1113");
    }
