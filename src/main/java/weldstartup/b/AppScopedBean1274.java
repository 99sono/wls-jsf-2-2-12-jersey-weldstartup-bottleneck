...
public class AppScopedBean1274 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1274.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1274");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1274");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1274");
    }
