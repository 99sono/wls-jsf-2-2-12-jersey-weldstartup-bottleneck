...
public class AppScopedBean1537 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1537.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1537");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1537");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1537");
    }
