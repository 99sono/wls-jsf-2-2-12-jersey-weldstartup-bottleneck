...
public class AppScopedBean1588 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1588.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1588");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1588");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1588");
    }
