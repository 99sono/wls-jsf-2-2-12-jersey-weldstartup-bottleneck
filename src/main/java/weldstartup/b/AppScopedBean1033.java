...
public class AppScopedBean1033 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1033.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1033");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1033");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1033");
    }
