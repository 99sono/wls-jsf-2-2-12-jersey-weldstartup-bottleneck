...
public class AppScopedBean1496 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1496.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1496");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1496");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1496");
    }
