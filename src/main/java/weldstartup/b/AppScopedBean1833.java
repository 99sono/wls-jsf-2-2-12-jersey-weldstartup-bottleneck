...
public class AppScopedBean1833 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1833.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1833");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1833");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1833");
    }
