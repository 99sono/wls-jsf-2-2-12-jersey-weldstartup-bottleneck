...
public class AppScopedBean1869 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1869.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1869");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1869");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1869");
    }
