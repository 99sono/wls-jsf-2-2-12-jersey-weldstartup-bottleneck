...
public class AppScopedBean1069 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1069.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1069");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1069");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1069");
    }
