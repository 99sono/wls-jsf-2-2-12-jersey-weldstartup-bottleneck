...
public class AppScopedBean1771 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1771.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1771");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1771");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1771");
    }
