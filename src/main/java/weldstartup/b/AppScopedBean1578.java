...
public class AppScopedBean1578 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1578.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1578");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1578");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1578");
    }
