...
public class AppScopedBean1686 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1686.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1686");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1686");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1686");
    }
