...
public class AppScopedBean1696 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1696.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1696");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1696");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1696");
    }
