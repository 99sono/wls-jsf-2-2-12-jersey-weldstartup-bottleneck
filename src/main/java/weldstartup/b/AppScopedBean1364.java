...
public class AppScopedBean1364 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1364.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1364");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1364");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1364");
    }
