...
public class AppScopedBean1030 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1030.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1030");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1030");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1030");
    }
