...
public class AppScopedBean1847 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1847.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1847");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1847");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1847");
    }
