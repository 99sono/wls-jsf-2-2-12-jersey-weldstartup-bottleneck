...
public class AppScopedBean1759 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1759.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1759");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1759");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1759");
    }
