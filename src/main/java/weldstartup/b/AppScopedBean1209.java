...
public class AppScopedBean1209 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1209.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1209");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1209");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1209");
    }
