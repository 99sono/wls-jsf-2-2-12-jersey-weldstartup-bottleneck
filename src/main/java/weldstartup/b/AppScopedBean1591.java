...
public class AppScopedBean1591 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1591.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1591");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1591");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1591");
    }
