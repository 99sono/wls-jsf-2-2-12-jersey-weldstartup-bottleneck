...
public class AppScopedBean1570 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1570.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1570");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1570");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1570");
    }
