...
public class AppScopedBean1193 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1193.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1193");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1193");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1193");
    }
