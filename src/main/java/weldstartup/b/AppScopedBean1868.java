...
public class AppScopedBean1868 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1868.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1868");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1868");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1868");
    }
