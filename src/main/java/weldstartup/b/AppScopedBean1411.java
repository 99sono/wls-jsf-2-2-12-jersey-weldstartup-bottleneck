...
public class AppScopedBean1411 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1411.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1411");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1411");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1411");
    }
