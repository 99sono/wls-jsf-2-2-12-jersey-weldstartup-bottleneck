...
public class AppScopedBean1766 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1766.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1766");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1766");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1766");
    }
