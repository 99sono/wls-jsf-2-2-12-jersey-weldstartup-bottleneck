...
public class AppScopedBean1989 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1989.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1989");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1989");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1989");
    }
