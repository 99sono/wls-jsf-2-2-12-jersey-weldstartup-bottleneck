...
public class AppScopedBean1916 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1916.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1916");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1916");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1916");
    }
