...
public class AppScopedBean1314 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1314.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1314");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1314");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1314");
    }
