...
public class AppScopedBean1164 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1164.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1164");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1164");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1164");
    }
