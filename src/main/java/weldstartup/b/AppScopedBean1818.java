...
public class AppScopedBean1818 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1818.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1818");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1818");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1818");
    }
