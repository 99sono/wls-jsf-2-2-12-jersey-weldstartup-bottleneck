...
public class AppScopedBean1558 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1558.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1558");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1558");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1558");
    }
