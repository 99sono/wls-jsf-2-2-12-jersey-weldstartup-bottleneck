...
public class AppScopedBean1046 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1046.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1046");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1046");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1046");
    }
