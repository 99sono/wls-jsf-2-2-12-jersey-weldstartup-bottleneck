...
public class AppScopedBean1262 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1262.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1262");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1262");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1262");
    }
