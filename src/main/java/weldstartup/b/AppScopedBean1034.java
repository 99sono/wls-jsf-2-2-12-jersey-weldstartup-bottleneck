...
public class AppScopedBean1034 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1034.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1034");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1034");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1034");
    }
