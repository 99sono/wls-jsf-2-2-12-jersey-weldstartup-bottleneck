...
public class AppScopedBean1112 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1112.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1112");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1112");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1112");
    }
