...
public class AppScopedBean1247 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1247.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1247");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1247");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1247");
    }
