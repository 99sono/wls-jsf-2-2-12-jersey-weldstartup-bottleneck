...
public class AppScopedBean1156 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1156.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1156");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1156");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1156");
    }
