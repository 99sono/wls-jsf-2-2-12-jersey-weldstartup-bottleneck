...
public class AppScopedBean1052 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1052.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1052");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1052");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1052");
    }
