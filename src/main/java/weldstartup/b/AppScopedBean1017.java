...
public class AppScopedBean1017 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1017.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1017");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1017");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1017");
    }
