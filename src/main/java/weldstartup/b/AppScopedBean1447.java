...
public class AppScopedBean1447 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1447.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1447");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1447");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1447");
    }
