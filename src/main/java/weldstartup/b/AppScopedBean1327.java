...
public class AppScopedBean1327 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1327.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1327");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1327");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1327");
    }
