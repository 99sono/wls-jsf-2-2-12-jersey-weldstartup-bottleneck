...
public class AppScopedBean1087 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1087.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1087");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1087");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1087");
    }
