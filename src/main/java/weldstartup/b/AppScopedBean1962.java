...
public class AppScopedBean1962 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1962.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1962");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1962");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1962");
    }
