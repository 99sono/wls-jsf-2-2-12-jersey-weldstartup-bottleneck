...
public class AppScopedBean1492 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1492.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1492");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1492");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1492");
    }
