...
public class AppScopedBean1502 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1502.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1502");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1502");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1502");
    }
