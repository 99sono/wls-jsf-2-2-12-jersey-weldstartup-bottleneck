...
public class AppScopedBean1451 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1451.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1451");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1451");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1451");
    }
