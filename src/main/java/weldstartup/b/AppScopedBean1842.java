...
public class AppScopedBean1842 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1842.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1842");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1842");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1842");
    }
