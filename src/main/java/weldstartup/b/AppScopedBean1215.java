...
public class AppScopedBean1215 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1215.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1215");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1215");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1215");
    }
