...
public class AppScopedBean1397 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1397.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1397");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1397");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1397");
    }
