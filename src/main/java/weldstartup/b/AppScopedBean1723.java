...
public class AppScopedBean1723 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1723.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1723");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1723");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1723");
    }
