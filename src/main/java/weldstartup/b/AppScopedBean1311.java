...
public class AppScopedBean1311 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1311.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1311");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1311");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1311");
    }
