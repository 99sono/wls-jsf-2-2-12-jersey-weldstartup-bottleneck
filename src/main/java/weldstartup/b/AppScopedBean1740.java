...
public class AppScopedBean1740 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1740.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1740");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1740");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1740");
    }
