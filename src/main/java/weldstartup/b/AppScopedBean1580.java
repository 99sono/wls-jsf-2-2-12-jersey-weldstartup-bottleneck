...
public class AppScopedBean1580 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1580.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1580");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1580");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1580");
    }
