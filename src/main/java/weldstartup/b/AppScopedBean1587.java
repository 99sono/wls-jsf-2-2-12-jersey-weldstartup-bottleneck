...
public class AppScopedBean1587 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1587.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1587");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1587");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1587");
    }
