...
public class AppScopedBean1826 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1826.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1826");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1826");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1826");
    }
