...
public class AppScopedBean1437 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1437.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1437");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1437");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1437");
    }
