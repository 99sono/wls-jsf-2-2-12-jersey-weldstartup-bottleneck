...
public class AppScopedBean1782 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1782.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1782");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1782");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1782");
    }
