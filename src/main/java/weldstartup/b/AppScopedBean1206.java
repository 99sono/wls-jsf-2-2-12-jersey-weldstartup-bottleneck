...
public class AppScopedBean1206 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1206.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1206");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1206");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1206");
    }
