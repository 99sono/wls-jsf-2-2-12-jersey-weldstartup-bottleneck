...
public class AppScopedBean1200 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1200.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1200");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1200");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1200");
    }
