...
public class AppScopedBean1352 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1352.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1352");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1352");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1352");
    }
