...
public class AppScopedBean1424 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1424.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1424");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1424");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1424");
    }
