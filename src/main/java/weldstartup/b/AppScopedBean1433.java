...
public class AppScopedBean1433 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1433.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1433");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1433");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1433");
    }
