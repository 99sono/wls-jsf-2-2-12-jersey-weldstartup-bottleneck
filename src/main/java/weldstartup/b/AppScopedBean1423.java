...
public class AppScopedBean1423 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1423.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1423");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1423");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1423");
    }
