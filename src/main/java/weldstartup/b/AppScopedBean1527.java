...
public class AppScopedBean1527 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1527.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1527");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1527");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1527");
    }
