...
public class AppScopedBean1886 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1886.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1886");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1886");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1886");
    }
