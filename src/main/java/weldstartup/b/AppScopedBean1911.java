...
public class AppScopedBean1911 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1911.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1911");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1911");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1911");
    }
