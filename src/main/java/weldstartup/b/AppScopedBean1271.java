...
public class AppScopedBean1271 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1271.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1271");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1271");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1271");
    }
