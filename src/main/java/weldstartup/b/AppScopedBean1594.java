...
public class AppScopedBean1594 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1594.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1594");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1594");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1594");
    }
