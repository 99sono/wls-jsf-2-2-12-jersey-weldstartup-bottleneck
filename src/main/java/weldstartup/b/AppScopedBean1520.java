...
public class AppScopedBean1520 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1520.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1520");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1520");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1520");
    }
