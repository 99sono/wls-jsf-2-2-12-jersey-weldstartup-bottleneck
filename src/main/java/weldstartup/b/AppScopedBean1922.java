...
public class AppScopedBean1922 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1922.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1922");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1922");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1922");
    }
