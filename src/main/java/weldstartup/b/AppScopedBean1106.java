...
public class AppScopedBean1106 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1106.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1106");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1106");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1106");
    }
