...
public class AppScopedBean1237 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1237.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1237");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1237");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1237");
    }
