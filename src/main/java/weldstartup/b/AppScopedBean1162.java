...
public class AppScopedBean1162 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1162.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1162");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1162");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1162");
    }
