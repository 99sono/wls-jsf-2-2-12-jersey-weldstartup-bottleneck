...
public class AppScopedBean1635 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1635.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1635");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1635");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1635");
    }
