...
public class AppScopedBean1093 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1093.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1093");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1093");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1093");
    }
