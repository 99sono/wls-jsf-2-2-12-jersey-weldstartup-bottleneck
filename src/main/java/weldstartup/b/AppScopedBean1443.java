...
public class AppScopedBean1443 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1443.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1443");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1443");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1443");
    }
