...
public class AppScopedBean1453 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1453.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1453");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1453");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1453");
    }
