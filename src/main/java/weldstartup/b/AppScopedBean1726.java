...
public class AppScopedBean1726 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1726.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1726");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1726");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1726");
    }
