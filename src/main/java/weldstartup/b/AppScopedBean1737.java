...
public class AppScopedBean1737 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1737.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1737");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1737");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1737");
    }
