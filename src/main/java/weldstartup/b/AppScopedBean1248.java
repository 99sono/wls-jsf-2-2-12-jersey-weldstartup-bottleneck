...
public class AppScopedBean1248 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1248.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1248");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1248");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1248");
    }
