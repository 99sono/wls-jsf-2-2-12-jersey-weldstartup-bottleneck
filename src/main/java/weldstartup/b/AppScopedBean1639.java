...
public class AppScopedBean1639 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1639.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1639");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1639");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1639");
    }
