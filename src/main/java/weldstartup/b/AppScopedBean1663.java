...
public class AppScopedBean1663 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1663.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1663");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1663");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1663");
    }
