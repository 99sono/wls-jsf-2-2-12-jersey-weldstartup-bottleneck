...
public class AppScopedBean1168 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1168.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1168");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1168");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1168");
    }
