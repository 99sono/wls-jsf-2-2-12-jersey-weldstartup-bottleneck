...
public class AppScopedBean1488 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1488.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1488");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1488");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1488");
    }
