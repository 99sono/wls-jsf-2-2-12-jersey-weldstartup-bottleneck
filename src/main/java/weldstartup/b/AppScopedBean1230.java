...
public class AppScopedBean1230 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1230.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1230");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1230");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1230");
    }
