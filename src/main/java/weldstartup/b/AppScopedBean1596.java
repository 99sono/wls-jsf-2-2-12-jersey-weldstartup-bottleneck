...
public class AppScopedBean1596 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1596.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1596");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1596");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1596");
    }
