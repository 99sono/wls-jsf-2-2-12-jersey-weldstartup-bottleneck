...
public class AppScopedBean1151 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1151.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1151");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1151");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1151");
    }
