...
public class AppScopedBean1242 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1242.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1242");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1242");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1242");
    }
