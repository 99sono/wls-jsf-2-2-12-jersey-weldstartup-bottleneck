...
public class AppScopedBean1998 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1998.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1998");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1998");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1998");
    }
