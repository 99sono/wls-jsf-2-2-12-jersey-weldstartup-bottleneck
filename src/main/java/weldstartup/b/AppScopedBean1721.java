...
public class AppScopedBean1721 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1721.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1721");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1721");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1721");
    }
