...
public class AppScopedBean1430 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1430.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1430");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1430");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1430");
    }
