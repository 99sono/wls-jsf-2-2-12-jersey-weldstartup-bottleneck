...
public class AppScopedBean1426 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1426.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1426");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1426");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1426");
    }
