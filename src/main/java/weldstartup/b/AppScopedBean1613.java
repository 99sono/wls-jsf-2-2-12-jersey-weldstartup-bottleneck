...
public class AppScopedBean1613 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1613.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1613");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1613");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1613");
    }
