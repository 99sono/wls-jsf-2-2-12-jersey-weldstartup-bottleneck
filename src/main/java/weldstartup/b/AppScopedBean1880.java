...
public class AppScopedBean1880 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1880.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1880");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1880");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1880");
    }
