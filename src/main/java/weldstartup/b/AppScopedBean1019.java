...
public class AppScopedBean1019 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1019.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1019");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1019");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1019");
    }
