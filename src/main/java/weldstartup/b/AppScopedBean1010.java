...
public class AppScopedBean1010 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1010.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1010");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1010");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1010");
    }
