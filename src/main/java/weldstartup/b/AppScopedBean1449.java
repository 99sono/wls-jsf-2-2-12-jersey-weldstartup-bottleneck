...
public class AppScopedBean1449 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1449.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1449");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1449");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1449");
    }
