...
public class AppScopedBean1148 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1148.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1148");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1148");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1148");
    }
