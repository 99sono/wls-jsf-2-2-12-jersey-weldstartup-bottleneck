...
public class AppScopedBean1042 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1042.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1042");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1042");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1042");
    }
