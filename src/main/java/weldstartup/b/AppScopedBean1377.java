...
public class AppScopedBean1377 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1377.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1377");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1377");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1377");
    }
