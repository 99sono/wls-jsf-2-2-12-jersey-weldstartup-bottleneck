...
public class AppScopedBean1597 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1597.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1597");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1597");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1597");
    }
