...
public class AppScopedBean1890 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1890.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1890");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1890");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1890");
    }
