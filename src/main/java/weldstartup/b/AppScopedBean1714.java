...
public class AppScopedBean1714 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1714.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1714");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1714");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1714");
    }
