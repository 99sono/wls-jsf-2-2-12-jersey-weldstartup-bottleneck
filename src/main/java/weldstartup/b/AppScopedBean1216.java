...
public class AppScopedBean1216 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1216.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1216");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1216");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1216");
    }
