...
public class AppScopedBean1646 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1646.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1646");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1646");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1646");
    }
