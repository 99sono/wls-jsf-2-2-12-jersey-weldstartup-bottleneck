...
public class AppScopedBean1334 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1334.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1334");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1334");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1334");
    }
