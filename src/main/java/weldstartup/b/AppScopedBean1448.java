...
public class AppScopedBean1448 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1448.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1448");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1448");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1448");
    }
