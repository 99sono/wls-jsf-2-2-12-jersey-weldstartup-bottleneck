...
public class AppScopedBean1758 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1758.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1758");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1758");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1758");
    }
