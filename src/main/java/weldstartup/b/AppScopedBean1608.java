...
public class AppScopedBean1608 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1608.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1608");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1608");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1608");
    }
