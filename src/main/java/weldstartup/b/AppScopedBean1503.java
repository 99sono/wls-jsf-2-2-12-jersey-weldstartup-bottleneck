...
public class AppScopedBean1503 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1503.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1503");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1503");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1503");
    }
