...
public class AppScopedBean1079 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1079.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1079");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1079");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1079");
    }
