...
public class AppScopedBean1401 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1401.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1401");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1401");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1401");
    }
