...
public class AppScopedBean1145 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1145.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1145");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1145");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1145");
    }
