...
public class AppScopedBean1909 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1909.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1909");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1909");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1909");
    }
