...
public class AppScopedBean1541 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1541.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1541");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1541");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1541");
    }
