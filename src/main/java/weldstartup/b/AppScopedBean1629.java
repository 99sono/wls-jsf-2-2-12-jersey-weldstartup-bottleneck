...
public class AppScopedBean1629 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1629.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1629");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1629");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1629");
    }
