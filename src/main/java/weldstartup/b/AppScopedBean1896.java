...
public class AppScopedBean1896 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1896.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1896");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1896");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1896");
    }
