...
public class AppScopedBean1748 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1748.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1748");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1748");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1748");
    }
