...
public class AppScopedBean1944 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1944.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1944");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1944");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1944");
    }
