...
public class AppScopedBean1915 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1915.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1915");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1915");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1915");
    }
