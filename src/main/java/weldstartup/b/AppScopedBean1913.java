...
public class AppScopedBean1913 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1913.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1913");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1913");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1913");
    }
