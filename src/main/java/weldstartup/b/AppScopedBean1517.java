...
public class AppScopedBean1517 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1517.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1517");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1517");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1517");
    }
