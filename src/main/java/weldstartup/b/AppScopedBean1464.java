...
public class AppScopedBean1464 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1464.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1464");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1464");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1464");
    }
