...
public class AppScopedBean1231 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1231.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1231");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1231");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1231");
    }
