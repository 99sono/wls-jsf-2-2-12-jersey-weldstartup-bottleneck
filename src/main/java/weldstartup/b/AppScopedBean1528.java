...
public class AppScopedBean1528 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1528.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1528");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1528");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1528");
    }
