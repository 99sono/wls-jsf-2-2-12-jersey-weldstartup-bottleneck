...
public class AppScopedBean1619 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1619.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1619");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1619");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1619");
    }
