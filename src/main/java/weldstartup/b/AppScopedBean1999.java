...
public class AppScopedBean1999 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1999.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1999");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1999");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1999");
    }
