...
public class AppScopedBean1054 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1054.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1054");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1054");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1054");
    }
