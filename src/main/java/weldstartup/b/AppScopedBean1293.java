...
public class AppScopedBean1293 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1293.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1293");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1293");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1293");
    }
