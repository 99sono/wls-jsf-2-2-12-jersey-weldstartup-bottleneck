...
public class AppScopedBean1276 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1276.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1276");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1276");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1276");
    }
