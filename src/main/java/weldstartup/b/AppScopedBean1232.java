...
public class AppScopedBean1232 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1232.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1232");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1232");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1232");
    }
