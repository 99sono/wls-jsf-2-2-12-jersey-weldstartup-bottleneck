...
public class AppScopedBean1889 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1889.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1889");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1889");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1889");
    }
