...
public class AppScopedBean1935 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1935.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1935");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1935");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1935");
    }
