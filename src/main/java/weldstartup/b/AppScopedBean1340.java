...
public class AppScopedBean1340 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1340.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1340");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1340");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1340");
    }
