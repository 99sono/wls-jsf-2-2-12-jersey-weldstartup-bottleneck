...
public class AppScopedBean1933 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1933.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1933");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1933");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1933");
    }
