...
public class AppScopedBean1249 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1249.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1249");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1249");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1249");
    }
