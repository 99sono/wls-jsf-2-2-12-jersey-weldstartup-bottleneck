...
public class AppScopedBean1739 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1739.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1739");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1739");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1739");
    }
