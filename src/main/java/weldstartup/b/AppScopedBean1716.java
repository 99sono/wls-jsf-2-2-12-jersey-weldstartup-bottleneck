...
public class AppScopedBean1716 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1716.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1716");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1716");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1716");
    }
