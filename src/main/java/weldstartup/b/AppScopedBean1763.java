...
public class AppScopedBean1763 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1763.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1763");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1763");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1763");
    }
