...
public class AppScopedBean1268 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1268.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1268");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1268");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1268");
    }
