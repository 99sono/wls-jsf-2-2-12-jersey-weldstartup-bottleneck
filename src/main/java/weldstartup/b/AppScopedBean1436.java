...
public class AppScopedBean1436 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1436.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1436");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1436");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1436");
    }
