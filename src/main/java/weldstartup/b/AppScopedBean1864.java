...
public class AppScopedBean1864 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1864.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1864");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1864");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1864");
    }
