...
public class AppScopedBean1214 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1214.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1214");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1214");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1214");
    }
