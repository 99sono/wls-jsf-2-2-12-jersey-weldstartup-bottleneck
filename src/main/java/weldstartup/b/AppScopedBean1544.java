...
public class AppScopedBean1544 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1544.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1544");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1544");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1544");
    }
