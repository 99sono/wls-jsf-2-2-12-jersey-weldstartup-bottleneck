...
public class AppScopedBean1839 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1839.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1839");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1839");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1839");
    }
