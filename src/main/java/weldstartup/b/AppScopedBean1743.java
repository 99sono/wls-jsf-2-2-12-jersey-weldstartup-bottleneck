...
public class AppScopedBean1743 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1743.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1743");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1743");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1743");
    }
