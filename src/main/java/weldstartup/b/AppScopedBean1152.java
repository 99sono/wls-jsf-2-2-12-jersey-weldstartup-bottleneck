...
public class AppScopedBean1152 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1152.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1152");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1152");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1152");
    }
