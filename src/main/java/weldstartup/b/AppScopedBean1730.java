...
public class AppScopedBean1730 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1730.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1730");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1730");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1730");
    }
