...
public class AppScopedBean1253 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1253.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1253");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1253");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1253");
    }
