...
public class AppScopedBean1780 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1780.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1780");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1780");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1780");
    }
