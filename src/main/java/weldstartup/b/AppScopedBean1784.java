...
public class AppScopedBean1784 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1784.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1784");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1784");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1784");
    }
