...
public class AppScopedBean1236 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1236.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1236");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1236");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1236");
    }
