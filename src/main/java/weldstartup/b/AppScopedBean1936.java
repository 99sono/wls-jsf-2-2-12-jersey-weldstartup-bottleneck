...
public class AppScopedBean1936 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1936.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1936");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1936");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1936");
    }
