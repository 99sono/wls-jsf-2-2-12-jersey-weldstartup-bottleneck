...
public class AppScopedBean1685 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1685.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1685");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1685");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1685");
    }
