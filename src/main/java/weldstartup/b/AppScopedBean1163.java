...
public class AppScopedBean1163 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1163.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1163");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1163");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1163");
    }
