...
public class AppScopedBean1705 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1705.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1705");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1705");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1705");
    }
