...
public class AppScopedBean1566 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1566.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1566");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1566");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1566");
    }
