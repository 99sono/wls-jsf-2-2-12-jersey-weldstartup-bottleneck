...
public class AppScopedBean1881 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1881.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1881");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1881");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1881");
    }
