...
public class AppScopedBean1557 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1557.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1557");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1557");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1557");
    }
