...
public class AppScopedBean1469 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1469.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1469");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1469");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1469");
    }
