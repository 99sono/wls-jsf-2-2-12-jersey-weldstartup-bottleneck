...
public class AppScopedBean1799 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1799.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1799");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1799");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1799");
    }
