...
public class AppScopedBean1412 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1412.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1412");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1412");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1412");
    }
