...
public class AppScopedBean1661 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1661.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1661");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1661");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1661");
    }
