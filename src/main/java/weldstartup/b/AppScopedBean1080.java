...
public class AppScopedBean1080 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1080.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1080");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1080");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1080");
    }
