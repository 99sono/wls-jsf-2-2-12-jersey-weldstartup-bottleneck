...
public class AppScopedBean1367 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1367.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1367");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1367");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1367");
    }
