...
public class AppScopedBean1390 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1390.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1390");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1390");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1390");
    }
