...
public class AppScopedBean1351 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1351.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1351");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1351");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1351");
    }
