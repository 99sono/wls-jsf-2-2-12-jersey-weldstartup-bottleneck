...
public class AppScopedBean1160 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1160.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1160");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1160");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1160");
    }
