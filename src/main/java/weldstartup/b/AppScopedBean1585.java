...
public class AppScopedBean1585 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1585.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1585");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1585");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1585");
    }
