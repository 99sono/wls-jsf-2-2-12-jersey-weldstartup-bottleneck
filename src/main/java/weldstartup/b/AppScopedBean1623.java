...
public class AppScopedBean1623 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1623.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1623");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1623");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1623");
    }
