...
public class AppScopedBean1165 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1165.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1165");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1165");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1165");
    }
