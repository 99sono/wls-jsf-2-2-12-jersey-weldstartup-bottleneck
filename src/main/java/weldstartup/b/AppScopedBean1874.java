...
public class AppScopedBean1874 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1874.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1874");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1874");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1874");
    }
