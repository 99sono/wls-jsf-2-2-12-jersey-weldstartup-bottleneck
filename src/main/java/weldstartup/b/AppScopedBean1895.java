...
public class AppScopedBean1895 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1895.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1895");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1895");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1895");
    }
