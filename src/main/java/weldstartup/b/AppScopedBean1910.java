...
public class AppScopedBean1910 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1910.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1910");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1910");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1910");
    }
