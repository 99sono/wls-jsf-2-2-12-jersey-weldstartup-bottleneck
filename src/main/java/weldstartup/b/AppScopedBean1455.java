...
public class AppScopedBean1455 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1455.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1455");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1455");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1455");
    }
