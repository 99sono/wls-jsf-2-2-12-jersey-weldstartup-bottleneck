...
public class AppScopedBean1735 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1735.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1735");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1735");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1735");
    }
