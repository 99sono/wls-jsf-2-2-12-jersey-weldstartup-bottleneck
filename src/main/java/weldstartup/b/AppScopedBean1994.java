...
public class AppScopedBean1994 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1994.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1994");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1994");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1994");
    }
