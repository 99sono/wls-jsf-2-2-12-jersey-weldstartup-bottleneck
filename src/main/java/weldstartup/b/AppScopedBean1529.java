...
public class AppScopedBean1529 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1529.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1529");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1529");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1529");
    }
