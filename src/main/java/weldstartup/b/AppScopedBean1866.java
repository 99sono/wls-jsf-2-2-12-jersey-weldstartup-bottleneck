...
public class AppScopedBean1866 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1866.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1866");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1866");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1866");
    }
