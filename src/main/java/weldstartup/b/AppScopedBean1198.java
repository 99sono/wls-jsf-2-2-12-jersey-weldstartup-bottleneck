...
public class AppScopedBean1198 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1198.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1198");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1198");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1198");
    }
