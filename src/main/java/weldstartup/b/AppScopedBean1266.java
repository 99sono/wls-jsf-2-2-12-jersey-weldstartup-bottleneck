...
public class AppScopedBean1266 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1266.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1266");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1266");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1266");
    }
