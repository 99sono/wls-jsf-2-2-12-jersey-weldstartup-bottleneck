...
public class AppScopedBean1640 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1640.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1640");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1640");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1640");
    }
