...
public class AppScopedBean1968 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1968.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1968");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1968");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1968");
    }
