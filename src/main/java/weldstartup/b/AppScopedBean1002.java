...
public class AppScopedBean1002 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1002.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1002");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1002");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1002");
    }
