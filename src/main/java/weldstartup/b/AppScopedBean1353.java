...
public class AppScopedBean1353 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1353.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1353");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1353");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1353");
    }
