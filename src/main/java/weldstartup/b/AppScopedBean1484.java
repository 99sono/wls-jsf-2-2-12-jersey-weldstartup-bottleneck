...
public class AppScopedBean1484 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1484.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1484");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1484");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1484");
    }
