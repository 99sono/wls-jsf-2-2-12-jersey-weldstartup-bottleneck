...
public class AppScopedBean1277 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1277.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1277");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1277");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1277");
    }
