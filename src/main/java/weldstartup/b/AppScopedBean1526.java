...
public class AppScopedBean1526 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1526.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1526");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1526");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1526");
    }
