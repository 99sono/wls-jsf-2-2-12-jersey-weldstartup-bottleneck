...
public class AppScopedBean1062 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1062.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1062");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1062");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1062");
    }
