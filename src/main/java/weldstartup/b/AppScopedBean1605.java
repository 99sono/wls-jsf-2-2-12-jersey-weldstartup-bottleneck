...
public class AppScopedBean1605 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1605.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1605");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1605");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1605");
    }
