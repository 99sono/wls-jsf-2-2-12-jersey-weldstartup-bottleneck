...
public class AppScopedBean1575 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1575.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1575");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1575");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1575");
    }
