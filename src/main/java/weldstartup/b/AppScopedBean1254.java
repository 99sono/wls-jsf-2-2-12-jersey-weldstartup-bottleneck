...
public class AppScopedBean1254 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1254.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1254");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1254");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1254");
    }
