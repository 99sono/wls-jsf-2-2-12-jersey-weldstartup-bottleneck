...
public class AppScopedBean1174 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1174.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1174");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1174");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1174");
    }
