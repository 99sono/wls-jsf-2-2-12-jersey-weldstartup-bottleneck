...
public class AppScopedBean1863 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1863.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1863");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1863");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1863");
    }
