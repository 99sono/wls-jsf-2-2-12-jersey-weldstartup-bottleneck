...
public class AppScopedBean1904 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1904.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1904");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1904");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1904");
    }
