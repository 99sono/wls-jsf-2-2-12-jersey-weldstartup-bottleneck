...
public class AppScopedBean1871 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1871.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1871");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1871");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1871");
    }
