...
public class AppScopedBean1264 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1264.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1264");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1264");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1264");
    }
