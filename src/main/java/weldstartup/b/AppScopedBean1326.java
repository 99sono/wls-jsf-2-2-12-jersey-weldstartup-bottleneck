...
public class AppScopedBean1326 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1326.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1326");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1326");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1326");
    }
