...
public class AppScopedBean1632 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1632.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1632");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1632");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1632");
    }
