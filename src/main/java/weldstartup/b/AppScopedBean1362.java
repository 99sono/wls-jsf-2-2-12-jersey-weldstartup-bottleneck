...
public class AppScopedBean1362 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1362.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1362");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1362");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1362");
    }
