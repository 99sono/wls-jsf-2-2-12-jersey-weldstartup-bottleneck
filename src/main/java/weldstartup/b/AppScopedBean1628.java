...
public class AppScopedBean1628 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1628.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1628");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1628");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1628");
    }
