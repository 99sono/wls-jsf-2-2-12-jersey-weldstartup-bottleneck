...
public class AppScopedBean1524 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1524.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1524");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1524");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1524");
    }
