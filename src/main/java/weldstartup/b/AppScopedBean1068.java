...
public class AppScopedBean1068 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1068.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1068");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1068");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1068");
    }
