...
public class AppScopedBean1930 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1930.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1930");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1930");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1930");
    }
