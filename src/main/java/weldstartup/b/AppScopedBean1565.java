...
public class AppScopedBean1565 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1565.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1565");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1565");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1565");
    }
