...
public class AppScopedBean1040 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1040.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1040");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1040");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1040");
    }
