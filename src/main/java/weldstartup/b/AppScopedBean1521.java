...
public class AppScopedBean1521 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1521.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1521");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1521");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1521");
    }
