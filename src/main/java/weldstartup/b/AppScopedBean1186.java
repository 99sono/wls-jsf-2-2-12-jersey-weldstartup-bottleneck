...
public class AppScopedBean1186 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1186.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1186");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1186");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1186");
    }
