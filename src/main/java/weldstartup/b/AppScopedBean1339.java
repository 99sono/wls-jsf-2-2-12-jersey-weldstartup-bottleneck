...
public class AppScopedBean1339 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1339.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1339");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1339");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1339");
    }
