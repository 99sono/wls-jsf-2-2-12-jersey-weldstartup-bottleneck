...
public class AppScopedBean1279 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1279.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1279");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1279");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1279");
    }
