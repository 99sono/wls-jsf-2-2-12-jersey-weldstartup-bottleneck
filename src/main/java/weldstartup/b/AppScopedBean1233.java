...
public class AppScopedBean1233 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1233.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1233");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1233");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1233");
    }
