...
public class AppScopedBean1682 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1682.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1682");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1682");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1682");
    }
