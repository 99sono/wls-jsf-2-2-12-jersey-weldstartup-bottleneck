...
public class AppScopedBean1761 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1761.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1761");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1761");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1761");
    }
