...
public class AppScopedBean1101 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1101.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1101");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1101");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1101");
    }
