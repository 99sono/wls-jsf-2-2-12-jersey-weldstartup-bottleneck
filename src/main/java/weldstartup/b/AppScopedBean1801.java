...
public class AppScopedBean1801 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1801.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1801");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1801");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1801");
    }
