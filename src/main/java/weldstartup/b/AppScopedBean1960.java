...
public class AppScopedBean1960 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1960.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1960");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1960");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1960");
    }
