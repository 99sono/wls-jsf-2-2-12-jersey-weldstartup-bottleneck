...
public class AppScopedBean1941 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1941.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1941");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1941");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1941");
    }
