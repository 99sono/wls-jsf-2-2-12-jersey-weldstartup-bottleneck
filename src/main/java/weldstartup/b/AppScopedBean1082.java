...
public class AppScopedBean1082 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1082.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1082");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1082");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1082");
    }
