...
public class AppScopedBean1986 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1986.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1986");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1986");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1986");
    }
