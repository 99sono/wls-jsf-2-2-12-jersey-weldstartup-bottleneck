...
public class AppScopedBean1085 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1085.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1085");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1085");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1085");
    }
