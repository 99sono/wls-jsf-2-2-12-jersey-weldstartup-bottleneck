...
public class AppScopedBean1302 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1302.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1302");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1302");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1302");
    }
