...
public class AppScopedBean1313 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1313.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1313");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1313");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1313");
    }
