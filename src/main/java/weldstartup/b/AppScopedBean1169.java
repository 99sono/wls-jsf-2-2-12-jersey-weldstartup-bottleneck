...
public class AppScopedBean1169 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1169.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1169");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1169");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1169");
    }
