...
public class AppScopedBean1077 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1077.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1077");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1077");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1077");
    }
