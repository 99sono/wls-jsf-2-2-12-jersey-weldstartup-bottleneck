...
public class AppScopedBean1462 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1462.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1462");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1462");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1462");
    }
