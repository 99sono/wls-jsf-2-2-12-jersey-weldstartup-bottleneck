...
public class AppScopedBean1386 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1386.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1386");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1386");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1386");
    }
