...
public class AppScopedBean1783 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1783.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1783");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1783");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1783");
    }
