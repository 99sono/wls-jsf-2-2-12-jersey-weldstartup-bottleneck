...
public class AppScopedBean1417 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1417.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1417");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1417");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1417");
    }
