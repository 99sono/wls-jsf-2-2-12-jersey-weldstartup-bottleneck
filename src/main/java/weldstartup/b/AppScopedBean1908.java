...
public class AppScopedBean1908 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1908.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1908");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1908");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1908");
    }
