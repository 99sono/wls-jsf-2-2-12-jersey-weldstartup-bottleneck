...
public class AppScopedBean1501 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1501.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1501");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1501");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1501");
    }
