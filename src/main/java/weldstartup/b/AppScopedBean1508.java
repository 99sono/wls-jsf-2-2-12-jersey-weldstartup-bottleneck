...
public class AppScopedBean1508 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1508.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1508");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1508");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1508");
    }
