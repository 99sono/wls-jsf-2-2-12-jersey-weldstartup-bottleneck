...
public class AppScopedBean1637 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1637.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1637");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1637");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1637");
    }
