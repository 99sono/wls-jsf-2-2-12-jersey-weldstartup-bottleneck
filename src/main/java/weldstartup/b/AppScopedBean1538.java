...
public class AppScopedBean1538 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1538.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1538");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1538");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1538");
    }
