...
public class AppScopedBean1861 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1861.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1861");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1861");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1861");
    }
