...
public class AppScopedBean1711 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1711.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1711");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1711");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1711");
    }
