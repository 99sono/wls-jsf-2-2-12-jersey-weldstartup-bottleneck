...
public class AppScopedBean1972 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1972.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1972");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1972");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1972");
    }
