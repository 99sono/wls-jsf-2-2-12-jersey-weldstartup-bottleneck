...
public class AppScopedBean1803 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1803.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1803");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1803");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1803");
    }
