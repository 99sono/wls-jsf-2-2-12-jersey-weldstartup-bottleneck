...
public class AppScopedBean1676 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1676.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1676");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1676");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1676");
    }
