...
public class AppScopedBean1201 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1201.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1201");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1201");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1201");
    }
