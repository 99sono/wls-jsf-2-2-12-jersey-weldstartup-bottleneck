...
public class AppScopedBean1559 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1559.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1559");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1559");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1559");
    }
