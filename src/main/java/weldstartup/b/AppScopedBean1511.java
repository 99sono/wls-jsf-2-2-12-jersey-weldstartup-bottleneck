...
public class AppScopedBean1511 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1511.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1511");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1511");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1511");
    }
