...
public class AppScopedBean1779 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1779.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1779");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1779");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1779");
    }
