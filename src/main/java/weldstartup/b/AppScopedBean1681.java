...
public class AppScopedBean1681 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1681.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1681");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1681");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1681");
    }
