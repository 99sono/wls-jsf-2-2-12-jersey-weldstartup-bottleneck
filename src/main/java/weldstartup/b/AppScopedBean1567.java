...
public class AppScopedBean1567 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1567.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1567");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1567");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1567");
    }
