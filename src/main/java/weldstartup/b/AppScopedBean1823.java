...
public class AppScopedBean1823 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1823.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1823");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1823");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1823");
    }
