...
public class AppScopedBean1295 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1295.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1295");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1295");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1295");
    }
