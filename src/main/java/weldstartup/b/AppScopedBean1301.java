...
public class AppScopedBean1301 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1301.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1301");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1301");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1301");
    }
