...
public class AppScopedBean1045 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1045.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1045");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1045");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1045");
    }
