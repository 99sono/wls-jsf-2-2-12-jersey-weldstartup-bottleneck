...
public class AppScopedBean1363 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1363.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1363");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1363");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1363");
    }
