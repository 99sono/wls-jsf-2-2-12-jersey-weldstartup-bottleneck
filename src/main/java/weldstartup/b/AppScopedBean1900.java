...
public class AppScopedBean1900 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1900.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1900");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1900");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1900");
    }
