...
public class AppScopedBean1284 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1284.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1284");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1284");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1284");
    }
