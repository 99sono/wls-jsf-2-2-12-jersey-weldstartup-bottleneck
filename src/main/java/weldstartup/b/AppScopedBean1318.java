...
public class AppScopedBean1318 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1318.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1318");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1318");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1318");
    }
