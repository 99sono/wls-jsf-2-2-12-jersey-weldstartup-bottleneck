...
public class AppScopedBean1902 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1902.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1902");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1902");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1902");
    }
