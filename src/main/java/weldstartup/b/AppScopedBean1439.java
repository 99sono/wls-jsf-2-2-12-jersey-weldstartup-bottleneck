...
public class AppScopedBean1439 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1439.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1439");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1439");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1439");
    }
