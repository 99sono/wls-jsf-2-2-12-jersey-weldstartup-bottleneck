...
public class AppScopedBean1697 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1697.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1697");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1697");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1697");
    }
