...
public class AppScopedBean1211 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1211.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1211");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1211");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1211");
    }
