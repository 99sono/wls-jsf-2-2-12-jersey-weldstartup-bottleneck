...
public class AppScopedBean1636 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1636.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1636");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1636");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1636");
    }
