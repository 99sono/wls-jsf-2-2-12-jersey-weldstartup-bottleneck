...
public class AppScopedBean1228 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1228.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1228");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1228");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1228");
    }
