...
public class AppScopedBean1786 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1786.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1786");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1786");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1786");
    }
