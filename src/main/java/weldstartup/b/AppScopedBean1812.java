...
public class AppScopedBean1812 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1812.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1812");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1812");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1812");
    }
