...
public class AppScopedBean1906 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1906.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1906");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1906");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1906");
    }
