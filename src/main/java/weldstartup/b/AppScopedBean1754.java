...
public class AppScopedBean1754 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1754.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1754");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1754");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1754");
    }
