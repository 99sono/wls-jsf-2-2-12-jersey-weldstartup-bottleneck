...
public class AppScopedBean1020 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1020.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1020");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1020");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1020");
    }
