...
public class AppScopedBean1499 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1499.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1499");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1499");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1499");
    }
