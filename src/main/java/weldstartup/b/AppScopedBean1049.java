...
public class AppScopedBean1049 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1049.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1049");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1049");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1049");
    }
