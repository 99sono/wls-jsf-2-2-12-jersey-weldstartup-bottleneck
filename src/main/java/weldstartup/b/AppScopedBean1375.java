...
public class AppScopedBean1375 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1375.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1375");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1375");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1375");
    }
