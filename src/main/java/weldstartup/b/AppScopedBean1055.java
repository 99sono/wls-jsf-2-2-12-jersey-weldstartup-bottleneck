...
public class AppScopedBean1055 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1055.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1055");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1055");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1055");
    }
