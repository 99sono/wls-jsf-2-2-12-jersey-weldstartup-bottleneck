...
public class AppScopedBean1461 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1461.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1461");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1461");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1461");
    }
