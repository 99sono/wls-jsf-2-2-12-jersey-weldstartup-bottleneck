...
public class AppScopedBean1800 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1800.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1800");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1800");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1800");
    }
