...
public class AppScopedBean1147 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1147.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1147");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1147");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1147");
    }
