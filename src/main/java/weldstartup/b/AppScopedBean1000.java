...
public class AppScopedBean1000 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1000.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1000");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1000");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1000");
    }
