...
public class AppScopedBean1535 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1535.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1535");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1535");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1535");
    }
