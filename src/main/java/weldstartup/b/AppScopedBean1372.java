...
public class AppScopedBean1372 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1372.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1372");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1372");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1372");
    }
