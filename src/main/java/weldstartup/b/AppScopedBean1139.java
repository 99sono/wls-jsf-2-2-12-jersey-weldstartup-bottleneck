...
public class AppScopedBean1139 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1139.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1139");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1139");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1139");
    }
