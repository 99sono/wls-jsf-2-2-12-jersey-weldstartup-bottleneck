...
public class AppScopedBean1063 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1063.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1063");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1063");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1063");
    }
