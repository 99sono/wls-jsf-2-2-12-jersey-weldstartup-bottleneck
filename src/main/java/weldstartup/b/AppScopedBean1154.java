...
public class AppScopedBean1154 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1154.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1154");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1154");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1154");
    }
