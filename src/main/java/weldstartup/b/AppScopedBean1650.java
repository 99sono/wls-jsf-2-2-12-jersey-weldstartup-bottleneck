...
public class AppScopedBean1650 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1650.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1650");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1650");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1650");
    }
