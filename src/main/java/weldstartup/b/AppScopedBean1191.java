...
public class AppScopedBean1191 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1191.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1191");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1191");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1191");
    }
