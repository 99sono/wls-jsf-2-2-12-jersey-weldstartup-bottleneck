...
public class AppScopedBean1542 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1542.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1542");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1542");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1542");
    }
