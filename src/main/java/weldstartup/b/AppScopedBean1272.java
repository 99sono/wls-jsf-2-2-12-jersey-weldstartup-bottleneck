...
public class AppScopedBean1272 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1272.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1272");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1272");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1272");
    }
