...
public class AppScopedBean1050 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1050.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1050");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1050");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1050");
    }
