...
public class AppScopedBean1706 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1706.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1706");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1706");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1706");
    }
