...
public class AppScopedBean1867 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1867.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1867");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1867");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1867");
    }
