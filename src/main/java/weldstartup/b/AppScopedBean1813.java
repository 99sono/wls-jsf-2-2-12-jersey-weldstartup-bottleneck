...
public class AppScopedBean1813 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1813.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1813");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1813");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1813");
    }
