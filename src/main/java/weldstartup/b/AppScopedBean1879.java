...
public class AppScopedBean1879 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1879.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1879");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1879");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1879");
    }
