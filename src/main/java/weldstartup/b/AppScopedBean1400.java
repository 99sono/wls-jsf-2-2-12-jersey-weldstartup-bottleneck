...
public class AppScopedBean1400 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1400.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1400");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1400");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1400");
    }
