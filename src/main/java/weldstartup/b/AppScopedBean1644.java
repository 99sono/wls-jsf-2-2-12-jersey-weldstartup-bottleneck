...
public class AppScopedBean1644 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1644.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1644");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1644");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1644");
    }
