...
public class AppScopedBean1354 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1354.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1354");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1354");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1354");
    }
