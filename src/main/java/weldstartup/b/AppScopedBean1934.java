...
public class AppScopedBean1934 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1934.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1934");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1934");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1934");
    }
