...
public class AppScopedBean1753 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1753.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1753");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1753");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1753");
    }
