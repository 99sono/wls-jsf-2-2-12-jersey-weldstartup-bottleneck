...
public class AppScopedBean1971 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1971.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1971");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1971");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1971");
    }
