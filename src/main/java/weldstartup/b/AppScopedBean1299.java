...
public class AppScopedBean1299 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1299.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1299");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1299");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1299");
    }
