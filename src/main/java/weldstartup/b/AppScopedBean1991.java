...
public class AppScopedBean1991 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1991.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1991");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1991");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1991");
    }
