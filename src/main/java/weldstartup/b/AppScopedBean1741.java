...
public class AppScopedBean1741 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1741.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1741");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1741");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1741");
    }
