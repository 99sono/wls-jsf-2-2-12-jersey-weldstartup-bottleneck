...
public class AppScopedBean1144 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1144.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1144");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1144");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1144");
    }
