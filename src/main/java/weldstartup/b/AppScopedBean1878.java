...
public class AppScopedBean1878 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1878.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1878");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1878");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1878");
    }
