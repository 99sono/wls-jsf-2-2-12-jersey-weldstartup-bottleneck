...
public class AppScopedBean1190 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1190.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1190");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1190");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1190");
    }
