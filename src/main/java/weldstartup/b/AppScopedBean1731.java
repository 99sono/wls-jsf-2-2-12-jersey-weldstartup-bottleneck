...
public class AppScopedBean1731 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1731.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1731");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1731");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1731");
    }
