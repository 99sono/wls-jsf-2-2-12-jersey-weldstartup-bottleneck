...
public class AppScopedBean1182 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1182.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1182");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1182");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1182");
    }
