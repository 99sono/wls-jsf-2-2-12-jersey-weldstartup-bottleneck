...
public class AppScopedBean1384 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1384.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1384");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1384");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1384");
    }
