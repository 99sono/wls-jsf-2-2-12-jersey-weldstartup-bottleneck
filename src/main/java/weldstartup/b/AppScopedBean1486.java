...
public class AppScopedBean1486 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1486.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1486");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1486");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1486");
    }
