...
public class AppScopedBean1641 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1641.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1641");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1641");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1641");
    }
