...
public class AppScopedBean1554 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1554.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1554");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1554");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1554");
    }
