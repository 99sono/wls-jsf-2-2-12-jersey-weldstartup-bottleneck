...
public class AppScopedBean1098 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1098.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1098");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1098");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1098");
    }
