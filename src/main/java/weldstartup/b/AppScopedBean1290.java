...
public class AppScopedBean1290 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1290.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1290");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1290");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1290");
    }
