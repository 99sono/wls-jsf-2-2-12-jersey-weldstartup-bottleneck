...
public class AppScopedBean1945 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1945.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1945");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1945");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1945");
    }
