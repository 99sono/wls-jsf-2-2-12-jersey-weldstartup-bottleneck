...
public class AppScopedBean1335 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1335.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1335");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1335");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1335");
    }
