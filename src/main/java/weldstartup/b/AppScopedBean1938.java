...
public class AppScopedBean1938 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1938.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1938");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1938");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1938");
    }
