...
public class AppScopedBean1307 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1307.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1307");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1307");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1307");
    }
