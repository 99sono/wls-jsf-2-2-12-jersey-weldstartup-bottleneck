...
public class AppScopedBean1343 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1343.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1343");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1343");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1343");
    }
