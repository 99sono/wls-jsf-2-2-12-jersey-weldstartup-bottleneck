...
public class AppScopedBean1678 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1678.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1678");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1678");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1678");
    }
