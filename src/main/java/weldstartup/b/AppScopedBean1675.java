...
public class AppScopedBean1675 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1675.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1675");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1675");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1675");
    }
