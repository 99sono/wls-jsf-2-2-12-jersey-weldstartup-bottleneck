...
public class AppScopedBean1092 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1092.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1092");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1092");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1092");
    }
