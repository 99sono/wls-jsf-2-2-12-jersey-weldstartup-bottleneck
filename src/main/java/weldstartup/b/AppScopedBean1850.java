...
public class AppScopedBean1850 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1850.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1850");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1850");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1850");
    }
