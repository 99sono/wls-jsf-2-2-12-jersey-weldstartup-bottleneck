...
public class AppScopedBean1048 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1048.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1048");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1048");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1048");
    }
