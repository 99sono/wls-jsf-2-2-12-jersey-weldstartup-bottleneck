...
public class AppScopedBean1699 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1699.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1699");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1699");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1699");
    }
