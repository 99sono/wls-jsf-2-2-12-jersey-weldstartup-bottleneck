...
public class AppScopedBean1870 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1870.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1870");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1870");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1870");
    }
