...
public class AppScopedBean1574 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1574.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1574");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1574");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1574");
    }
