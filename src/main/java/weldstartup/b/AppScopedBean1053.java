...
public class AppScopedBean1053 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1053.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1053");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1053");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1053");
    }
