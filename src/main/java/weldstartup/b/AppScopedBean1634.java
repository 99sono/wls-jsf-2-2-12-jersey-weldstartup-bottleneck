...
public class AppScopedBean1634 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1634.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1634");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1634");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1634");
    }
