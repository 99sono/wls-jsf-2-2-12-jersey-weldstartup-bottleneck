...
public class AppScopedBean1703 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1703.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1703");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1703");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1703");
    }
