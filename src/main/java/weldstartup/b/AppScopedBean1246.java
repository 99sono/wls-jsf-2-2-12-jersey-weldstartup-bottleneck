...
public class AppScopedBean1246 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1246.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1246");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1246");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1246");
    }
