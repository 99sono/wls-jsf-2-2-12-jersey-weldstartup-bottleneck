...
public class AppScopedBean1672 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1672.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1672");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1672");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1672");
    }
