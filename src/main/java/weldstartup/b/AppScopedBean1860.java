...
public class AppScopedBean1860 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1860.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1860");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1860");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1860");
    }
