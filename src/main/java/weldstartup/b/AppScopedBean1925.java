...
public class AppScopedBean1925 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1925.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1925");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1925");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1925");
    }
