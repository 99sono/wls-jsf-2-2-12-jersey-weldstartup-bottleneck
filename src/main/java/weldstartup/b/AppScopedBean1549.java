...
public class AppScopedBean1549 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1549.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1549");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1549");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1549");
    }
