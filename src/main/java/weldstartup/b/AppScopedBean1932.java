...
public class AppScopedBean1932 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1932.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1932");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1932");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1932");
    }
