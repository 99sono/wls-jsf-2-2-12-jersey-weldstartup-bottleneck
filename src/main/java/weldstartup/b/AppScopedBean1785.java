...
public class AppScopedBean1785 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1785.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1785");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1785");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1785");
    }
