...
public class AppScopedBean1687 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1687.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1687");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1687");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1687");
    }
