...
public class AppScopedBean1677 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1677.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1677");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1677");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1677");
    }
