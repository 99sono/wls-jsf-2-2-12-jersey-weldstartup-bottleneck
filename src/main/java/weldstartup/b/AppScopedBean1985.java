...
public class AppScopedBean1985 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1985.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1985");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1985");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1985");
    }
