...
public class AppScopedBean1980 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1980.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1980");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1980");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1980");
    }
