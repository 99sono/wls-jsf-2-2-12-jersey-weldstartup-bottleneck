...
public class AppScopedBean1012 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1012.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1012");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1012");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1012");
    }
