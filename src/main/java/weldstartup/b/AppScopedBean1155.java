...
public class AppScopedBean1155 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1155.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1155");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1155");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1155");
    }
