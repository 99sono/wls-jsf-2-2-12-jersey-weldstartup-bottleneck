...
public class AppScopedBean1590 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1590.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1590");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1590");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1590");
    }
