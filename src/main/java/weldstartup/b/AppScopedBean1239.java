...
public class AppScopedBean1239 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1239.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1239");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1239");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1239");
    }
