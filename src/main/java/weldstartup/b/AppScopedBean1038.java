...
public class AppScopedBean1038 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1038.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1038");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1038");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1038");
    }
