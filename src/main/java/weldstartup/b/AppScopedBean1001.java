...
public class AppScopedBean1001 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1001.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1001");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1001");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1001");
    }
