...
public class AppScopedBean1083 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1083.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1083");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1083");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1083");
    }
