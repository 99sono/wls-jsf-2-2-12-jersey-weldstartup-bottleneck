...
public class AppScopedBean1105 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1105.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1105");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1105");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1105");
    }
