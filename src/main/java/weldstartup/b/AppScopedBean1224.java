...
public class AppScopedBean1224 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1224.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1224");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1224");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1224");
    }
