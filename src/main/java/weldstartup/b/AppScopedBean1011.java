...
public class AppScopedBean1011 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1011.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1011");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1011");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1011");
    }
