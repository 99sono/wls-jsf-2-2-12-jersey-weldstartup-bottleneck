...
public class AppScopedBean1793 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1793.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1793");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1793");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1793");
    }
