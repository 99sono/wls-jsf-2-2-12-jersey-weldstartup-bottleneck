...
public class AppScopedBean1742 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1742.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1742");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1742");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1742");
    }
