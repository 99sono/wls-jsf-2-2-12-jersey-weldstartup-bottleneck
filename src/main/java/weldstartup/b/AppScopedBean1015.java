...
public class AppScopedBean1015 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1015.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1015");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1015");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1015");
    }
