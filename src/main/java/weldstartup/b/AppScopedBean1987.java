...
public class AppScopedBean1987 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1987.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1987");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1987");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1987");
    }
