...
public class AppScopedBean1480 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1480.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1480");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1480");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1480");
    }
