...
public class AppScopedBean1577 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1577.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1577");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1577");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1577");
    }
