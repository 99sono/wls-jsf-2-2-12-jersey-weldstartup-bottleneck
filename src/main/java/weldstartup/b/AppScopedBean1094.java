...
public class AppScopedBean1094 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1094.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1094");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1094");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1094");
    }
