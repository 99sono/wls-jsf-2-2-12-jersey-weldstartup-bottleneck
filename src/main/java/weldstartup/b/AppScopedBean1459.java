...
public class AppScopedBean1459 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1459.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1459");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1459");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1459");
    }
