...
public class AppScopedBean1924 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1924.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1924");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1924");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1924");
    }
