...
public class AppScopedBean1067 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1067.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1067");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1067");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1067");
    }
