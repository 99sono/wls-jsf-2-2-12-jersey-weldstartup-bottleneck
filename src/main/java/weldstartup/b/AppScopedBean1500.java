...
public class AppScopedBean1500 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1500.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1500");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1500");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1500");
    }
