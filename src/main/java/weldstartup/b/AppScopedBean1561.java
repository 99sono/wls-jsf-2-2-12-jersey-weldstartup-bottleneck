...
public class AppScopedBean1561 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1561.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1561");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1561");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1561");
    }
