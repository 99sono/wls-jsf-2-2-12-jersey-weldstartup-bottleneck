...
public class AppScopedBean1483 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1483.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1483");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1483");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1483");
    }
