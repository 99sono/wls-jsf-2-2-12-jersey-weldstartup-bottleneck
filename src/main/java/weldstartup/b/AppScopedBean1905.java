...
public class AppScopedBean1905 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1905.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1905");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1905");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1905");
    }
