...
public class AppScopedBean1689 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1689.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1689");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1689");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1689");
    }
