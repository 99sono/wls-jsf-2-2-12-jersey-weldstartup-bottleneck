...
public class AppScopedBean1702 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1702.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1702");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1702");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1702");
    }
