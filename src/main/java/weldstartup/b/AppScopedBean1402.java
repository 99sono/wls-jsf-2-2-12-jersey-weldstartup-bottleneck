...
public class AppScopedBean1402 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1402.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1402");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1402");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1402");
    }
