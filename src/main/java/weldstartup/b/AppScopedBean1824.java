...
public class AppScopedBean1824 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1824.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1824");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1824");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1824");
    }
