...
public class AppScopedBean1129 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1129.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1129");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1129");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1129");
    }
