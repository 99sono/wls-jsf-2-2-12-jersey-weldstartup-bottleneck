...
public class AppScopedBean1110 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1110.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1110");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1110");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1110");
    }
