...
public class AppScopedBean1851 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1851.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1851");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1851");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1851");
    }
