...
public class AppScopedBean1827 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1827.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1827");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1827");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1827");
    }
