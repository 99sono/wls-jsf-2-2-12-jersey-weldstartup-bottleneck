...
public class AppScopedBean1497 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1497.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1497");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1497");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1497");
    }
