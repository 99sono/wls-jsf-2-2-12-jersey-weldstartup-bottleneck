...
public class AppScopedBean1603 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1603.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1603");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1603");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1603");
    }
