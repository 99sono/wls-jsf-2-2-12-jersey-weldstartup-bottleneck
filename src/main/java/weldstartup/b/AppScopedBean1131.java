...
public class AppScopedBean1131 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1131.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1131");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1131");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1131");
    }
