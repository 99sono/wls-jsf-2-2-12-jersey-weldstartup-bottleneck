...
public class AppScopedBean1495 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1495.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1495");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1495");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1495");
    }
