...
public class AppScopedBean1809 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1809.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1809");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1809");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1809");
    }
