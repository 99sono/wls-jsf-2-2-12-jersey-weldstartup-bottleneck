...
public class AppScopedBean1485 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1485.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1485");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1485");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1485");
    }
