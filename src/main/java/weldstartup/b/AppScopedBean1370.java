...
public class AppScopedBean1370 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1370.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1370");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1370");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1370");
    }
