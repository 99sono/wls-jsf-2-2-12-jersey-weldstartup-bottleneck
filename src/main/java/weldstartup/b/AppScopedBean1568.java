...
public class AppScopedBean1568 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1568.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1568");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1568");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1568");
    }
