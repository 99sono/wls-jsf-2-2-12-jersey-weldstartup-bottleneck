...
public class AppScopedBean1854 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1854.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1854");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1854");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1854");
    }
