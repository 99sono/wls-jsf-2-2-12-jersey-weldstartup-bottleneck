...
public class AppScopedBean1478 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1478.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1478");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1478");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1478");
    }
