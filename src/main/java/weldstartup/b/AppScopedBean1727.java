...
public class AppScopedBean1727 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1727.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1727");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1727");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1727");
    }
