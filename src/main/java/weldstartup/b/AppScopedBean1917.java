...
public class AppScopedBean1917 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1917.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1917");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1917");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1917");
    }
