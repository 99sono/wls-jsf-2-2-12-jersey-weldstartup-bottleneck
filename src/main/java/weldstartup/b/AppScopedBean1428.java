...
public class AppScopedBean1428 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1428.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1428");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1428");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1428");
    }
