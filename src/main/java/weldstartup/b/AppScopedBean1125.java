...
public class AppScopedBean1125 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1125.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1125");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1125");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1125");
    }
