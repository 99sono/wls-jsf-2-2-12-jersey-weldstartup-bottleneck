...
public class AppScopedBean1482 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1482.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1482");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1482");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1482");
    }
