...
public class AppScopedBean1645 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1645.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1645");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1645");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1645");
    }
