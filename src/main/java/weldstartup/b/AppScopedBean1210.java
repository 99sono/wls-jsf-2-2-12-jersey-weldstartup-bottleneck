...
public class AppScopedBean1210 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1210.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1210");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1210");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1210");
    }
