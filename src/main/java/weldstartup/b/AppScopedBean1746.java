...
public class AppScopedBean1746 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1746.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1746");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1746");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1746");
    }
