...
public class AppScopedBean1514 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1514.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1514");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1514");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1514");
    }
