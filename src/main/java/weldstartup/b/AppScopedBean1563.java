...
public class AppScopedBean1563 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1563.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1563");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1563");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1563");
    }
