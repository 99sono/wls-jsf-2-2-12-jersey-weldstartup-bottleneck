...
public class AppScopedBean1429 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1429.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1429");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1429");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1429");
    }
