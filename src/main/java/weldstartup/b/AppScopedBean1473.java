...
public class AppScopedBean1473 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1473.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1473");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1473");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1473");
    }
