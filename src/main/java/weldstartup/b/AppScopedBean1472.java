...
public class AppScopedBean1472 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1472.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1472");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1472");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1472");
    }
