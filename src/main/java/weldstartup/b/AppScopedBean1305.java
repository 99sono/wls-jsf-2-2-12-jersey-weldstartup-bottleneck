...
public class AppScopedBean1305 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1305.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1305");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1305");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1305");
    }
