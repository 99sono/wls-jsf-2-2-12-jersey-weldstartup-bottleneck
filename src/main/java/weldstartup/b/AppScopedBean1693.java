...
public class AppScopedBean1693 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1693.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1693");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1693");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1693");
    }
