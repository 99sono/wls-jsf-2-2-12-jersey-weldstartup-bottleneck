...
public class AppScopedBean1413 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1413.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1413");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1413");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1413");
    }
