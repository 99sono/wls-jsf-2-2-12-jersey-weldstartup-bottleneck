...
public class AppScopedBean1345 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1345.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1345");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1345");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1345");
    }
