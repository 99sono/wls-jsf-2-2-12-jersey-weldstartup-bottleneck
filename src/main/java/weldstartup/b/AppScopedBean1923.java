...
public class AppScopedBean1923 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1923.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1923");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1923");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1923");
    }
