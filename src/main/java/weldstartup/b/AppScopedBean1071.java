...
public class AppScopedBean1071 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1071.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1071");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1071");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1071");
    }
