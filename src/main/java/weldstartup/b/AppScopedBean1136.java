...
public class AppScopedBean1136 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1136.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1136");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1136");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1136");
    }
