...
public class AppScopedBean1919 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1919.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1919");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1919");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1919");
    }
