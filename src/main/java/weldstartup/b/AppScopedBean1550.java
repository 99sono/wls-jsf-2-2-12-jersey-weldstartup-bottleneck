...
public class AppScopedBean1550 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1550.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1550");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1550");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1550");
    }
