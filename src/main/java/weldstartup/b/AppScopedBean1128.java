...
public class AppScopedBean1128 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1128.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1128");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1128");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1128");
    }
