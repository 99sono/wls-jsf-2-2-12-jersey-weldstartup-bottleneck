...
public class AppScopedBean1745 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1745.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1745");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1745");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1745");
    }
