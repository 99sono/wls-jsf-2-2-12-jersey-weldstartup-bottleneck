...
public class AppScopedBean1234 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1234.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1234");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1234");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1234");
    }
