...
public class AppScopedBean1572 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1572.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1572");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1572");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1572");
    }
