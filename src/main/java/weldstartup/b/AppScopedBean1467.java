...
public class AppScopedBean1467 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1467.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1467");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1467");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1467");
    }
