...
public class AppScopedBean1631 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1631.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1631");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1631");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1631");
    }
