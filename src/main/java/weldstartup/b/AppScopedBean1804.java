...
public class AppScopedBean1804 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1804.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1804");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1804");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1804");
    }
