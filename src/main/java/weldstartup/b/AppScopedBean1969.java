...
public class AppScopedBean1969 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1969.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1969");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1969");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1969");
    }
