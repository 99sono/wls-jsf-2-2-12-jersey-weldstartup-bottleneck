...
public class AppScopedBean1751 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1751.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1751");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1751");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1751");
    }
