...
public class AppScopedBean1815 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1815.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1815");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1815");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1815");
    }
