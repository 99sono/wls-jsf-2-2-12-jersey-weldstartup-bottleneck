...
public class AppScopedBean1187 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1187.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1187");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1187");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1187");
    }
