...
public class AppScopedBean1611 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1611.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1611");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1611");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1611");
    }
