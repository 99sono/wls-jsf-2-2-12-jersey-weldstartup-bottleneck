...
public class AppScopedBean1979 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1979.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1979");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1979");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1979");
    }
