...
public class AppScopedBean1776 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1776.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1776");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1776");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1776");
    }
