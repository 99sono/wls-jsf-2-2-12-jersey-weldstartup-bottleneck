...
public class AppScopedBean1849 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1849.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1849");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1849");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1849");
    }
