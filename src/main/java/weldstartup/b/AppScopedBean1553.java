...
public class AppScopedBean1553 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1553.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1553");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1553");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1553");
    }
