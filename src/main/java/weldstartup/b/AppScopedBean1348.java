...
public class AppScopedBean1348 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1348.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1348");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1348");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1348");
    }
