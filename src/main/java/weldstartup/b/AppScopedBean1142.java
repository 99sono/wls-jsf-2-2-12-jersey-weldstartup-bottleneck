...
public class AppScopedBean1142 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1142.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1142");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1142");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1142");
    }
