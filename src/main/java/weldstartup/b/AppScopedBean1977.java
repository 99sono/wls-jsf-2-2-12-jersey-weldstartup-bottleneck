...
public class AppScopedBean1977 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1977.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1977");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1977");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1977");
    }
