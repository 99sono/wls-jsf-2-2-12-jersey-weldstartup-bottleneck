...
public class AppScopedBean1848 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1848.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1848");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1848");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1848");
    }
