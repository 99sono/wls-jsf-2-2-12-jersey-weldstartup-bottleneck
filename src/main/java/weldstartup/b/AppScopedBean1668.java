...
public class AppScopedBean1668 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1668.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1668");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1668");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1668");
    }
