...
public class AppScopedBean1009 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1009.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1009");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1009");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1009");
    }
