...
public class AppScopedBean1662 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1662.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1662");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1662");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1662");
    }
