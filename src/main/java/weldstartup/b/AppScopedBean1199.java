...
public class AppScopedBean1199 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1199.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1199");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1199");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1199");
    }
