...
public class AppScopedBean1406 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1406.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1406");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1406");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1406");
    }
