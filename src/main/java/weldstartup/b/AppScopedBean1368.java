...
public class AppScopedBean1368 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1368.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1368");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1368");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1368");
    }
