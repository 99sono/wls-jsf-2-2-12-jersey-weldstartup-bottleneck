...
public class AppScopedBean1153 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1153.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1153");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1153");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1153");
    }
