...
public class AppScopedBean1807 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1807.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1807");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1807");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1807");
    }
