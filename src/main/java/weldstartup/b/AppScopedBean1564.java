...
public class AppScopedBean1564 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1564.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1564");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1564");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1564");
    }
