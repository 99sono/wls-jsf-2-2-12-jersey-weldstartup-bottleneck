...
public class AppScopedBean1438 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1438.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1438");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1438");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1438");
    }
