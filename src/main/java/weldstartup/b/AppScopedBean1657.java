...
public class AppScopedBean1657 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1657.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1657");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1657");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1657");
    }
