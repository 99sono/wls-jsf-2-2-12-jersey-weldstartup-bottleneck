...
public class AppScopedBean1622 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1622.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1622");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1622");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1622");
    }
