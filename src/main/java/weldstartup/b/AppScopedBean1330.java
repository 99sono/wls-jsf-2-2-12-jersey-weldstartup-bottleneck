...
public class AppScopedBean1330 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1330.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1330");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1330");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1330");
    }
