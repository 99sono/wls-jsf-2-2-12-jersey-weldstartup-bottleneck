...
public class AppScopedBean1396 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1396.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1396");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1396");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1396");
    }
