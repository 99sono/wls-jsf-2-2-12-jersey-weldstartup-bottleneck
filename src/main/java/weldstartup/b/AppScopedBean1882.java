...
public class AppScopedBean1882 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1882.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1882");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1882");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1882");
    }
