...
public class AppScopedBean1475 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1475.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1475");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1475");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1475");
    }
