...
public class AppScopedBean1992 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1992.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1992");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1992");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1992");
    }
