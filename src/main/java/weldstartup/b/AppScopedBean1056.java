...
public class AppScopedBean1056 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1056.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1056");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1056");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1056");
    }
