...
public class AppScopedBean1814 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1814.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1814");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1814");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1814");
    }
