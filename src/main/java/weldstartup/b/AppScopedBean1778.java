...
public class AppScopedBean1778 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1778.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1778");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1778");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1778");
    }
