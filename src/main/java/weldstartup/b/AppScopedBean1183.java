...
public class AppScopedBean1183 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1183.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1183");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1183");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1183");
    }
