...
public class AppScopedBean1684 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1684.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1684");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1684");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1684");
    }
