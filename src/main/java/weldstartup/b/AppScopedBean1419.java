...
public class AppScopedBean1419 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1419.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1419");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1419");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1419");
    }
