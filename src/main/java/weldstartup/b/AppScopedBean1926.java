...
public class AppScopedBean1926 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1926.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1926");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1926");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1926");
    }
