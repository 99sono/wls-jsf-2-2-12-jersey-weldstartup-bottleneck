...
public class AppScopedBean1294 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1294.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1294");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1294");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1294");
    }
