...
public class AppScopedBean1691 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1691.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1691");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1691");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1691");
    }
