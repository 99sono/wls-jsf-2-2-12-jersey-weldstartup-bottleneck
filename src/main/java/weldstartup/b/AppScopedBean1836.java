...
public class AppScopedBean1836 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1836.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1836");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1836");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1836");
    }
