...
public class AppScopedBean1137 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1137.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1137");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1137");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1137");
    }
