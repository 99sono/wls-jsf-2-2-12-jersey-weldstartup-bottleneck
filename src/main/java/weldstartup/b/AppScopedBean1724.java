...
public class AppScopedBean1724 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1724.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1724");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1724");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1724");
    }
