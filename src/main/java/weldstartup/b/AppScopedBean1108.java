...
public class AppScopedBean1108 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1108.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1108");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1108");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1108");
    }
