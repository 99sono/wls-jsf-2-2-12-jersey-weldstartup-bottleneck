...
public class AppScopedBean1655 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1655.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1655");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1655");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1655");
    }
