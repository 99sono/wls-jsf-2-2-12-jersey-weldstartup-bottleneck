...
public class AppScopedBean1371 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1371.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1371");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1371");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1371");
    }
