...
public class AppScopedBean1988 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1988.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1988");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1988");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1988");
    }
