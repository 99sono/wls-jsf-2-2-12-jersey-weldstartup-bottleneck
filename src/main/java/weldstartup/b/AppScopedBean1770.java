...
public class AppScopedBean1770 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1770.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1770");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1770");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1770");
    }
