...
public class AppScopedBean1674 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1674.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1674");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1674");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1674");
    }
