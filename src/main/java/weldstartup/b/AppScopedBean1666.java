...
public class AppScopedBean1666 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1666.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1666");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1666");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1666");
    }
