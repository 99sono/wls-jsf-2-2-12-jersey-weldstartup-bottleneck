...
public class AppScopedBean1630 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1630.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1630");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1630");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1630");
    }
