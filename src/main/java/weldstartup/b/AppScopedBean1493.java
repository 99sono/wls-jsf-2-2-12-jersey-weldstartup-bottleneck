...
public class AppScopedBean1493 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1493.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1493");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1493");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1493");
    }
