...
public class AppScopedBean1837 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1837.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1837");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1837");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1837");
    }
