...
public class AppScopedBean1775 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1775.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1775");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1775");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1775");
    }
