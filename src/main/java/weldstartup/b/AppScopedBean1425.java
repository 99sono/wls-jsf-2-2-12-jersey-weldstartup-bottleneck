...
public class AppScopedBean1425 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1425.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1425");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1425");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1425");
    }
