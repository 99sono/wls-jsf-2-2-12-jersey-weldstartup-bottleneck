...
public class AppScopedBean1852 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1852.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1852");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1852");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1852");
    }
