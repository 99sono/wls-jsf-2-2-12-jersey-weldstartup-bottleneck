...
public class AppScopedBean1171 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1171.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1171");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1171");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1171");
    }
