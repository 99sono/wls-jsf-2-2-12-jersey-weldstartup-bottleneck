...
public class AppScopedBean1479 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1479.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1479");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1479");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1479");
    }
