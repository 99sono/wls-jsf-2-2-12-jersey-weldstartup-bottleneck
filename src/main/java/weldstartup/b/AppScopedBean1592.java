...
public class AppScopedBean1592 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1592.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1592");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1592");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1592");
    }
