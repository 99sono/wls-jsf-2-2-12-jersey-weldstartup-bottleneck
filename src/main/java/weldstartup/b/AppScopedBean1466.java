...
public class AppScopedBean1466 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1466.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1466");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1466");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1466");
    }
