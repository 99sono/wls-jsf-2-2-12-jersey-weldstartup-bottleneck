...
public class AppScopedBean1146 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1146.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1146");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1146");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1146");
    }
