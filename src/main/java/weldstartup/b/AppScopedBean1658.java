...
public class AppScopedBean1658 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1658.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1658");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1658");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1658");
    }
