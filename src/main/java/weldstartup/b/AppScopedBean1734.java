...
public class AppScopedBean1734 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1734.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1734");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1734");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1734");
    }
