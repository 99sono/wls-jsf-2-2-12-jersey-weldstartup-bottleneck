...
public class AppScopedBean1445 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1445.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1445");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1445");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1445");
    }
