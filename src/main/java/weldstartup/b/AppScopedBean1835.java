...
public class AppScopedBean1835 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1835.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1835");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1835");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1835");
    }
