...
public class AppScopedBean1931 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1931.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1931");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1931");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1931");
    }
