...
public class AppScopedBean1762 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1762.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1762");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1762");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1762");
    }
