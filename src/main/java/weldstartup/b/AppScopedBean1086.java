...
public class AppScopedBean1086 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1086.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1086");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1086");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1086");
    }
