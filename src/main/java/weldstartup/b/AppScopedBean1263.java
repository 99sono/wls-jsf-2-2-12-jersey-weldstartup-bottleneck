...
public class AppScopedBean1263 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1263.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1263");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1263");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1263");
    }
