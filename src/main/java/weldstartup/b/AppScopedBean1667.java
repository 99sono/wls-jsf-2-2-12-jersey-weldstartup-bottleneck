...
public class AppScopedBean1667 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1667.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1667");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1667");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1667");
    }
