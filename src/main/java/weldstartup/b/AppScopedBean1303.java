...
public class AppScopedBean1303 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1303.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1303");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1303");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1303");
    }
