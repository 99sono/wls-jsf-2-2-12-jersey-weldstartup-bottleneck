...
public class AppScopedBean1241 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1241.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1241");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1241");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1241");
    }
