...
public class AppScopedBean1692 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1692.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1692");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1692");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1692");
    }
