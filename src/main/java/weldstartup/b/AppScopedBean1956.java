...
public class AppScopedBean1956 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1956.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1956");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1956");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1956");
    }
