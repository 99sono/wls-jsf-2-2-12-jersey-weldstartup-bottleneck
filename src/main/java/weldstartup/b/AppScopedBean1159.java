...
public class AppScopedBean1159 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1159.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1159");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1159");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1159");
    }
