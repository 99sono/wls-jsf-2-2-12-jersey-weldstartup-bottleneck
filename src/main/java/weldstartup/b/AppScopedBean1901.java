...
public class AppScopedBean1901 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1901.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1901");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1901");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1901");
    }
