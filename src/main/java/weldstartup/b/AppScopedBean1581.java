...
public class AppScopedBean1581 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1581.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1581");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1581");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1581");
    }
