...
public class AppScopedBean1328 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1328.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1328");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1328");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1328");
    }
