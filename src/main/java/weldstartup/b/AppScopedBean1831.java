...
public class AppScopedBean1831 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1831.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1831");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1831");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1831");
    }
