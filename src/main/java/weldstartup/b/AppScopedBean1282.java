...
public class AppScopedBean1282 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1282.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1282");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1282");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1282");
    }
