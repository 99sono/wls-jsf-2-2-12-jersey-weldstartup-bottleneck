...
public class AppScopedBean1208 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1208.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1208");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1208");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1208");
    }
