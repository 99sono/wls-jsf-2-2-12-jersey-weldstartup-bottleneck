...
public class AppScopedBean1409 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1409.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1409");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1409");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1409");
    }
