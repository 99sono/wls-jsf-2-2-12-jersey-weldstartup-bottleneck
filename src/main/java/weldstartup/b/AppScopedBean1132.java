...
public class AppScopedBean1132 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1132.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1132");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1132");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1132");
    }
