...
public class AppScopedBean1506 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1506.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1506");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1506");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1506");
    }
