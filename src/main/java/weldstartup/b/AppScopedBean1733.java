...
public class AppScopedBean1733 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1733.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1733");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1733");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1733");
    }
