...
public class AppScopedBean1717 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1717.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1717");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1717");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1717");
    }
