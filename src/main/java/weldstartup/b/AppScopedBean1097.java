...
public class AppScopedBean1097 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1097.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1097");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1097");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1097");
    }
