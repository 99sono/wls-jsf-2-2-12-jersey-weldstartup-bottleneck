...
public class AppScopedBean1610 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1610.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1610");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1610");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1610");
    }
