...
public class AppScopedBean1273 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1273.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1273");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1273");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1273");
    }
