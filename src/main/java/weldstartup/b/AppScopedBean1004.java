...
public class AppScopedBean1004 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1004.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1004");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1004");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1004");
    }
