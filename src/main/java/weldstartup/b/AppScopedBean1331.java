...
public class AppScopedBean1331 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1331.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1331");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1331");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1331");
    }
