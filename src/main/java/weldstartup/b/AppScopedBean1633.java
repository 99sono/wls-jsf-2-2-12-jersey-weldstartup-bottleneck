...
public class AppScopedBean1633 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1633.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1633");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1633");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1633");
    }
