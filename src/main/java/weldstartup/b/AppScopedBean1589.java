...
public class AppScopedBean1589 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1589.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1589");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1589");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1589");
    }
