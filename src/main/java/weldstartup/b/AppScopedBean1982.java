...
public class AppScopedBean1982 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1982.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1982");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1982");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1982");
    }
