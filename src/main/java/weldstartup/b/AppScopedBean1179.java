...
public class AppScopedBean1179 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1179.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1179");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1179");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1179");
    }
