...
public class AppScopedBean1161 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1161.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1161");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1161");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1161");
    }
