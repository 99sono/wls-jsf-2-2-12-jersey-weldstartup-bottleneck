...
public class AppScopedBean1843 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1843.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1843");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1843");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1843");
    }
