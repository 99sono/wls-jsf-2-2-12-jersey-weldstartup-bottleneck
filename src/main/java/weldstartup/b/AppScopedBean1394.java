...
public class AppScopedBean1394 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1394.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1394");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1394");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1394");
    }
