...
public class AppScopedBean1100 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1100.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1100");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1100");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1100");
    }
