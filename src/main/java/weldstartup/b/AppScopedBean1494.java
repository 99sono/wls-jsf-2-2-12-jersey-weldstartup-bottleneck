...
public class AppScopedBean1494 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1494.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1494");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1494");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1494");
    }
