...
public class AppScopedBean1747 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1747.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1747");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1747");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1747");
    }
