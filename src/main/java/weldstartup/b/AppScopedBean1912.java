...
public class AppScopedBean1912 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1912.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1912");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1912");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1912");
    }
