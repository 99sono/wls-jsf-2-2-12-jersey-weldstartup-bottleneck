...
public class AppScopedBean1853 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1853.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1853");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1853");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1853");
    }
