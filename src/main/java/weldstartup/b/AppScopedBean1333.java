...
public class AppScopedBean1333 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1333.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1333");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1333");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1333");
    }
