...
public class AppScopedBean1838 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1838.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1838");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1838");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1838");
    }
