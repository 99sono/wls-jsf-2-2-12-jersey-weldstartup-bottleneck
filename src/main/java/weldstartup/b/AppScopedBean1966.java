...
public class AppScopedBean1966 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1966.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1966");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1966");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1966");
    }
