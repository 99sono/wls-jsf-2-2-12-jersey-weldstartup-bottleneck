...
public class AppScopedBean1099 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1099.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1099");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1099");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1099");
    }
