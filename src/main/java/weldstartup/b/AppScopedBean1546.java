...
public class AppScopedBean1546 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1546.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1546");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1546");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1546");
    }
