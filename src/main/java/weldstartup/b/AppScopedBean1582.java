...
public class AppScopedBean1582 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1582.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1582");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1582");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1582");
    }
