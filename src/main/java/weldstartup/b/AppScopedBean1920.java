...
public class AppScopedBean1920 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1920.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1920");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1920");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1920");
    }
