...
public class AppScopedBean1317 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1317.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1317");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1317");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1317");
    }
