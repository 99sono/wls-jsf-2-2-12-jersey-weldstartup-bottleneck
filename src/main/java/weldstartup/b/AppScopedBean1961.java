...
public class AppScopedBean1961 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1961.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1961");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1961");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1961");
    }
