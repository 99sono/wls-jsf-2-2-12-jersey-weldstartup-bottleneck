...
public class AppScopedBean1720 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1720.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1720");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1720");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1720");
    }
