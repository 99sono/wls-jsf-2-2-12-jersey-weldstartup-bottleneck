...
public class AppScopedBean1509 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1509.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1509");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1509");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1509");
    }
