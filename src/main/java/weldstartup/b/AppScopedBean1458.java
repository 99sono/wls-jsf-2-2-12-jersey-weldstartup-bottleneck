...
public class AppScopedBean1458 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1458.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1458");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1458");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1458");
    }
