...
public class AppScopedBean1899 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1899.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1899");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1899");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1899");
    }
