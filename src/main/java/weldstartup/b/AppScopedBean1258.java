...
public class AppScopedBean1258 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1258.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1258");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1258");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1258");
    }
