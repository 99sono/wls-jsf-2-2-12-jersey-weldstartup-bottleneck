...
public class AppScopedBean1983 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1983.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1983");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1983");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1983");
    }
