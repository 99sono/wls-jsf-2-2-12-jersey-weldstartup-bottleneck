...
public class AppScopedBean1369 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1369.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1369");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1369");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1369");
    }
