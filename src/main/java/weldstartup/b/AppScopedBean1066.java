...
public class AppScopedBean1066 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1066.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1066");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1066");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1066");
    }
