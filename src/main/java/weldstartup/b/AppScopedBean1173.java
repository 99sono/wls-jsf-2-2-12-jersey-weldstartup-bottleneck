...
public class AppScopedBean1173 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1173.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1173");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1173");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1173");
    }
