...
public class AppScopedBean1471 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1471.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1471");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1471");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1471");
    }
