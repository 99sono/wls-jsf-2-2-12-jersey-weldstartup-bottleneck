...
public class AppScopedBean1043 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1043.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1043");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1043");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1043");
    }
