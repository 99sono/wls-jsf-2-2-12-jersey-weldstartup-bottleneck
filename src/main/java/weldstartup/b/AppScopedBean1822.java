...
public class AppScopedBean1822 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1822.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1822");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1822");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1822");
    }
