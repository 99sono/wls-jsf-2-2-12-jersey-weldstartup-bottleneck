...
public class AppScopedBean1051 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1051.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1051");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1051");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1051");
    }
