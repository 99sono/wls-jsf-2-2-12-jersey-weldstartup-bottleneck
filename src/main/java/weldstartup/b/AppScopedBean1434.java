...
public class AppScopedBean1434 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1434.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1434");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1434");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1434");
    }
