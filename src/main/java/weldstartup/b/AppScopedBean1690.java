...
public class AppScopedBean1690 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1690.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1690");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1690");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1690");
    }
