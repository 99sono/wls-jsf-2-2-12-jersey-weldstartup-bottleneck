...
public class AppScopedBean1029 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1029.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1029");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1029");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1029");
    }
