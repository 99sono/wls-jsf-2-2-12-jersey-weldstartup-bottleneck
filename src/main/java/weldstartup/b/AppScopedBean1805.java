...
public class AppScopedBean1805 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1805.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1805");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1805");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1805");
    }
