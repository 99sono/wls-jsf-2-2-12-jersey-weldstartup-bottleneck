...
public class AppScopedBean1525 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1525.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1525");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1525");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1525");
    }
