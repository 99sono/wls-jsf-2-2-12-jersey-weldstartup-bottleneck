...
public class AppScopedBean1562 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1562.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1562");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1562");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1562");
    }
