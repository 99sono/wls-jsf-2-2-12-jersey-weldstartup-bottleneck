...
public class AppScopedBean1665 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1665.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1665");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1665");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1665");
    }
