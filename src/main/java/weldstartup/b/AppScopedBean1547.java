...
public class AppScopedBean1547 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1547.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1547");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1547");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1547");
    }
