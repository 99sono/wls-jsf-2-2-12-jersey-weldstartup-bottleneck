...
public class AppScopedBean1275 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1275.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1275");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1275");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1275");
    }
