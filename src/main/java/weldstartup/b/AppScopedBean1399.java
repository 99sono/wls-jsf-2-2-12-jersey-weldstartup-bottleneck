...
public class AppScopedBean1399 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1399.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1399");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1399");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1399");
    }
