...
public class AppScopedBean1118 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1118.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1118");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1118");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1118");
    }
