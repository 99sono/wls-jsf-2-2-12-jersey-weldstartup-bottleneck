...
public class AppScopedBean1176 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1176.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1176");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1176");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1176");
    }
