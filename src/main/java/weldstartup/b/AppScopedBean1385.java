...
public class AppScopedBean1385 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1385.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1385");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1385");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1385");
    }
