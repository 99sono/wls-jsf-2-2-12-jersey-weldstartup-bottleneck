...
public class AppScopedBean1825 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1825.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1825");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1825");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1825");
    }
