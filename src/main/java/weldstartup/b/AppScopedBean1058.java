...
public class AppScopedBean1058 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1058.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1058");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1058");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1058");
    }
