...
public class AppScopedBean1229 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1229.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1229");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1229");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1229");
    }
