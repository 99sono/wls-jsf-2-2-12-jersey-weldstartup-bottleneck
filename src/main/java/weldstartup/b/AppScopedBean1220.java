...
public class AppScopedBean1220 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1220.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1220");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1220");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1220");
    }
