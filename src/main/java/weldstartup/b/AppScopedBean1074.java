...
public class AppScopedBean1074 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1074.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1074");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1074");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1074");
    }
