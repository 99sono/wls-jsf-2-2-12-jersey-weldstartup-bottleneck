...
public class AppScopedBean1555 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1555.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1555");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1555");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1555");
    }
