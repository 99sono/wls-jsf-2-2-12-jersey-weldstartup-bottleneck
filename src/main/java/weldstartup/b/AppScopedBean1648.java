...
public class AppScopedBean1648 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1648.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1648");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1648");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1648");
    }
