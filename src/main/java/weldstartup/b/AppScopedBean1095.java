...
public class AppScopedBean1095 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1095.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1095");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1095");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1095");
    }
