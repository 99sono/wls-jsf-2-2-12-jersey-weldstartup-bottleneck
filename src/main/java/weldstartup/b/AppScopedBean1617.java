...
public class AppScopedBean1617 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1617.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1617");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1617");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1617");
    }
