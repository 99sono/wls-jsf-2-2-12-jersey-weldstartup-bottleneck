...
public class AppScopedBean1974 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1974.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1974");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1974");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1974");
    }
