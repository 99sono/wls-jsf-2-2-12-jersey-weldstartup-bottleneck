...
public class AppScopedBean1338 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1338.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1338");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1338");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1338");
    }
