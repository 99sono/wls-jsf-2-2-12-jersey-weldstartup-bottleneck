...
public class AppScopedBean1212 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1212.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1212");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1212");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1212");
    }
