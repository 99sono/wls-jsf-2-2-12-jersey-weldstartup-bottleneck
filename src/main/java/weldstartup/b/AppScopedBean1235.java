...
public class AppScopedBean1235 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1235.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1235");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1235");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1235");
    }
