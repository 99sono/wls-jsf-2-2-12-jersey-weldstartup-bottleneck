...
public class AppScopedBean1764 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1764.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1764");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1764");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1764");
    }
