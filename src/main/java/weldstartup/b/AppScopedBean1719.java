...
public class AppScopedBean1719 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1719.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1719");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1719");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1719");
    }
