...
public class AppScopedBean1481 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1481.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1481");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1481");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1481");
    }
