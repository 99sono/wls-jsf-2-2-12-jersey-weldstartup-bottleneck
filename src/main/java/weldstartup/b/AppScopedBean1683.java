...
public class AppScopedBean1683 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1683.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1683");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1683");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1683");
    }
