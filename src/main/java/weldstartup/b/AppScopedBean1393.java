...
public class AppScopedBean1393 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1393.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1393");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1393");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1393");
    }
