...
public class AppScopedBean1996 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1996.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1996");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1996");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1996");
    }
