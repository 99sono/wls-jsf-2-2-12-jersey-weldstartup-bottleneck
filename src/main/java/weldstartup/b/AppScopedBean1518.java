...
public class AppScopedBean1518 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1518.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1518");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1518");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1518");
    }
