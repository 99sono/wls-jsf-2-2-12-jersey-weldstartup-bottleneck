...
public class AppScopedBean1513 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1513.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1513");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1513");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1513");
    }
