...
public class AppScopedBean1185 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1185.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1185");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1185");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1185");
    }
