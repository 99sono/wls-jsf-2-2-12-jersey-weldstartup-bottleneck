...
public class AppScopedBean1732 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1732.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1732");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1732");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1732");
    }
