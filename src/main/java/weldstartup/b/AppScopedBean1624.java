...
public class AppScopedBean1624 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1624.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1624");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1624");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1624");
    }
