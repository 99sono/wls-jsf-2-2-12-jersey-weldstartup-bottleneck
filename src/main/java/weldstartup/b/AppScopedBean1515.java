...
public class AppScopedBean1515 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1515.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1515");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1515");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1515");
    }
