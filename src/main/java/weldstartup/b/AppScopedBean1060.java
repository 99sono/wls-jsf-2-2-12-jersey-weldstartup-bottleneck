...
public class AppScopedBean1060 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1060.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1060");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1060");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1060");
    }
