...
public class AppScopedBean1395 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1395.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1395");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1395");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1395");
    }
