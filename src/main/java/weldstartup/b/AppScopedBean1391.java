...
public class AppScopedBean1391 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1391.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1391");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1391");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1391");
    }
