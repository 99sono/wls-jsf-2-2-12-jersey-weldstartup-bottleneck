...
public class AppScopedBean1342 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1342.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1342");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1342");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1342");
    }
