...
public class AppScopedBean1790 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1790.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1790");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1790");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1790");
    }
