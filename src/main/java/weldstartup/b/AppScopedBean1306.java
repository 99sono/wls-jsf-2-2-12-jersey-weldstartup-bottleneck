...
public class AppScopedBean1306 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1306.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1306");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1306");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1306");
    }
