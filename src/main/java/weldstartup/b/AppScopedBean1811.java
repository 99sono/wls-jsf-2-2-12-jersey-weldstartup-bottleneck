...
public class AppScopedBean1811 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1811.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1811");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1811");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1811");
    }
