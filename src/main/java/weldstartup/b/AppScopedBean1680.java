...
public class AppScopedBean1680 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1680.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1680");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1680");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1680");
    }
