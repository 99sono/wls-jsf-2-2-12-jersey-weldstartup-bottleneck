...
public class AppScopedBean1291 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1291.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1291");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1291");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1291");
    }
