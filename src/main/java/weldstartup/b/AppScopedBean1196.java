...
public class AppScopedBean1196 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1196.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1196");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1196");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1196");
    }
