...
public class AppScopedBean1725 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1725.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1725");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1725");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1725");
    }
