...
public class AppScopedBean1487 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1487.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1487");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1487");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1487");
    }
