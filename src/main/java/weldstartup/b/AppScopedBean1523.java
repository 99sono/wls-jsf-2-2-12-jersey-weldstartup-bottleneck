...
public class AppScopedBean1523 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1523.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1523");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1523");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1523");
    }
