...
public class AppScopedBean1604 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1604.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1604");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1604");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1604");
    }
