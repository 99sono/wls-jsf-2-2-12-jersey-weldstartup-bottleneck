...
public class AppScopedBean1382 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1382.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1382");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1382");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1382");
    }
