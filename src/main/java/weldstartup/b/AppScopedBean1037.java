...
public class AppScopedBean1037 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1037.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1037");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1037");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1037");
    }
