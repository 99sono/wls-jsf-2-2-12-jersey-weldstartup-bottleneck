...
public class AppScopedBean1312 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1312.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1312");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1312");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1312");
    }
