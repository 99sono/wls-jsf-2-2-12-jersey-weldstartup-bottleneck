...
public class AppScopedBean1238 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1238.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1238");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1238");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1238");
    }
