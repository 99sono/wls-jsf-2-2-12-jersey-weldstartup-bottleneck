...
public class AppScopedBean1361 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1361.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1361");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1361");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1361");
    }
