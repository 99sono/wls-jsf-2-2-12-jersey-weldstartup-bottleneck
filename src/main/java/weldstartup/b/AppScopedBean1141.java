...
public class AppScopedBean1141 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1141.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1141");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1141");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1141");
    }
