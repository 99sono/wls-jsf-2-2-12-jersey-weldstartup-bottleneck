...
public class AppScopedBean1035 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1035.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1035");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1035");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1035");
    }
