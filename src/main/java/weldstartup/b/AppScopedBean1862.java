...
public class AppScopedBean1862 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1862.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1862");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1862");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1862");
    }
