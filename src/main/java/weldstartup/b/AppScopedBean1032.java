...
public class AppScopedBean1032 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1032.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1032");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1032");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1032");
    }
