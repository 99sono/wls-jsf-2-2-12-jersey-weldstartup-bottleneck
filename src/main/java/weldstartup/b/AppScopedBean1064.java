...
public class AppScopedBean1064 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1064.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1064");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1064");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1064");
    }
