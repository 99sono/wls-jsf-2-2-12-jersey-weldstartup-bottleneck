...
public class AppScopedBean1512 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1512.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1512");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1512");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1512");
    }
