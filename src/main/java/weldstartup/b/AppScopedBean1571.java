...
public class AppScopedBean1571 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1571.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1571");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1571");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1571");
    }
