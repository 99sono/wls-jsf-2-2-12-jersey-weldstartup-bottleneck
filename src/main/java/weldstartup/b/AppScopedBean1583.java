...
public class AppScopedBean1583 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1583.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1583");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1583");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1583");
    }
