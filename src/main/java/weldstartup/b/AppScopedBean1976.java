...
public class AppScopedBean1976 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1976.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1976");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1976");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1976");
    }
