...
public class AppScopedBean1660 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1660.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1660");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1660");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1660");
    }
