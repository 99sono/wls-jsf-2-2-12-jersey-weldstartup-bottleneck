...
public class AppScopedBean1170 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1170.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1170");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1170");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1170");
    }
