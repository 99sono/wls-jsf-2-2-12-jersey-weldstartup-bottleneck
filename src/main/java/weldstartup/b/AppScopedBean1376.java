...
public class AppScopedBean1376 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1376.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1376");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1376");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1376");
    }
