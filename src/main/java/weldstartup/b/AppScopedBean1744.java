...
public class AppScopedBean1744 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1744.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1744");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1744");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1744");
    }
