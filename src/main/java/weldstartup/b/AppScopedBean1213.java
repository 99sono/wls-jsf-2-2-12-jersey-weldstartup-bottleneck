...
public class AppScopedBean1213 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1213.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1213");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1213");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1213");
    }
