...
public class AppScopedBean1287 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1287.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1287");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1287");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1287");
    }
