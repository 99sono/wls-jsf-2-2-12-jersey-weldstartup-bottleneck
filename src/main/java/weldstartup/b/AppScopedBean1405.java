...
public class AppScopedBean1405 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1405.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1405");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1405");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1405");
    }
