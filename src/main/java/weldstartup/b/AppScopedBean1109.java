...
public class AppScopedBean1109 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1109.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1109");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1109");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1109");
    }
