...
public class AppScopedBean1844 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1844.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1844");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1844");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1844");
    }
