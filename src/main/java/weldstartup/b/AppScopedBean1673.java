...
public class AppScopedBean1673 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1673.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1673");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1673");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1673");
    }
