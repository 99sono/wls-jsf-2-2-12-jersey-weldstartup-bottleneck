...
public class AppScopedBean1403 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1403.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1403");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1403");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1403");
    }
