...
public class AppScopedBean1671 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1671.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1671");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1671");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1671");
    }
