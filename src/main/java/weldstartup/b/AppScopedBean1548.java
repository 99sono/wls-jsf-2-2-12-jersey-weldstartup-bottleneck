...
public class AppScopedBean1548 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1548.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1548");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1548");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1548");
    }
