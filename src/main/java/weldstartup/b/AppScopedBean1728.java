...
public class AppScopedBean1728 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1728.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1728");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1728");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1728");
    }
