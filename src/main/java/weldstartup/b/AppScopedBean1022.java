...
public class AppScopedBean1022 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1022.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1022");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1022");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1022");
    }
