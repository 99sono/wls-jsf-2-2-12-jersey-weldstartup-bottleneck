...
public class AppScopedBean1157 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1157.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1157");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1157");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1157");
    }
