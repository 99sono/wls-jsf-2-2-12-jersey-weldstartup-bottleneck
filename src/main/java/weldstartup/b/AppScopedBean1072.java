...
public class AppScopedBean1072 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1072.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1072");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1072");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1072");
    }
