...
public class AppScopedBean1476 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1476.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1476");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1476");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1476");
    }
