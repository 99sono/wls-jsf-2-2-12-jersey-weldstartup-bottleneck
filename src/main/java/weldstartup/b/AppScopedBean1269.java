...
public class AppScopedBean1269 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1269.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1269");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1269");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1269");
    }
