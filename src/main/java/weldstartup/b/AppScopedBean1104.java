...
public class AppScopedBean1104 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1104.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1104");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1104");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1104");
    }
