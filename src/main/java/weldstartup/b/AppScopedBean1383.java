...
public class AppScopedBean1383 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1383.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1383");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1383");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1383");
    }
