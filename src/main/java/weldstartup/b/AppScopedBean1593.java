...
public class AppScopedBean1593 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1593.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1593");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1593");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1593");
    }
