...
public class AppScopedBean1830 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1830.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1830");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1830");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1830");
    }
