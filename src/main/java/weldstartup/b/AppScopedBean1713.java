...
public class AppScopedBean1713 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1713.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1713");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1713");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1713");
    }
