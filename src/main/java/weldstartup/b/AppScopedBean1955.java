...
public class AppScopedBean1955 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1955.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1955");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1955");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1955");
    }
