...
public class AppScopedBean1225 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1225.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1225");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1225");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1225");
    }
