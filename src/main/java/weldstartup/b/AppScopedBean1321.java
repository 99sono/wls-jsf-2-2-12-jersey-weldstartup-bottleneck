...
public class AppScopedBean1321 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1321.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1321");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1321");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1321");
    }
