...
public class AppScopedBean1103 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1103.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1103");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1103");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1103");
    }
