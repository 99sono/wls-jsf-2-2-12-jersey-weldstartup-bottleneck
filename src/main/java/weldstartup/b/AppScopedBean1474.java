...
public class AppScopedBean1474 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1474.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1474");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1474");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1474");
    }
