...
public class AppScopedBean1821 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1821.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1821");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1821");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1821");
    }
