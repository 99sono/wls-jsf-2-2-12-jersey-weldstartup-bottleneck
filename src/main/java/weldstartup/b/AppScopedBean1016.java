...
public class AppScopedBean1016 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1016.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1016");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1016");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1016");
    }
