...
public class AppScopedBean1178 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1178.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1178");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1178");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1178");
    }
