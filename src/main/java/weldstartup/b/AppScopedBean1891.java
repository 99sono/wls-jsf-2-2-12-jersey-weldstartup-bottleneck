...
public class AppScopedBean1891 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1891.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1891");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1891");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1891");
    }
