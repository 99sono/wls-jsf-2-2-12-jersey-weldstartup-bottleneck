...
public class AppScopedBean1802 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1802.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1802");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1802");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1802");
    }
