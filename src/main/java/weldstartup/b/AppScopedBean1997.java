...
public class AppScopedBean1997 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1997.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1997");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1997");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1997");
    }
