...
public class AppScopedBean1442 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1442.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1442");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1442");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1442");
    }
