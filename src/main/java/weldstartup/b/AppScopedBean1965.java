...
public class AppScopedBean1965 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1965.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1965");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1965");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1965");
    }
