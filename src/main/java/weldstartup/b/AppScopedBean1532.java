...
public class AppScopedBean1532 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1532.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1532");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1532");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1532");
    }
