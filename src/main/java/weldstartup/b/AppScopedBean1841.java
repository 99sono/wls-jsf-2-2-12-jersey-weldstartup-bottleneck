...
public class AppScopedBean1841 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1841.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1841");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1841");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1841");
    }
