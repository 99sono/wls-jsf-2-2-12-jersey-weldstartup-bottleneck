...
public class AppScopedBean1007 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1007.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1007");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1007");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1007");
    }
