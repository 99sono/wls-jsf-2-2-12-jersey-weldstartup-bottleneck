...
public class AppScopedBean1355 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1355.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1355");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1355");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1355");
    }
