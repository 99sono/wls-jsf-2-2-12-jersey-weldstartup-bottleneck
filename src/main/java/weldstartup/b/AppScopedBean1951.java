...
public class AppScopedBean1951 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1951.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1951");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1951");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1951");
    }
