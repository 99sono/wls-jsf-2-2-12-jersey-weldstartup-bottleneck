...
public class AppScopedBean1569 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1569.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1569");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1569");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1569");
    }
