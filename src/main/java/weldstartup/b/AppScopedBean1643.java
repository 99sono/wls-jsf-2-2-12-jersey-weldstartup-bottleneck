...
public class AppScopedBean1643 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1643.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1643");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1643");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1643");
    }
