...
public class AppScopedBean1407 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1407.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1407");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1407");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1407");
    }
