...
public class AppScopedBean1044 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1044.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1044");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1044");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1044");
    }
