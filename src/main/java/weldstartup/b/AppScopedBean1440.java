...
public class AppScopedBean1440 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1440.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1440");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1440");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1440");
    }
