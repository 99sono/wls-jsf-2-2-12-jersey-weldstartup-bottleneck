...
public class AppScopedBean1003 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1003.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1003");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1003");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1003");
    }
