...
public class AppScopedBean1026 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1026.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1026");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1026");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1026");
    }
