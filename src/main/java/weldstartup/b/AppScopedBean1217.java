...
public class AppScopedBean1217 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1217.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1217");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1217");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1217");
    }
