...
public class AppScopedBean1167 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1167.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1167");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1167");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1167");
    }
