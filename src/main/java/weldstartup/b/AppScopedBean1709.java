...
public class AppScopedBean1709 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1709.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1709");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1709");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1709");
    }
