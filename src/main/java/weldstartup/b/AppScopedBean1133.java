...
public class AppScopedBean1133 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1133.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1133");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1133");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1133");
    }
