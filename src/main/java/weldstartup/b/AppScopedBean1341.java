...
public class AppScopedBean1341 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1341.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1341");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1341");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1341");
    }
