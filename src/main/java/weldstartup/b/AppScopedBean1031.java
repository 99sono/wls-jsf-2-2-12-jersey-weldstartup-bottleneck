...
public class AppScopedBean1031 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1031.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1031");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1031");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1031");
    }
