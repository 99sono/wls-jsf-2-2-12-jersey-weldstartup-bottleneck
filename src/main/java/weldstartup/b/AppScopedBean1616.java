...
public class AppScopedBean1616 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1616.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1616");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1616");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1616");
    }
