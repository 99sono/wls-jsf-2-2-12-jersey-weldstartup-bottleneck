...
public class AppScopedBean1316 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1316.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1316");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1316");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1316");
    }
