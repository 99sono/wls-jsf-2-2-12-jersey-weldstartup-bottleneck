...
public class AppScopedBean1261 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1261.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1261");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1261");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1261");
    }
