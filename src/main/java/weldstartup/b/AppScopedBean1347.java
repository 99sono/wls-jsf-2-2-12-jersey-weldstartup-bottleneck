...
public class AppScopedBean1347 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1347.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1347");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1347");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1347");
    }
