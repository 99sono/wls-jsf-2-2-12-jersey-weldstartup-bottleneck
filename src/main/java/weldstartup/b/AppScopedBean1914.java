...
public class AppScopedBean1914 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1914.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1914");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1914");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1914");
    }
