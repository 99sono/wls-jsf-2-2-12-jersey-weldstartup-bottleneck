...
public class AppScopedBean1536 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1536.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1536");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1536");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1536");
    }
