...
public class AppScopedBean1081 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1081.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1081");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1081");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1081");
    }
