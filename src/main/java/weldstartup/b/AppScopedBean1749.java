...
public class AppScopedBean1749 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1749.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1749");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1749");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1749");
    }
