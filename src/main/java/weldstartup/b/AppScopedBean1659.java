...
public class AppScopedBean1659 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1659.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1659");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1659");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1659");
    }
