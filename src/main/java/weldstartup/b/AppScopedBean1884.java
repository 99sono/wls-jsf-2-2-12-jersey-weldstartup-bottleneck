...
public class AppScopedBean1884 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean1884.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean1884");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean1884");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean1884");
    }
