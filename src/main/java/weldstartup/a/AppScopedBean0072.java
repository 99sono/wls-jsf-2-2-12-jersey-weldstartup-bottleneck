...
public class AppScopedBean0072 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0072.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0072");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0072");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0072");
    }
