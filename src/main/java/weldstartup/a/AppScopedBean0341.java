...
public class AppScopedBean0341 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0341.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0341");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0341");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0341");
    }
