...
public class AppScopedBean0239 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0239.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0239");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0239");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0239");
    }
