...
public class AppScopedBean0682 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0682.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0682");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0682");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0682");
    }
