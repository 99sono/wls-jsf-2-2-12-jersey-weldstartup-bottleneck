...
public class AppScopedBean0571 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0571.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0571");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0571");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0571");
    }
