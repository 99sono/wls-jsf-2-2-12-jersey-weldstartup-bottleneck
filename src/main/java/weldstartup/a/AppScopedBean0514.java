...
public class AppScopedBean0514 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0514.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0514");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0514");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0514");
    }
