...
public class AppScopedBean0290 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0290.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0290");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0290");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0290");
    }
