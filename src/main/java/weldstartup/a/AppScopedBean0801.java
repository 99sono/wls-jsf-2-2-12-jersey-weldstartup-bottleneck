...
public class AppScopedBean0801 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0801.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0801");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0801");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0801");
    }
