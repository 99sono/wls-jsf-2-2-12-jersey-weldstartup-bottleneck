...
public class AppScopedBean0078 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0078.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0078");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0078");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0078");
    }
