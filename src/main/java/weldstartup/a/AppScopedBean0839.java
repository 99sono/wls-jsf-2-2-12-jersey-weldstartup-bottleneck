...
public class AppScopedBean0839 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0839.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0839");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0839");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0839");
    }
