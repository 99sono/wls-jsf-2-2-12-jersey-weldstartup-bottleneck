...
public class AppScopedBean0370 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0370.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0370");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0370");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0370");
    }
