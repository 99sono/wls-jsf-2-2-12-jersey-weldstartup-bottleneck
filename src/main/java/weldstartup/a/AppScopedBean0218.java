...
public class AppScopedBean0218 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0218.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0218");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0218");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0218");
    }
