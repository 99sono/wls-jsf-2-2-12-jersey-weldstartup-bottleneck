...
public class AppScopedBean0786 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0786.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0786");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0786");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0786");
    }
