...
public class AppScopedBean0792 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0792.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0792");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0792");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0792");
    }
