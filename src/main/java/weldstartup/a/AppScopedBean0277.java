...
public class AppScopedBean0277 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0277.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0277");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0277");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0277");
    }
