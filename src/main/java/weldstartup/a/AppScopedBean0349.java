...
public class AppScopedBean0349 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0349.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0349");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0349");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0349");
    }
