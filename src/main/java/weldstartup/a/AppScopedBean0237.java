...
public class AppScopedBean0237 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0237.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0237");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0237");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0237");
    }
