...
public class AppScopedBean0965 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0965.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0965");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0965");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0965");
    }
