...
public class AppScopedBean0504 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0504.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0504");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0504");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0504");
    }
