...
public class AppScopedBean0882 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0882.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0882");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0882");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0882");
    }
