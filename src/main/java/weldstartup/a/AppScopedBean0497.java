...
public class AppScopedBean0497 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0497.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0497");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0497");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0497");
    }
