...
public class AppScopedBean0108 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0108.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0108");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0108");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0108");
    }
