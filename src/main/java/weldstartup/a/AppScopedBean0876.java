...
public class AppScopedBean0876 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0876.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0876");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0876");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0876");
    }
