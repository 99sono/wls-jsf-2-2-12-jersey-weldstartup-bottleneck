...
public class AppScopedBean0927 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0927.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0927");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0927");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0927");
    }
