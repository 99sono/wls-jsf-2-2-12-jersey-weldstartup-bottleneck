...
public class AppScopedBean0834 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0834.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0834");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0834");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0834");
    }
