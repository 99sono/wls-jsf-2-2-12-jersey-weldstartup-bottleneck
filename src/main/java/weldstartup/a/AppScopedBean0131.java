...
public class AppScopedBean0131 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0131.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0131");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0131");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0131");
    }
