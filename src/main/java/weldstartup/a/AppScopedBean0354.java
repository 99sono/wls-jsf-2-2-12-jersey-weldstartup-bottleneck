...
public class AppScopedBean0354 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0354.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0354");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0354");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0354");
    }
