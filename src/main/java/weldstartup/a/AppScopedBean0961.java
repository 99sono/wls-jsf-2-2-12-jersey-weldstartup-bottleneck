...
public class AppScopedBean0961 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0961.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0961");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0961");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0961");
    }
