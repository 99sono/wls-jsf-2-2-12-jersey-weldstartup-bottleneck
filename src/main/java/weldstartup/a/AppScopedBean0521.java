...
public class AppScopedBean0521 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0521.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0521");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0521");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0521");
    }
