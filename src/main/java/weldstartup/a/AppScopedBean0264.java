...
public class AppScopedBean0264 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0264.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0264");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0264");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0264");
    }
