...
public class AppScopedBean0696 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0696.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0696");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0696");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0696");
    }
