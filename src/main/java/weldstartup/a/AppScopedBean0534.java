...
public class AppScopedBean0534 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0534.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0534");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0534");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0534");
    }
