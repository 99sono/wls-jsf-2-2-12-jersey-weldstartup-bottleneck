...
public class AppScopedBean0355 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0355.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0355");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0355");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0355");
    }
