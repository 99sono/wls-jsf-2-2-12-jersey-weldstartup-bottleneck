...
public class AppScopedBean0822 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0822.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0822");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0822");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0822");
    }
