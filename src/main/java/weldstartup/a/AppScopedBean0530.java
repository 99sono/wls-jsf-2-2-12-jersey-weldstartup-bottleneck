...
public class AppScopedBean0530 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0530.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0530");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0530");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0530");
    }
