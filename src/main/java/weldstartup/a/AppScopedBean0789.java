...
public class AppScopedBean0789 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0789.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0789");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0789");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0789");
    }
