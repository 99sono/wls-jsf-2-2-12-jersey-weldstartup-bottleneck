...
public class AppScopedBean0931 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0931.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0931");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0931");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0931");
    }
