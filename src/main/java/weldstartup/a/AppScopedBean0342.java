...
public class AppScopedBean0342 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0342.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0342");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0342");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0342");
    }
