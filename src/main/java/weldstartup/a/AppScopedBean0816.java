...
public class AppScopedBean0816 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0816.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0816");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0816");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0816");
    }
