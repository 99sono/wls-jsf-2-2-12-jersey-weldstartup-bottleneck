...
public class AppScopedBean0803 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0803.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0803");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0803");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0803");
    }
