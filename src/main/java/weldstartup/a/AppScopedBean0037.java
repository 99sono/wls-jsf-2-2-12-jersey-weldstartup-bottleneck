...
public class AppScopedBean0037 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0037.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0037");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0037");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0037");
    }
