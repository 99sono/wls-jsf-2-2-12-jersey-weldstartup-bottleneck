...
public class AppScopedBean0568 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0568.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0568");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0568");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0568");
    }
