...
public class AppScopedBean0299 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0299.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0299");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0299");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0299");
    }
