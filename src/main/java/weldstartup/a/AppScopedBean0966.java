...
public class AppScopedBean0966 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0966.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0966");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0966");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0966");
    }
