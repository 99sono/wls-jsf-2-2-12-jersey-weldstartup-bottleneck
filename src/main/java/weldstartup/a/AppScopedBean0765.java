...
public class AppScopedBean0765 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0765.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0765");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0765");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0765");
    }
