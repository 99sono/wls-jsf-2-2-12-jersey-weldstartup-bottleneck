...
public class AppScopedBean0066 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0066.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0066");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0066");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0066");
    }
