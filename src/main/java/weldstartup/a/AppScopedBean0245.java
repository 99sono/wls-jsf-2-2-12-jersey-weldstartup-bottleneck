...
public class AppScopedBean0245 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0245.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0245");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0245");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0245");
    }
