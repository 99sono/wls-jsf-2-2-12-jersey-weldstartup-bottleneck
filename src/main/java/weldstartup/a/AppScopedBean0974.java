...
public class AppScopedBean0974 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0974.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0974");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0974");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0974");
    }
