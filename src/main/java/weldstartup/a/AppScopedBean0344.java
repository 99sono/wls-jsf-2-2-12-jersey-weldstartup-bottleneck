...
public class AppScopedBean0344 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0344.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0344");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0344");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0344");
    }
