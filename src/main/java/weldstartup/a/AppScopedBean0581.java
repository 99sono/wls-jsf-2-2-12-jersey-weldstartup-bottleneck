...
public class AppScopedBean0581 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0581.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0581");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0581");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0581");
    }
