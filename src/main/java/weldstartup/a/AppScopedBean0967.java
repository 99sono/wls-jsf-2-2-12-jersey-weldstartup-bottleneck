...
public class AppScopedBean0967 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0967.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0967");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0967");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0967");
    }
