...
public class AppScopedBean0715 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0715.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0715");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0715");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0715");
    }
