...
public class AppScopedBean0205 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0205.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0205");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0205");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0205");
    }
