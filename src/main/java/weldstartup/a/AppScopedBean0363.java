...
public class AppScopedBean0363 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0363.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0363");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0363");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0363");
    }
