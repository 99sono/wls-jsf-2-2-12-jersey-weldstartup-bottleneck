...
public class AppScopedBean0202 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0202.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0202");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0202");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0202");
    }
