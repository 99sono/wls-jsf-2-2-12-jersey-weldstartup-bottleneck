...
public class AppScopedBean0911 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0911.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0911");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0911");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0911");
    }
