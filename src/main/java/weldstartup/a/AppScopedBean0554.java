...
public class AppScopedBean0554 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0554.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0554");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0554");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0554");
    }
