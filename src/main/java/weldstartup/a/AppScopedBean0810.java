...
public class AppScopedBean0810 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0810.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0810");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0810");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0810");
    }
