...
public class AppScopedBean0983 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0983.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0983");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0983");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0983");
    }
