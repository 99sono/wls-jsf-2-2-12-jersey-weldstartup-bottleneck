...
public class AppScopedBean0748 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0748.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0748");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0748");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0748");
    }
