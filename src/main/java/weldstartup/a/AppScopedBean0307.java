...
public class AppScopedBean0307 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0307.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0307");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0307");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0307");
    }
