...
public class AppScopedBean0960 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0960.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0960");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0960");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0960");
    }
