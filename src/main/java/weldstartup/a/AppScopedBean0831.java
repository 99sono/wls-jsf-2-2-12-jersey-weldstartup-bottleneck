...
public class AppScopedBean0831 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0831.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0831");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0831");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0831");
    }
