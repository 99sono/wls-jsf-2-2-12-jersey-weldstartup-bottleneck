...
public class AppScopedBean0941 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0941.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0941");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0941");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0941");
    }
