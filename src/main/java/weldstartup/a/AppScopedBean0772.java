...
public class AppScopedBean0772 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0772.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0772");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0772");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0772");
    }
