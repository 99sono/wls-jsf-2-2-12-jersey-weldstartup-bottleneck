...
public class AppScopedBean0594 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0594.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0594");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0594");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0594");
    }
