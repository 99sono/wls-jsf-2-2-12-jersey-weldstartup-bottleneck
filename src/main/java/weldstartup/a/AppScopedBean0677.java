...
public class AppScopedBean0677 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0677.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0677");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0677");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0677");
    }
