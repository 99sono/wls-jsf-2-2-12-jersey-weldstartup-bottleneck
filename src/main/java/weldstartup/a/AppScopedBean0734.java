...
public class AppScopedBean0734 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0734.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0734");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0734");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0734");
    }
