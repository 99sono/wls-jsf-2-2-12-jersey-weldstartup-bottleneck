...
public class AppScopedBean0196 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0196.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0196");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0196");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0196");
    }
