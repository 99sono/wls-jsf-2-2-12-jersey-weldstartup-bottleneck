...
public class AppScopedBean0934 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0934.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0934");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0934");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0934");
    }
