...
public class AppScopedBean0775 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0775.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0775");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0775");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0775");
    }
