...
public class AppScopedBean0929 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0929.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0929");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0929");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0929");
    }
