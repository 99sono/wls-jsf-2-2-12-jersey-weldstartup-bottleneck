...
public class AppScopedBean0555 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0555.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0555");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0555");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0555");
    }
