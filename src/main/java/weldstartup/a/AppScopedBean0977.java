...
public class AppScopedBean0977 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0977.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0977");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0977");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0977");
    }
