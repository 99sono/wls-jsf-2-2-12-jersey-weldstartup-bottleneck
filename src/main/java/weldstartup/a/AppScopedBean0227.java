...
public class AppScopedBean0227 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0227.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0227");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0227");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0227");
    }
