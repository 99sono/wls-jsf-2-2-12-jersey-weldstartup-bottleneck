...
public class AppScopedBean0562 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0562.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0562");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0562");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0562");
    }
