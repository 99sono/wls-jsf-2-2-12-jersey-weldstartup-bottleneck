...
public class AppScopedBean0830 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0830.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0830");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0830");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0830");
    }
