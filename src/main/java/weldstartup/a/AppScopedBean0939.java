...
public class AppScopedBean0939 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0939.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0939");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0939");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0939");
    }
