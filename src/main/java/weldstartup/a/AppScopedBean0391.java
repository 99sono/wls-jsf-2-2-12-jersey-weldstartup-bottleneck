...
public class AppScopedBean0391 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0391.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0391");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0391");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0391");
    }
