...
public class AppScopedBean0333 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0333.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0333");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0333");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0333");
    }
