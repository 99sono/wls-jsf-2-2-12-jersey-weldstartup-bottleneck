...
public class AppScopedBean0298 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0298.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0298");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0298");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0298");
    }
