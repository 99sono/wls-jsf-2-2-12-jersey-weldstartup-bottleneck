...
public class AppScopedBean0440 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0440.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0440");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0440");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0440");
    }
