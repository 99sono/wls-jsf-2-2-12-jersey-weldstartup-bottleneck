...
public class AppScopedBean0922 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0922.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0922");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0922");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0922");
    }
