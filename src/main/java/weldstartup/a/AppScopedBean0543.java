...
public class AppScopedBean0543 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0543.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0543");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0543");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0543");
    }
