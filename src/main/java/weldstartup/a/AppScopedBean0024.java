...
public class AppScopedBean0024 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0024.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0024");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0024");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0024");
    }
