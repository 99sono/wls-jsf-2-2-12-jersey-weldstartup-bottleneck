...
public class AppScopedBean0736 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0736.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0736");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0736");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0736");
    }
