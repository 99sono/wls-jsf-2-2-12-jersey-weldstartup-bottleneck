...
public class AppScopedBean0383 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0383.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0383");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0383");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0383");
    }
