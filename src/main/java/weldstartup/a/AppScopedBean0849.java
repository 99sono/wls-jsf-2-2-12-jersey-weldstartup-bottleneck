...
public class AppScopedBean0849 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0849.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0849");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0849");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0849");
    }
