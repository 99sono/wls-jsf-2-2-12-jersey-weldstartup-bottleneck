...
public class AppScopedBean0002 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0002.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0002");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0002");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0002");
    }
