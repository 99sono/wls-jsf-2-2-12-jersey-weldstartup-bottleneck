...
public class AppScopedBean0352 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0352.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0352");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0352");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0352");
    }
