...
public class AppScopedBean0027 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0027.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0027");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0027");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0027");
    }
