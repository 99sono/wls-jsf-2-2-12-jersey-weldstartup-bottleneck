...
public class AppScopedBean0930 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0930.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0930");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0930");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0930");
    }
