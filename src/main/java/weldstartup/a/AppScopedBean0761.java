...
public class AppScopedBean0761 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0761.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0761");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0761");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0761");
    }
