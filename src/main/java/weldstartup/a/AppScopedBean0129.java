...
public class AppScopedBean0129 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0129.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0129");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0129");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0129");
    }
