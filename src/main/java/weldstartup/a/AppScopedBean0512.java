...
public class AppScopedBean0512 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0512.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0512");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0512");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0512");
    }
