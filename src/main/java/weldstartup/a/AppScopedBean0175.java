...
public class AppScopedBean0175 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0175.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0175");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0175");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0175");
    }
