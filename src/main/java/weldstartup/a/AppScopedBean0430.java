...
public class AppScopedBean0430 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0430.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0430");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0430");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0430");
    }
