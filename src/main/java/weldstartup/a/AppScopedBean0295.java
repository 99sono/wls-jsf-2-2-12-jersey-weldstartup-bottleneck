...
public class AppScopedBean0295 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0295.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0295");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0295");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0295");
    }
