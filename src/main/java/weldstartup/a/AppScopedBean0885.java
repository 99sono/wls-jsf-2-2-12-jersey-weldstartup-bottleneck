...
public class AppScopedBean0885 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0885.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0885");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0885");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0885");
    }
