...
public class AppScopedBean0408 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0408.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0408");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0408");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0408");
    }
