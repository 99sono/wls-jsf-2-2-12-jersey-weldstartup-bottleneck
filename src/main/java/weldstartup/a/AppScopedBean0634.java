...
public class AppScopedBean0634 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0634.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0634");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0634");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0634");
    }
