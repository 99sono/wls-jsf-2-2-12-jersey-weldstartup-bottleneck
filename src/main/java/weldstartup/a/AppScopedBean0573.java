...
public class AppScopedBean0573 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0573.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0573");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0573");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0573");
    }
