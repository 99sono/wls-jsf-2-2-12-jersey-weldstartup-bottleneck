...
public class AppScopedBean0580 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0580.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0580");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0580");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0580");
    }
