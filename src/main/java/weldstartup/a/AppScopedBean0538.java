...
public class AppScopedBean0538 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0538.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0538");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0538");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0538");
    }
