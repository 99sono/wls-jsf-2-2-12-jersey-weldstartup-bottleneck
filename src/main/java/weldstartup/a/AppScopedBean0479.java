...
public class AppScopedBean0479 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0479.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0479");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0479");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0479");
    }
