...
public class AppScopedBean0340 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0340.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0340");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0340");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0340");
    }
