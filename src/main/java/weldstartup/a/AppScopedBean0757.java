...
public class AppScopedBean0757 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0757.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0757");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0757");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0757");
    }
