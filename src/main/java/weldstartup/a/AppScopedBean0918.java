...
public class AppScopedBean0918 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0918.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0918");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0918");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0918");
    }
