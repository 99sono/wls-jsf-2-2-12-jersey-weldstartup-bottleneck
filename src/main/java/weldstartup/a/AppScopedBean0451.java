...
public class AppScopedBean0451 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0451.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0451");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0451");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0451");
    }
