...
public class AppScopedBean0423 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0423.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0423");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0423");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0423");
    }
