...
public class AppScopedBean0695 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0695.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0695");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0695");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0695");
    }
