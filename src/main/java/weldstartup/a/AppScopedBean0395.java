...
public class AppScopedBean0395 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0395.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0395");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0395");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0395");
    }
