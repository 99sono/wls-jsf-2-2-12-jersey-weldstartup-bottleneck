...
public class AppScopedBean0745 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0745.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0745");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0745");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0745");
    }
