...
public class AppScopedBean0351 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0351.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0351");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0351");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0351");
    }
