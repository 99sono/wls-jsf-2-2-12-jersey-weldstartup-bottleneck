...
public class AppScopedBean0703 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0703.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0703");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0703");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0703");
    }
