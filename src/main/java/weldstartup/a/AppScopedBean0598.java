...
public class AppScopedBean0598 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0598.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0598");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0598");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0598");
    }
