...
public class AppScopedBean0942 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0942.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0942");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0942");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0942");
    }
