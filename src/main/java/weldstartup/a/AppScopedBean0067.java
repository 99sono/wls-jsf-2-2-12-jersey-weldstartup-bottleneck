...
public class AppScopedBean0067 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0067.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0067");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0067");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0067");
    }
