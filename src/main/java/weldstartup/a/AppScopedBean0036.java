...
public class AppScopedBean0036 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0036.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0036");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0036");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0036");
    }
