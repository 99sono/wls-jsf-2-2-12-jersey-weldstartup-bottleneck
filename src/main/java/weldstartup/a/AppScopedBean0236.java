...
public class AppScopedBean0236 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0236.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0236");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0236");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0236");
    }
