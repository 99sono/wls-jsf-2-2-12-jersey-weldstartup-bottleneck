...
public class AppScopedBean0260 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0260.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0260");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0260");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0260");
    }
