...
public class AppScopedBean0844 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0844.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0844");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0844");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0844");
    }
