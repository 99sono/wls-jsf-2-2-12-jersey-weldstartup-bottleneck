...
public class AppScopedBean0377 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0377.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0377");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0377");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0377");
    }
