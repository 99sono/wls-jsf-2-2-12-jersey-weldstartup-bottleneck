...
public class AppScopedBean0656 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0656.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0656");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0656");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0656");
    }
