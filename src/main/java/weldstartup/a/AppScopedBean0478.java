...
public class AppScopedBean0478 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0478.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0478");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0478");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0478");
    }
