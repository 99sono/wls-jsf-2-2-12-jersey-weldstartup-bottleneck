...
public class AppScopedBean0712 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0712.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0712");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0712");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0712");
    }
