...
public class AppScopedBean0531 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0531.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0531");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0531");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0531");
    }
