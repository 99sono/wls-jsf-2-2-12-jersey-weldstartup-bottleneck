...
public class AppScopedBean0524 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0524.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0524");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0524");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0524");
    }
