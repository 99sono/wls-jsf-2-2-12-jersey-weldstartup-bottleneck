...
public class AppScopedBean0388 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0388.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0388");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0388");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0388");
    }
