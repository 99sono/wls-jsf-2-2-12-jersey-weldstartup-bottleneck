...
public class AppScopedBean0643 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0643.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0643");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0643");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0643");
    }
