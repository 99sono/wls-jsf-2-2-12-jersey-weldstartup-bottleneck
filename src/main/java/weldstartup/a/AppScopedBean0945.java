...
public class AppScopedBean0945 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0945.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0945");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0945");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0945");
    }
