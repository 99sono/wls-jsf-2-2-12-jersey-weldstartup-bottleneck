...
public class AppScopedBean0437 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0437.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0437");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0437");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0437");
    }
