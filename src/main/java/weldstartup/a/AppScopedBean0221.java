...
public class AppScopedBean0221 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0221.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0221");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0221");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0221");
    }
