...
public class AppScopedBean0359 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0359.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0359");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0359");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0359");
    }
