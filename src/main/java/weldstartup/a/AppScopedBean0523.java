...
public class AppScopedBean0523 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0523.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0523");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0523");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0523");
    }
