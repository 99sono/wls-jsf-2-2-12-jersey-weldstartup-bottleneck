...
public class AppScopedBean0517 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0517.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0517");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0517");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0517");
    }
