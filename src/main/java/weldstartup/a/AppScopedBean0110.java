...
public class AppScopedBean0110 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0110.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0110");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0110");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0110");
    }
