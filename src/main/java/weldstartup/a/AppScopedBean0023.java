...
public class AppScopedBean0023 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0023.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0023");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0023");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0023");
    }
