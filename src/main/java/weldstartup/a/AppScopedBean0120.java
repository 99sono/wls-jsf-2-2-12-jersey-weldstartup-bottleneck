...
public class AppScopedBean0120 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0120.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0120");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0120");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0120");
    }
