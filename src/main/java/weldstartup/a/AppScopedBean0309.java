...
public class AppScopedBean0309 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0309.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0309");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0309");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0309");
    }
