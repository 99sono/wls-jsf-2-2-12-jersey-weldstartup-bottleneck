...
public class AppScopedBean0936 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0936.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0936");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0936");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0936");
    }
