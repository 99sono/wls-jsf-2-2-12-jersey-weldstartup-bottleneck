...
public class AppScopedBean0617 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0617.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0617");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0617");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0617");
    }
