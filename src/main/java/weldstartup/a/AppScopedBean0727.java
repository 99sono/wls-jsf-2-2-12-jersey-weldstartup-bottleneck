...
public class AppScopedBean0727 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0727.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0727");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0727");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0727");
    }
