...
public class AppScopedBean0297 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0297.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0297");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0297");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0297");
    }
