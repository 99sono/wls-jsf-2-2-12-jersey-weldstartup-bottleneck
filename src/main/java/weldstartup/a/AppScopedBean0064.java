...
public class AppScopedBean0064 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0064.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0064");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0064");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0064");
    }
