...
public class AppScopedBean0587 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0587.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0587");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0587");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0587");
    }
