...
public class AppScopedBean0861 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0861.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0861");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0861");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0861");
    }
