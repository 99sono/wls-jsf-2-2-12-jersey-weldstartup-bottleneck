...
public class AppScopedBean0494 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0494.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0494");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0494");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0494");
    }
