...
public class AppScopedBean0396 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0396.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0396");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0396");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0396");
    }
