...
public class AppScopedBean0048 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0048.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0048");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0048");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0048");
    }
