...
public class AppScopedBean0243 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0243.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0243");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0243");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0243");
    }
