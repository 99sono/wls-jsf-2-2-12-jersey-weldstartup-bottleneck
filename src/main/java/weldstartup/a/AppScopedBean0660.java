...
public class AppScopedBean0660 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0660.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0660");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0660");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0660");
    }
