...
public class AppScopedBean0271 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0271.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0271");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0271");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0271");
    }
