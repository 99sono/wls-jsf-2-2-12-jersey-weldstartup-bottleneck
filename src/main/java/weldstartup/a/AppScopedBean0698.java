...
public class AppScopedBean0698 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0698.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0698");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0698");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0698");
    }
