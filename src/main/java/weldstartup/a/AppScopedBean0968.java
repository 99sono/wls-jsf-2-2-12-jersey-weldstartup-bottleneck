...
public class AppScopedBean0968 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0968.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0968");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0968");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0968");
    }
