...
public class AppScopedBean0265 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0265.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0265");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0265");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0265");
    }
