...
public class AppScopedBean0114 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0114.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0114");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0114");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0114");
    }
