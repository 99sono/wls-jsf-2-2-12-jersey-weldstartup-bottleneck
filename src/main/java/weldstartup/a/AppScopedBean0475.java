...
public class AppScopedBean0475 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0475.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0475");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0475");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0475");
    }
