...
public class AppScopedBean0316 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0316.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0316");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0316");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0316");
    }
