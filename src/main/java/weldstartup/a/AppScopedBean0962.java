...
public class AppScopedBean0962 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0962.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0962");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0962");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0962");
    }
