...
public class AppScopedBean0887 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0887.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0887");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0887");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0887");
    }
