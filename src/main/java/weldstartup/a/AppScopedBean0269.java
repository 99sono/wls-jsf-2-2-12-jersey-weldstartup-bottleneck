...
public class AppScopedBean0269 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0269.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0269");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0269");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0269");
    }
