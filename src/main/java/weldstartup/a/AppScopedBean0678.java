...
public class AppScopedBean0678 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0678.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0678");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0678");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0678");
    }
