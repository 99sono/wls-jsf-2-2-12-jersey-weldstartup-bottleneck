...
public class AppScopedBean0086 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0086.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0086");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0086");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0086");
    }
