...
public class AppScopedBean0134 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0134.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0134");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0134");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0134");
    }
