...
public class AppScopedBean0441 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0441.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0441");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0441");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0441");
    }
