...
public class AppScopedBean0371 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0371.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0371");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0371");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0371");
    }
