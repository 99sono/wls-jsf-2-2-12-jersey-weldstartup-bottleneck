...
public class AppScopedBean0223 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0223.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0223");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0223");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0223");
    }
