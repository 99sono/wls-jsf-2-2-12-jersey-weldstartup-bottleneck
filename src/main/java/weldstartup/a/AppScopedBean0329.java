...
public class AppScopedBean0329 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0329.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0329");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0329");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0329");
    }
