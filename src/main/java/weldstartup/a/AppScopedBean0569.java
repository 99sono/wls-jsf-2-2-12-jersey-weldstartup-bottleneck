...
public class AppScopedBean0569 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0569.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0569");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0569");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0569");
    }
