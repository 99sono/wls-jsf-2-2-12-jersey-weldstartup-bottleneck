...
public class AppScopedBean0434 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0434.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0434");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0434");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0434");
    }
