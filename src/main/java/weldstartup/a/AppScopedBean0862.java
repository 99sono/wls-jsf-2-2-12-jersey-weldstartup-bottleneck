...
public class AppScopedBean0862 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0862.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0862");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0862");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0862");
    }
