...
public class AppScopedBean0160 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0160.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0160");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0160");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0160");
    }
