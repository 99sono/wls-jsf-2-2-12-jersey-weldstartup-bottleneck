...
public class AppScopedBean0599 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0599.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0599");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0599");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0599");
    }
