...
public class AppScopedBean0306 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0306.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0306");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0306");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0306");
    }
