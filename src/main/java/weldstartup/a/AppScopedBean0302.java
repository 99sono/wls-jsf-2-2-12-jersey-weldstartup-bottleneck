...
public class AppScopedBean0302 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0302.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0302");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0302");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0302");
    }
