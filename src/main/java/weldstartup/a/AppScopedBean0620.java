...
public class AppScopedBean0620 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0620.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0620");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0620");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0620");
    }
