...
public class AppScopedBean0147 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0147.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0147");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0147");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0147");
    }
