...
public class AppScopedBean0466 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0466.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0466");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0466");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0466");
    }
