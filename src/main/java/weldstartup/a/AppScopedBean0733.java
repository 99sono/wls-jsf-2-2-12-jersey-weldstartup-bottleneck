...
public class AppScopedBean0733 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0733.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0733");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0733");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0733");
    }
