...
public class AppScopedBean0644 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0644.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0644");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0644");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0644");
    }
