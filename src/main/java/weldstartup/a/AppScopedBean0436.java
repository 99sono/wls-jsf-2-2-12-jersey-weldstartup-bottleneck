...
public class AppScopedBean0436 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0436.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0436");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0436");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0436");
    }
