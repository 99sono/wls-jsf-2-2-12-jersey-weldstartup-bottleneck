...
public class AppScopedBean0888 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0888.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0888");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0888");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0888");
    }
