...
public class AppScopedBean0289 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0289.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0289");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0289");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0289");
    }
