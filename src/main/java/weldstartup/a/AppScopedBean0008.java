...
public class AppScopedBean0008 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0008.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0008");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0008");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0008");
    }
