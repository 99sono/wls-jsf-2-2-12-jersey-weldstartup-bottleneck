...
public class AppScopedBean0899 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0899.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0899");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0899");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0899");
    }
