...
public class AppScopedBean0574 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0574.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0574");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0574");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0574");
    }
