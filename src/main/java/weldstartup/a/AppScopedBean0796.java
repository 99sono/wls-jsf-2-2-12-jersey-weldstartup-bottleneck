...
public class AppScopedBean0796 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0796.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0796");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0796");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0796");
    }
