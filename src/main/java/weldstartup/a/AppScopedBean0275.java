...
public class AppScopedBean0275 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0275.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0275");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0275");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0275");
    }
