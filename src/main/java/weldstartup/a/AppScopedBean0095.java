...
public class AppScopedBean0095 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0095.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0095");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0095");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0095");
    }
