...
public class AppScopedBean0467 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0467.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0467");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0467");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0467");
    }
