...
public class AppScopedBean0763 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0763.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0763");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0763");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0763");
    }
