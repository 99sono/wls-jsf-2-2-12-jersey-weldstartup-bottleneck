...
public class AppScopedBean0516 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0516.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0516");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0516");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0516");
    }
