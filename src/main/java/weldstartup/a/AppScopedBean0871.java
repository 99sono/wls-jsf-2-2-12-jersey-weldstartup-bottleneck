...
public class AppScopedBean0871 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0871.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0871");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0871");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0871");
    }
