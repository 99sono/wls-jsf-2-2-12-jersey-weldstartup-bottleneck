...
public class AppScopedBean0059 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0059.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0059");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0059");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0059");
    }
