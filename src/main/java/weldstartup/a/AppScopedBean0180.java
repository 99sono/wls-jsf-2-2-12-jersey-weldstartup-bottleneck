...
public class AppScopedBean0180 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0180.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0180");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0180");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0180");
    }
