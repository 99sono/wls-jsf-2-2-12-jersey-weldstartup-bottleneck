...
public class AppScopedBean0671 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0671.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0671");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0671");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0671");
    }
