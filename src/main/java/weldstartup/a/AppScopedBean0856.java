...
public class AppScopedBean0856 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0856.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0856");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0856");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0856");
    }
