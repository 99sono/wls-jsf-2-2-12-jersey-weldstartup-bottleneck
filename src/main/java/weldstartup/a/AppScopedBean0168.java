...
public class AppScopedBean0168 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0168.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0168");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0168");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0168");
    }
