...
public class AppScopedBean0053 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0053.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0053");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0053");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0053");
    }
