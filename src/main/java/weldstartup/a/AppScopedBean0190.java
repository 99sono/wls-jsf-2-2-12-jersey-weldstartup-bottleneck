...
public class AppScopedBean0190 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0190.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0190");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0190");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0190");
    }
