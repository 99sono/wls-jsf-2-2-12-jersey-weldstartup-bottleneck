...
public class AppScopedBean0032 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0032.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0032");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0032");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0032");
    }
