...
public class AppScopedBean0419 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0419.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0419");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0419");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0419");
    }
