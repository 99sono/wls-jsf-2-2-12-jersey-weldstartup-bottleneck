...
public class AppScopedBean0735 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0735.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0735");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0735");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0735");
    }
