...
public class AppScopedBean0595 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0595.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0595");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0595");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0595");
    }
