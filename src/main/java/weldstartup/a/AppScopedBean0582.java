...
public class AppScopedBean0582 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0582.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0582");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0582");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0582");
    }
