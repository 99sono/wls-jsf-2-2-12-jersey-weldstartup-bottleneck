...
public class AppScopedBean0062 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0062.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0062");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0062");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0062");
    }
