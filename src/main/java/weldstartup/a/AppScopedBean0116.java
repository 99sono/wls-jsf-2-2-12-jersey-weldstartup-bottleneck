...
public class AppScopedBean0116 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0116.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0116");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0116");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0116");
    }
