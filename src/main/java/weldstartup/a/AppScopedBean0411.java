...
public class AppScopedBean0411 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0411.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0411");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0411");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0411");
    }
