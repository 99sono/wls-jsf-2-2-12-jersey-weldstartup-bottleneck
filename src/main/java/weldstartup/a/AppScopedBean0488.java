...
public class AppScopedBean0488 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0488.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0488");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0488");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0488");
    }
