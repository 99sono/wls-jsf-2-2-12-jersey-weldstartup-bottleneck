...
public class AppScopedBean0397 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0397.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0397");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0397");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0397");
    }
