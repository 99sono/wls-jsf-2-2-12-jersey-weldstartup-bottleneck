...
public class AppScopedBean0044 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0044.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0044");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0044");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0044");
    }
