...
public class AppScopedBean0320 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0320.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0320");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0320");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0320");
    }
