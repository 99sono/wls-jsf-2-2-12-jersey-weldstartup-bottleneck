...
public class AppScopedBean0578 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0578.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0578");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0578");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0578");
    }
