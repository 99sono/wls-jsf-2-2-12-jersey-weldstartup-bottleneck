...
public class AppScopedBean0999 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0999.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0999");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0999");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0999");
    }
