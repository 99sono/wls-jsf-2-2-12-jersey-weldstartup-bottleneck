...
public class AppScopedBean0707 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0707.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0707");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0707");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0707");
    }
