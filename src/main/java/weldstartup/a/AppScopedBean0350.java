...
public class AppScopedBean0350 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0350.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0350");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0350");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0350");
    }
