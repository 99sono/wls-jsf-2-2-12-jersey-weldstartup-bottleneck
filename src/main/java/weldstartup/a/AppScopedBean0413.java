...
public class AppScopedBean0413 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0413.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0413");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0413");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0413");
    }
