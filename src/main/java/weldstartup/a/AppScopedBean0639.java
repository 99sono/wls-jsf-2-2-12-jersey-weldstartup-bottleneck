...
public class AppScopedBean0639 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0639.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0639");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0639");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0639");
    }
