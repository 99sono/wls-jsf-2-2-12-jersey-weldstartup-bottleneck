...
public class AppScopedBean0410 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0410.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0410");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0410");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0410");
    }
