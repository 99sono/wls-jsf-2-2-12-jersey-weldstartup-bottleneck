...
public class AppScopedBean0457 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0457.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0457");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0457");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0457");
    }
