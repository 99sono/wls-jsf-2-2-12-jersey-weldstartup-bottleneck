...
public class AppScopedBean0515 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0515.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0515");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0515");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0515");
    }
