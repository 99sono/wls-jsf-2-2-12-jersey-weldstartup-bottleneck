...
public class AppScopedBean0483 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0483.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0483");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0483");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0483");
    }
