...
public class AppScopedBean0499 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0499.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0499");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0499");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0499");
    }
