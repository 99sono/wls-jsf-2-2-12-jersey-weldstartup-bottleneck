...
public class AppScopedBean0807 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0807.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0807");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0807");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0807");
    }
