...
public class AppScopedBean0126 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0126.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0126");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0126");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0126");
    }
