...
public class AppScopedBean0872 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0872.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0872");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0872");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0872");
    }
