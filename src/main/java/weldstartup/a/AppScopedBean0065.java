...
public class AppScopedBean0065 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0065.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0065");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0065");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0065");
    }
