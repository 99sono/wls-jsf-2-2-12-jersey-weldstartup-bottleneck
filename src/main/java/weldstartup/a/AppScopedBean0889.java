...
public class AppScopedBean0889 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0889.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0889");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0889");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0889");
    }
