...
public class AppScopedBean0799 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0799.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0799");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0799");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0799");
    }
