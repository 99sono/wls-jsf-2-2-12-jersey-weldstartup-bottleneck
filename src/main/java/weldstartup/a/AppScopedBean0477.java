...
public class AppScopedBean0477 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0477.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0477");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0477");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0477");
    }
