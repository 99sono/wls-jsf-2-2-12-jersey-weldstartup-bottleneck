...
public class AppScopedBean0111 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0111.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0111");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0111");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0111");
    }
