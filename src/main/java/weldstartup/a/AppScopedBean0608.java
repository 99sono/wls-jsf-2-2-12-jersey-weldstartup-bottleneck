...
public class AppScopedBean0608 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0608.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0608");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0608");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0608");
    }
