...
public class AppScopedBean0136 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0136.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0136");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0136");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0136");
    }
