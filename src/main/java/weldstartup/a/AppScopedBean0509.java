...
public class AppScopedBean0509 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0509.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0509");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0509");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0509");
    }
