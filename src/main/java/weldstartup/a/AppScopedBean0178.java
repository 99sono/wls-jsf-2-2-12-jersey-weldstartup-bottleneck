...
public class AppScopedBean0178 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0178.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0178");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0178");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0178");
    }
