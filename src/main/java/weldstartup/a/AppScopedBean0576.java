...
public class AppScopedBean0576 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0576.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0576");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0576");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0576");
    }
