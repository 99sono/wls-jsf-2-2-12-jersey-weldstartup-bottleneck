...
public class AppScopedBean0832 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0832.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0832");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0832");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0832");
    }
