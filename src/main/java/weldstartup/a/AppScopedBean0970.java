...
public class AppScopedBean0970 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0970.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0970");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0970");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0970");
    }
