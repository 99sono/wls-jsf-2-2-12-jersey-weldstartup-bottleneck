...
public class AppScopedBean0485 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0485.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0485");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0485");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0485");
    }
