...
public class AppScopedBean0375 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0375.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0375");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0375");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0375");
    }
