...
public class AppScopedBean0051 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0051.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0051");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0051");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0051");
    }
