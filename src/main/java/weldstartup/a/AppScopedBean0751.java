...
public class AppScopedBean0751 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0751.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0751");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0751");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0751");
    }
