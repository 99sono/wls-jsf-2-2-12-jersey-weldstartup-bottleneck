...
public class AppScopedBean0251 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0251.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0251");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0251");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0251");
    }
