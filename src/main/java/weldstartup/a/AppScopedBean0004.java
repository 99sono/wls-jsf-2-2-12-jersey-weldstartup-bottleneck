...
public class AppScopedBean0004 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0004.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0004");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0004");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0004");
    }
