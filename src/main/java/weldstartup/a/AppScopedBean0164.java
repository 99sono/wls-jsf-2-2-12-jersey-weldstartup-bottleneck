...
public class AppScopedBean0164 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0164.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0164");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0164");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0164");
    }
