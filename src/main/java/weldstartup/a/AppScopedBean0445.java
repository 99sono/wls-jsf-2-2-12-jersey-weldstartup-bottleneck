...
public class AppScopedBean0445 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0445.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0445");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0445");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0445");
    }
