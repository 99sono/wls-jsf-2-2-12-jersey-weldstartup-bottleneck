...
public class AppScopedBean0015 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0015.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0015");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0015");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0015");
    }
