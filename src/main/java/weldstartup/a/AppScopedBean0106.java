...
public class AppScopedBean0106 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0106.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0106");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0106");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0106");
    }
