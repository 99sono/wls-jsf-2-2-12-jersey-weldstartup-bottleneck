...
public class AppScopedBean0593 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0593.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0593");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0593");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0593");
    }
