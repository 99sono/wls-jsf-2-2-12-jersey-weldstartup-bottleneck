...
public class AppScopedBean0368 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0368.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0368");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0368");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0368");
    }
