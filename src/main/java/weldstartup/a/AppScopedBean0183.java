...
public class AppScopedBean0183 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0183.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0183");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0183");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0183");
    }
