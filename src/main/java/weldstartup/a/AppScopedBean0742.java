...
public class AppScopedBean0742 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0742.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0742");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0742");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0742");
    }
