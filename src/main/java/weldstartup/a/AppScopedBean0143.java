...
public class AppScopedBean0143 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0143.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0143");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0143");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0143");
    }
