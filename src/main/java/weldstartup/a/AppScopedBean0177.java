...
public class AppScopedBean0177 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0177.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0177");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0177");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0177");
    }
