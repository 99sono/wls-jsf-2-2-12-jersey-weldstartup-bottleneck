...
public class AppScopedBean0013 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0013.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0013");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0013");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0013");
    }
