...
public class AppScopedBean0029 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0029.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0029");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0029");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0029");
    }
