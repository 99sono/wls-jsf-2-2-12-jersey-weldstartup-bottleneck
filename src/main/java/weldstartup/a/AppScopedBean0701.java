...
public class AppScopedBean0701 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0701.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0701");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0701");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0701");
    }
