...
public class AppScopedBean0857 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0857.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0857");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0857");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0857");
    }
