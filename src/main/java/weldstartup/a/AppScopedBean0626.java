...
public class AppScopedBean0626 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0626.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0626");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0626");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0626");
    }
