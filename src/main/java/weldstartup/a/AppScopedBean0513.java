...
public class AppScopedBean0513 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0513.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0513");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0513");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0513");
    }
