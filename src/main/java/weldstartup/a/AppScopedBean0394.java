...
public class AppScopedBean0394 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0394.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0394");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0394");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0394");
    }
