...
public class AppScopedBean0152 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0152.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0152");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0152");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0152");
    }
