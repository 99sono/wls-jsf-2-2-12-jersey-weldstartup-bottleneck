...
public class AppScopedBean0312 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0312.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0312");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0312");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0312");
    }
