...
public class AppScopedBean0442 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0442.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0442");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0442");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0442");
    }
