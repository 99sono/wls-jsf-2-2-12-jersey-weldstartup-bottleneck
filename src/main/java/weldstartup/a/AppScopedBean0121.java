...
public class AppScopedBean0121 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0121.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0121");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0121");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0121");
    }
