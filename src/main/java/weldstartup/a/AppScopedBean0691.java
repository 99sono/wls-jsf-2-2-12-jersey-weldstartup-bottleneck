...
public class AppScopedBean0691 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0691.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0691");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0691");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0691");
    }
