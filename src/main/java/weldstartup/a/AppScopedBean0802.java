...
public class AppScopedBean0802 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0802.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0802");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0802");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0802");
    }
