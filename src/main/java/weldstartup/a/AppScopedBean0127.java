...
public class AppScopedBean0127 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0127.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0127");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0127");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0127");
    }
