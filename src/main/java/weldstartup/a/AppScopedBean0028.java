...
public class AppScopedBean0028 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0028.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0028");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0028");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0028");
    }
