...
public class AppScopedBean0959 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0959.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0959");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0959");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0959");
    }
