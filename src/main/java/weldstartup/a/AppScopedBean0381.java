...
public class AppScopedBean0381 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0381.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0381");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0381");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0381");
    }
