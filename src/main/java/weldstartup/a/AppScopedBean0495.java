...
public class AppScopedBean0495 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0495.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0495");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0495");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0495");
    }
