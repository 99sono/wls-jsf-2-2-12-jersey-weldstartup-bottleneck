...
public class AppScopedBean0829 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0829.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0829");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0829");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0829");
    }
