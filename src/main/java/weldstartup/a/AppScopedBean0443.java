...
public class AppScopedBean0443 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0443.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0443");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0443");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0443");
    }
