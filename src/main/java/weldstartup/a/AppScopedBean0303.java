...
public class AppScopedBean0303 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0303.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0303");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0303");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0303");
    }
