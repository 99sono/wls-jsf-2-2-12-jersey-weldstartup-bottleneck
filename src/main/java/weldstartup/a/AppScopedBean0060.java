...
public class AppScopedBean0060 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0060.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0060");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0060");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0060");
    }
