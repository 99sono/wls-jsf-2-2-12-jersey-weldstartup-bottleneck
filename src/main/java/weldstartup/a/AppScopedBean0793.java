...
public class AppScopedBean0793 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0793.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0793");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0793");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0793");
    }
