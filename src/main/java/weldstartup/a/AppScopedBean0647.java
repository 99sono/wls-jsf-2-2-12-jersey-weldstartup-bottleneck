...
public class AppScopedBean0647 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0647.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0647");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0647");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0647");
    }
