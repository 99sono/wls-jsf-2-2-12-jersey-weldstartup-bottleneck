...
public class AppScopedBean0726 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0726.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0726");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0726");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0726");
    }
