...
public class AppScopedBean0769 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0769.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0769");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0769");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0769");
    }
