...
public class AppScopedBean0520 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0520.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0520");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0520");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0520");
    }
