...
public class AppScopedBean0704 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0704.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0704");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0704");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0704");
    }
