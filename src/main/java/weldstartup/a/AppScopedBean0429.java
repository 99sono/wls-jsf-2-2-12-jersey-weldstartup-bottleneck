...
public class AppScopedBean0429 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0429.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0429");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0429");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0429");
    }
