...
public class AppScopedBean0921 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0921.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0921");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0921");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0921");
    }
