...
public class AppScopedBean0738 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0738.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0738");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0738");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0738");
    }
