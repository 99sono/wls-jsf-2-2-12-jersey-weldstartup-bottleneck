...
public class AppScopedBean0908 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0908.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0908");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0908");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0908");
    }
