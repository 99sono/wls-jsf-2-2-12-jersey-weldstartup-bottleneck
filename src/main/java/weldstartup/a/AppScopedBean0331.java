...
public class AppScopedBean0331 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0331.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0331");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0331");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0331");
    }
