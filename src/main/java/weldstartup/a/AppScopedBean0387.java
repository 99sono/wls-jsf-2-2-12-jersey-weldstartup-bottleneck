...
public class AppScopedBean0387 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0387.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0387");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0387");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0387");
    }
