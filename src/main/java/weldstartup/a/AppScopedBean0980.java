...
public class AppScopedBean0980 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0980.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0980");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0980");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0980");
    }
