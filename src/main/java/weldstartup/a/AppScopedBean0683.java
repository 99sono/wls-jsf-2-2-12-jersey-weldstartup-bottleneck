...
public class AppScopedBean0683 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0683.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0683");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0683");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0683");
    }
