...
public class AppScopedBean0104 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0104.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0104");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0104");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0104");
    }
