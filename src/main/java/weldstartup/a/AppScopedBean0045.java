...
public class AppScopedBean0045 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0045.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0045");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0045");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0045");
    }
