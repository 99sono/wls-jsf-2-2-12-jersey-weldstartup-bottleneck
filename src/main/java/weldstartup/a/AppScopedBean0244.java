...
public class AppScopedBean0244 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0244.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0244");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0244");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0244");
    }
