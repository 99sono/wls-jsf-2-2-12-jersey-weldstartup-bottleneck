...
public class AppScopedBean0747 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0747.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0747");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0747");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0747");
    }
