...
public class AppScopedBean0937 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0937.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0937");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0937");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0937");
    }
