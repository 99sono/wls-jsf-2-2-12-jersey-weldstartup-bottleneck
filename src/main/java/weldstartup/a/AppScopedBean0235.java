...
public class AppScopedBean0235 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0235.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0235");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0235");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0235");
    }
