...
public class AppScopedBean0219 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0219.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0219");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0219");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0219");
    }
