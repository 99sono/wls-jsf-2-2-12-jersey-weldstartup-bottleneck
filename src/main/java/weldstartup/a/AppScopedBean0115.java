...
public class AppScopedBean0115 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0115.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0115");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0115");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0115");
    }
