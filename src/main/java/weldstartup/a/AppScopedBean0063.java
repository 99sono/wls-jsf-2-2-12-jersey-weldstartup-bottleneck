...
public class AppScopedBean0063 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0063.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0063");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0063");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0063");
    }
