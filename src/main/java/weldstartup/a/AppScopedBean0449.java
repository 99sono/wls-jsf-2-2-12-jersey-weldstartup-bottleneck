...
public class AppScopedBean0449 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0449.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0449");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0449");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0449");
    }
