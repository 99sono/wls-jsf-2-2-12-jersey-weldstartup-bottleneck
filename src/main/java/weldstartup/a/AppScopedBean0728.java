...
public class AppScopedBean0728 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0728.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0728");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0728");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0728");
    }
