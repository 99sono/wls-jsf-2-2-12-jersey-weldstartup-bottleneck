...
public class AppScopedBean0142 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0142.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0142");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0142");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0142");
    }
