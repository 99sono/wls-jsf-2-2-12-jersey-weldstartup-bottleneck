...
public class AppScopedBean0258 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0258.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0258");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0258");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0258");
    }
