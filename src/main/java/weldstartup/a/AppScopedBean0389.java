...
public class AppScopedBean0389 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0389.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0389");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0389");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0389");
    }
