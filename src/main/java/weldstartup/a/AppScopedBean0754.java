...
public class AppScopedBean0754 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0754.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0754");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0754");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0754");
    }
