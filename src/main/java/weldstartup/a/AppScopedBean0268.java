...
public class AppScopedBean0268 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0268.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0268");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0268");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0268");
    }
