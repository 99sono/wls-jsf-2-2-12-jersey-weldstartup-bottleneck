...
public class AppScopedBean0173 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0173.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0173");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0173");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0173");
    }
