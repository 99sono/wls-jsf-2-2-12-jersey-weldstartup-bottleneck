...
public class AppScopedBean0746 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0746.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0746");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0746");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0746");
    }
