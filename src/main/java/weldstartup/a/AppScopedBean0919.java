...
public class AppScopedBean0919 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0919.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0919");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0919");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0919");
    }
