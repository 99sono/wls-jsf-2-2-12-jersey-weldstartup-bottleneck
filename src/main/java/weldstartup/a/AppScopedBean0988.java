...
public class AppScopedBean0988 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0988.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0988");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0988");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0988");
    }
