...
public class AppScopedBean0590 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0590.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0590");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0590");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0590");
    }
