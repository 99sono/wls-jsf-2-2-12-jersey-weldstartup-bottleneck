...
public class AppScopedBean0560 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0560.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0560");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0560");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0560");
    }
