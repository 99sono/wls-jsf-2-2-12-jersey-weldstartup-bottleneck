...
public class AppScopedBean0186 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0186.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0186");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0186");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0186");
    }
