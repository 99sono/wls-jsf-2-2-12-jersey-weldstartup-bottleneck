...
public class AppScopedBean0650 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0650.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0650");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0650");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0650");
    }
