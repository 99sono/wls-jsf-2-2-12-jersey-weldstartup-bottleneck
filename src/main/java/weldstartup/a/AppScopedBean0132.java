...
public class AppScopedBean0132 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0132.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0132");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0132");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0132");
    }
