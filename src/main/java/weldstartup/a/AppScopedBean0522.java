...
public class AppScopedBean0522 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0522.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0522");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0522");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0522");
    }
