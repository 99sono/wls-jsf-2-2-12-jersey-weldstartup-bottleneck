...
public class AppScopedBean0584 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0584.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0584");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0584");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0584");
    }
