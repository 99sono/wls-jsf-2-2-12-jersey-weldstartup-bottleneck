...
public class AppScopedBean0602 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0602.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0602");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0602");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0602");
    }
