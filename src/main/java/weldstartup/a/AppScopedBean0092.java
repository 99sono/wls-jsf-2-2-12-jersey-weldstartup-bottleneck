...
public class AppScopedBean0092 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0092.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0092");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0092");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0092");
    }
