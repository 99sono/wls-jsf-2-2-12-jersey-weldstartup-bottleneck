...
public class AppScopedBean0956 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0956.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0956");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0956");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0956");
    }
