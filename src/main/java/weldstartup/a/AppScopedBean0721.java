...
public class AppScopedBean0721 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0721.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0721");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0721");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0721");
    }
