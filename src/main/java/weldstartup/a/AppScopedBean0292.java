...
public class AppScopedBean0292 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0292.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0292");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0292");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0292");
    }
