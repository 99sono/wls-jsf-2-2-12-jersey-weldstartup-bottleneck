...
public class AppScopedBean0203 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0203.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0203");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0203");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0203");
    }
