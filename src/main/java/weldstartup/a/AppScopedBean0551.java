...
public class AppScopedBean0551 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0551.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0551");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0551");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0551");
    }
