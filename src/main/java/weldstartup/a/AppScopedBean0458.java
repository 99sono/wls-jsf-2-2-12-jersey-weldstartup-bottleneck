...
public class AppScopedBean0458 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0458.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0458");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0458");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0458");
    }
