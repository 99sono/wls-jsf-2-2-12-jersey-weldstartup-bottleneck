...
public class AppScopedBean0014 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0014.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0014");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0014");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0014");
    }
