...
public class AppScopedBean0564 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0564.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0564");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0564");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0564");
    }
