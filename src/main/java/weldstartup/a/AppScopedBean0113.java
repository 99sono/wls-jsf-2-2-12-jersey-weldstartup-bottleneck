...
public class AppScopedBean0113 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0113.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0113");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0113");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0113");
    }
