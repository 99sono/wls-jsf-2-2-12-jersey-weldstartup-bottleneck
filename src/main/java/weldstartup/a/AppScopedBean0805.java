...
public class AppScopedBean0805 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0805.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0805");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0805");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0805");
    }
