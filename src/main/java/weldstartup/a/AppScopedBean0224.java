...
public class AppScopedBean0224 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0224.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0224");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0224");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0224");
    }
