...
public class AppScopedBean0559 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0559.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0559");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0559");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0559");
    }
