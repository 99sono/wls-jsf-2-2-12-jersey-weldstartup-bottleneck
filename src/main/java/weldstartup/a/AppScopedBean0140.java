...
public class AppScopedBean0140 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0140.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0140");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0140");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0140");
    }
