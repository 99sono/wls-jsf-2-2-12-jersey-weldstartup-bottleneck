...
public class AppScopedBean0041 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0041.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0041");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0041");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0041");
    }
