...
public class AppScopedBean0068 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0068.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0068");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0068");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0068");
    }
