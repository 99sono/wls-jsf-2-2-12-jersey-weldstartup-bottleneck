...
public class AppScopedBean0327 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0327.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0327");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0327");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0327");
    }
