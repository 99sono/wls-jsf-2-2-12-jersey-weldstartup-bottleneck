...
public class AppScopedBean0717 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0717.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0717");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0717");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0717");
    }
