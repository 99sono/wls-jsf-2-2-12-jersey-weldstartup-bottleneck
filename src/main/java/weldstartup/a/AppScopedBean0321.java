...
public class AppScopedBean0321 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0321.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0321");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0321");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0321");
    }
