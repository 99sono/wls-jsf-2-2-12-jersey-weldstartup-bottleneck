...
public class AppScopedBean0435 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0435.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0435");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0435");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0435");
    }
