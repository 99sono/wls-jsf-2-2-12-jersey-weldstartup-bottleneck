...
public class AppScopedBean0198 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0198.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0198");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0198");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0198");
    }
