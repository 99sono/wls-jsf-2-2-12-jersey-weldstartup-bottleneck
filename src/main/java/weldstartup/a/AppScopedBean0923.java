...
public class AppScopedBean0923 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0923.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0923");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0923");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0923");
    }
