...
public class AppScopedBean0826 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0826.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0826");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0826");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0826");
    }
