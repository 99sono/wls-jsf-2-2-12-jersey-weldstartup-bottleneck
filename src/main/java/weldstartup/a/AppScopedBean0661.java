...
public class AppScopedBean0661 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0661.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0661");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0661");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0661");
    }
