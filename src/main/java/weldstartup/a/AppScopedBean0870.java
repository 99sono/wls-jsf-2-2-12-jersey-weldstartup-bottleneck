...
public class AppScopedBean0870 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0870.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0870");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0870");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0870");
    }
