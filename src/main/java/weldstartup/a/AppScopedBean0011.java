...
public class AppScopedBean0011 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0011.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0011");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0011");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0011");
    }
