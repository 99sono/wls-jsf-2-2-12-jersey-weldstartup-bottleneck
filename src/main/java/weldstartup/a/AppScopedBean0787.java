...
public class AppScopedBean0787 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0787.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0787");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0787");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0787");
    }
