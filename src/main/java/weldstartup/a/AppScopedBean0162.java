...
public class AppScopedBean0162 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0162.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0162");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0162");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0162");
    }
