...
public class AppScopedBean0991 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0991.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0991");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0991");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0991");
    }
