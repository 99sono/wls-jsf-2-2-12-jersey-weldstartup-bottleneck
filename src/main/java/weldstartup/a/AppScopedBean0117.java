...
public class AppScopedBean0117 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0117.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0117");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0117");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0117");
    }
