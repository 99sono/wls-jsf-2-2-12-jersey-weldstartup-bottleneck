...
public class AppScopedBean0519 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0519.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0519");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0519");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0519");
    }
