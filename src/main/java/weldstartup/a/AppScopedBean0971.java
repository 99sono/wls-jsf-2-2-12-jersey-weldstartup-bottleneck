...
public class AppScopedBean0971 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0971.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0971");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0971");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0971");
    }
