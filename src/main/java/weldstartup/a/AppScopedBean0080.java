...
public class AppScopedBean0080 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0080.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0080");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0080");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0080");
    }
