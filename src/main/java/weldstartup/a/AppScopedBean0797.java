...
public class AppScopedBean0797 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0797.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0797");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0797");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0797");
    }
