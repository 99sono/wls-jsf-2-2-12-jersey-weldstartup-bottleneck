...
public class AppScopedBean0909 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0909.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0909");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0909");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0909");
    }
