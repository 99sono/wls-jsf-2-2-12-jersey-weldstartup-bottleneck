...
public class AppScopedBean0536 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0536.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0536");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0536");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0536");
    }
