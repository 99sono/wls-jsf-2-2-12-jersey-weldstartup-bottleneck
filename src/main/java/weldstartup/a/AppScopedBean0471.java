...
public class AppScopedBean0471 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0471.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0471");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0471");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0471");
    }
