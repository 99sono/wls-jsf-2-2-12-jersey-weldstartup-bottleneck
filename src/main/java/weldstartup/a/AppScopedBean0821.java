...
public class AppScopedBean0821 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0821.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0821");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0821");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0821");
    }
