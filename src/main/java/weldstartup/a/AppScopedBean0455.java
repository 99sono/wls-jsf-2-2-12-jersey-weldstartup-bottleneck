...
public class AppScopedBean0455 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0455.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0455");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0455");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0455");
    }
