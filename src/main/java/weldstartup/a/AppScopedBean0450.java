...
public class AppScopedBean0450 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0450.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0450");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0450");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0450");
    }
