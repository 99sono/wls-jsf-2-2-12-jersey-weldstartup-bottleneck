...
public class AppScopedBean0056 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0056.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0056");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0056");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0056");
    }
