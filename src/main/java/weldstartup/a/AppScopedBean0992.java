...
public class AppScopedBean0992 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0992.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0992");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0992");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0992");
    }
