...
public class AppScopedBean0362 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0362.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0362");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0362");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0362");
    }
