...
public class AppScopedBean0452 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0452.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0452");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0452");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0452");
    }
