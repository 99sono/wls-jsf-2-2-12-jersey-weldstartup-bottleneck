...
public class AppScopedBean0102 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0102.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0102");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0102");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0102");
    }
