...
public class AppScopedBean0470 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0470.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0470");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0470");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0470");
    }
