...
public class AppScopedBean0762 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0762.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0762");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0762");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0762");
    }
