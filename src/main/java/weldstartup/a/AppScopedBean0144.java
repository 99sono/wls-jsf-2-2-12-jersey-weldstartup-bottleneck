...
public class AppScopedBean0144 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0144.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0144");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0144");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0144");
    }
