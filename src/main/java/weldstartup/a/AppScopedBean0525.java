...
public class AppScopedBean0525 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0525.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0525");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0525");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0525");
    }
