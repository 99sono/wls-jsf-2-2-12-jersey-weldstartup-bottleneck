...
public class AppScopedBean0328 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0328.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0328");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0328");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0328");
    }
