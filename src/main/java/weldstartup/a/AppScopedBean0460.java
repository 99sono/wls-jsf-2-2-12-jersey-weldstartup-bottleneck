...
public class AppScopedBean0460 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0460.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0460");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0460");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0460");
    }
