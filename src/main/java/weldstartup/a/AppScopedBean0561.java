...
public class AppScopedBean0561 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0561.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0561");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0561");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0561");
    }
