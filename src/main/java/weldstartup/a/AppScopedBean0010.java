...
public class AppScopedBean0010 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0010.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0010");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0010");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0010");
    }
