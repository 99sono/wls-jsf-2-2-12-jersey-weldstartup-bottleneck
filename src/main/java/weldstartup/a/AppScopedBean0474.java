...
public class AppScopedBean0474 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0474.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0474");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0474");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0474");
    }
