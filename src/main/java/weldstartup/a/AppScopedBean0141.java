...
public class AppScopedBean0141 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0141.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0141");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0141");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0141");
    }
