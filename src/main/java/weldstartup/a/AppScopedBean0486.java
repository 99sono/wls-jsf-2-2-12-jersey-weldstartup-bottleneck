...
public class AppScopedBean0486 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0486.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0486");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0486");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0486");
    }
