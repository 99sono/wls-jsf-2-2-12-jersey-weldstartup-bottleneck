...
public class AppScopedBean0253 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0253.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0253");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0253");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0253");
    }
