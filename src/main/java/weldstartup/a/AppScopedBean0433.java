...
public class AppScopedBean0433 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0433.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0433");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0433");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0433");
    }
