...
public class AppScopedBean0282 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0282.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0282");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0282");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0282");
    }
