...
public class AppScopedBean0744 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0744.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0744");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0744");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0744");
    }
