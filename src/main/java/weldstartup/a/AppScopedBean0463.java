...
public class AppScopedBean0463 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0463.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0463");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0463");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0463");
    }
