...
public class AppScopedBean0285 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0285.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0285");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0285");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0285");
    }
