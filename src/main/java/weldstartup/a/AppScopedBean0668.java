...
public class AppScopedBean0668 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0668.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0668");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0668");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0668");
    }
