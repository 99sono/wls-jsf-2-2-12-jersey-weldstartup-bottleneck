...
public class AppScopedBean0641 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0641.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0641");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0641");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0641");
    }
