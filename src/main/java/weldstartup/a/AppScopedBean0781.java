...
public class AppScopedBean0781 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0781.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0781");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0781");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0781");
    }
