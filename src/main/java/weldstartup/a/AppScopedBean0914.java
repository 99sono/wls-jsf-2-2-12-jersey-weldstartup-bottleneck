...
public class AppScopedBean0914 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0914.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0914");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0914");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0914");
    }
