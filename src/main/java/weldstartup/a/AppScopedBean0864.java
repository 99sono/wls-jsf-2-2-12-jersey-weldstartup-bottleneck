...
public class AppScopedBean0864 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0864.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0864");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0864");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0864");
    }
