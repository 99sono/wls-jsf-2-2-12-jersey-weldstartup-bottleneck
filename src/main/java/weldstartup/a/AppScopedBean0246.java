...
public class AppScopedBean0246 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0246.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0246");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0246");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0246");
    }
