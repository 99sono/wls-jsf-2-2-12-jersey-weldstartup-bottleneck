...
public class AppScopedBean0473 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0473.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0473");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0473");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0473");
    }
