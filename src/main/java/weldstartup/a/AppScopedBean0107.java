...
public class AppScopedBean0107 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0107.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0107");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0107");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0107");
    }
