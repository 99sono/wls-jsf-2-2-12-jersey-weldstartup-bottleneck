...
public class AppScopedBean0591 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0591.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0591");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0591");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0591");
    }
