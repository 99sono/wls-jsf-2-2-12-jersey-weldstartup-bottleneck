...
public class AppScopedBean0768 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0768.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0768");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0768");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0768");
    }
