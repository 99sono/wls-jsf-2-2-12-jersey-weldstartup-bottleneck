...
public class AppScopedBean0431 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0431.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0431");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0431");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0431");
    }
