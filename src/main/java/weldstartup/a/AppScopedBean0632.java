...
public class AppScopedBean0632 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0632.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0632");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0632");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0632");
    }
