...
public class AppScopedBean0407 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0407.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0407");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0407");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0407");
    }
