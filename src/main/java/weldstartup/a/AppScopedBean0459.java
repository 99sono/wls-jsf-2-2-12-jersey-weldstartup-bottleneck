...
public class AppScopedBean0459 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0459.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0459");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0459");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0459");
    }
