...
public class AppScopedBean0806 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0806.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0806");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0806");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0806");
    }
