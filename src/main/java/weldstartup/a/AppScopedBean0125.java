...
public class AppScopedBean0125 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0125.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0125");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0125");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0125");
    }
