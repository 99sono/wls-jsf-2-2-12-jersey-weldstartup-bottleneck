...
public class AppScopedBean0565 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0565.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0565");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0565");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0565");
    }
