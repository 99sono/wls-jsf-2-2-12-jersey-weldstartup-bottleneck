...
public class AppScopedBean0444 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0444.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0444");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0444");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0444");
    }
