...
public class AppScopedBean0630 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0630.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0630");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0630");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0630");
    }
