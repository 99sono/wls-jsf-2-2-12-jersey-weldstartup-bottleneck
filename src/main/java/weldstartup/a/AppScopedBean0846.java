...
public class AppScopedBean0846 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0846.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0846");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0846");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0846");
    }
