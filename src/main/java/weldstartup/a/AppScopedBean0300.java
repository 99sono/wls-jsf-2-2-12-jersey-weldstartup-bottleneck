...
public class AppScopedBean0300 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0300.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0300");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0300");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0300");
    }
