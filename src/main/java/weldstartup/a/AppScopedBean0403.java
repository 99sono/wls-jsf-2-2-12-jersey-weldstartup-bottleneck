...
public class AppScopedBean0403 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0403.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0403");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0403");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0403");
    }
