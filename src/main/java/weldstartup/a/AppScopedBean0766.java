...
public class AppScopedBean0766 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0766.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0766");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0766");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0766");
    }
