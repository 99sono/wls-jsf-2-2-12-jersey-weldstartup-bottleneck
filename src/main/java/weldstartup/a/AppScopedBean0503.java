...
public class AppScopedBean0503 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0503.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0503");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0503");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0503");
    }
