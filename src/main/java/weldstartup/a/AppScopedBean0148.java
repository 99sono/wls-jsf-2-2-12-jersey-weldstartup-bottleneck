...
public class AppScopedBean0148 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0148.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0148");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0148");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0148");
    }
