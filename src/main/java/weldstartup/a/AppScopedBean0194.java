...
public class AppScopedBean0194 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0194.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0194");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0194");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0194");
    }
