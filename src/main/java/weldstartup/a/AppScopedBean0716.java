...
public class AppScopedBean0716 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0716.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0716");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0716");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0716");
    }
