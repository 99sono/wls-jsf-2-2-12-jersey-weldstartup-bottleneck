...
public class AppScopedBean0070 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0070.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0070");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0070");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0070");
    }
