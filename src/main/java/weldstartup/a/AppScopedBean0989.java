...
public class AppScopedBean0989 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0989.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0989");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0989");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0989");
    }
