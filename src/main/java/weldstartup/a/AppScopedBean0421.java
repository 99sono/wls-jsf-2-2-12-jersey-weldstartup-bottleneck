...
public class AppScopedBean0421 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0421.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0421");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0421");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0421");
    }
