...
public class AppScopedBean0843 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0843.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0843");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0843");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0843");
    }
