...
public class AppScopedBean0547 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0547.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0547");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0547");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0547");
    }
