...
public class AppScopedBean0193 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0193.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0193");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0193");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0193");
    }
