...
public class AppScopedBean0278 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0278.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0278");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0278");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0278");
    }
