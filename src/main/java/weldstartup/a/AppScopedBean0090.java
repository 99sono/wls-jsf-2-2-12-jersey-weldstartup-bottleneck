...
public class AppScopedBean0090 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0090.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0090");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0090");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0090");
    }
