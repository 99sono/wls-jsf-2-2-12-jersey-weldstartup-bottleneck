...
public class AppScopedBean0169 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0169.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0169");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0169");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0169");
    }
