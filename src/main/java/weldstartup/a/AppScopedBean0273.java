...
public class AppScopedBean0273 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0273.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0273");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0273");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0273");
    }
