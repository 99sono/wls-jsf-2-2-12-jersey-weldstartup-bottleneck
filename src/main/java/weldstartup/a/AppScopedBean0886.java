...
public class AppScopedBean0886 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0886.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0886");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0886");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0886");
    }
