...
public class AppScopedBean0248 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0248.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0248");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0248");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0248");
    }
