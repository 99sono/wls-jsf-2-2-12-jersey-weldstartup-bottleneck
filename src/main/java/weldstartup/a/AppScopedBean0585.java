...
public class AppScopedBean0585 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0585.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0585");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0585");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0585");
    }
