...
public class AppScopedBean0079 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0079.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0079");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0079");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0079");
    }
