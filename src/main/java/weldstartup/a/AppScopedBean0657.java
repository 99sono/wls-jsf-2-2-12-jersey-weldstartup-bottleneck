...
public class AppScopedBean0657 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0657.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0657");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0657");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0657");
    }
