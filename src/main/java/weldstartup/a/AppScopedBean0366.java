...
public class AppScopedBean0366 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0366.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0366");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0366");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0366");
    }
