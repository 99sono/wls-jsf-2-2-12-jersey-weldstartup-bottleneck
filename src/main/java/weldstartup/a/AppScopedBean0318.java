...
public class AppScopedBean0318 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0318.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0318");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0318");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0318");
    }
