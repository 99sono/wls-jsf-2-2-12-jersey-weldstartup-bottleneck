...
public class AppScopedBean0266 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0266.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0266");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0266");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0266");
    }
