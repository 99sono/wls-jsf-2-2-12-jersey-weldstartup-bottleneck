...
public class AppScopedBean0138 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0138.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0138");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0138");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0138");
    }
