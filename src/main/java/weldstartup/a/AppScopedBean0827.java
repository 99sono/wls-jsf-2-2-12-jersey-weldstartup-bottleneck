...
public class AppScopedBean0827 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0827.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0827");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0827");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0827");
    }
