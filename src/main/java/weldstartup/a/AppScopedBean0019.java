...
public class AppScopedBean0019 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0019.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0019");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0019");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0019");
    }
