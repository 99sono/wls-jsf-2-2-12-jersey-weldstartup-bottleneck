...
public class AppScopedBean0606 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0606.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0606");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0606");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0606");
    }
