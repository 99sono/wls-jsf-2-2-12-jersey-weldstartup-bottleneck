...
public class AppScopedBean0835 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0835.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0835");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0835");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0835");
    }
