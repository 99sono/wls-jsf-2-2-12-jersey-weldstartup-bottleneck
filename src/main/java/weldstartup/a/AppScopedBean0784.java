...
public class AppScopedBean0784 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0784.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0784");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0784");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0784");
    }
