...
public class AppScopedBean0425 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0425.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0425");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0425");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0425");
    }
