...
public class AppScopedBean0749 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0749.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0749");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0749");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0749");
    }
