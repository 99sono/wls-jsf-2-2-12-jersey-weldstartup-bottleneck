...
public class AppScopedBean0247 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0247.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0247");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0247");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0247");
    }
