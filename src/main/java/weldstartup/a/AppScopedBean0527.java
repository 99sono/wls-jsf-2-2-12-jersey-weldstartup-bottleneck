...
public class AppScopedBean0527 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0527.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0527");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0527");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0527");
    }
