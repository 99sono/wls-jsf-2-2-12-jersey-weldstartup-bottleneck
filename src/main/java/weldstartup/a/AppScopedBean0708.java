...
public class AppScopedBean0708 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0708.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0708");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0708");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0708");
    }
