...
public class AppScopedBean0259 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0259.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0259");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0259");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0259");
    }
