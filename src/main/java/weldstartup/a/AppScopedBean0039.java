...
public class AppScopedBean0039 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0039.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0039");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0039");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0039");
    }
