...
public class AppScopedBean0124 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0124.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0124");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0124");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0124");
    }
