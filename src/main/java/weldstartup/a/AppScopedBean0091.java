...
public class AppScopedBean0091 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0091.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0091");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0091");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0091");
    }
