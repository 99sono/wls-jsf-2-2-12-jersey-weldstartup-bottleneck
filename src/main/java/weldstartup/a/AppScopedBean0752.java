...
public class AppScopedBean0752 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0752.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0752");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0752");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0752");
    }
