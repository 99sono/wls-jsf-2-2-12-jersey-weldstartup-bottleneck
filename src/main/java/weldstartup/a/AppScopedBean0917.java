...
public class AppScopedBean0917 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0917.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0917");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0917");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0917");
    }
