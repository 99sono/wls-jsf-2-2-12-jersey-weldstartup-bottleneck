...
public class AppScopedBean0508 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0508.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0508");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0508");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0508");
    }
