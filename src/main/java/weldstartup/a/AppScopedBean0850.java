...
public class AppScopedBean0850 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0850.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0850");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0850");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0850");
    }
