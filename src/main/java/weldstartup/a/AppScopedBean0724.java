...
public class AppScopedBean0724 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0724.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0724");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0724");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0724");
    }
