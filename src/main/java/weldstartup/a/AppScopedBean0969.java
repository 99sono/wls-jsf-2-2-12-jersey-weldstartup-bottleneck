...
public class AppScopedBean0969 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0969.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0969");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0969");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0969");
    }
