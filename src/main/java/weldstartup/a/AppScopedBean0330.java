...
public class AppScopedBean0330 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0330.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0330");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0330");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0330");
    }
