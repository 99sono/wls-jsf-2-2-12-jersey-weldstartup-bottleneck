...
public class AppScopedBean0907 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0907.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0907");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0907");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0907");
    }
