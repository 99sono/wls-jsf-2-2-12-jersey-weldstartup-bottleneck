...
public class AppScopedBean0261 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0261.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0261");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0261");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0261");
    }
