...
public class AppScopedBean0926 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0926.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0926");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0926");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0926");
    }
