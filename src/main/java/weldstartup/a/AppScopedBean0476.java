...
public class AppScopedBean0476 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0476.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0476");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0476");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0476");
    }
