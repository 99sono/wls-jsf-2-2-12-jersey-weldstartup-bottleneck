...
public class AppScopedBean0987 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0987.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0987");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0987");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0987");
    }
