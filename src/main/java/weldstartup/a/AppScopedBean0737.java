...
public class AppScopedBean0737 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0737.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0737");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0737");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0737");
    }
