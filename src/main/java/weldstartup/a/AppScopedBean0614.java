...
public class AppScopedBean0614 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0614.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0614");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0614");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0614");
    }
