...
public class AppScopedBean0773 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0773.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0773");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0773");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0773");
    }
