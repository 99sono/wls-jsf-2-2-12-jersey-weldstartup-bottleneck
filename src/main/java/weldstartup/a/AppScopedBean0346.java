...
public class AppScopedBean0346 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0346.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0346");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0346");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0346");
    }
