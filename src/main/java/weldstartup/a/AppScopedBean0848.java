...
public class AppScopedBean0848 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0848.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0848");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0848");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0848");
    }
