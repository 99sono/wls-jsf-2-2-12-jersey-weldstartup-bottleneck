...
public class AppScopedBean0652 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0652.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0652");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0652");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0652");
    }
