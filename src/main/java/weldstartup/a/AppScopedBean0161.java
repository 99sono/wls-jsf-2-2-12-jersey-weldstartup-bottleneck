...
public class AppScopedBean0161 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0161.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0161");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0161");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0161");
    }
