...
public class AppScopedBean0296 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0296.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0296");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0296");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0296");
    }
