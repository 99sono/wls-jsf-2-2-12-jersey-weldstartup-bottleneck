...
public class AppScopedBean0100 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0100.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0100");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0100");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0100");
    }
