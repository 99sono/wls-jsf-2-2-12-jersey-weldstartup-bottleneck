...
public class AppScopedBean0345 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0345.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0345");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0345");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0345");
    }
