...
public class AppScopedBean0655 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0655.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0655");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0655");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0655");
    }
