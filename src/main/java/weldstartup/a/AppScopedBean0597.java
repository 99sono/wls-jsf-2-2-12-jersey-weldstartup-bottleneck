...
public class AppScopedBean0597 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0597.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0597");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0597");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0597");
    }
