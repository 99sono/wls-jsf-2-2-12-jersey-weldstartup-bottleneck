...
public class AppScopedBean0653 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0653.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0653");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0653");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0653");
    }
