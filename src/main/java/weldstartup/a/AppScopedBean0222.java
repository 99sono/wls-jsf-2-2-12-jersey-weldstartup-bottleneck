...
public class AppScopedBean0222 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0222.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0222");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0222");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0222");
    }
