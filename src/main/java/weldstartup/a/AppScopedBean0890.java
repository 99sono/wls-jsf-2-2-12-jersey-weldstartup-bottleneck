...
public class AppScopedBean0890 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0890.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0890");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0890");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0890");
    }
