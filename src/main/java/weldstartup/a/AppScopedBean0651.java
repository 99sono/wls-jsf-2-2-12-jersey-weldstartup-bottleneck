...
public class AppScopedBean0651 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0651.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0651");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0651");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0651");
    }
