...
public class AppScopedBean0811 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0811.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0811");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0811");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0811");
    }
