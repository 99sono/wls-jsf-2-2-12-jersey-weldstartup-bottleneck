...
public class AppScopedBean0197 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0197.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0197");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0197");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0197");
    }
