...
public class AppScopedBean0392 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0392.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0392");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0392");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0392");
    }
