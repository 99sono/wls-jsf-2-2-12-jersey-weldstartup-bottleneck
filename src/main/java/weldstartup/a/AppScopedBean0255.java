...
public class AppScopedBean0255 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0255.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0255");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0255");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0255");
    }
