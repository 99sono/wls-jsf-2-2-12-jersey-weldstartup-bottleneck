...
public class AppScopedBean0659 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0659.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0659");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0659");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0659");
    }
