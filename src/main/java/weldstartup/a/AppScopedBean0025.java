...
public class AppScopedBean0025 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0025.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0025");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0025");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0025");
    }
