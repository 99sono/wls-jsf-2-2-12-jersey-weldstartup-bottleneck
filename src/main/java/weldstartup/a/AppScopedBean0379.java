...
public class AppScopedBean0379 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0379.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0379");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0379");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0379");
    }
