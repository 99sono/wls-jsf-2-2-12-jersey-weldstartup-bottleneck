...
public class AppScopedBean0208 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0208.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0208");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0208");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0208");
    }
