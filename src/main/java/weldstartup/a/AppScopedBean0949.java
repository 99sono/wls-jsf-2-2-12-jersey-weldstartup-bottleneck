...
public class AppScopedBean0949 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0949.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0949");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0949");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0949");
    }
