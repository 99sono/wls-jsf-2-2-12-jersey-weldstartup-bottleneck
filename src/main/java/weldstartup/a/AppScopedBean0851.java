...
public class AppScopedBean0851 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0851.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0851");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0851");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0851");
    }
