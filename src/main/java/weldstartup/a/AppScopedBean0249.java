...
public class AppScopedBean0249 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0249.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0249");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0249");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0249");
    }
