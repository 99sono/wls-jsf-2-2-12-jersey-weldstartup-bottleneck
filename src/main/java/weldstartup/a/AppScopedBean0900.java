...
public class AppScopedBean0900 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0900.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0900");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0900");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0900");
    }
