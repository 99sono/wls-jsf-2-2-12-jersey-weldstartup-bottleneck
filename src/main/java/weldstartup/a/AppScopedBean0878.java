...
public class AppScopedBean0878 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0878.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0878");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0878");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0878");
    }
