...
public class AppScopedBean0016 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0016.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0016");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0016");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0016");
    }
