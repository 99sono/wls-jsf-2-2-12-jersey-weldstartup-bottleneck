...
public class AppScopedBean0636 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0636.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0636");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0636");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0636");
    }
