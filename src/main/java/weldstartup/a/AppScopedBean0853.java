...
public class AppScopedBean0853 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0853.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0853");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0853");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0853");
    }
