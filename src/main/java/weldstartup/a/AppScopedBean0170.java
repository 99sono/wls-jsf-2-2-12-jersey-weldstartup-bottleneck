...
public class AppScopedBean0170 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0170.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0170");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0170");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0170");
    }
