...
public class AppScopedBean0487 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0487.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0487");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0487");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0487");
    }
