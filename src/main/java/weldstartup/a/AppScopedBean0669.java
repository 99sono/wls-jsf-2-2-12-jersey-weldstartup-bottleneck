...
public class AppScopedBean0669 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0669.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0669");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0669");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0669");
    }
