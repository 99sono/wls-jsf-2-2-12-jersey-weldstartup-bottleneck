...
public class AppScopedBean0685 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0685.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0685");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0685");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0685");
    }
