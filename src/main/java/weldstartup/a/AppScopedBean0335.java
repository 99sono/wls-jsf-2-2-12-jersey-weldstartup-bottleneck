...
public class AppScopedBean0335 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0335.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0335");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0335");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0335");
    }
