...
public class AppScopedBean0498 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0498.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0498");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0498");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0498");
    }
