...
public class AppScopedBean0418 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0418.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0418");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0418");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0418");
    }
