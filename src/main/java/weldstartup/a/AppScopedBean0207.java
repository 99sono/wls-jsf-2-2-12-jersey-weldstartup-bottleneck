...
public class AppScopedBean0207 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0207.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0207");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0207");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0207");
    }
