...
public class AppScopedBean0706 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0706.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0706");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0706");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0706");
    }
