...
public class AppScopedBean0336 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0336.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0336");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0336");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0336");
    }
