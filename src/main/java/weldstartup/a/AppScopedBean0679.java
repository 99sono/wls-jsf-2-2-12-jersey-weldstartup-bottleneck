...
public class AppScopedBean0679 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0679.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0679");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0679");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0679");
    }
