...
public class AppScopedBean0529 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0529.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0529");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0529");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0529");
    }
