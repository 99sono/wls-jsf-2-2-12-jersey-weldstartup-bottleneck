...
public class AppScopedBean0209 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0209.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0209");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0209");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0209");
    }
