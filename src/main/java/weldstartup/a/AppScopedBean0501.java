...
public class AppScopedBean0501 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0501.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0501");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0501");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0501");
    }
