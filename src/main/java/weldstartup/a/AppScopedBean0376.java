...
public class AppScopedBean0376 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0376.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0376");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0376");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0376");
    }
