...
public class AppScopedBean0622 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0622.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0622");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0622");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0622");
    }
