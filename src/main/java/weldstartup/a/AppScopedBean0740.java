...
public class AppScopedBean0740 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0740.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0740");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0740");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0740");
    }
