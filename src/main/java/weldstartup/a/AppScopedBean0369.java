...
public class AppScopedBean0369 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0369.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0369");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0369");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0369");
    }
