...
public class AppScopedBean0753 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0753.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0753");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0753");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0753");
    }
