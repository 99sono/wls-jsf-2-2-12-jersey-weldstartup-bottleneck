...
public class AppScopedBean0539 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0539.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0539");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0539");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0539");
    }
