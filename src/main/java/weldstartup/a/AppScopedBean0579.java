...
public class AppScopedBean0579 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0579.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0579");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0579");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0579");
    }
