...
public class AppScopedBean0874 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0874.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0874");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0874");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0874");
    }
