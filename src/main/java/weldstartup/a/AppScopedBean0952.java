...
public class AppScopedBean0952 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0952.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0952");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0952");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0952");
    }
