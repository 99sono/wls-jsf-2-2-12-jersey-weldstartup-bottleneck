...
public class AppScopedBean0176 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0176.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0176");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0176");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0176");
    }
