...
public class AppScopedBean0986 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0986.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0986");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0986");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0986");
    }
