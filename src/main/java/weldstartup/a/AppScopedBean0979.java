...
public class AppScopedBean0979 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0979.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0979");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0979");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0979");
    }
