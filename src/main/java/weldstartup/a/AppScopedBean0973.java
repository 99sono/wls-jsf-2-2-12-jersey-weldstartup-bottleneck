...
public class AppScopedBean0973 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0973.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0973");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0973");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0973");
    }
