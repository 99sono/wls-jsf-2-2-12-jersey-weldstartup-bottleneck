...
public class AppScopedBean0506 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0506.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0506");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0506");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0506");
    }
