...
public class AppScopedBean0283 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0283.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0283");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0283");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0283");
    }
