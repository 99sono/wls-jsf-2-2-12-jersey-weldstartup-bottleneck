...
public class AppScopedBean0496 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0496.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0496");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0496");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0496");
    }
