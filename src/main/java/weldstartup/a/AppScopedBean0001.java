...
public class AppScopedBean0001 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0001.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0001");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0001");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0001");
    }
