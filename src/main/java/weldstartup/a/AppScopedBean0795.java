...
public class AppScopedBean0795 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0795.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0795");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0795");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0795");
    }
