...
public class AppScopedBean0172 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0172.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0172");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0172");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0172");
    }
