...
public class AppScopedBean0719 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0719.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0719");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0719");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0719");
    }
