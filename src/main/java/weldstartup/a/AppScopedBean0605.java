...
public class AppScopedBean0605 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0605.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0605");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0605");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0605");
    }
