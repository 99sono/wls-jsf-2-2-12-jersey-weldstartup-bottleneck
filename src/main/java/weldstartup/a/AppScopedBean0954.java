...
public class AppScopedBean0954 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0954.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0954");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0954");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0954");
    }
