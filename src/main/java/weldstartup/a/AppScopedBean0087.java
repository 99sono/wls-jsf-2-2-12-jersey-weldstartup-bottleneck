...
public class AppScopedBean0087 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0087.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0087");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0087");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0087");
    }
