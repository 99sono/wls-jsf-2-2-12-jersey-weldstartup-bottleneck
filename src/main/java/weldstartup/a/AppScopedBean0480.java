...
public class AppScopedBean0480 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0480.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0480");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0480");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0480");
    }
