...
public class AppScopedBean0877 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0877.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0877");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0877");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0877");
    }
