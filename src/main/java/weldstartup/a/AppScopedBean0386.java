...
public class AppScopedBean0386 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0386.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0386");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0386");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0386");
    }
