...
public class AppScopedBean0790 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0790.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0790");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0790");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0790");
    }
