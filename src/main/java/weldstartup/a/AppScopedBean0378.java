...
public class AppScopedBean0378 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0378.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0378");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0378");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0378");
    }
