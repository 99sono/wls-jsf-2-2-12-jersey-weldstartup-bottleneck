...
public class AppScopedBean0798 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0798.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0798");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0798");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0798");
    }
