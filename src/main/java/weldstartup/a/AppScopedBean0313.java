...
public class AppScopedBean0313 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0313.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0313");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0313");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0313");
    }
