...
public class AppScopedBean0866 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0866.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0866");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0866");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0866");
    }
