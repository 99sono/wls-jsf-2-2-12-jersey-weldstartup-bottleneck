...
public class AppScopedBean0055 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0055.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0055");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0055");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0055");
    }
