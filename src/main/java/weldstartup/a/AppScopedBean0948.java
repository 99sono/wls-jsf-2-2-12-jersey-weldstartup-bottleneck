...
public class AppScopedBean0948 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0948.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0948");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0948");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0948");
    }
