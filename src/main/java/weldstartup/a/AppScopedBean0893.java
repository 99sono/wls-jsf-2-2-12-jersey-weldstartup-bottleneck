...
public class AppScopedBean0893 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0893.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0893");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0893");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0893");
    }
