...
public class AppScopedBean0211 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0211.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0211");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0211");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0211");
    }
