...
public class AppScopedBean0946 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0946.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0946");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0946");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0946");
    }
