...
public class AppScopedBean0093 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0093.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0093");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0093");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0093");
    }
