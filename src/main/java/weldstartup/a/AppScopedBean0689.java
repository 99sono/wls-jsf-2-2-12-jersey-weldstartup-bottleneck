...
public class AppScopedBean0689 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0689.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0689");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0689");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0689");
    }
