...
public class AppScopedBean0231 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0231.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0231");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0231");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0231");
    }
