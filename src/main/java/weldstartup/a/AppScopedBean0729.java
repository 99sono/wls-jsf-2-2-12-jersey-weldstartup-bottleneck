...
public class AppScopedBean0729 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0729.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0729");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0729");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0729");
    }
