...
public class AppScopedBean0624 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0624.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0624");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0624");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0624");
    }
