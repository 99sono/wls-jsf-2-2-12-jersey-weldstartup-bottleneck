...
public class AppScopedBean0225 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0225.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0225");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0225");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0225");
    }
