...
public class AppScopedBean0610 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0610.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0610");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0610");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0610");
    }
