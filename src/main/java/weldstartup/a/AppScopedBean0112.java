...
public class AppScopedBean0112 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0112.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0112");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0112");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0112");
    }
