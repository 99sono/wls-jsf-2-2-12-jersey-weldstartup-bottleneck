...
public class AppScopedBean0906 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0906.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0906");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0906");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0906");
    }
