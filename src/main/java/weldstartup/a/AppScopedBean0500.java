...
public class AppScopedBean0500 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0500.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0500");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0500");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0500");
    }
