...
public class AppScopedBean0642 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0642.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0642");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0642");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0642");
    }
