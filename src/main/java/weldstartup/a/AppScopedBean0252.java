...
public class AppScopedBean0252 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0252.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0252");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0252");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0252");
    }
