...
public class AppScopedBean0858 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0858.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0858");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0858");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0858");
    }
