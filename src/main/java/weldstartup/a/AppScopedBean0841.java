...
public class AppScopedBean0841 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0841.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0841");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0841");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0841");
    }
