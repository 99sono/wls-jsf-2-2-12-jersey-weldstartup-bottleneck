...
public class AppScopedBean0301 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0301.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0301");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0301");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0301");
    }
