...
public class AppScopedBean0006 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0006.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0006");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0006");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0006");
    }
