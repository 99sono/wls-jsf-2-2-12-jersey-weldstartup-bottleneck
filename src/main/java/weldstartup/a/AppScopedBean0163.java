...
public class AppScopedBean0163 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0163.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0163");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0163");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0163");
    }
