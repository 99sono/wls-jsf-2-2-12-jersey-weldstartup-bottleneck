...
public class AppScopedBean0635 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0635.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0635");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0635");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0635");
    }
