...
public class AppScopedBean0553 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0553.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0553");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0553");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0553");
    }
