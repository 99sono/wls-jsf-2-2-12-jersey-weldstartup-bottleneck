...
public class AppScopedBean0084 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0084.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0084");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0084");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0084");
    }
