...
public class AppScopedBean0234 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0234.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0234");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0234");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0234");
    }
