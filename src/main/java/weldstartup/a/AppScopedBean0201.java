...
public class AppScopedBean0201 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0201.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0201");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0201");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0201");
    }
