...
public class AppScopedBean0493 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0493.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0493");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0493");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0493");
    }
