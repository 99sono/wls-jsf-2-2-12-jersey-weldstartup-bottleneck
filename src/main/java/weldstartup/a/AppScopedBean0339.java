...
public class AppScopedBean0339 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0339.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0339");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0339");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0339");
    }
