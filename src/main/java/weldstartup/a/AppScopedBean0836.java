...
public class AppScopedBean0836 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0836.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0836");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0836");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0836");
    }
