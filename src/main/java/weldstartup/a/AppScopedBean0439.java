...
public class AppScopedBean0439 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0439.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0439");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0439");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0439");
    }
