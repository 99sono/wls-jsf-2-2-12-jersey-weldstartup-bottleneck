...
public class AppScopedBean0950 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0950.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0950");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0950");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0950");
    }
