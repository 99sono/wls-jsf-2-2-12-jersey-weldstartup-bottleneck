...
public class AppScopedBean0601 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0601.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0601");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0601");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0601");
    }
