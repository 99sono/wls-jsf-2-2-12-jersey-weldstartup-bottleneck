...
public class AppScopedBean0788 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0788.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0788");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0788");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0788");
    }
