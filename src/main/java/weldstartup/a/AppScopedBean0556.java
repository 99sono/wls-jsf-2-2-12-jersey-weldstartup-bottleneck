...
public class AppScopedBean0556 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0556.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0556");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0556");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0556");
    }
