...
public class AppScopedBean0975 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0975.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0975");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0975");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0975");
    }
