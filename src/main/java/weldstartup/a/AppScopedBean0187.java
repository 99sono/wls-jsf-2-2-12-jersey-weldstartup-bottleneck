...
public class AppScopedBean0187 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0187.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0187");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0187");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0187");
    }
