...
public class AppScopedBean0739 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0739.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0739");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0739");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0739");
    }
