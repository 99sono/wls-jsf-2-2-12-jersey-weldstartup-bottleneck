...
public class AppScopedBean0171 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0171.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0171");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0171");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0171");
    }
