...
public class AppScopedBean0913 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0913.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0913");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0913");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0913");
    }
