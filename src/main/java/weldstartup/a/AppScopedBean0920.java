...
public class AppScopedBean0920 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0920.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0920");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0920");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0920");
    }
