...
public class AppScopedBean0615 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0615.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0615");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0615");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0615");
    }
