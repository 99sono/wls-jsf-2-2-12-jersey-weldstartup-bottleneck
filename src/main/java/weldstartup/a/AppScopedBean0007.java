...
public class AppScopedBean0007 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0007.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0007");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0007");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0007");
    }
