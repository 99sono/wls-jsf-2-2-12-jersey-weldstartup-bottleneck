...
public class AppScopedBean0003 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0003.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0003");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0003");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0003");
    }
