...
public class AppScopedBean0759 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0759.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0759");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0759");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0759");
    }
