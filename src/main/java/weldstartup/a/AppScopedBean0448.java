...
public class AppScopedBean0448 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0448.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0448");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0448");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0448");
    }
