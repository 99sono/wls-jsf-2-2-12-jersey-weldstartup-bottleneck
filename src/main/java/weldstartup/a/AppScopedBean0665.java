...
public class AppScopedBean0665 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0665.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0665");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0665");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0665");
    }
