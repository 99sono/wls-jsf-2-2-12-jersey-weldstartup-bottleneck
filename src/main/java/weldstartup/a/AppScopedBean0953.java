...
public class AppScopedBean0953 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0953.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0953");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0953");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0953");
    }
