...
public class AppScopedBean0210 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0210.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0210");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0210");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0210");
    }
