...
public class AppScopedBean0133 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0133.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0133");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0133");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0133");
    }
