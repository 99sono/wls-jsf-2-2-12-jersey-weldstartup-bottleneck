...
public class AppScopedBean0723 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0723.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0723");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0723");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0723");
    }
