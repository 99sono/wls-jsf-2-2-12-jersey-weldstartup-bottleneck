...
public class AppScopedBean0925 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0925.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0925");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0925");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0925");
    }
