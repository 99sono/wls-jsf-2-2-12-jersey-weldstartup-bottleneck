...
public class AppScopedBean0631 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0631.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0631");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0631");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0631");
    }
