...
public class AppScopedBean0609 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0609.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0609");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0609");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0609");
    }
