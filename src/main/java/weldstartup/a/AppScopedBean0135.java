...
public class AppScopedBean0135 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0135.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0135");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0135");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0135");
    }
