...
public class AppScopedBean0061 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0061.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0061");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0061");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0061");
    }
