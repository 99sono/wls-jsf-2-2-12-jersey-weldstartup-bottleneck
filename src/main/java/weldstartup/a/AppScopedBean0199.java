...
public class AppScopedBean0199 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0199.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0199");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0199");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0199");
    }
