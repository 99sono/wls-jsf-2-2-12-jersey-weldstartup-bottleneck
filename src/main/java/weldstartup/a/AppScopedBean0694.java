...
public class AppScopedBean0694 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0694.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0694");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0694");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0694");
    }
