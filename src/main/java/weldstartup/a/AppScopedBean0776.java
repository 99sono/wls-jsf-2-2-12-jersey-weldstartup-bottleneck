...
public class AppScopedBean0776 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0776.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0776");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0776");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0776");
    }
