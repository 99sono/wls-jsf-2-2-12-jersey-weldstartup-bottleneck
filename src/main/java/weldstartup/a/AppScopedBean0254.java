...
public class AppScopedBean0254 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0254.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0254");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0254");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0254");
    }
