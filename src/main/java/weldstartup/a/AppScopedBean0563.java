...
public class AppScopedBean0563 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0563.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0563");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0563");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0563");
    }
