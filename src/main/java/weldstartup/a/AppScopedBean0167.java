...
public class AppScopedBean0167 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0167.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0167");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0167");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0167");
    }
