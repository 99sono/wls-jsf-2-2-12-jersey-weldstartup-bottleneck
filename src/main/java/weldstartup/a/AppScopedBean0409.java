...
public class AppScopedBean0409 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0409.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0409");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0409");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0409");
    }
