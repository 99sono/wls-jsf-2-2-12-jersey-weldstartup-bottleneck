...
public class AppScopedBean0824 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0824.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0824");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0824");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0824");
    }
