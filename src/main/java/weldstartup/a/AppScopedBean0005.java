...
public class AppScopedBean0005 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0005.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0005");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0005");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0005");
    }
