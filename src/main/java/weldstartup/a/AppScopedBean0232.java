...
public class AppScopedBean0232 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0232.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0232");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0232");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0232");
    }
