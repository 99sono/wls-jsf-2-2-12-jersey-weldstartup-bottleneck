...
public class AppScopedBean0361 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0361.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0361");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0361");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0361");
    }
