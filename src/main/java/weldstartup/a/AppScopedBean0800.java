...
public class AppScopedBean0800 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0800.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0800");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0800");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0800");
    }
