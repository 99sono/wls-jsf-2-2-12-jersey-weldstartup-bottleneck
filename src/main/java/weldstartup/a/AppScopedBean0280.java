...
public class AppScopedBean0280 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0280.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0280");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0280");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0280");
    }
