...
public class AppScopedBean0550 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0550.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0550");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0550");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0550");
    }
