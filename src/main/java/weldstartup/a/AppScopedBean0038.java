...
public class AppScopedBean0038 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0038.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0038");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0038");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0038");
    }
