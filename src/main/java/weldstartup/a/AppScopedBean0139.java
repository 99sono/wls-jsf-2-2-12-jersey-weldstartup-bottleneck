...
public class AppScopedBean0139 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0139.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0139");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0139");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0139");
    }
