...
public class AppScopedBean0938 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0938.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0938");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0938");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0938");
    }
