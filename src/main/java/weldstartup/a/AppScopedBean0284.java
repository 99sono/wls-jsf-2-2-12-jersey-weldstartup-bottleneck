...
public class AppScopedBean0284 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0284.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0284");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0284");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0284");
    }
