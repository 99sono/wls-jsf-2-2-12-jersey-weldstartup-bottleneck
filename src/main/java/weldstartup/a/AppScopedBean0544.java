...
public class AppScopedBean0544 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0544.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0544");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0544");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0544");
    }
