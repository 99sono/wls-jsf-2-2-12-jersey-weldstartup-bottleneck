...
public class AppScopedBean0532 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0532.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0532");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0532");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0532");
    }
