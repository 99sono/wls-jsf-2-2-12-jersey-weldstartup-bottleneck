...
public class AppScopedBean0667 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0667.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0667");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0667");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0667");
    }
