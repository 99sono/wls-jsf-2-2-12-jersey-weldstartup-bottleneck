...
public class AppScopedBean0823 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0823.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0823");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0823");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0823");
    }
