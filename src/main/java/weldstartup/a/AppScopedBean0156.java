...
public class AppScopedBean0156 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0156.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0156");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0156");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0156");
    }
