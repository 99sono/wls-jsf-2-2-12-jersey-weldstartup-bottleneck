...
public class AppScopedBean0558 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0558.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0558");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0558");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0558");
    }
