...
public class AppScopedBean0046 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0046.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0046");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0046");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0046");
    }
