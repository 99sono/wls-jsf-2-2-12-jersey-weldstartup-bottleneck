...
public class AppScopedBean0518 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0518.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0518");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0518");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0518");
    }
