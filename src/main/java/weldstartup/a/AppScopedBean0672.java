...
public class AppScopedBean0672 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0672.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0672");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0672");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0672");
    }
