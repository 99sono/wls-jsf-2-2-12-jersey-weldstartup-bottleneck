...
public class AppScopedBean0274 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0274.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0274");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0274");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0274");
    }
