...
public class AppScopedBean0767 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0767.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0767");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0767");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0767");
    }
