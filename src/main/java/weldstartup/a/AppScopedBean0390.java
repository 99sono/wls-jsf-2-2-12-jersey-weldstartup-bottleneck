...
public class AppScopedBean0390 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0390.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0390");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0390");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0390");
    }
