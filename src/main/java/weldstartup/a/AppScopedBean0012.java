...
public class AppScopedBean0012 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0012.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0012");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0012");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0012");
    }
