...
public class AppScopedBean0426 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0426.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0426");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0426");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0426");
    }
