...
public class AppScopedBean0535 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0535.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0535");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0535");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0535");
    }
