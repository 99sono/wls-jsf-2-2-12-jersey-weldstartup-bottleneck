...
public class AppScopedBean0680 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0680.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0680");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0680");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0680");
    }
