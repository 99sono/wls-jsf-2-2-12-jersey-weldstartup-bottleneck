...
public class AppScopedBean0020 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0020.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0020");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0020");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0020");
    }
