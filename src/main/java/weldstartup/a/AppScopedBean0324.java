...
public class AppScopedBean0324 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0324.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0324");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0324");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0324");
    }
