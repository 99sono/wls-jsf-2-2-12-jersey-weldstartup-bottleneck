...
public class AppScopedBean0098 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0098.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0098");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0098");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0098");
    }
