...
public class AppScopedBean0382 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0382.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0382");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0382");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0382");
    }
