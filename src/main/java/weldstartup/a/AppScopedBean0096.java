...
public class AppScopedBean0096 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0096.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0096");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0096");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0096");
    }
