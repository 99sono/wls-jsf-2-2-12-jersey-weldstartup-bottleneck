...
public class AppScopedBean0640 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0640.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0640");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0640");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0640");
    }
