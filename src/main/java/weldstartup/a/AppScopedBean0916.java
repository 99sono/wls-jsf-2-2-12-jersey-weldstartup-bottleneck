...
public class AppScopedBean0916 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0916.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0916");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0916");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0916");
    }
