...
public class AppScopedBean0286 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0286.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0286");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0286");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0286");
    }
