...
public class AppScopedBean0099 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0099.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0099");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0099");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0099");
    }
