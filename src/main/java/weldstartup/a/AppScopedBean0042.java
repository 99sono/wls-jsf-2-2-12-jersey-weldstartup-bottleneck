...
public class AppScopedBean0042 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0042.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0042");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0042");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0042");
    }
