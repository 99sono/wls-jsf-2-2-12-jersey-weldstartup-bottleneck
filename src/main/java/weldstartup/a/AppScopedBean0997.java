...
public class AppScopedBean0997 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0997.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0997");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0997");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0997");
    }
