...
public class AppScopedBean0808 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0808.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0808");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0808");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0808");
    }
