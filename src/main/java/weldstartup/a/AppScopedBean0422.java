...
public class AppScopedBean0422 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0422.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0422");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0422");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0422");
    }
