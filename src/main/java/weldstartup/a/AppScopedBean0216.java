...
public class AppScopedBean0216 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0216.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0216");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0216");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0216");
    }
