...
public class AppScopedBean0322 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0322.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0322");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0322");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0322");
    }
