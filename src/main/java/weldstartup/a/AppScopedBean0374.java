...
public class AppScopedBean0374 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0374.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0374");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0374");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0374");
    }
