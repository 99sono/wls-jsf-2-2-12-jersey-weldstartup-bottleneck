...
public class AppScopedBean0233 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0233.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0233");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0233");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0233");
    }
