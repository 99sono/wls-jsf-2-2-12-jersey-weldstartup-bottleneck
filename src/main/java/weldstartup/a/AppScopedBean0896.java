...
public class AppScopedBean0896 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0896.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0896");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0896");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0896");
    }
