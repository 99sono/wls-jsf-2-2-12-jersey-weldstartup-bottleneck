...
public class AppScopedBean0372 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0372.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0372");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0372");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0372");
    }
