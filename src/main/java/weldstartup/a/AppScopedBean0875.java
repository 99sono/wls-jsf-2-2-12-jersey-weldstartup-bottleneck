...
public class AppScopedBean0875 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0875.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0875");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0875");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0875");
    }
