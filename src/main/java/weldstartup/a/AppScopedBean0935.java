...
public class AppScopedBean0935 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0935.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0935");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0935");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0935");
    }
