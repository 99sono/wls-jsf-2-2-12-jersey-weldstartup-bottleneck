...
public class AppScopedBean0229 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0229.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0229");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0229");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0229");
    }
