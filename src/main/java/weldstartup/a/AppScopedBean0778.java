...
public class AppScopedBean0778 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0778.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0778");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0778");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0778");
    }
