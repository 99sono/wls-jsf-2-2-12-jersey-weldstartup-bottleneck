...
public class AppScopedBean0348 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0348.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0348");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0348");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0348");
    }
