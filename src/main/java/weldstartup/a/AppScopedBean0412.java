...
public class AppScopedBean0412 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0412.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0412");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0412");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0412");
    }
