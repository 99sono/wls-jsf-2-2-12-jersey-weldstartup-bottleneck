...
public class AppScopedBean0511 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0511.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0511");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0511");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0511");
    }
