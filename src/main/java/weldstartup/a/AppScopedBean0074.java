...
public class AppScopedBean0074 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0074.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0074");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0074");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0074");
    }
