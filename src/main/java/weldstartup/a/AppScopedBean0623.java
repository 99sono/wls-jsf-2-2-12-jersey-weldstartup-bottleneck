...
public class AppScopedBean0623 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0623.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0623");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0623");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0623");
    }
