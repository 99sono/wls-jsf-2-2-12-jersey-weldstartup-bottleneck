...
public class AppScopedBean0081 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0081.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0081");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0081");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0081");
    }
