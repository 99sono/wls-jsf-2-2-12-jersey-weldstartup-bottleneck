...
public class AppScopedBean0709 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0709.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0709");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0709");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0709");
    }
