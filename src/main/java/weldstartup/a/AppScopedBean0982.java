...
public class AppScopedBean0982 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0982.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0982");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0982");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0982");
    }
