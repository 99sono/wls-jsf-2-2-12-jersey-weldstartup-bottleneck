...
public class AppScopedBean0718 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0718.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0718");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0718");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0718");
    }
