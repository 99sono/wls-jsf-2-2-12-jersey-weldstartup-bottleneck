...
public class AppScopedBean0288 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0288.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0288");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0288");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0288");
    }
