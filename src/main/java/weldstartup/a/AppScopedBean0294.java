...
public class AppScopedBean0294 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0294.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0294");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0294");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0294");
    }
