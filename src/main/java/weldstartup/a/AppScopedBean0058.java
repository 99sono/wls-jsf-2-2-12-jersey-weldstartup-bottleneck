...
public class AppScopedBean0058 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0058.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0058");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0058");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0058");
    }
