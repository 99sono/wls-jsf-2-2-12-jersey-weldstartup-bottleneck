...
public class AppScopedBean0417 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0417.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0417");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0417");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0417");
    }
