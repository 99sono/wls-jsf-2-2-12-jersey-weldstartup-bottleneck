...
public class AppScopedBean0103 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0103.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0103");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0103");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0103");
    }
