...
public class AppScopedBean0756 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0756.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0756");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0756");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0756");
    }
