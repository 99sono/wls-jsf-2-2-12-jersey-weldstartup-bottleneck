...
public class AppScopedBean0607 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0607.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0607");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0607");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0607");
    }
