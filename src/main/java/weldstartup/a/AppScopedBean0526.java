...
public class AppScopedBean0526 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0526.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0526");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0526");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0526");
    }
