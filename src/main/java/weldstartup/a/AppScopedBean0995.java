...
public class AppScopedBean0995 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0995.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0995");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0995");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0995");
    }
