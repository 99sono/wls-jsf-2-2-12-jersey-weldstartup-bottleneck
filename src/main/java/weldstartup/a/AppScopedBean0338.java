...
public class AppScopedBean0338 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0338.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0338");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0338");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0338");
    }
