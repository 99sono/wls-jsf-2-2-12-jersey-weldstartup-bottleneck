...
public class AppScopedBean0157 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0157.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0157");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0157");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0157");
    }
