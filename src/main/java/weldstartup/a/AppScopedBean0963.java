...
public class AppScopedBean0963 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0963.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0963");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0963");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0963");
    }
