...
public class AppScopedBean0859 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0859.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0859");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0859");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0859");
    }
