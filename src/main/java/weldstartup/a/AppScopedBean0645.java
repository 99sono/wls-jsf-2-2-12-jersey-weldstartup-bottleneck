...
public class AppScopedBean0645 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0645.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0645");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0645");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0645");
    }
