...
public class AppScopedBean0438 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0438.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0438");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0438");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0438");
    }
