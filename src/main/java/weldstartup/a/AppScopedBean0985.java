...
public class AppScopedBean0985 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0985.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0985");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0985");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0985");
    }
