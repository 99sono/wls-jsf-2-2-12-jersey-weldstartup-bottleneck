...
public class AppScopedBean0833 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0833.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0833");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0833");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0833");
    }
