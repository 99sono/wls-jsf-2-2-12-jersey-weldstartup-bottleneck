...
public class AppScopedBean0648 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0648.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0648");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0648");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0648");
    }
