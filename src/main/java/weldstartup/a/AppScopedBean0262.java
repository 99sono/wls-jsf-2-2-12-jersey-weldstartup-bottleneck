...
public class AppScopedBean0262 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0262.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0262");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0262");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0262");
    }
