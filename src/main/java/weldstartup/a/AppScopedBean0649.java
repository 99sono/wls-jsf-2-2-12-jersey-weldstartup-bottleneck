...
public class AppScopedBean0649 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0649.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0649");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0649");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0649");
    }
