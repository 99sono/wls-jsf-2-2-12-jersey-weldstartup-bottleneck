...
public class AppScopedBean0817 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0817.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0817");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0817");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0817");
    }
