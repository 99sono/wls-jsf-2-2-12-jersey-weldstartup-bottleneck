...
public class AppScopedBean0812 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0812.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0812");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0812");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0812");
    }
