...
public class AppScopedBean0646 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0646.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0646");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0646");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0646");
    }
