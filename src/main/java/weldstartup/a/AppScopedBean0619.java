...
public class AppScopedBean0619 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0619.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0619");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0619");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0619");
    }
