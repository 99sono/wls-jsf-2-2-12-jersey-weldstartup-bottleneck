...
public class AppScopedBean0267 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0267.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0267");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0267");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0267");
    }
