...
public class AppScopedBean0583 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0583.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0583");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0583");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0583");
    }
