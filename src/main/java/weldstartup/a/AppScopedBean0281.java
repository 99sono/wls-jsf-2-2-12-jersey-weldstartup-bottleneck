...
public class AppScopedBean0281 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0281.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0281");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0281");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0281");
    }
