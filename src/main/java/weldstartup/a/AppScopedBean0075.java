...
public class AppScopedBean0075 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0075.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0075");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0075");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0075");
    }
