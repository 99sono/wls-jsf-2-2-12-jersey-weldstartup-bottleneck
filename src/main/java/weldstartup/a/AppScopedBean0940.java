...
public class AppScopedBean0940 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0940.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0940");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0940");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0940");
    }
