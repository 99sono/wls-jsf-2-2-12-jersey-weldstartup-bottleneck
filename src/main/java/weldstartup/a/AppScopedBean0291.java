...
public class AppScopedBean0291 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0291.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0291");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0291");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0291");
    }
