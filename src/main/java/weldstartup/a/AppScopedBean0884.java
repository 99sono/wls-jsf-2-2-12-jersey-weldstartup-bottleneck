...
public class AppScopedBean0884 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0884.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0884");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0884");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0884");
    }
