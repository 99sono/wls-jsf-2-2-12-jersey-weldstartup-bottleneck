...
public class AppScopedBean0343 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0343.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0343");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0343");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0343");
    }
