...
public class AppScopedBean0323 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0323.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0323");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0323");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0323");
    }
