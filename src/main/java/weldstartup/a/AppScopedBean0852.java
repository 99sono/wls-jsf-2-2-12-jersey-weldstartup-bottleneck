...
public class AppScopedBean0852 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0852.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0852");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0852");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0852");
    }
