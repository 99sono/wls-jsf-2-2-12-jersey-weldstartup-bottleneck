...
public class AppScopedBean0722 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0722.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0722");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0722");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0722");
    }
