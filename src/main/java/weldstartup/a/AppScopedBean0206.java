...
public class AppScopedBean0206 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0206.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0206");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0206");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0206");
    }
