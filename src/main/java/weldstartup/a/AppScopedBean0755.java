...
public class AppScopedBean0755 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0755.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0755");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0755");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0755");
    }
