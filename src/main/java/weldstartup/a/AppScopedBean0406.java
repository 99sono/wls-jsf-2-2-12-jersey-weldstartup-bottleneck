...
public class AppScopedBean0406 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0406.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0406");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0406");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0406");
    }
