...
public class AppScopedBean0050 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0050.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0050");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0050");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0050");
    }
