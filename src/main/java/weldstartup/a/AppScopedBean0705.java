...
public class AppScopedBean0705 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0705.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0705");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0705");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0705");
    }
