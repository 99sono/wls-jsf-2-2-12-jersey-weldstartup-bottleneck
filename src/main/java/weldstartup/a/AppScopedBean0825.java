...
public class AppScopedBean0825 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0825.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0825");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0825");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0825");
    }
