...
public class AppScopedBean0213 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0213.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0213");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0213");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0213");
    }
