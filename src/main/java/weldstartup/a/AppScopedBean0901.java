...
public class AppScopedBean0901 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0901.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0901");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0901");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0901");
    }
