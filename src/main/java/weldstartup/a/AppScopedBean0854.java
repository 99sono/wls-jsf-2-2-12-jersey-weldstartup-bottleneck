...
public class AppScopedBean0854 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0854.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0854");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0854");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0854");
    }
