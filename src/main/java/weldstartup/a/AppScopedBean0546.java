...
public class AppScopedBean0546 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0546.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0546");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0546");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0546");
    }
