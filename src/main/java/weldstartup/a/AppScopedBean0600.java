...
public class AppScopedBean0600 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0600.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0600");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0600");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0600");
    }
