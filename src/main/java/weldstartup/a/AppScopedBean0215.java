...
public class AppScopedBean0215 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0215.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0215");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0215");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0215");
    }
