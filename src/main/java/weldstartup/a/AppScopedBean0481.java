...
public class AppScopedBean0481 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0481.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0481");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0481");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0481");
    }
