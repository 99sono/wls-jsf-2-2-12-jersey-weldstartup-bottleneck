...
public class AppScopedBean0033 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0033.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0033");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0033");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0033");
    }
