...
public class AppScopedBean0510 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0510.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0510");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0510");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0510");
    }
