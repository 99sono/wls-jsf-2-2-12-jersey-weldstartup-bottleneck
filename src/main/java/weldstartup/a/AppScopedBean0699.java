...
public class AppScopedBean0699 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0699.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0699");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0699");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0699");
    }
