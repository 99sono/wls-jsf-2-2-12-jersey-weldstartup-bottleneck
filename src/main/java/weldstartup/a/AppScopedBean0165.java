...
public class AppScopedBean0165 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0165.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0165");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0165");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0165");
    }
