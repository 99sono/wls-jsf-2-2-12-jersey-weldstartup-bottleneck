...
public class AppScopedBean0009 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0009.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0009");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0009");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0009");
    }
