...
public class AppScopedBean0464 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0464.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0464");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0464");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0464");
    }
