...
public class AppScopedBean0915 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0915.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0915");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0915");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0915");
    }
