...
public class AppScopedBean0731 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0731.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0731");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0731");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0731");
    }
