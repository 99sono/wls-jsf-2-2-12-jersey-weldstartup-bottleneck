...
public class AppScopedBean0711 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0711.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0711");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0711");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0711");
    }
