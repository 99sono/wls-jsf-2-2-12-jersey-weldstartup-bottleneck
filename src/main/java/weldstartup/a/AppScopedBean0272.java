...
public class AppScopedBean0272 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0272.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0272");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0272");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0272");
    }
