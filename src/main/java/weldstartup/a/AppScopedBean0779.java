...
public class AppScopedBean0779 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0779.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0779");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0779");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0779");
    }
