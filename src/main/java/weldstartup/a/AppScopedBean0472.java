...
public class AppScopedBean0472 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0472.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0472");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0472");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0472");
    }
