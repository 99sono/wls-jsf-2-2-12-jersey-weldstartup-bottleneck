...
public class AppScopedBean0491 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0491.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0491");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0491");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0491");
    }
