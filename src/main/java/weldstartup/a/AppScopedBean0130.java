...
public class AppScopedBean0130 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0130.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0130");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0130");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0130");
    }
