...
public class AppScopedBean0456 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0456.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0456");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0456");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0456");
    }
