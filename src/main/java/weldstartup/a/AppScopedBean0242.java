...
public class AppScopedBean0242 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0242.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0242");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0242");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0242");
    }
