...
public class AppScopedBean0031 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0031.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0031");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0031");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0031");
    }
