...
public class AppScopedBean0189 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0189.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0189");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0189");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0189");
    }
