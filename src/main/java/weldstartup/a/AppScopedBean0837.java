...
public class AppScopedBean0837 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0837.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0837");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0837");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0837");
    }
