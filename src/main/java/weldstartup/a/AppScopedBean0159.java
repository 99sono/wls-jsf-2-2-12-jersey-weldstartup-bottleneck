...
public class AppScopedBean0159 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0159.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0159");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0159");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0159");
    }
