...
public class AppScopedBean0424 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0424.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0424");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0424");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0424");
    }
