...
public class AppScopedBean0166 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0166.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0166");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0166");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0166");
    }
