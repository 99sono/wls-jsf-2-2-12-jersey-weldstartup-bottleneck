...
public class AppScopedBean0794 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0794.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0794");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0794");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0794");
    }
