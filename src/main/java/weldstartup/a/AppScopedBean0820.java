...
public class AppScopedBean0820 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0820.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0820");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0820");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0820");
    }
