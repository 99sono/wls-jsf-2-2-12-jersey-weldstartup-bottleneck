...
public class AppScopedBean0670 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0670.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0670");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0670");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0670");
    }
