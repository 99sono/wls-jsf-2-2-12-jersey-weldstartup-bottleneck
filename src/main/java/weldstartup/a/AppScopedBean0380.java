...
public class AppScopedBean0380 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0380.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0380");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0380");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0380");
    }
