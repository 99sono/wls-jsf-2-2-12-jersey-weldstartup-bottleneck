...
public class AppScopedBean0964 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0964.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0964");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0964");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0964");
    }
