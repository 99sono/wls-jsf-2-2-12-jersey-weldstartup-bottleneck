...
public class AppScopedBean0399 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0399.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0399");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0399");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0399");
    }
