...
public class AppScopedBean0860 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0860.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0860");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0860");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0860");
    }
