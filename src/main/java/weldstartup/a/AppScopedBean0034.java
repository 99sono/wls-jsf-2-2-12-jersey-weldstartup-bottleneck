...
public class AppScopedBean0034 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0034.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0034");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0034");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0034");
    }
