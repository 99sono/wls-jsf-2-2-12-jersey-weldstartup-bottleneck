...
public class AppScopedBean0897 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0897.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0897");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0897");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0897");
    }
