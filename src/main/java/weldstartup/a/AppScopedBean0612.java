...
public class AppScopedBean0612 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0612.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0612");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0612");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0612");
    }
