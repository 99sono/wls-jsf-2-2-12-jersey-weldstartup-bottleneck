...
public class AppScopedBean0686 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0686.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0686");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0686");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0686");
    }
