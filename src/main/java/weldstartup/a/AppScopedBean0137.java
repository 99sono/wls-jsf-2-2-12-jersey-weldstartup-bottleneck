...
public class AppScopedBean0137 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0137.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0137");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0137");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0137");
    }
