...
public class AppScopedBean0750 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0750.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0750");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0750");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0750");
    }
