...
public class AppScopedBean0972 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0972.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0972");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0972");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0972");
    }
