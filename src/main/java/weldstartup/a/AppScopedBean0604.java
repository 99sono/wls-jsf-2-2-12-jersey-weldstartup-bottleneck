...
public class AppScopedBean0604 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0604.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0604");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0604");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0604");
    }
