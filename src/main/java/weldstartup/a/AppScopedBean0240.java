...
public class AppScopedBean0240 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0240.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0240");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0240");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0240");
    }
