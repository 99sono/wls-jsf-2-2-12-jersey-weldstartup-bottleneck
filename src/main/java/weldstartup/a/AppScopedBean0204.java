...
public class AppScopedBean0204 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0204.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0204");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0204");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0204");
    }
