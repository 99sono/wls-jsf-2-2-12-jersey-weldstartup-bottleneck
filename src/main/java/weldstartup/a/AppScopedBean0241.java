...
public class AppScopedBean0241 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0241.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0241");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0241");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0241");
    }
