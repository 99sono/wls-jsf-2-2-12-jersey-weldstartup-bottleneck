...
public class AppScopedBean0880 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0880.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0880");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0880");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0880");
    }
