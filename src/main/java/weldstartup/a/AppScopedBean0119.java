...
public class AppScopedBean0119 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0119.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0119");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0119");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0119");
    }
