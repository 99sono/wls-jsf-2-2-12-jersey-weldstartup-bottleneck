...
public class AppScopedBean0257 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0257.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0257");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0257");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0257");
    }
