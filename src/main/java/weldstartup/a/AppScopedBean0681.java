...
public class AppScopedBean0681 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0681.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0681");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0681");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0681");
    }
