...
public class AppScopedBean0360 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0360.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0360");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0360");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0360");
    }
