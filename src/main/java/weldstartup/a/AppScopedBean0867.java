...
public class AppScopedBean0867 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0867.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0867");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0867");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0867");
    }
