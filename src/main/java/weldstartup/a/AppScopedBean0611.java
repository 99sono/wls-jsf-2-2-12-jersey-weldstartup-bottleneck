...
public class AppScopedBean0611 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0611.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0611");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0611");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0611");
    }
