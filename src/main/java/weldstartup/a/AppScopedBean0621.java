...
public class AppScopedBean0621 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0621.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0621");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0621");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0621");
    }
