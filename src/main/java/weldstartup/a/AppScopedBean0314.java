...
public class AppScopedBean0314 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0314.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0314");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0314");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0314");
    }
