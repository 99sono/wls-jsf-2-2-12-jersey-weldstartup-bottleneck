...
public class AppScopedBean0414 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0414.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0414");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0414");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0414");
    }
