...
public class AppScopedBean0863 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0863.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0863");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0863");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0863");
    }
