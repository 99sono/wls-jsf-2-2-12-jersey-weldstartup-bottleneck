...
public class AppScopedBean0468 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0468.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0468");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0468");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0468");
    }
