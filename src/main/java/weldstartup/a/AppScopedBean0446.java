...
public class AppScopedBean0446 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0446.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0446");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0446");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0446");
    }
