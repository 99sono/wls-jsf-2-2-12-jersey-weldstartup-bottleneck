...
public class AppScopedBean0276 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0276.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0276");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0276");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0276");
    }
