...
public class AppScopedBean0771 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0771.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0771");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0771");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0771");
    }
