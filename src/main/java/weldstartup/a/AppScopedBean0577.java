...
public class AppScopedBean0577 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0577.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0577");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0577");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0577");
    }
