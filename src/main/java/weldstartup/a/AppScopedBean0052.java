...
public class AppScopedBean0052 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0052.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0052");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0052");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0052");
    }
