...
public class AppScopedBean0057 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0057.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0057");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0057");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0057");
    }
