...
public class AppScopedBean0393 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0393.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0393");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0393");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0393");
    }
