...
public class AppScopedBean0675 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0675.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0675");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0675");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0675");
    }
