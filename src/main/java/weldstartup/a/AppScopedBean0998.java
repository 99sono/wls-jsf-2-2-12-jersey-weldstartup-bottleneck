...
public class AppScopedBean0998 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0998.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0998");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0998");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0998");
    }
