...
public class AppScopedBean0662 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0662.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0662");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0662");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0662");
    }
