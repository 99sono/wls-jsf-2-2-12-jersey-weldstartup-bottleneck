...
public class AppScopedBean0230 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0230.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0230");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0230");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0230");
    }
