...
public class AppScopedBean0958 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0958.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0958");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0958");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0958");
    }
