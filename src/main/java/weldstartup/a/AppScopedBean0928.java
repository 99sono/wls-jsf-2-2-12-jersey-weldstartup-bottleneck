...
public class AppScopedBean0928 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0928.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0928");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0928");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0928");
    }
