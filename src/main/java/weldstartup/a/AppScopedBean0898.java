...
public class AppScopedBean0898 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0898.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0898");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0898");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0898");
    }
