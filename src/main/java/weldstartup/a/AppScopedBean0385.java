...
public class AppScopedBean0385 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0385.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0385");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0385");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0385");
    }
