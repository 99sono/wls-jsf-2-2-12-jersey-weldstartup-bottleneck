...
public class AppScopedBean0184 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0184.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0184");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0184");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0184");
    }
