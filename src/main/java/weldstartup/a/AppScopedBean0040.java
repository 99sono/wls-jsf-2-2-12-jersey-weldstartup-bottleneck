...
public class AppScopedBean0040 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0040.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0040");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0040");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0040");
    }
