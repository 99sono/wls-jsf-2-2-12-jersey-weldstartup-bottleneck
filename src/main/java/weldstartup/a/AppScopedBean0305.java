...
public class AppScopedBean0305 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0305.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0305");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0305");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0305");
    }
