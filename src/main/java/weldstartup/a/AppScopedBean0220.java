...
public class AppScopedBean0220 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0220.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0220");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0220");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0220");
    }
