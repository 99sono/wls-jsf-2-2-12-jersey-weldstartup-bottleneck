...
public class AppScopedBean0654 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0654.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0654");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0654");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0654");
    }
