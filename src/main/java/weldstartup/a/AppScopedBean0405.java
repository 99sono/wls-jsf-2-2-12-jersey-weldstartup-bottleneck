...
public class AppScopedBean0405 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0405.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0405");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0405");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0405");
    }
