...
public class AppScopedBean0263 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0263.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0263");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0263");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0263");
    }
