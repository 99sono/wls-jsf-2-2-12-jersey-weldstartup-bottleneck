...
public class AppScopedBean0154 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0154.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0154");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0154");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0154");
    }
