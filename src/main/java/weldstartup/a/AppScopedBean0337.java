...
public class AppScopedBean0337 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0337.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0337");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0337");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0337");
    }
