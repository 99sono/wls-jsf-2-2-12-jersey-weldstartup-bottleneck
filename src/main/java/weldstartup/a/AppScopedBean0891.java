...
public class AppScopedBean0891 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0891.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0891");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0891");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0891");
    }
