...
public class AppScopedBean0552 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0552.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0552");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0552");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0552");
    }
