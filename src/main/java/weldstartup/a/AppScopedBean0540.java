...
public class AppScopedBean0540 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0540.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0540");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0540");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0540");
    }
