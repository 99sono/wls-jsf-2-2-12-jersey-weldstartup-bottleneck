...
public class AppScopedBean0188 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0188.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0188");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0188");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0188");
    }
