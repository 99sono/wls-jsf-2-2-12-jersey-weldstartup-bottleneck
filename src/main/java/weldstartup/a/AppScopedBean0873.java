...
public class AppScopedBean0873 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0873.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0873");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0873");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0873");
    }
