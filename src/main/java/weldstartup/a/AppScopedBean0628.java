...
public class AppScopedBean0628 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0628.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0628");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0628");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0628");
    }
