...
public class AppScopedBean0155 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0155.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0155");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0155");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0155");
    }
