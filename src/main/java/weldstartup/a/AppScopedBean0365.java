...
public class AppScopedBean0365 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0365.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0365");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0365");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0365");
    }
