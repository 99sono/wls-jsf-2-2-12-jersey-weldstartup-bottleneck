...
public class AppScopedBean0101 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0101.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0101");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0101");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0101");
    }
