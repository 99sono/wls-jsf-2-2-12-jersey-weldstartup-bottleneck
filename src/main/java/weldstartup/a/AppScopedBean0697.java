...
public class AppScopedBean0697 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0697.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0697");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0697");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0697");
    }
