...
public class AppScopedBean0625 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0625.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0625");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0625");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0625");
    }
