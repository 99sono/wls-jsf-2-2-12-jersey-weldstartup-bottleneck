...
public class AppScopedBean0270 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0270.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0270");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0270");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0270");
    }
