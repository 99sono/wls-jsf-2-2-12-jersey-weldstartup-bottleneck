...
public class AppScopedBean0637 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0637.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0637");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0637");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0637");
    }
