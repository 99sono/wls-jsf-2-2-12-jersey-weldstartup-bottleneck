...
public class AppScopedBean0317 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0317.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0317");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0317");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0317");
    }
