...
public class AppScopedBean0200 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0200.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0200");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0200");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0200");
    }
