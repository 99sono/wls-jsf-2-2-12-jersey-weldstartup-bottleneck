...
public class AppScopedBean0865 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0865.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0865");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0865");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0865");
    }
