...
public class AppScopedBean0018 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0018.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0018");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0018");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0018");
    }
