...
public class AppScopedBean0367 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0367.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0367");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0367");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0367");
    }
