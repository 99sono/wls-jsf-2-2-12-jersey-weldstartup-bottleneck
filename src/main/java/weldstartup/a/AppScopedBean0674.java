...
public class AppScopedBean0674 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0674.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0674");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0674");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0674");
    }
