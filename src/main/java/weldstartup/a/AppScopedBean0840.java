...
public class AppScopedBean0840 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0840.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0840");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0840");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0840");
    }
