...
public class AppScopedBean0082 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0082.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0082");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0082");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0082");
    }
