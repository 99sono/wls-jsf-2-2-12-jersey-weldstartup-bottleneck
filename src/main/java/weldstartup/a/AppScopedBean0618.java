...
public class AppScopedBean0618 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0618.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0618");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0618");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0618");
    }
