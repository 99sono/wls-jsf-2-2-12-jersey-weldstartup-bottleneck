...
public class AppScopedBean0094 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0094.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0094");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0094");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0094");
    }
