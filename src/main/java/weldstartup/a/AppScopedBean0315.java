...
public class AppScopedBean0315 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0315.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0315");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0315");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0315");
    }
