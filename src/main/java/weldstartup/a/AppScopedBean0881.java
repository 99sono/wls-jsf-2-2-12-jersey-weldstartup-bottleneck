...
public class AppScopedBean0881 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0881.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0881");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0881");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0881");
    }
