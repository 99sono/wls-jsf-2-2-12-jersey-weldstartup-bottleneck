...
public class AppScopedBean0076 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0076.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0076");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0076");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0076");
    }
