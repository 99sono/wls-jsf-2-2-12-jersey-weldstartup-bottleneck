...
public class AppScopedBean0804 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0804.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0804");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0804");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0804");
    }
