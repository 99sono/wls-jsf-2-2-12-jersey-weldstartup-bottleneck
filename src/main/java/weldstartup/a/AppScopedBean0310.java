...
public class AppScopedBean0310 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0310.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0310");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0310");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0310");
    }
