...
public class AppScopedBean0603 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0603.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0603");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0603");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0603");
    }
