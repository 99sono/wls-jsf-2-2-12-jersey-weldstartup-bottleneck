...
public class AppScopedBean0809 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0809.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0809");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0809");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0809");
    }
