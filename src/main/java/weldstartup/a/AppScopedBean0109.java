...
public class AppScopedBean0109 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0109.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0109");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0109");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0109");
    }
