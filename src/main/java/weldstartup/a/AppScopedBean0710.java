...
public class AppScopedBean0710 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0710.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0710");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0710");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0710");
    }
