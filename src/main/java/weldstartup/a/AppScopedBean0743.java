...
public class AppScopedBean0743 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0743.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0743");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0743");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0743");
    }
