...
public class AppScopedBean0904 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0904.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0904");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0904");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0904");
    }
