...
public class AppScopedBean0401 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0401.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0401");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0401");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0401");
    }
