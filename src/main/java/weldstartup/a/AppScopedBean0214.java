...
public class AppScopedBean0214 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0214.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0214");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0214");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0214");
    }
