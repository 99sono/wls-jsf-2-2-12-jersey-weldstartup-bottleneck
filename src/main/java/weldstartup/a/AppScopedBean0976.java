...
public class AppScopedBean0976 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0976.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0976");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0976");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0976");
    }
