...
public class AppScopedBean0588 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0588.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0588");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0588");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0588");
    }
