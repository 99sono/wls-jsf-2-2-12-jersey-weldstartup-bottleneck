...
public class AppScopedBean0902 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0902.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0902");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0902");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0902");
    }
