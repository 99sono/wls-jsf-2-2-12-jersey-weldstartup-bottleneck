...
public class AppScopedBean0123 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0123.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0123");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0123");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0123");
    }
