...
public class AppScopedBean0676 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0676.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0676");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0676");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0676");
    }
