...
public class AppScopedBean0572 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0572.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0572");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0572");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0572");
    }
