...
public class AppScopedBean0774 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0774.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0774");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0774");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0774");
    }
