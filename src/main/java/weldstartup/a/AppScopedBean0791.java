...
public class AppScopedBean0791 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0791.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0791");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0791");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0791");
    }
