...
public class AppScopedBean0684 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0684.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0684");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0684");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0684");
    }
