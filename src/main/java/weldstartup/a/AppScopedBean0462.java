...
public class AppScopedBean0462 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0462.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0462");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0462");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0462");
    }
