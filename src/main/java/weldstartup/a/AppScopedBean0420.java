...
public class AppScopedBean0420 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0420.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0420");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0420");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0420");
    }
