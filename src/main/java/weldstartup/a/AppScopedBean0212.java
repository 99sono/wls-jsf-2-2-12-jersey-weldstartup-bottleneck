...
public class AppScopedBean0212 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0212.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0212");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0212");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0212");
    }
