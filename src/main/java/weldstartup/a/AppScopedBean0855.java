...
public class AppScopedBean0855 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0855.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0855");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0855");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0855");
    }
