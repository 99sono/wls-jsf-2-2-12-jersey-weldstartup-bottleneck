...
public class AppScopedBean0482 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0482.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0482");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0482");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0482");
    }
