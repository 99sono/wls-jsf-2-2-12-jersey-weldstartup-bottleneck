...
public class AppScopedBean0469 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0469.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0469");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0469");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0469");
    }
