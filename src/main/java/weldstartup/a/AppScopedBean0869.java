...
public class AppScopedBean0869 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0869.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0869");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0869");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0869");
    }
