...
public class AppScopedBean0118 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0118.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0118");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0118");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0118");
    }
