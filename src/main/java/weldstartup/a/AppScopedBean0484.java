...
public class AppScopedBean0484 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0484.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0484");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0484");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0484");
    }
