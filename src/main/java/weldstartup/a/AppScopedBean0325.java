...
public class AppScopedBean0325 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0325.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0325");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0325");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0325");
    }
