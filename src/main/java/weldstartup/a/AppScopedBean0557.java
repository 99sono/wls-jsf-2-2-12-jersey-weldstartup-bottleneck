...
public class AppScopedBean0557 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0557.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0557");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0557");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0557");
    }
