...
public class AppScopedBean0153 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0153.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0153");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0153");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0153");
    }
