...
public class AppScopedBean0570 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0570.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0570");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0570");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0570");
    }
