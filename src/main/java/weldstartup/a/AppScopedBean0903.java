...
public class AppScopedBean0903 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0903.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0903");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0903");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0903");
    }
