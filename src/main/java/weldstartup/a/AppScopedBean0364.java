...
public class AppScopedBean0364 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0364.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0364");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0364");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0364");
    }
