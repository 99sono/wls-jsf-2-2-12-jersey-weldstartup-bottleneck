...
public class AppScopedBean0957 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0957.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0957");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0957");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0957");
    }
