...
public class AppScopedBean0813 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0813.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0813");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0813");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0813");
    }
