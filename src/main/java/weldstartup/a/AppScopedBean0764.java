...
public class AppScopedBean0764 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0764.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0764");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0764");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0764");
    }
