...
public class AppScopedBean0732 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0732.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0732");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0732");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0732");
    }
