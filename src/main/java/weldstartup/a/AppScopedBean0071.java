...
public class AppScopedBean0071 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0071.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0071");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0071");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0071");
    }
