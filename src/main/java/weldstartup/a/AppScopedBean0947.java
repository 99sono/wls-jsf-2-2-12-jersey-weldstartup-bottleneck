...
public class AppScopedBean0947 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0947.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0947");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0947");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0947");
    }
