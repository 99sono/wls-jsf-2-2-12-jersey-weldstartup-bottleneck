...
public class AppScopedBean0533 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0533.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0533");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0533");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0533");
    }
