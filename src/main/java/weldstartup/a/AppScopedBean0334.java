...
public class AppScopedBean0334 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0334.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0334");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0334");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0334");
    }
