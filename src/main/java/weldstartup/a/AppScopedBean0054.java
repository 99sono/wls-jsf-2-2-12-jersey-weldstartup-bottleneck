...
public class AppScopedBean0054 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0054.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0054");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0054");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0054");
    }
