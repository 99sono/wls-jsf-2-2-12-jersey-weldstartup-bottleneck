...
public class AppScopedBean0145 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0145.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0145");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0145");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0145");
    }
