...
public class AppScopedBean0894 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0894.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0894");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0894");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0894");
    }
