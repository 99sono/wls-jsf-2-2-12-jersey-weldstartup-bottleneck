...
public class AppScopedBean0021 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0021.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0021");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0021");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0021");
    }
