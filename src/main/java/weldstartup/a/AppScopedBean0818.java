...
public class AppScopedBean0818 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0818.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0818");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0818");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0818");
    }
