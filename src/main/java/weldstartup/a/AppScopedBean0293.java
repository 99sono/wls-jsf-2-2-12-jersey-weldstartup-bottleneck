...
public class AppScopedBean0293 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0293.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0293");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0293");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0293");
    }
