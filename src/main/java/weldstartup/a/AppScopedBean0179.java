...
public class AppScopedBean0179 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0179.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0179");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0179");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0179");
    }
