...
public class AppScopedBean0944 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0944.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0944");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0944");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0944");
    }
