...
public class AppScopedBean0492 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0492.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0492");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0492");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0492");
    }
