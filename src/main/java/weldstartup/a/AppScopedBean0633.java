...
public class AppScopedBean0633 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0633.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0633");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0633");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0633");
    }
