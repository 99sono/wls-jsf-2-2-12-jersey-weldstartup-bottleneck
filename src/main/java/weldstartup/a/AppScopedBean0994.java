...
public class AppScopedBean0994 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0994.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0994");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0994");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0994");
    }
