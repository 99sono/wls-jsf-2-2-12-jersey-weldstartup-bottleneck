...
public class AppScopedBean0174 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0174.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0174");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0174");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0174");
    }
