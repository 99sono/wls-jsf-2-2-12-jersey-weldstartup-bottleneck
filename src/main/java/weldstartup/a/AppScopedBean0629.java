...
public class AppScopedBean0629 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0629.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0629");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0629");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0629");
    }
