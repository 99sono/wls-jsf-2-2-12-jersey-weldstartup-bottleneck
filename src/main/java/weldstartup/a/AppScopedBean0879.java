...
public class AppScopedBean0879 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0879.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0879");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0879");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0879");
    }
