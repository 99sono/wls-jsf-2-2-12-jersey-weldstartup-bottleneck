...
public class AppScopedBean0815 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0815.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0815");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0815");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0815");
    }
