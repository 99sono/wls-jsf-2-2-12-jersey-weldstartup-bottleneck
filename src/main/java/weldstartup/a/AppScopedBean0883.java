...
public class AppScopedBean0883 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0883.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0883");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0883");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0883");
    }
