...
public class AppScopedBean0845 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0845.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0845");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0845");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0845");
    }
