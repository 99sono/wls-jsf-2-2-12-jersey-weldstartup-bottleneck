...
public class AppScopedBean0842 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0842.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0842");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0842");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0842");
    }
