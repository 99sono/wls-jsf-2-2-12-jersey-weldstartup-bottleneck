...
public class AppScopedBean0575 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0575.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0575");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0575");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0575");
    }
