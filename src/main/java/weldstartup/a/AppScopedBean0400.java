...
public class AppScopedBean0400 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0400.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0400");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0400");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0400");
    }
