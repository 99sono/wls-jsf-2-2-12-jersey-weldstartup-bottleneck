...
public class AppScopedBean0158 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0158.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0158");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0158");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0158");
    }
