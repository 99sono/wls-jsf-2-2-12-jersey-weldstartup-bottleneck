...
public class AppScopedBean0353 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0353.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0353");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0353");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0353");
    }
