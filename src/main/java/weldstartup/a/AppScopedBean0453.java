...
public class AppScopedBean0453 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0453.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0453");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0453");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0453");
    }
