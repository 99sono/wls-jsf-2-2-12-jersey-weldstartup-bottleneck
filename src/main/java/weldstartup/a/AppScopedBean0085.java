...
public class AppScopedBean0085 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0085.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0085");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0085");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0085");
    }
