...
public class AppScopedBean0073 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0073.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0073");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0073");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0073");
    }
