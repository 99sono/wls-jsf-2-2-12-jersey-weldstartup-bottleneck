...
public class AppScopedBean0905 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0905.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0905");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0905");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0905");
    }
