...
public class AppScopedBean0149 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0149.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0149");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0149");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0149");
    }
