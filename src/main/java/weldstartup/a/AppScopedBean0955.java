...
public class AppScopedBean0955 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0955.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0955");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0955");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0955");
    }
