...
public class AppScopedBean0673 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0673.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0673");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0673");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0673");
    }
