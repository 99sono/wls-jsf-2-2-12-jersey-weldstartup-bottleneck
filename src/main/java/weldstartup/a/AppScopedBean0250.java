...
public class AppScopedBean0250 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0250.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0250");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0250");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0250");
    }
