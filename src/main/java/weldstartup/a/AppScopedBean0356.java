...
public class AppScopedBean0356 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0356.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0356");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0356");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0356");
    }
