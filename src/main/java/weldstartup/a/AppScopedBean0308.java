...
public class AppScopedBean0308 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0308.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0308");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0308");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0308");
    }
