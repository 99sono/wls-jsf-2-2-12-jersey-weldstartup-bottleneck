...
public class AppScopedBean0549 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0549.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0549");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0549");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0549");
    }
