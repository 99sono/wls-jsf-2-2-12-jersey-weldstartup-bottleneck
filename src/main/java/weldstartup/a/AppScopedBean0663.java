...
public class AppScopedBean0663 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0663.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0663");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0663");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0663");
    }
