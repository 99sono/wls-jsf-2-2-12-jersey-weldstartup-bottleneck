...
public class AppScopedBean0720 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0720.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0720");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0720");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0720");
    }
