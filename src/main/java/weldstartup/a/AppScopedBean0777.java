...
public class AppScopedBean0777 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0777.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0777");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0777");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0777");
    }
