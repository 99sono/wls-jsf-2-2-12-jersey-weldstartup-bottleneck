...
public class AppScopedBean0182 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0182.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0182");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0182");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0182");
    }
