...
public class AppScopedBean0537 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0537.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0537");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0537");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0537");
    }
