...
public class AppScopedBean0311 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0311.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0311");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0311");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0311");
    }
