...
public class AppScopedBean0279 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0279.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0279");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0279");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0279");
    }
