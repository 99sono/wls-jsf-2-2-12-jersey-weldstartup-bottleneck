...
public class AppScopedBean0447 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0447.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0447");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0447");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0447");
    }
