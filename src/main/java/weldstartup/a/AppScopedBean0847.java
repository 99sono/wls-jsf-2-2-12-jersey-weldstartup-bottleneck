...
public class AppScopedBean0847 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0847.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0847");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0847");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0847");
    }
