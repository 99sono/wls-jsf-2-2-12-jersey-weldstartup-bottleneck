...
public class AppScopedBean0326 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0326.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0326");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0326");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0326");
    }
