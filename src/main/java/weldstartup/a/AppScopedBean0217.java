...
public class AppScopedBean0217 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0217.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0217");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0217");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0217");
    }
