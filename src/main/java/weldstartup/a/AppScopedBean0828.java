...
public class AppScopedBean0828 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0828.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0828");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0828");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0828");
    }
