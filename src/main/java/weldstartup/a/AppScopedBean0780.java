...
public class AppScopedBean0780 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0780.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0780");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0780");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0780");
    }
