...
public class AppScopedBean0664 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0664.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0664");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0664");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0664");
    }
