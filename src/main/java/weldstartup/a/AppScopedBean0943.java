...
public class AppScopedBean0943 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0943.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0943");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0943");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0943");
    }
