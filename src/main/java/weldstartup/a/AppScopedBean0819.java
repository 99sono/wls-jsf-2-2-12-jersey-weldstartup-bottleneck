...
public class AppScopedBean0819 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0819.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0819");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0819");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0819");
    }
