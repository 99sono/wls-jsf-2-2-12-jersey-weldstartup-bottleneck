...
public class AppScopedBean0596 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0596.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0596");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0596");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0596");
    }
