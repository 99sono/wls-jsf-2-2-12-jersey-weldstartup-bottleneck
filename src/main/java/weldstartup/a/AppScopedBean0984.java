...
public class AppScopedBean0984 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0984.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0984");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0984");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0984");
    }
