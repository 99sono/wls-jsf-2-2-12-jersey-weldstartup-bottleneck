...
public class AppScopedBean0151 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0151.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0151");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0151");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0151");
    }
