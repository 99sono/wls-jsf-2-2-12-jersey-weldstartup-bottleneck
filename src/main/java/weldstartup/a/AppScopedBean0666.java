...
public class AppScopedBean0666 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0666.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0666");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0666");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0666");
    }
