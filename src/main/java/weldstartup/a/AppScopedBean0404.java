...
public class AppScopedBean0404 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0404.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0404");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0404");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0404");
    }
