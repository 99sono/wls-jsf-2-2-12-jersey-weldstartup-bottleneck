...
public class AppScopedBean0910 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0910.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0910");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0910");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0910");
    }
