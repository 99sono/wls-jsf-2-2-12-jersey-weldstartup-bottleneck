...
public class AppScopedBean0592 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0592.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0592");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0592");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0592");
    }
