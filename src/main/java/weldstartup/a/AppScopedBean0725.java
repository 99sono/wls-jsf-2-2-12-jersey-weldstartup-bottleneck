...
public class AppScopedBean0725 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0725.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0725");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0725");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0725");
    }
