...
public class AppScopedBean0228 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0228.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0228");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0228");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0228");
    }
