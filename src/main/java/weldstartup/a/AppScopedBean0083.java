...
public class AppScopedBean0083 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0083.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0083");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0083");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0083");
    }
