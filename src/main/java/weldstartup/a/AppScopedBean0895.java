...
public class AppScopedBean0895 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0895.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0895");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0895");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0895");
    }
