...
public class AppScopedBean0690 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0690.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0690");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0690");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0690");
    }
