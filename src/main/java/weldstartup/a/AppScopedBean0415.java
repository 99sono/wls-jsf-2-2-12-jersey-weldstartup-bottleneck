...
public class AppScopedBean0415 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0415.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0415");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0415");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0415");
    }
