...
public class AppScopedBean0191 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0191.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0191");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0191");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0191");
    }
