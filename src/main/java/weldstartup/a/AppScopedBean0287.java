...
public class AppScopedBean0287 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0287.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0287");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0287");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0287");
    }
