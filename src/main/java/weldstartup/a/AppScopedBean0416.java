...
public class AppScopedBean0416 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0416.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0416");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0416");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0416");
    }
