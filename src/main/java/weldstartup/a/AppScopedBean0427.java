...
public class AppScopedBean0427 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0427.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0427");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0427");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0427");
    }
