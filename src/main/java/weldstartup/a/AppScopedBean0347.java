...
public class AppScopedBean0347 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0347.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0347");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0347");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0347");
    }
