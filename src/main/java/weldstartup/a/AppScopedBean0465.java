...
public class AppScopedBean0465 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0465.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0465");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0465");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0465");
    }
