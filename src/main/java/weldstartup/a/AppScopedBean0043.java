...
public class AppScopedBean0043 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0043.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0043");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0043");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0043");
    }
