...
public class AppScopedBean0760 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0760.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0760");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0760");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0760");
    }
