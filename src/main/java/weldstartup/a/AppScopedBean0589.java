...
public class AppScopedBean0589 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0589.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0589");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0589");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0589");
    }
