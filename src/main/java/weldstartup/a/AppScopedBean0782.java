...
public class AppScopedBean0782 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0782.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0782");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0782");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0782");
    }
