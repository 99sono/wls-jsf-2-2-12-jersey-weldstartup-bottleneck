...
public class AppScopedBean0638 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0638.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0638");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0638");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0638");
    }
