...
public class AppScopedBean0490 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0490.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0490");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0490");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0490");
    }
