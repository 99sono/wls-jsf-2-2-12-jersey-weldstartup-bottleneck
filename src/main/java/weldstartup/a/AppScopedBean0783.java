...
public class AppScopedBean0783 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0783.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0783");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0783");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0783");
    }
