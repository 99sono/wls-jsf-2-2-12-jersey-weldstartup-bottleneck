...
public class AppScopedBean0714 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0714.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0714");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0714");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0714");
    }
