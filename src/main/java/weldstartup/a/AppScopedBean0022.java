...
public class AppScopedBean0022 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0022.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0022");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0022");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0022");
    }
