...
public class AppScopedBean0332 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0332.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0332");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0332");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0332");
    }
