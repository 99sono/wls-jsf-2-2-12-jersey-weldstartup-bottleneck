...
public class AppScopedBean0357 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0357.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0357");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0357");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0357");
    }
