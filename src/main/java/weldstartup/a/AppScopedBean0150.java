...
public class AppScopedBean0150 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0150.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0150");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0150");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0150");
    }
