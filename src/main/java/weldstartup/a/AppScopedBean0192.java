...
public class AppScopedBean0192 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0192.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0192");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0192");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0192");
    }
