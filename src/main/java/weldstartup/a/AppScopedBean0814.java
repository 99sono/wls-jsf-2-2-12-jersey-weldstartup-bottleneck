...
public class AppScopedBean0814 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0814.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0814");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0814");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0814");
    }
