...
public class AppScopedBean0627 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0627.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0627");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0627");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0627");
    }
