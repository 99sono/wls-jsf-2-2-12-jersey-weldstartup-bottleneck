...
public class AppScopedBean0069 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0069.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0069");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0069");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0069");
    }
