...
public class AppScopedBean0489 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0489.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0489");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0489");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0489");
    }
