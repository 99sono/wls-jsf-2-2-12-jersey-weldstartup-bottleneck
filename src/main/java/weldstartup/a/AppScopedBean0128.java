...
public class AppScopedBean0128 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0128.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0128");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0128");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0128");
    }
