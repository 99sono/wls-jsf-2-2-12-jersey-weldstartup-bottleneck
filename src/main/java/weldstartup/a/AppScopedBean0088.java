...
public class AppScopedBean0088 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0088.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0088");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0088");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0088");
    }
