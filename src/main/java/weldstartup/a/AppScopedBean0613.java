...
public class AppScopedBean0613 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0613.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0613");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0613");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0613");
    }
