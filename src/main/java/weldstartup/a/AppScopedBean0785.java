...
public class AppScopedBean0785 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0785.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0785");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0785");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0785");
    }
