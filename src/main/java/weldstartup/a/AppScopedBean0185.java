...
public class AppScopedBean0185 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0185.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0185");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0185");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0185");
    }
