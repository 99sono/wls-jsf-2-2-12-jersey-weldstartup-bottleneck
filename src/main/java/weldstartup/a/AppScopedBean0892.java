...
public class AppScopedBean0892 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0892.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0892");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0892");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0892");
    }
