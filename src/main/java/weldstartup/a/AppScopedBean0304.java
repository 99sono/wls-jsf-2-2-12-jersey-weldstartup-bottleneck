...
public class AppScopedBean0304 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0304.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0304");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0304");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0304");
    }
