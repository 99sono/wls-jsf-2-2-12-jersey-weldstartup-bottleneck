...
public class AppScopedBean0238 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0238.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0238");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0238");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0238");
    }
