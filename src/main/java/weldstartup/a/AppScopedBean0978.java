...
public class AppScopedBean0978 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0978.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0978");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0978");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0978");
    }
