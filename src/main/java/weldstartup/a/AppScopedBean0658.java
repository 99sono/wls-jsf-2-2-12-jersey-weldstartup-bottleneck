...
public class AppScopedBean0658 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0658.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0658");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0658");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0658");
    }
