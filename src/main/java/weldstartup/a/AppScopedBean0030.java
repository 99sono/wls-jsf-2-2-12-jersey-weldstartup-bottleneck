...
public class AppScopedBean0030 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0030.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0030");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0030");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0030");
    }
