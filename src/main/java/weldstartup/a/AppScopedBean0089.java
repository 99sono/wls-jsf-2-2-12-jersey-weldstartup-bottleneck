...
public class AppScopedBean0089 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0089.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0089");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0089");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0089");
    }
