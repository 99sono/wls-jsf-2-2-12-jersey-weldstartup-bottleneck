...
public class AppScopedBean0358 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0358.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0358");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0358");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0358");
    }
