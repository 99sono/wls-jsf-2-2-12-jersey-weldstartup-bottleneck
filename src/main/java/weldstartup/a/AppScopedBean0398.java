...
public class AppScopedBean0398 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0398.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0398");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0398");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0398");
    }
