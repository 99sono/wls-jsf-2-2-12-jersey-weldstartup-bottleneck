...
public class AppScopedBean0951 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0951.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0951");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0951");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0951");
    }
