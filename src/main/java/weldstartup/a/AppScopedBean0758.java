...
public class AppScopedBean0758 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0758.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0758");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0758");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0758");
    }
