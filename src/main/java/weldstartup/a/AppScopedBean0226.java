...
public class AppScopedBean0226 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0226.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0226");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0226");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0226");
    }
