...
public class AppScopedBean0256 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0256.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0256");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0256");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0256");
    }
