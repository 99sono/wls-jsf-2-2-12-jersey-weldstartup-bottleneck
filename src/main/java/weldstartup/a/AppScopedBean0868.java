...
public class AppScopedBean0868 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0868.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0868");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0868");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0868");
    }
