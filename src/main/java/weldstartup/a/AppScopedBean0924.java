...
public class AppScopedBean0924 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0924.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0924");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0924");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0924");
    }
