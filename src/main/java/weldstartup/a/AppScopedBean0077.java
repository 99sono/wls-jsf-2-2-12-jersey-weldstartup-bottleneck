...
public class AppScopedBean0077 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0077.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0077");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0077");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0077");
    }
