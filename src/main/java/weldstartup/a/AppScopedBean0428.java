...
public class AppScopedBean0428 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0428.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0428");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0428");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0428");
    }
