...
public class AppScopedBean0122 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0122.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0122");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0122");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0122");
    }
