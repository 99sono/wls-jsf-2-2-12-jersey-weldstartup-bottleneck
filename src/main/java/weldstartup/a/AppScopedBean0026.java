...
public class AppScopedBean0026 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0026.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0026");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0026");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0026");
    }
