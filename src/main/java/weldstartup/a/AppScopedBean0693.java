...
public class AppScopedBean0693 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0693.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0693");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0693");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0693");
    }
