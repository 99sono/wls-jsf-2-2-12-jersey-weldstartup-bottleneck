...
public class AppScopedBean0993 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0993.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0993");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0993");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0993");
    }
