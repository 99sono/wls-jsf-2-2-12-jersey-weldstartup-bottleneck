...
public class AppScopedBean0713 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0713.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0713");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0713");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0713");
    }
