...
public class AppScopedBean0687 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0687.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0687");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0687");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0687");
    }
