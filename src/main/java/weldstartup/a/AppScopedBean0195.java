...
public class AppScopedBean0195 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0195.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0195");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0195");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0195");
    }
