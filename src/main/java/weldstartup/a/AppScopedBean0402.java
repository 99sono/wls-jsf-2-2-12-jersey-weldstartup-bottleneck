...
public class AppScopedBean0402 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0402.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0402");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0402");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0402");
    }
