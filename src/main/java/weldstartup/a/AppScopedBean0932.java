...
public class AppScopedBean0932 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0932.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0932");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0932");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0932");
    }
