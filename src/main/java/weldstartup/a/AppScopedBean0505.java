...
public class AppScopedBean0505 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0505.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0505");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0505");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0505");
    }
