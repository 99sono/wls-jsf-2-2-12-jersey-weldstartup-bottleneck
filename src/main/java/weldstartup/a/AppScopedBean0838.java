...
public class AppScopedBean0838 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0838.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0838");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0838");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0838");
    }
