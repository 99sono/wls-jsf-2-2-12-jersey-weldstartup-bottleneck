...
public class AppScopedBean0692 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0692.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0692");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0692");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0692");
    }
