...
public class AppScopedBean0461 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0461.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0461");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0461");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0461");
    }
