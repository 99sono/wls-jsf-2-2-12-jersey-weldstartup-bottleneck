...
public class AppScopedBean0741 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0741.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0741");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0741");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0741");
    }
