...
public class AppScopedBean0373 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0373.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0373");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0373");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0373");
    }
