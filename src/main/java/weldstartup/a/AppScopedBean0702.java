...
public class AppScopedBean0702 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0702.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0702");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0702");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0702");
    }
