...
public class AppScopedBean0502 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0502.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0502");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0502");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0502");
    }
