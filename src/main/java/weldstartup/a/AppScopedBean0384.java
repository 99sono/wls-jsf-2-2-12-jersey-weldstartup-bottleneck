...
public class AppScopedBean0384 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0384.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0384");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0384");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0384");
    }
