...
public class AppScopedBean0105 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0105.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0105");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0105");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0105");
    }
