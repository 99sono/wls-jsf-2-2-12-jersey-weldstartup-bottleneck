...
public class AppScopedBean0432 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0432.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0432");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0432");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0432");
    }
