...
public class AppScopedBean0567 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0567.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0567");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0567");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0567");
    }
