...
public class AppScopedBean0017 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0017.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0017");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0017");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0017");
    }
