...
public class AppScopedBean0528 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0528.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0528");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0528");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0528");
    }
