...
public class AppScopedBean0319 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0319.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0319");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0319");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0319");
    }
