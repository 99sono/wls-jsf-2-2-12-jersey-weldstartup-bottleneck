...
public class AppScopedBean0035 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0035.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0035");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0035");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0035");
    }
