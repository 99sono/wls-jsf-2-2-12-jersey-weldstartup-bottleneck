...
public class AppScopedBean0990 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0990.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0990");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0990");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0990");
    }
