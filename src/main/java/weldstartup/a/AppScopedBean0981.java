...
public class AppScopedBean0981 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0981.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0981");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0981");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0981");
    }
