...
public class AppScopedBean0912 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0912.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0912");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0912");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0912");
    }
