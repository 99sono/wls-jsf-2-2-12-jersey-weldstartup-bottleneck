...
public class AppScopedBean0049 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0049.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0049");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0049");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0049");
    }
