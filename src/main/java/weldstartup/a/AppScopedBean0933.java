...
public class AppScopedBean0933 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0933.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0933");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0933");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0933");
    }
