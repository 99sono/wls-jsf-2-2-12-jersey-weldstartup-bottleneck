...
public class AppScopedBean0770 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0770.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0770");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0770");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0770");
    }
