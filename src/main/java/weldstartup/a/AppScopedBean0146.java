...
public class AppScopedBean0146 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0146.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0146");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0146");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0146");
    }
