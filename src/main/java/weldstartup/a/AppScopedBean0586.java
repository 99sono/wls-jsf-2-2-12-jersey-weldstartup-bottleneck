...
public class AppScopedBean0586 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0586.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0586");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0586");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0586");
    }
