...
public class AppScopedBean0996 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0996.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0996");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0996");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0996");
    }
