...
public class AppScopedBean0507 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0507.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0507");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0507");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0507");
    }
