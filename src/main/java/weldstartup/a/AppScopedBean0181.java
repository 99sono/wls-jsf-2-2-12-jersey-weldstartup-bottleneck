...
public class AppScopedBean0181 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0181.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0181");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0181");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0181");
    }
