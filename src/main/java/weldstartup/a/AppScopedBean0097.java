...
public class AppScopedBean0097 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0097.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0097");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0097");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0097");
    }
