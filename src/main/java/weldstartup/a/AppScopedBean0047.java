...
public class AppScopedBean0047 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0047.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0047");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0047");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0047");
    }
