...
public class AppScopedBean0566 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0566.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0566");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0566");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0566");
    }
