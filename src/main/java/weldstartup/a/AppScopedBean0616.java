...
public class AppScopedBean0616 {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppScopedBean0616.class);
    ...
    public void postConstruct() {
        LOGGER.info("Post construct method invoked. AppScopedBean0616");
    }

    @PreDestroy
    public void preDestroy() {
        LOGGER.info("Pre-destroy method invoked. AppScopedBean0616");
    }

    public void dummyLogic() {
        LOGGER.info("Dummy logic invoked. AppScopedBean0616");
    }
